...
def run_json_qcschema(json_data, clean, json_serialization, keep_wfn=False):
    ...
    if "tIJAB" in json_data["extras"]["psi4:arrays"]:
        json_data["extras"]["psi4:arrays"]["tIJAB"] = wfn.get_amplitudes("tIJAB").to_array()
    if "tIA" in json_data["extras"]["psi4:arrays"]:
        json_data["extras"]["psi4:arrays"]["tIA"] = wfn.get_amplitudes("tIA").to_array()
    if "Da" in json_data["extras"]["psi4:arrays"]:
        json_data["extras"]["psi4:arrays"]["Da"] = wfn.Da().to_array()

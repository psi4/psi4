...
C  in the file COPYRIGHT.
         SUBROUTINE  ERD__RYS_ROOTS_WEIGHTS
     +
     +                    ( NT,NTGQP,
     +                      NGQP,NMOM,
     +                      TVAL,RYSZERO,
...
C
C
 1000    CALL  ERD__RYS_1_ROOTS_WEIGHTS (NT,TVAL,          RTS,WTS)
         RETURN
 2000    CALL  ERD__RYS_2_ROOTS_WEIGHTS (NT,NTGQP,TVAL,    RTS,WTS)
         RETURN
 3000    CALL  ERD__RYS_3_ROOTS_WEIGHTS (NT,NTGQP,TVAL,    RTS,WTS)
         RETURN
 4000    CALL  ERD__RYS_4_ROOTS_WEIGHTS (NT,NTGQP,TVAL,    RTS,WTS)
         RETURN
 5000    CALL  ERD__RYS_5_ROOTS_WEIGHTS (NT,NTGQP,TVAL,    RTS,WTS)
         RETURN
C
C

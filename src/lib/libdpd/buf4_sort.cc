                    ...
                    int pqnum, int rsnum, const char *label)
{
    ...
    case qspr:
        ...
        if(incore) {
            ...
            psi::fprintf(stderr, "LIBDPD: Out-of-core algorithm not yet coded for qspr sort.\n");
            dpd_error("buf4_sort", stderr);
        }
    ...
    case qsrp:
        ...
        if(incore) {
            ...
            psi::fprintf(stderr, "LIBDPD: Out-of-core algorithm not yet coded for qsrp sort.\n");
            dpd_error("buf4_sort", stderr);
        }
    ...
    case rpqs:
        ...
        if(incore) {
            ...
            psi::fprintf(stderr, "LIBDPD: Out-of-core algorithm not yet coded for rpqs sort.\n");
            dpd_error("buf4_sort", stderr);
        }
    ...
    case rpsq:
        ...
        if(incore) {
            ...
            psi::fprintf(stderr, "LIBDPD: Out-of-core algorithm not yet coded for rpsq sort.\n");
            dpd_error("buf4_sort", stderr);
        }
...
#ifdef DPD_DEBUG
                psi::fprintf(stdout, "Gpq = %d\n", Gpq);
                psi::fprintf(stdout, "OutBuf.rowtot[Gpq]  = %d\n", OutBuf.params->rowtot[Gpq]);
                psi::fprintf(stdout, "OutBuf.coltot[Grs]  = %d\n", OutBuf.params->coltot[Grs]);
                psi::fprintf(stdout, "out_nbuckets        = %d\n", out_nbuckets);
                psi::fprintf(stdout, "out_rows_per_bucket = %d\n", out_rows_per_bucket);
                psi::fprintf(stdout, "out_rows_left       = %d\n", out_rows_left);
                psi::fprintf(stdout, "InBuf.rowtot[Grs]   = %d\n", InBuf->params->rowtot[Grs]);
                psi::fprintf(stdout, "InBuf.coltot[Gpq]   = %d\n", InBuf->params->coltot[Gpq]);
                psi::fprintf(stdout, "in_nbuckets         = %d\n", in_nbuckets);
                psi::fprintf(stdout, "in_rows_per_bucket  = %d\n", in_rows_per_bucket);
                psi::fprintf(stdout, "in_rows_left        = %d\n", in_rows_left);
                fflush(stdout);
#endif
    ...
    case srqp:
        ...
        if(incore) {
            ...
            psi::fprintf(stderr, "LIBDPD: Out-of-core algorithm not yet coded for srqp sort.\n");
            dpd_error("buf4_sort", stderr);
        }

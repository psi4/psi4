...
boost::shared_ptr<Dispersion> Dispersion::build(const std::string & name, double s6, double s8, double sr6, double sr8)
{
...
double D1::compute_energy(boost::shared_ptr<Molecule> mol)
{
    double energy = 0.0;
...
SharedMatrix D1::compute_gradient(boost::shared_ptr<Molecule> mol)
{
    // Build Z, x, y, and z
    int natom = 0;
    ...
    SharedMatrix G(new Matrix("D1 Gradient", natom, 3));
    double* grad = G->pointer()[0];
...
SharedMatrix D1::compute_hessian(boost::shared_ptr<Molecule> mol)
{
    // Build Z, x, y, and z
    int natom = 0;
    ...
    // gradient array in [x1 y1 z1 x2 y2 z2 ... ]
    SharedMatrix H(new Matrix("D1 Hessian", 3*natom, 3*natom));
    double** hess = H->pointer();
...
double D2::compute_energy(boost::shared_ptr<Molecule> mol)
{
    double energy = 0.0;
...
SharedMatrix D2::compute_gradient(boost::shared_ptr<Molecule> mol)
{
    // Build Z, x, y, and z
    int natom = 0;
    ...
    // gradient array in [x1 y1 z1 x2 y2 z2 ... ]
    SharedMatrix G(new Matrix("D2 Gradient", natom, 3));
    double* grad = G->pointer()[0];
...
SharedMatrix D2::compute_hessian(boost::shared_ptr<Molecule> mol)
{
    // Build Z, x, y, and z
    int natom = 0;
    ...
    // gradient array in [x1 y1 z1 x2 y2 z2 ... ]
    SharedMatrix H(new Matrix("D2 Hessian", 3*natom, 3*natom));
    double** hess = H->pointer();
...
double D3::compute_energy(boost::shared_ptr<Molecule> mol)
{
    throw PSIEXCEPTION("D3: Not implemented");
}
SharedMatrix D3::compute_gradient(boost::shared_ptr<Molecule> mol)
{
    throw PSIEXCEPTION("D3: Not implemented");
}
SharedMatrix D3::compute_hessian(boost::shared_ptr<Molecule> mol)
{
    throw PSIEXCEPTION("D3: Not implemented");
}

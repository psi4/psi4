...
double SAPT2::exch120_k11u_3()
{
  ...
  for(int r1=0; r1<nvirA_; r1++) {
    C_DGEMM('T','N',noccB_,aoccA_*aoccA_,nvirA_,1.0,&(sAB_[noccA_][0]),
      nmo_,&(thetaRRAA[r1*nvirA_][0]),aoccA_*aoccA_,0.0,
  ...
  for(int r1=0; r1<nvirA_; r1++) {
    C_DGEMM('T','N',noccB_,aoccA_*aoccA_,nvirA_,1.0,&(sAB_[noccA_][0]),
      nmo_,&(tRRAA[r1*nvirA_][0]),aoccA_*aoccA_,0.0,&(tRBAA[r1*noccB_][0]),
      aoccA_*aoccA_);
  }
...
double SAPT2::exch102_k11u_3()
{
  ...
  for(int s1=0; s1<nvirB_; s1++) {
    C_DGEMM('N','N',noccA_,aoccB_*aoccB_,nvirB_,1.0,&(sAB_[0][noccB_]),nmo_,
  ...
  for(int s1=0; s1<nvirB_; s1++) {
    C_DGEMM('N','N',noccA_,aoccB_*aoccB_,nvirB_,1.0,&(sAB_[0][noccB_]),
      nmo_,&(tSSBB[s1*nvirB_][0]),aoccB_*aoccB_,0.0,
...
double SAPT2::exch120_k11u_4()
{
  ...
  C_DGEMM('N','T',aoccA_,aoccA_,noccB_,1.0,&(sAB_[foccA_][0]),nmo_,
    &(sAB_[foccA_][0]),nmo_,0.0,&(sAA[0][0]),aoccA_);
  ...
  C_DGEMM('N','N',aoccA_,noccB_*(ndf_+3),noccB_,1.0,&(sAB_[foccA_][0]),nmo_,
...
double SAPT2::exch102_k11u_4()
{
  ...
  C_DGEMM('T','N',aoccB_,aoccB_*(ndf_+3),noccA_,1.0,&(sAB_[0][foccB_]),nmo_,
  ...
  C_DGEMM('T','N',aoccB_,aoccB_,noccA_,1.0,&(sAB_[0][foccB_]),nmo_,
    &(sAB_[0][foccB_]),nmo_,0.0,&(sBB[0][0]),aoccB_);
  ...
  C_DGEMM('T','N',aoccB_,noccA_*(ndf_+3),noccA_,1.0,&(sAB_[0][foccB_]),nmo_,
  ...
  for(int b=0; b<aoccB_; b++) {
    C_DGEMM('T','N',aoccB_,ndf_+3,noccA_,1.0,&(sAB_[0][foccB_]),nmo_,
...
double SAPT2::exch120_k11u_5()
{
  ...
  C_DGEMM('T','N',noccB_,nvirA_*(ndf_+3),aoccA_,1.0,&(sAB_[foccA_][0]),nmo_,
...
double SAPT2::exch102_k11u_5()
{
  ...
  C_DGEMM('N','N',noccA_,nvirB_*(ndf_+3),aoccB_,1.0,&(sAB_[0][foccB_]),nmo_,
...
double SAPT2::exch120_k11u_6()
{
  ...
  C_DGEMM('T','N',noccB_,aoccA_*(ndf_+3),aoccA_,1.0,&(sAB_[foccA_][0]),nmo_,
  ...
  for(int b=0; b<noccB_; b++) {
    C_DGEMM('T','N',noccB_,ndf_+3,aoccA_,1.0,&(sAB_[foccA_][0]),nmo_,
  ...
  C_DGEMM('T','N',noccB_,nvirA_*(ndf_+3),nvirA_,1.0,&(sAB_[noccA_][0]),
    nmo_,&(T_p_RR[0][0]),nvirA_*(ndf_+3),0.0,&(C_p_BR[0][0]),nvirA_*(ndf_+3));
  ...
  C_DGEMM('N','T',nvirA_,nvirA_,noccB_,1.0,&(sAB_[noccA_][0]),nmo_,
    &(sAB_[noccA_][0]),nmo_,0.0,&(sRR[0][0]),nvirA_);
...
double SAPT2::exch102_k11u_6()
{
  ...
  C_DGEMM('N','N',noccA_,aoccB_*(ndf_+3),aoccB_,1.0,&(sAB_[0][foccB_]),nmo_,
  ...
  C_DGEMM('N','N',noccA_,nvirB_*(ndf_+3),nvirB_,1.0,&(sAB_[0][noccB_]),
    nmo_,&(T_p_SS[0][0]),nvirB_*(ndf_+3),0.0,&(C_p_AS[0][0]),nvirB_*(ndf_+3));
  ...
  C_DGEMM('T','N',nvirB_,nvirB_,noccA_,1.0,&(sAB_[0][noccB_]),nmo_,
    &(sAB_[0][noccB_]),nmo_,0.0,&(sSS[0][0]),nvirB_);

...
SAPT2p::SAPT2p(Options& options, shared_ptr<PSIO> psio,
  shared_ptr<Chkpt> chkpt) : SAPT2(options, psio, chkpt)
{
}
...
double SAPT2p::print_results()
{
  ...
  Process::environment.globals["SAPT ENERGY"] = sapt2p;

/*                                                                                                       
 * Test Program for GA                                                                                   
 * This is to test GA_PGroup_destroy (is a collective operation)                                               
 ...
 * _pgroup_destroy -- to destroy the created process group handle
...
main(int argc, char **argv)
{
  ...
  GA_Pgroup_destroy(p_Geven);
  GA_Pgroup_destroy(p_Godd);

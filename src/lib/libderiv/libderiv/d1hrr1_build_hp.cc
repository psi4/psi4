  /* This machine-generated function computes a quartet of (hp| first derivative integrals */

void d1hrr1_build_hp(const double *AB, double *vp, const double *I0, const double *I1,

  /* This machine-generated function computes a quartet of (dp| first derivative integrals */

void d1hrr1_build_dp(const double *AB, double *vp, const double *I0, const double *I1,

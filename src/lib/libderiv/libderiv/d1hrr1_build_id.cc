  /* This machine-generated function computes a quartet of (id| first derivative integrals */

void d1hrr1_build_id(const double *AB, double *vp, const double *I0, const double *I1,

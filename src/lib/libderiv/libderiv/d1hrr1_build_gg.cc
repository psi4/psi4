  /* This machine-generated function computes a quartet of (gg| first derivative integrals */

void d1hrr1_build_gg(const double *AB, double *vp, const double *I0, const double *I1,

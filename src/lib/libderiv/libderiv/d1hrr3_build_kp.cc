  /* This machine-generated function computes a quartet of |kp) first derivative ERIs */

void d1hrr3_build_kp(const double *CD, double *vp, const double *I0, const double *I1,
        ...
        double c5, const double *I5, double c6, const double *I6, double c7, const double *I7, int ab_num)
{
  ...
  for(ab=0;ab<ab_num;ab++) {
    ...
    *(vp++) = I0[36] + CD1*I1[28] + c3*I3[28] - c6*I6[28];
    *(vp++) = I0[37] + CD2*I1[28] + c4*I4[28] - c7*I7[28];
    *(vp++) = I0[29] + CD0*I1[29] + c2*I2[29] - c5*I5[29];
    *(vp++) = I0[37] + CD1*I1[29] + c3*I3[29] - c6*I6[29];
    *(vp++) = I0[38] + CD2*I1[29] + c4*I4[29] - c7*I7[29];
    *(vp++) = I0[30] + CD0*I1[30] + c2*I2[30] - c5*I5[30];
    *(vp++) = I0[38] + CD1*I1[30] + c3*I3[30] - c6*I6[30];
    *(vp++) = I0[39] + CD2*I1[30] + c4*I4[30] - c7*I7[30];
    *(vp++) = I0[31] + CD0*I1[31] + c2*I2[31] - c5*I5[31];
    *(vp++) = I0[39] + CD1*I1[31] + c3*I3[31] - c6*I6[31];
    *(vp++) = I0[40] + CD2*I1[31] + c4*I4[31] - c7*I7[31];
    *(vp++) = I0[32] + CD0*I1[32] + c2*I2[32] - c5*I5[32];
    *(vp++) = I0[40] + CD1*I1[32] + c3*I3[32] - c6*I6[32];
    *(vp++) = I0[41] + CD2*I1[32] + c4*I4[32] - c7*I7[32];
    *(vp++) = I0[33] + CD0*I1[33] + c2*I2[33] - c5*I5[33];
    *(vp++) = I0[41] + CD1*I1[33] + c3*I3[33] - c6*I6[33];
    *(vp++) = I0[42] + CD2*I1[33] + c4*I4[33] - c7*I7[33];
    *(vp++) = I0[34] + CD0*I1[34] + c2*I2[34] - c5*I5[34];
    *(vp++) = I0[42] + CD1*I1[34] + c3*I3[34] - c6*I6[34];
    *(vp++) = I0[43] + CD2*I1[34] + c4*I4[34] - c7*I7[34];
    *(vp++) = I0[35] + CD0*I1[35] + c2*I2[35] - c5*I5[35];
    *(vp++) = I0[43] + CD1*I1[35] + c3*I3[35] - c6*I6[35];
    *(vp++) = I0[44] + CD2*I1[35] + c4*I4[35] - c7*I7[35];
    I0 += 45;
    I1 += 36;
    I2 += 36;
    I3 += 36;

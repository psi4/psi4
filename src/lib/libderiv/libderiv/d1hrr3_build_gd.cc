  /* This machine-generated function computes a quartet of |gd) first derivative ERIs */

void d1hrr3_build_gd(const double *CD, double *vp, const double *I0, const double *I1,

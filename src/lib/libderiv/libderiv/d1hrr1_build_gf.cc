  /* This machine-generated function computes a quartet of (gf| first derivative integrals */

void d1hrr1_build_gf(const double *AB, double *vp, const double *I0, const double *I1,

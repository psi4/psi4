...
void deriv_build_DZ_m(prim_data *Data, const int abc_num, double *vp, const double *I0, const double *I1)
{
  ...
  for(abc=0;abc<abc_num;abc++) {
    ...
    *(vp++) = twotzeta*I0[46] ;
    *(vp++) = twotzeta*I0[47] - 1.000000*I1[28];
    *(vp++) = twotzeta*I0[48] - 2.000000*I1[29];
    *(vp++) = twotzeta*I0[49] - 3.000000*I1[30];
    *(vp++) = twotzeta*I0[50] - 4.000000*I1[31];
    *(vp++) = twotzeta*I0[51] - 5.000000*I1[32];
    *(vp++) = twotzeta*I0[52] - 6.000000*I1[33];
    *(vp++) = twotzeta*I0[53] - 7.000000*I1[34];
    *(vp++) = twotzeta*I0[54] - 8.000000*I1[35];
    *(vp++) = twotzeta*I0[56] ;
    *(vp++) = twotzeta*I0[57] - 1.000000*I1[36];
    *(vp++) = twotzeta*I0[58] - 2.000000*I1[37];
    *(vp++) = twotzeta*I0[59] - 3.000000*I1[38];
    *(vp++) = twotzeta*I0[60] - 4.000000*I1[39];
    *(vp++) = twotzeta*I0[61] - 5.000000*I1[40];
    *(vp++) = twotzeta*I0[62] - 6.000000*I1[41];
    *(vp++) = twotzeta*I0[63] - 7.000000*I1[42];
    *(vp++) = twotzeta*I0[64] - 8.000000*I1[43];
    *(vp++) = twotzeta*I0[65] - 9.000000*I1[44];
  I0 += 66;  I1 += 45;
  }
}

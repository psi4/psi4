  /* This machine-generated function computes a quartet of (gd| first derivative integrals */

void d1hrr1_build_gd(const double *AB, double *vp, const double *I0, const double *I1,

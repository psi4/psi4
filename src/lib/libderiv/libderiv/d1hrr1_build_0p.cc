  /* This machine-generated function computes a quartet of (0p| first derivative integrals */

void d1hrr1_build_0p(const double *AB, double *vp, const double *I0, const double *I1,

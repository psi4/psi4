  /* This machine-generated function computes a quartet of (fp| first derivative integrals */

void d1hrr1_build_fp(const double *AB, double *vp, const double *I0, const double *I1,

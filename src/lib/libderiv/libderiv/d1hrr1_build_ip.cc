  /* This machine-generated function computes a quartet of (ip| first derivative integrals */

void d1hrr1_build_ip(const double *AB, double *vp, const double *I0, const double *I1,

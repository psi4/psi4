  /* This machine-generated function computes a quartet of (ff| first derivative integrals */

void d1hrr1_build_ff(const double *AB, double *vp, const double *I0, const double *I1,

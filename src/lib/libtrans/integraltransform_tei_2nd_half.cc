                                             ...
                                             shared_ptr<MOSpace> s3, shared_ptr<MOSpace> s4)
{
    ...
    if(_useIWL) iwl = new IWL(_psio, PSIF_MO_AA_TEI, _tolerance, 0, 0);
    ...
    if(_transformationType != Restricted){
        ...
        if(_useIWL) iwl = new IWL(_psio, PSIF_MO_AB_TEI, _tolerance, 0, 0);
        ...
        if(_useIWL) iwl = new IWL(_psio, PSIF_MO_BB_TEI, _tolerance, 0, 0);

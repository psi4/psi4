...
C  in the file COPYRIGHT.
         SUBROUTINE  ERD__MEMORY_DERV_CSGTO
     +
     +                    ( NALPHA,NCOEFF,
     ...
     +
C------------------------------------------------------------------------
C  OPERATION   : ERD__MEMORY_DERV_CSGTO
...
C                derivative integrals. Most of this data is not needed
...
C
         ...
         INEED = 2 * ZNEED + NDERX + NDERY + NDERZ + 3
...
C                primitive (e0|cd) or (ab|cd) contracted derivative
C                batch generation.
C
C
     ...
     +                         DUMMYI (50),DUMMYI (51),DUMMYI (52),
     +                         DUMMYI (53),DUMMYI (54),DUMMYI (55),
     +                         DUMMYI (56) )
     +
     +

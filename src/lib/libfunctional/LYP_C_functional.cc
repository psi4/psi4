...
void LYP_C_Functional::computeRKSFunctional(shared_ptr<Properties> prop)
{
    ...
    for (int index = 0; index < ntrue; index++) {
        ...
        if (rho_a[index] > cutoff_) {
            ...
            double t4121 = 1/pow(t4120,1.0/3.0);
            double t4122 = Dd*t4121;
            double t4123 = t4122+1.0;
            double t4124 = 1/t4123;
            double t4125 = rho_a[index]*rho_a[index];
            functional_[index] = A*rho_a[index]*t4124*-2.0-A*B*1/pow(t4120,1.1E1/3.0)*t4124*exp(-C*t4121)*(t4125* \
    ...
    for (int index = 0; index < ntrue && deriv_ >= 1; index++) {
        ...
        if (rho_a[index] > cutoff_) {
            ...
            double t4128 = 1/pow(t4127,1.0/3.0);
            double t4129 = Dd*t4128;
            double t4130 = t4129+1.0;
            double t4131 = rho_a[index]*rho_a[index];
            double t4132 = 1/t4130;
            double t4151 = C*t4128;
            double t4133 = exp(-t4151);
            double t4134 = 1/pow(t4127,4.0/3.0);
            double t4135 = 1/(t4130*t4130);
            double t4136 = Dd*Dd;
            double t4137 = 1/pow(t4127,5.0/3.0);
            ...
            double t4157 = 1/(rho_a[index]*rho_a[index]*rho_a[index]*rho_a[index]*rho_a[index]);
            v_rho_a_[index] = -A*t4132-A*Dd*t4131*t4135*1/pow(t4127,7.0/3.0)*(4.0/3.0)-A*B*t4132*t4133*1/pow(t4127,1.4E1/ \
               3.0)*t4156*(1.1E1/3.0)+A*B*t4132*t4133*1/pow(t4127,1.1E1/3.0)*(-t4131*(CFext*pow(rho_a[index],5.0/ \
    ...
    for (int index = 0; index < ntrue && deriv_ >= 2; index++) {
        ...
        if (rho_a[index] > cutoff_) {
            ...
            double t4170 = 1/pow(t4169,1.0/3.0);
            double t4171 = Dd*t4170;
            double t4172 = t4171+1.0;
            double t4173 = 1/(t4172*t4172);
            double t4174 = rho_a[index]*rho_a[index];
            double t4175 = 1/t4172;
            double t4197 = C*t4170;
            double t4176 = exp(-t4197);
            double t4177 = 1/pow(t4169,1.1E1/3.0);
            double t4178 = 1/pow(t4169,4.0/3.0);
            double t4179 = Dd*Dd;
            double t4180 = 1/pow(t4169,5.0/3.0);
            double t4181 = 1/pow(t4169,7.0/3.0);
            double t4182 = 1/(t4172*t4172*t4172);
            double t4183 = 1/(rho_a[index]*rho_a[index]*rho_a[index]);
            double t4184 = 1/pow(t4169,8.0/3.0);
            ...
            double t4236 = 1/pow(t4169,1.9E1/3.0);
            ...
            double t4240 = 1/(rho_a[index]*rho_a[index]*rho_a[index]*rho_a[index]*rho_a[index]);
            double t4242 = 1/(rho_a[index]*rho_a[index]*rho_a[index]*rho_a[index]*rho_a[index]*rho_a[index]);
            v_rho_a_rho_a_[index] = A*Dd*rho_a[index]*t4181*t4173*(-1.6E1/3.0)-A*t4182*t4174*t4177*t4179*(1.6E1/ \
               9.0)+A*Dd*t4173*t4174*1/pow(t4169,1.0E1/3.0)*(8.0E1/9.0)+A*B*t4175*t4176*1/pow(t4169,1.7E1/3.0)*t4235* \
               (3.08E2/9.0)-A*B*t4175*t4176*1/pow(t4169,1.4E1/3.0)*t4239*(4.4E1/3.0)+A*B*t4175*t4176*t4177*(gamma_aa[index]* \
               (8.0/3.0)+t4195+t4188-CFext*t4196*2.0-gamma_aa[index]*t4191*2.0-rho_a[index]*t4211*2.0+t4174*(t4221+ \
               t4230-gamma_aa[index]*t4225*2.0))+A*B*t4175*t4176*t4177*(gamma_aa[index]*(1.4E1/3.0)-rho_a[index]* \
               t4211*2.0+t4174*(t4221+t4230-gamma_aa[index]*t4225*2.0-CFext*pow(rho_a[index],2.0/3.0)*(4.0E1/9.0) \
               ))+A*B*t4182*t4176*t4179*t4235*t4236*(4.0/9.0)+A*B*(C*C)*t4175*t4176*t4235*t4236*(2.0/9.0)-A*B*C*t4175* \
               t4176*t4242*t4235*(1.3E1/1.44E2)+A*B*C*t4175*t4176*t4240*t4239*(1.0/2.4E1)-A*B*Dd*t4173*t4176*t4242* \
               t4235*(1.3E1/1.44E2)+A*B*Dd*t4173*t4176*t4240*t4239*(1.0/2.4E1)+A*B*C*Dd*t4173*t4176*t4235*t4236*(4.0/ \
               9.0);
        } else {
        ...
        if (is_gga_) {
            ...
            if (rho_a[index] > cutoff_) {
                ...
                double t4273 = 1/(rho_a[index]*rho_a[index]*rho_a[index]*rho_a[index]*rho_a[index]);
...
void LYP_C_Functional::computeUKSFunctional(shared_ptr<Properties> prop)
{
    ...
    for (int index = 0; index < ntrue; index++) {
        ...
        if (rho_a[index] > cutoff_ && rho_b[index] > cutoff_) {
            ...
            double t3453 = 1/pow(t3452,1.0/3.0);
            double t3454 = Dd*t3453;
            double t3455 = t3454+1.0;
            double t3456 = 1/t3455;
            ...
            double t3461 = 1/t3452;
            functional_[index] = A*rho_a[index]*rho_b[index]*t3461*t3456*-4.0-A*B*1/pow(t3452,1.1E1/3.0)*t3456* \
    ...
    for (int index = 0; index < ntrue && deriv_ >= 1; index++) {
        ...
        if (rho_a[index] > cutoff_ && rho_b[index] > cutoff_) {
            ...
            double t3464 = 1/pow(t3463,1.0/3.0);
            double t3465 = Dd*t3464;
            double t3466 = t3465+1.0;
            double t3467 = 1/t3466;
            ...
            double t3494 = 1/pow(t3463,4.0/3.0);
            double t3495 = 1/(t3466*t3466);
            double t3496 = Dd*Dd;
            double t3497 = 1/pow(t3463,5.0/3.0);
            double t3498 = 1/(t3463*t3463);
            ...
            double t3509 = 1/(t3463*t3463*t3463*t3463*t3463);
            v_rho_a_[index] = A*rho_b[index]*t3472*t3467*-4.0+A*rho_a[index]*rho_b[index]*t3467*t3498*4.0+A*B* \
               1/pow(t3463,1.1E1/3.0)*t3473*t3467*(rho_b[index]*t3492-gamma_aa[index]*(rho_a[index]*(4.0/3.0)+t3493) \
               ...
               1/pow(t3463,7.0/3.0)*t3495*(4.0/3.0)+A*B*1/pow(t3463,1.4E1/3.0)*t3473*t3467*t3508*(1.1E1/3.0)-A*B* \
               C*t3473*t3467*t3508*t3509*(1.0/3.0)-A*B*Dd*t3473*t3495*t3508*t3509*(1.0/3.0);
        } else if (rho_a[index] > cutoff_) {
            v_rho_a_[index] = 0.0;
        } else if (rho_b[index] > cutoff_) {
            v_rho_a_[index] = 0.0;
        ...
        if (rho_a[index] > cutoff_ && rho_b[index] > cutoff_) {
            ...
            double t3514 = 1/pow(t3513,1.0/3.0);
            double t3515 = Dd*t3514;
            double t3516 = t3515+1.0;
            double t3517 = 1/t3516;
            ...
            double t3544 = 1/pow(t3513,4.0/3.0);
            double t3545 = 1/(t3516*t3516);
            double t3546 = Dd*Dd;
            double t3547 = 1/pow(t3513,5.0/3.0);
            double t3548 = 1/(t3513*t3513);
            ...
            double t3560 = 1/(t3513*t3513*t3513*t3513*t3513);
            v_rho_b_[index] = A*rho_a[index]*t3522*t3517*-4.0+A*rho_a[index]*rho_b[index]*t3517*t3548*4.0+A*B* \
               1/pow(t3513,1.1E1/3.0)*t3523*t3517*(rho_a[index]*t3542-gamma_bb[index]*(rho_b[index]*(4.0/3.0)+t3543) \
               ...
               1/pow(t3513,7.0/3.0)*t3545*(4.0/3.0)-A*B*1/pow(t3513,1.4E1/3.0)*t3523*t3517*(t3552+t3555+t3556+t3559) \
               *(1.1E1/3.0)+A*B*C*t3523*t3560*t3517*(t3552+t3555+t3556+t3559)*(1.0/3.0)+A*B*Dd*t3523*t3560*t3545* \
               (t3552+t3555+t3556+t3559)*(1.0/3.0);
        } else if (rho_a[index] > cutoff_) {
            v_rho_b_[index] = 0.0;
        } else if (rho_b[index] > cutoff_) {
            v_rho_b_[index] = 0.0;
        ...
        if (is_gga_) {
            ...
            if (rho_a[index] > cutoff_ && rho_b[index] > cutoff_) {
                ...
                double t3563 = 1/pow(t3562,1.0/3.0);
                double t3564 = Dd*t3563;
                double t3565 = t3564+1.0;
                double t3566 = 1/t3565;
                v_gamma_aa_[index] = A*B*1/pow(t3562,1.1E1/3.0)*t3566*exp(-C*t3563)*(rho_b[index]*rho_b[index]+rho_a[index]* \
                   rho_b[index]*(C*t3563*(1.0/3.0)+Dd*t3563*t3566*(1.0/3.0)+(rho_a[index]*(C*t3563*(1.0/9.0)+Dd*t3563* \
                   t3566*(1.0/9.0)-1.1E1/9.0))/t3562-1.0/9.0));
            } else if (rho_a[index] > cutoff_) {
                v_gamma_aa_[index] = 0.0;
            } else if (rho_b[index] > cutoff_) {
                v_gamma_aa_[index] = 0.0;
            ...
            if (rho_a[index] > cutoff_ && rho_b[index] > cutoff_) {
                ...
                double t3569 = 1/pow(t3568,1.0/3.0);
                double t3570 = Dd*t3569;
                double t3571 = t3570+1.0;
                double t3572 = 1/t3571;
                v_gamma_ab_[index] = A*B*t3572*1/pow(t3568,1.1E1/3.0)*exp(-C*t3569)*((t3568*t3568)*(4.0/3.0)+rho_a[index]* \
            ...
            if (rho_a[index] > cutoff_ && rho_b[index] > cutoff_) {
                ...
                double t3575 = 1/pow(t3574,1.0/3.0);
                double t3576 = Dd*t3575;
                double t3577 = t3576+1.0;
                double t3578 = 1/t3577;
                v_gamma_bb_[index] = A*B*1/pow(t3574,1.1E1/3.0)*t3578*exp(-C*t3575)*(rho_a[index]*rho_a[index]+rho_a[index]* \
                   rho_b[index]*(C*t3575*(1.0/3.0)+Dd*t3575*t3578*(1.0/3.0)+(rho_b[index]*(C*t3575*(1.0/9.0)+Dd*t3575* \
                   t3578*(1.0/9.0)-1.1E1/9.0))/t3574-1.0/9.0));
            } else if (rho_a[index] > cutoff_) {
    ...
    for (int index = 0; index < ntrue && deriv_ >= 2; index++) {
        ...
        if (rho_a[index] > cutoff_ && rho_b[index] > cutoff_) {
            ...
            double t3583 = 1/pow(t3582,1.0/3.0);
            double t3584 = Dd*t3583;
            double t3585 = t3584+1.0;
            double t3586 = 1/t3585;
            ...
            double t3614 = 1/pow(t3582,4.0/3.0);
            double t3615 = Dd*Dd;
            double t3616 = 1/pow(t3582,5.0/3.0);
            double t3617 = 1/(t3582*t3582);
            double t3619 = 1/pow(t3582,1.1E1/3.0);
            ...
            double t3635 = 1/pow(t3582,7.0/3.0);
            double t3636 = 1/(t3582*t3582*t3582);
            double t3637 = 1/(t3585*t3585*t3585);
            double t3638 = 1/pow(t3582,8.0/3.0);
            ...
            double t3659 = 1/(t3582*t3582*t3582*t3582*t3582);
            ...
            double t3667 = 1/(t3582*t3582*t3582*t3582*t3582*t3582);
            double t3670 = 1/pow(t3582,1.9E1/3.0);
            v_rho_a_rho_a_[index] = A*rho_b[index]*t3586*t3617*8.0-A*Dd*rho_b[index]*t3591*t3635*(8.0/3.0)-A* \
               rho_a[index]*rho_b[index]*t3586*t3636*8.0+A*Dd*rho_a[index]*rho_b[index]*1/pow(t3582,1.0E1/3.0)*t3591* \
               (4.0E1/9.0)+A*B*1/pow(t3582,1.4E1/3.0)*t3592*t3586*t3658*(2.2E1/3.0)-A*B*1/pow(t3582,1.7E1/3.0)*t3592* \
               t3586*t3666*(1.54E2/9.0)+A*B*t3592*t3586*t3619*(gamma_ab[index]*(8.0/3.0)+gamma_bb[index]*2.0-rho_b[index]* \
               t3634*2.0-rho_a[index]*rho_b[index]*(CFext*pow(rho_a[index],2.0/3.0)*(4.0E1/9.0)+t3597*(C*t3635*(2.0/ \
               8.1E1)+Dd*t3586*t3635*(2.0/8.1E1)-t3591*t3615*t3638*(1.0/2.7E1)+Dd*t3615*t3636*t3637*(1.0/8.1E1))- \
               t3590*(C*t3635*(1.4E1/8.1E1)+Dd*t3586*t3635*(1.4E1/8.1E1)-t3591*t3615*t3638*(7.0/2.7E1)+Dd*t3615*t3636* \
               t3637*(7.0/8.1E1))-t3604*t3607*(C*t3635*(4.0/8.1E1)+Dd*t3586*t3635*(4.0/8.1E1)-t3591*t3615*t3638*(2.0/ \
               2.7E1)+Dd*t3615*t3636*t3637*(2.0/8.1E1))+gamma_aa[index]*t3604*t3631*2.0+gamma_aa[index]*t3610*t3617* \
               2.0-t3610*t3607*t3636*2.0-t3631*t3607*t3617*2.0))-A*rho_a[index]*rho_b[index]*t3615*t3619*t3637*(8.0/ \
               9.0)-A*B*t3592*t3615*t3670*t3637*t3666*(2.0/9.0)-A*B*(C*C)*t3592*t3586*t3670*t3666*(1.0/9.0)+A*B*C* \
               t3592*t3586*t3666*t3667*(2.6E1/9.0)-A*B*C*t3592*t3586*t3658*t3659*(2.0/3.0)+A*B*Dd*t3591*t3592*t3666* \
               t3667*(2.6E1/9.0)-A*B*Dd*t3591*t3592*t3658*t3659*(2.0/3.0)-A*B*C*Dd*t3591*t3592*t3670*t3666*(2.0/9.0) \
               ;
        } else if (rho_a[index] > cutoff_) {
            v_rho_a_rho_a_[index] = 0.0;
        } else if (rho_b[index] > cutoff_) {
        ...
        if (rho_a[index] > cutoff_ && rho_b[index] > cutoff_) {
            ...
            double t3673 = 1/pow(t3672,1.0/3.0);
            double t3674 = Dd*t3673;
            double t3675 = t3674+1.0;
            double t3676 = 1/t3675;
            double t3677 = 1/(t3672*t3672);
            double t3678 = 1/pow(t3672,7.0/3.0);
            double t3679 = 1/(t3675*t3675);
            ...
            double t3691 = 1/pow(t3672,4.0/3.0);
            double t3692 = Dd*Dd;
            double t3693 = 1/pow(t3672,5.0/3.0);
            ...
            double t3718 = 1/(t3672*t3672*t3672);
            double t3719 = 1/(t3675*t3675*t3675);
            double t3720 = 1/pow(t3672,8.0/3.0);
            ...
            double t3732 = 1/pow(t3672,1.4E1/3.0);
            ...
            double t3743 = 1/pow(t3672,1.1E1/3.0);
            ...
            double t3752 = 1/(t3672*t3672*t3672*t3672*t3672);
            ...
            v_rho_a_rho_b_[index] = A*t3684*t3676*-4.0+A*rho_a[index]*t3676*t3677*4.0+A*rho_b[index]*t3676*t3677* \
               ...
               rho_b[index]*t3676*t3718*8.0+A*Dd*rho_a[index]*rho_b[index]*1/pow(t3672,1.0E1/3.0)*t3679*(4.0E1/9.0) \
               -A*B*1/pow(t3672,1.7E1/3.0)*t3676*t3685*(t3761+t3764-t3680*t3683*(2.0/3.0)-rho_a[index]*rho_b[index]* \
        ...
        if (rho_a[index] > cutoff_ && rho_b[index] > cutoff_) {
            ...
            double t3772 = 1/pow(t3771,1.0/3.0);
            double t3773 = Dd*t3772;
            double t3774 = t3773+1.0;
            double t3775 = 1/t3774;
            ...
            double t3803 = 1/pow(t3771,4.0/3.0);
            double t3804 = Dd*Dd;
            double t3805 = 1/pow(t3771,5.0/3.0);
            double t3806 = 1/(t3771*t3771);
            double t3808 = 1/pow(t3771,1.1E1/3.0);
            ...
            double t3824 = 1/pow(t3771,7.0/3.0);
            double t3825 = 1/(t3771*t3771*t3771);
            double t3826 = 1/(t3774*t3774*t3774);
            double t3827 = 1/pow(t3771,8.0/3.0);
            ...
            double t3848 = 1/(t3771*t3771*t3771*t3771*t3771);
            ...
            double t3856 = 1/(t3771*t3771*t3771*t3771*t3771*t3771);
            double t3859 = 1/pow(t3771,1.9E1/3.0);
            v_rho_b_rho_b_[index] = A*rho_a[index]*t3775*t3806*8.0-A*Dd*rho_a[index]*t3780*t3824*(8.0/3.0)-A* \
               rho_a[index]*rho_b[index]*t3775*t3825*8.0+A*Dd*rho_a[index]*rho_b[index]*1/pow(t3771,1.0E1/3.0)*t3780* \
               (4.0E1/9.0)+A*B*1/pow(t3771,1.4E1/3.0)*t3781*t3775*t3847*(2.2E1/3.0)-A*B*1/pow(t3771,1.7E1/3.0)*t3781* \
               t3775*t3855*(1.54E2/9.0)+A*B*t3781*t3775*t3808*(gamma_aa[index]*2.0+gamma_ab[index]*(8.0/3.0)-rho_a[index]* \
               t3823*2.0-rho_a[index]*rho_b[index]*(CFext*pow(rho_b[index],2.0/3.0)*(4.0E1/9.0)+t3786*(C*t3824*(2.0/ \
               8.1E1)+Dd*t3775*t3824*(2.0/8.1E1)-t3780*t3804*t3827*(1.0/2.7E1)+Dd*t3804*t3825*t3826*(1.0/8.1E1))- \
               t3779*(C*t3824*(1.4E1/8.1E1)+Dd*t3775*t3824*(1.4E1/8.1E1)-t3780*t3804*t3827*(7.0/2.7E1)+Dd*t3804*t3825* \
               t3826*(7.0/8.1E1))-t3793*t3796*(C*t3824*(4.0/8.1E1)+Dd*t3775*t3824*(4.0/8.1E1)-t3780*t3804*t3827*(2.0/ \
               2.7E1)+Dd*t3804*t3825*t3826*(2.0/8.1E1))+gamma_bb[index]*t3793*t3820*2.0+gamma_bb[index]*t3799*t3806* \
               2.0-t3796*t3799*t3825*2.0-t3796*t3820*t3806*2.0))-A*rho_a[index]*rho_b[index]*t3804*t3808*t3826*(8.0/ \
               9.0)-A*B*t3781*t3804*t3826*t3855*t3859*(2.0/9.0)-A*B*(C*C)*t3781*t3775*t3855*t3859*(1.0/9.0)+A*B*C* \
               t3781*t3775*t3855*t3856*(2.6E1/9.0)-A*B*C*t3781*t3775*t3847*t3848*(2.0/3.0)+A*B*Dd*t3780*t3781*t3855* \
               t3856*(2.6E1/9.0)-A*B*Dd*t3780*t3781*t3847*t3848*(2.0/3.0)-A*B*C*Dd*t3780*t3781*t3855*t3859*(2.0/9.0) \
               ;
        } else if (rho_a[index] > cutoff_) {
        ...
        if (is_gga_) {
            ...
            if (rho_a[index] > cutoff_ && rho_b[index] > cutoff_) {
                ...
                double t3875 = 1/pow(t3861,4.0/3.0);
                double t3876 = Dd*Dd;
                double t3877 = 1/pow(t3861,5.0/3.0);
                double t3878 = 1/(t3864*t3864);
                double t3880 = rho_b[index]*rho_b[index];
                double t3881 = rho_a[index]*rho_b[index]*t3874;
                double t3882 = t3880+t3881;
                double t3883 = 1/(t3861*t3861*t3861*t3861*t3861);
                v_rho_a_gamma_aa_[index] = A*B*1/pow(t3861,1.4E1/3.0)*t3882*t3865*t3866*(-1.1E1/3.0)+A*B*1/pow(t3861,1.1E1/ \
                   ...
                   1/(t3861*t3861)*t3872+Dd*t3865*t3875*(1.0/9.0)-t3876*t3877*t3878*(1.0/9.0)))+A*B*C*t3882*t3865*t3883* \
            ...
            if (rho_a[index] > cutoff_ && rho_b[index] > cutoff_) {
                ...
                double t3886 = 1/pow(t3885,1.0/3.0);
                double t3887 = Dd*t3886;
                double t3888 = t3887+1.0;
                double t3889 = 1/t3888;
                ...
                double t3894 = 1/pow(t3885,4.0/3.0);
                double t3896 = t3885*t3885;
                double t3897 = t3896*(4.0/3.0);
                double t3898 = rho_a[index]*rho_b[index]*t3893;
                double t3899 = t3897+t3898;
                double t3900 = 1/(t3885*t3885*t3885*t3885*t3885);
                double t3901 = 1/(t3888*t3888);
                v_rho_a_gamma_ab_[index] = A*B*t3890*1/pow(t3885,1.4E1/3.0)*t3889*t3899*(-1.1E1/3.0)+A*B*t3890*1/ \
                   pow(t3885,1.1E1/3.0)*t3889*(rho_a[index]*(8.0/3.0)+rho_b[index]*(8.0/3.0)+rho_b[index]*t3893-rho_a[index]* \
                   rho_b[index]*(C*t3894*(7.0/2.7E1)-(Dd*Dd)*1/pow(t3885,5.0/3.0)*t3901*(7.0/2.7E1)+Dd*t3894*t3889*(7.0/ \
                   2.7E1)))+A*B*C*t3890*t3889*t3899*t3900*(1.0/3.0)+A*B*Dd*t3890*t3899*t3900*t3901*(1.0/3.0);
            } else if (rho_a[index] > cutoff_) {
            ...
            if (rho_a[index] > cutoff_ && rho_b[index] > cutoff_) {
                ...
                double t3917 = 1/pow(t3903,4.0/3.0);
                double t3918 = Dd*Dd;
                double t3919 = 1/pow(t3903,5.0/3.0);
                double t3920 = 1/(t3906*t3906);
                double t3922 = rho_a[index]*rho_a[index];
                double t3923 = rho_a[index]*rho_b[index]*t3916;
                double t3924 = t3922+t3923;
                double t3925 = 1/(t3903*t3903*t3903*t3903*t3903);
                v_rho_a_gamma_bb_[index] = A*B*1/pow(t3903,1.4E1/3.0)*t3924*t3907*t3908*(-1.1E1/3.0)+A*B*1/pow(t3903,1.1E1/ \
                   ...
                   +rho_b[index]*1/(t3903*t3903)*t3914+Dd*t3907*t3917*(1.0/9.0)-t3920*t3918*t3919*(1.0/9.0)))+A*B*C*t3924* \
                   t3907*t3925*t3908*(1.0/3.0)+A*B*Dd*t3920*t3924*t3925*t3908*(1.0/3.0);
            } else if (rho_a[index] > cutoff_) {
            ...
            if (rho_a[index] > cutoff_ && rho_b[index] > cutoff_) {
                ...
                double t3941 = 1/pow(t3927,4.0/3.0);
                double t3942 = Dd*Dd;
                double t3943 = 1/pow(t3927,5.0/3.0);
                double t3944 = 1/(t3930*t3930);
                double t3946 = rho_b[index]*rho_b[index];
                double t3947 = rho_a[index]*rho_b[index]*t3940;
                double t3948 = t3946+t3947;
                double t3949 = 1/(t3927*t3927*t3927*t3927*t3927);
                v_rho_b_gamma_aa_[index] = A*B*t3931*t3932*1/pow(t3927,1.4E1/3.0)*t3948*(-1.1E1/3.0)+A*B*t3931*t3932* \
                   1/pow(t3927,1.1E1/3.0)*(rho_b[index]*2.0+rho_a[index]*t3940-rho_a[index]*rho_b[index]*(C*t3941*(1.0/ \
                   9.0)+rho_a[index]*t3935*(C*t3941*(1.0/2.7E1)+Dd*t3931*t3941*(1.0/2.7E1)-t3942*t3943*t3944*(1.0/2.7E1) \
                   )+rho_a[index]*1/(t3927*t3927)*t3938+Dd*t3931*t3941*(1.0/9.0)-t3942*t3943*t3944*(1.0/9.0)))+A*B*C* \
                   t3931*t3932*t3948*t3949*(1.0/3.0)+A*B*Dd*t3932*t3944*t3948*t3949*(1.0/3.0);
            } else if (rho_a[index] > cutoff_) {
            ...
            if (rho_a[index] > cutoff_ && rho_b[index] > cutoff_) {
                ...
                double t3952 = 1/pow(t3951,1.0/3.0);
                double t3953 = Dd*t3952;
                double t3954 = t3953+1.0;
                double t3955 = 1/t3954;
                ...
                double t3960 = 1/pow(t3951,4.0/3.0);
                double t3962 = t3951*t3951;
                double t3963 = t3962*(4.0/3.0);
                double t3964 = rho_a[index]*rho_b[index]*t3959;
                double t3965 = t3963+t3964;
                double t3966 = 1/(t3951*t3951*t3951*t3951*t3951);
                double t3967 = 1/(t3954*t3954);
                v_rho_b_gamma_ab_[index] = A*B*1/pow(t3951,1.4E1/3.0)*t3955*t3956*t3965*(-1.1E1/3.0)+A*B*1/pow(t3951,1.1E1/ \
                   3.0)*t3955*t3956*(rho_a[index]*(8.0/3.0)+rho_b[index]*(8.0/3.0)+rho_a[index]*t3959-rho_a[index]*rho_b[index]* \
                   (C*t3960*(7.0/2.7E1)-(Dd*Dd)*1/pow(t3951,5.0/3.0)*t3967*(7.0/2.7E1)+Dd*t3960*t3955*(7.0/2.7E1)))+A* \
                   B*C*t3955*t3956*t3965*t3966*(1.0/3.0)+A*B*Dd*t3956*t3965*t3966*t3967*(1.0/3.0);
            } else if (rho_a[index] > cutoff_) {
            ...
            if (rho_a[index] > cutoff_ && rho_b[index] > cutoff_) {
                ...
                double t3983 = 1/pow(t3969,4.0/3.0);
                double t3984 = Dd*Dd;
                double t3985 = 1/pow(t3969,5.0/3.0);
                double t3986 = 1/(t3972*t3972);
                double t3988 = rho_a[index]*rho_a[index];
                double t3989 = rho_a[index]*rho_b[index]*t3982;
                double t3990 = t3988+t3989;
                double t3991 = 1/(t3969*t3969*t3969*t3969*t3969);
                v_rho_b_gamma_bb_[index] = A*B*t3990*t3973*t3974*1/pow(t3969,1.4E1/3.0)*(-1.1E1/3.0)+A*B*t3973*t3974* \
                   1/pow(t3969,1.1E1/3.0)*(rho_a[index]*t3982-rho_a[index]*rho_b[index]*(C*t3983*(1.0/9.0)-t3980*t3977+ \
                   rho_b[index]*t3977*(C*t3983*(1.0/2.7E1)+Dd*t3973*t3983*(1.0/2.7E1)-t3984*t3985*t3986*(1.0/2.7E1))+ \
                   rho_b[index]*t3980*1/(t3969*t3969)+Dd*t3973*t3983*(1.0/9.0)-t3984*t3985*t3986*(1.0/9.0)))+A*B*C*t3990* \
                   t3973*t3991*t3974*(1.0/3.0)+A*B*Dd*t3990*t3991*t3974*t3986*(1.0/3.0);
            } else if (rho_a[index] > cutoff_) {

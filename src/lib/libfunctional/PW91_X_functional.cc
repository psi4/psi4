...
void PW91_X_Functional::computeRKSFunctional(shared_ptr<Properties> prop)
{
    ...
    for (int index = 0; index < ntrue; index++) {
        ...
        if (rho_a[index] > cutoff_) {
            ...
            double t2418 = 1/pow(t2417,8.0/3.0);
            double t2419 = 1/k;
            double t2420 = gamma_aa[index]*4.0;
            double t2421 = sqrt(t2420);
            double t2422 = 1/pow(t2417,4.0/3.0);
            ...
            functional_[index] = (e*k*rho_a[index]*pow(t2417,1.0/3.0)*(t2425+gamma_aa[index]*t2416*t2418*(C3- \
               ...
               1/(k*k*k*k)*1/pow(t2417,1.6E1/3.0)+1.0);
        } else {
    ...
    for (int index = 0; index < ntrue && deriv_ >= 1; index++) {
        ...
        if (rho_a[index] > cutoff_) {
            ...
            double t2429 = 1/pow(t2428,8.0/3.0);
            double t2430 = 1/k;
            double t2431 = gamma_aa[index]*4.0;
            double t2432 = sqrt(t2431);
            double t2433 = 1/pow(t2428,4.0/3.0);
            ...
            double t2439 = 1/(k*k*k*k);
            double t2440 = 1/pow(t2428,1.6E1/3.0);
            double t2441 = C5*t2440*t2438*t2439;
            double t2442 = t2441+t2436+1.0;
            double t2443 = 1/t2442;
            double t2446 = gamma_aa[index]*t2427*t2429*1.0E2;
            double t2444 = exp(-t2446);
            double t2448 = C4*t2444;
            double t2445 = C3-t2448;
            double t2447 = 1/pow(t2428,1.1E1/3.0);
            double t2449 = gamma_aa[index]*t2427*t2445*t2429;
            double t2450 = t2436+t2449+1.0;
            double t2451 = 1/pow(t2428,1.9E1/3.0);
            double t2452 = 1/pow(t2428,7.0/3.0);
            double t2453 = C1*t2430*t2432*t2452*t2435*(4.0/3.0);
            double t2454 = C2*C2;
            double t2455 = gamma_aa[index]*t2427*t2454*t2429;
            double t2456 = t2455+1.0;
            double t2457 = 1/sqrt(t2456);
            double t2458 = C1*C2*gamma_aa[index]*t2427*t2447*t2457*(8.0/3.0);
            v_rho_a_[index] = e*k*t2450*t2443*t2437+e*k*rho_a[index]*t2450*t2443*1/pow(t2428,2.0/3.0)*(2.0/3.0) \
               -e*k*rho_a[index]*t2443*t2437*(t2453+t2458+gamma_aa[index]*t2427*t2445*t2447*(1.6E1/3.0)+C4*t2451* \
               t2444*t2438*t2439*(1.6E3/3.0))+e*k*rho_a[index]*t2450*1/(t2442*t2442)*t2437*(t2453+t2458+C5*t2451* \
        ...
        if (is_gga_) {
            ...
            if (rho_a[index] > cutoff_) {
                ...
                double t2464 = 1/pow(t2460,4.0/3.0);
                double t2465 = 1/(k*k);
                double t2466 = 1/pow(t2460,8.0/3.0);
                double t2467 = 1/(k*k*k*k);
                double t2480 = gamma_aa[index]*t2465*t2466*1.0E2;
                double t2468 = exp(-t2480);
                double t2469 = 1/pow(t2460,1.6E1/3.0);
                ...
                double t2476 = 1/sqrt(t2475);
                double t2477 = C1*C2*t2465*t2466*t2476*(1.0/2.0);
                double t2478 = 1/sqrt(t2462);
                ...
                v_gamma_aa_[index] = (e*k*rho_a[index]*t2472*(t2477+t2479+t2481*t2465*t2466+C4*gamma_aa[index]*t2467* \
                   t2468*t2469*1.0E2)*2.0)/t2485-e*k*rho_a[index]*t2472*1/(t2485*t2485)*(t2477+t2479+C5*gamma_aa[index]* \
    ...
    for (int index = 0; index < ntrue && deriv_ >= 2; index++) {
        ...
        if (rho_a[index] > cutoff_) {
            ...
            double t2492 = 1/pow(t2488,4.0/3.0);
            double t2493 = 1/(k*k);
            double t2494 = gamma_aa[index]*gamma_aa[index];
            double t2495 = 1/(k*k*k*k);
            double t2496 = 1/pow(t2488,8.0/3.0);
            ...
            double t2520 = 1/pow(t2488,2.0/3.0);
            ...
            double t2524 = 1/pow(t2488,2.2E1/3.0);
            double t2525 = 1/pow(t2488,1.4E1/3.0);
            double t2526 = C5*t2494*t2495*t2509*(3.2E1/3.0);
            double t2527 = t2511+t2516+t2526;
            double t2528 = 1/(t2506*t2506);
            double t2529 = 1/pow(t2488,1.0E1/3.0);
            double t2530 = C1*t2491*t2489*t2499*t2529*(5.6E1/9.0);
            double t2531 = 1/pow(t2514,3.0/2.0);
            ...
            v_rho_a_rho_a_[index] = e*k*t2520*t2507*t2519*(4.0/3.0)-e*k*t2523*t2507*t2508*2.0+e*k*t2508*t2527* \
               ...
               9.0)+C4*t2494*t2495*t2497*t2524*9.6E3-C4*gamma_aa[index]*1/(k*k*k*k*k*k)*1/pow(rho_a[index],1.0E1) \
               *t2494*t2497*(2.5E3/9.0)-C1*C2*t2494*t2495*t2512*t2531*t2524*(6.4E1/9.0))-e*k*rho_a[index]*1/pow(t2488,5.0/ \
               3.0)*t2507*t2519*(8.0/9.0)-e*k*rho_a[index]*t2520*t2523*t2507*(4.0/3.0)+e*k*rho_a[index]*1/(t2506* \
        ...
        if (is_gga_) {
            ...
            if (rho_a[index] > cutoff_) {
                ...
                double t2538 = 1/pow(t2534,4.0/3.0);
                double t2539 = 1/(k*k);
                double t2540 = 1/pow(t2534,8.0/3.0);
                double t2541 = 1/(k*k*k*k);
                double t2552 = gamma_aa[index]*t2540*t2539*1.0E2;
                double t2542 = exp(-t2552);
                double t2543 = 1/pow(t2534,1.6E1/3.0);
                ...
                double t2551 = 1/t2550;
                double t2561 = C4*t2542;
                double t2553 = C3-t2561;
                double t2554 = C2*C2;
                double t2555 = gamma_aa[index]*t2540*t2554*t2539;
                double t2556 = t2555+1.0;
                double t2557 = 1/sqrt(t2556);
                double t2558 = 1/pow(t2534,1.1E1/3.0);
                double t2559 = 1/sqrt(t2536);
                double t2560 = 1/pow(t2534,1.9E1/3.0);
                ...
                double t2567 = 1/pow(t2534,7.0/3.0);
                double t2568 = 1/(t2550*t2550);
                ...
                double t2573 = 1/pow(t2556,3.0/2.0);
                ...
                double t2578 = 1/pow(t2534,2.0/3.0);
                ...
                v_rho_a_gamma_aa_[index] = e*k*t2551*t2546*t2566-e*k*t2570*t2546*t2575*t2568-e*k*rho_a[index]*t2551* \
                   t2546*(t2571+t2572+t2553*t2539*t2558*(1.6E1/3.0)-C4*1/(k*k*k*k*k*k)*1/(rho_a[index]*rho_a[index]*rho_a[index]* \
                   rho_a[index]*rho_a[index]*rho_a[index]*rho_a[index]*rho_a[index]*rho_a[index])*t2542*t2547*(6.25E2/ \
                   6.0)+C4*gamma_aa[index]*t2541*t2542*t2560*1.6E3-C1*C2*gamma_aa[index]*t2541*t2560*t2554*t2573*(4.0/ \
                   3.0))+e*k*rho_a[index]*t2551*t2566*t2578*(2.0/3.0)+e*k*rho_a[index]*t2570*t2546*t2568*(t2571+t2572+ \
                   C5*gamma_aa[index]*t2541*t2560*(6.4E1/3.0)-C1*C2*gamma_aa[index]*t2541*t2560*t2554*t2573*(4.0/3.0) \
                   )+e*k*rho_a[index]*t2580*t2546*t2566*t2568-e*k*rho_a[index]*t2570*t2575*t2568*t2578*(2.0/3.0)+e*k* \
                   rho_a[index]*t2546*t2575*t2568*(t2576+t2577+gamma_aa[index]*t2553*t2539*t2558*(1.6E1/3.0)+C4*t2541* \
                   t2542*t2560*t2547*(1.6E3/3.0))-e*k*rho_a[index]*1/(t2550*t2550*t2550)*t2570*t2580*t2546*t2575*2.0;
            } else {
            ...
            if (rho_a[index] > cutoff_) {
                ...
                double t2586 = 1/pow(t2582,4.0/3.0);
                double t2587 = 1/(k*k*k*k);
                double t2588 = 1/pow(t2582,1.6E1/3.0);
                double t2589 = C2*C2;
                double t2590 = 1/(k*k);
                double t2591 = 1/pow(t2582,8.0/3.0);
                ...
                double t2608 = 1/pow(t2596,3.0/2.0);
                double t2609 = C1*C2*t2587*t2588*t2589*t2608*(1.0/4.0);
                double t2610 = 1/pow(t2584,3.0/2.0);
                double t2611 = C1*t2583*t2594*t2586*t2610*2.0;
                double t2612 = 1/gamma_aa[index];
                double t2617 = 1/(t2604*t2604);
                v_gamma_aa_gamma_aa_[index] = (e*k*rho_a[index]*t2597*(t2611+t2609-C4*t2592*t2587*t2588*2.0E2+C4* \
                   gamma_aa[index]*1/(k*k*k*k*k*k)*1/(rho_a[index]*rho_a[index]*rho_a[index]*rho_a[index]*rho_a[index]* \
                   rho_a[index]*rho_a[index]*rho_a[index])*t2592*(6.25E2/1.6E1)-C1*C2*t2590*t2591*t2598*t2612*(1.0/4.0) \
                   )*-2.0)/t2604+e*k*rho_a[index]*t2597*(t2599*t2599)*1/(t2604*t2604*t2604)*t2607*4.0-e*k*rho_a[index]* \
...
void PW91_X_Functional::computeUKSFunctional(shared_ptr<Properties> prop)
{
    ...
    for (int index = 0; index < ntrue; index++) {
        ...
        if (rho_a[index] > cutoff_ && rho_b[index] > cutoff_) {
            ...
            double t1487 = 1/pow(t1486,8.0/3.0);
            double t1488 = 1/k;
            double t1489 = gamma_aa[index]*4.0;
            double t1490 = sqrt(t1489);
            double t1491 = 1/pow(t1486,4.0/3.0);
            ...
            double t1496 = 1/pow(t1495,8.0/3.0);
            double t1497 = gamma_bb[index]*4.0;
            double t1498 = sqrt(t1497);
            double t1499 = 1/pow(t1495,4.0/3.0);
            double t1500 = 1/(k*k*k*k);
            ...
            functional_[index] = (e*k*rho_a[index]*pow(t1486,1.0/3.0)*(t1494+gamma_aa[index]*t1485*t1487*(C3- \
               C4*exp(gamma_aa[index]*t1485*t1487*-1.0E2))+1.0))/(t1494+C5*(gamma_aa[index]*gamma_aa[index])*1/pow(t1486,1.6E1/ \
               3.0)*t1500+1.0)+(e*k*rho_b[index]*pow(t1495,1.0/3.0)*(t1503+gamma_bb[index]*t1485*t1496*(C3-C4*exp(gamma_bb[index]* \
               t1485*t1496*-1.0E2))+1.0))/(t1503+C5*(gamma_bb[index]*gamma_bb[index])*1/pow(t1495,1.6E1/3.0)*t1500+ \
               1.0);
        } else if (rho_a[index] > cutoff_) {
            double t2147 = 1/(k*k);
            double t2148 = rho_a[index]*2.0;
            double t2149 = 1/pow(t2148,8.0/3.0);
            double t2150 = 1/k;
            double t2151 = gamma_aa[index]*4.0;
            double t2152 = sqrt(t2151);
            double t2153 = 1/pow(t2148,4.0/3.0);
            ...
            functional_[index] = (e*k*rho_a[index]*pow(t2148,1.0/3.0)*(t2156+gamma_aa[index]*t2147*t2149*(C3- \
               C4*exp(gamma_aa[index]*t2147*t2149*-1.0E2))+1.0))/(t2156+C5*(gamma_aa[index]*gamma_aa[index])*1/(k* \
               k*k*k)*1/pow(t2148,1.6E1/3.0)+1.0);
        } else if (rho_b[index] > cutoff_) {
            double t1914 = 1/(k*k);
            double t1915 = rho_b[index]*2.0;
            double t1916 = 1/pow(t1915,8.0/3.0);
            double t1917 = 1/k;
            double t1918 = gamma_bb[index]*4.0;
            double t1919 = sqrt(t1918);
            double t1920 = 1/pow(t1915,4.0/3.0);
            ...
            functional_[index] = (e*k*rho_b[index]*pow(t1915,1.0/3.0)*(t1923+gamma_bb[index]*t1914*t1916*(C3- \
               C4*exp(gamma_bb[index]*t1914*t1916*-1.0E2))+1.0))/(t1923+C5*(gamma_bb[index]*gamma_bb[index])*1/(k* \
               k*k*k)*1/pow(t1915,1.6E1/3.0)+1.0);
        } else {
            functional_[index] = 0.0;
        } 
    ...
    for (int index = 0; index < ntrue && deriv_ >= 1; index++) {
        ...
        if (rho_a[index] > cutoff_ && rho_b[index] > cutoff_) {
            ...
            double t1507 = 1/pow(t1506,8.0/3.0);
            double t1508 = 1/k;
            double t1509 = gamma_aa[index]*4.0;
            double t1510 = sqrt(t1509);
            double t1511 = 1/pow(t1506,4.0/3.0);
            ...
            double t1517 = 1/(k*k*k*k);
            double t1518 = 1/pow(t1506,1.6E1/3.0);
            double t1519 = C5*t1516*t1517*t1518;
            double t1520 = t1514+t1519+1.0;
            double t1521 = 1/t1520;
            double t1524 = gamma_aa[index]*t1505*t1507*1.0E2;
            double t1522 = exp(-t1524);
            double t1526 = C4*t1522;
            double t1523 = C3-t1526;
            double t1525 = 1/pow(t1506,1.1E1/3.0);
            double t1527 = gamma_aa[index]*t1505*t1523*t1507;
            double t1528 = t1514+t1527+1.0;
            double t1529 = 1/pow(t1506,1.9E1/3.0);
            double t1530 = 1/pow(t1506,7.0/3.0);
            double t1531 = C1*t1510*t1530*t1513*t1508*(4.0/3.0);
            double t1532 = C2*C2;
            double t1533 = gamma_aa[index]*t1505*t1532*t1507;
            double t1534 = t1533+1.0;
            double t1535 = 1/sqrt(t1534);
            double t1536 = C1*C2*gamma_aa[index]*t1505*t1525*t1535*(8.0/3.0);
            v_rho_a_[index] = e*k*t1521*t1515*t1528+e*k*rho_a[index]*t1521*1/pow(t1506,2.0/3.0)*t1528*(2.0/3.0) \
               -e*k*rho_a[index]*t1521*t1515*(t1531+t1536+gamma_aa[index]*t1505*t1523*t1525*(1.6E1/3.0)+C4*t1522* \
               t1516*t1517*t1529*(1.6E3/3.0))+e*k*rho_a[index]*1/(t1520*t1520)*t1515*t1528*(t1531+t1536+C5*t1516* \
               t1517*t1529*(3.2E1/3.0));
        } else if (rho_a[index] > cutoff_) {
            double t2158 = 1/(k*k);
            double t2159 = rho_a[index]*2.0;
            double t2160 = 1/pow(t2159,8.0/3.0);
            double t2161 = 1/k;
            double t2162 = gamma_aa[index]*4.0;
            double t2163 = sqrt(t2162);
            double t2164 = 1/pow(t2159,4.0/3.0);
            ...
            double t2170 = 1/(k*k*k*k);
            double t2171 = 1/pow(t2159,1.6E1/3.0);
            double t2172 = C5*t2170*t2171*t2169;
            double t2173 = t2172+t2167+1.0;
            double t2174 = 1/t2173;
            double t2177 = gamma_aa[index]*t2160*t2158*1.0E2;
            double t2175 = exp(-t2177);
            double t2179 = C4*t2175;
            double t2176 = C3-t2179;
            double t2178 = 1/pow(t2159,1.1E1/3.0);
            double t2180 = gamma_aa[index]*t2160*t2158*t2176;
            double t2181 = t2180+t2167+1.0;
            double t2182 = 1/pow(t2159,1.9E1/3.0);
            double t2183 = 1/pow(t2159,7.0/3.0);
            double t2184 = C1*t2161*t2163*t2183*t2166*(4.0/3.0);
            double t2185 = C2*C2;
            double t2186 = gamma_aa[index]*t2160*t2158*t2185;
            double t2187 = t2186+1.0;
            double t2188 = 1/sqrt(t2187);
            double t2189 = C1*C2*gamma_aa[index]*t2158*t2178*t2188*(8.0/3.0);
            v_rho_a_[index] = e*k*t2181*t2174*t2168+e*k*rho_a[index]*t2181*t2174*1/pow(t2159,2.0/3.0)*(2.0/3.0) \
               -e*k*rho_a[index]*t2174*t2168*(t2184+t2189+gamma_aa[index]*t2158*t2176*t2178*(1.6E1/3.0)+C4*t2170* \
               t2182*t2175*t2169*(1.6E3/3.0))+e*k*rho_a[index]*t2181*1/(t2173*t2173)*t2168*(t2184+t2189+C5*t2170* \
        ...
        if (rho_a[index] > cutoff_ && rho_b[index] > cutoff_) {
            ...
            double t1540 = 1/pow(t1539,8.0/3.0);
            double t1541 = 1/k;
            double t1542 = gamma_bb[index]*4.0;
            double t1543 = sqrt(t1542);
            double t1544 = 1/pow(t1539,4.0/3.0);
            ...
            double t1550 = 1/(k*k*k*k);
            double t1551 = 1/pow(t1539,1.6E1/3.0);
            double t1552 = C5*t1550*t1551*t1549;
            double t1553 = t1552+t1547+1.0;
            double t1554 = 1/t1553;
            double t1557 = gamma_bb[index]*t1540*t1538*1.0E2;
            double t1555 = exp(-t1557);
            double t1559 = C4*t1555;
            double t1556 = C3-t1559;
            double t1558 = 1/pow(t1539,1.1E1/3.0);
            double t1560 = gamma_bb[index]*t1540*t1538*t1556;
            double t1561 = t1560+t1547+1.0;
            double t1562 = 1/pow(t1539,1.9E1/3.0);
            double t1563 = 1/pow(t1539,7.0/3.0);
            double t1564 = C1*t1541*t1543*t1563*t1546*(4.0/3.0);
            double t1565 = C2*C2;
            double t1566 = gamma_bb[index]*t1540*t1538*t1565;
            double t1567 = t1566+1.0;
            double t1568 = 1/sqrt(t1567);
            double t1569 = C1*C2*gamma_bb[index]*t1538*t1558*t1568*(8.0/3.0);
            v_rho_b_[index] = e*k*t1561*t1554*t1548+e*k*rho_b[index]*t1561*t1554*1/pow(t1539,2.0/3.0)*(2.0/3.0) \
               -e*k*rho_b[index]*t1554*t1548*(t1564+t1569+gamma_bb[index]*t1538*t1556*t1558*(1.6E1/3.0)+C4*t1550* \
               t1562*t1555*t1549*(1.6E3/3.0))+e*k*rho_b[index]*t1561*1/(t1553*t1553)*t1548*(t1564+t1569+C5*t1550* \
            ...
            double t1928 = 1/pow(t1927,8.0/3.0);
            double t1929 = 1/k;
            double t1930 = gamma_bb[index]*4.0;
            double t1931 = sqrt(t1930);
            double t1932 = 1/pow(t1927,4.0/3.0);
            ...
            double t1938 = 1/(k*k*k*k);
            double t1939 = 1/pow(t1927,1.6E1/3.0);
            double t1940 = C5*t1937*t1938*t1939;
            double t1941 = t1940+t1935+1.0;
            double t1942 = 1/t1941;
            double t1945 = gamma_bb[index]*t1926*t1928*1.0E2;
            double t1943 = exp(-t1945);
            double t1947 = C4*t1943;
            double t1944 = C3-t1947;
            double t1946 = 1/pow(t1927,1.1E1/3.0);
            double t1948 = gamma_bb[index]*t1926*t1944*t1928;
            double t1949 = t1935+t1948+1.0;
            double t1950 = 1/pow(t1927,1.9E1/3.0);
            double t1951 = 1/pow(t1927,7.0/3.0);
            double t1952 = C1*t1931*t1951*t1934*t1929*(4.0/3.0);
            double t1953 = C2*C2;
            double t1954 = gamma_bb[index]*t1926*t1953*t1928;
            double t1955 = t1954+1.0;
            double t1956 = 1/sqrt(t1955);
            double t1957 = C1*C2*gamma_bb[index]*t1926*t1946*t1956*(8.0/3.0);
            v_rho_b_[index] = e*k*t1942*t1936*t1949+e*k*rho_b[index]*t1942*1/pow(t1927,2.0/3.0)*t1949*(2.0/3.0) \
               -e*k*rho_b[index]*t1942*t1936*(t1952+t1957+gamma_bb[index]*t1926*t1944*t1946*(1.6E1/3.0)+C4*t1950* \
               t1943*t1937*t1938*(1.6E3/3.0))+e*k*rho_b[index]*1/(t1941*t1941)*t1936*t1949*(t1952+t1957+C5*t1950* \
        ...
        if (is_gga_) {
            ...
            if (rho_a[index] > cutoff_ && rho_b[index] > cutoff_) {
                ...
                double t1575 = 1/pow(t1571,4.0/3.0);
                double t1576 = 1/(k*k);
                double t1577 = 1/pow(t1571,8.0/3.0);
                double t1578 = 1/(k*k*k*k);
                double t1591 = gamma_aa[index]*t1576*t1577*1.0E2;
                double t1579 = exp(-t1591);
                double t1580 = 1/pow(t1571,1.6E1/3.0);
                ...
                double t1587 = 1/sqrt(t1586);
                double t1588 = C1*C2*t1576*t1577*t1587*(1.0/2.0);
                double t1589 = 1/sqrt(t1573);
                ...
                v_gamma_aa_[index] = (e*k*rho_a[index]*t1583*(t1590+t1588+t1592*t1576*t1577+C4*gamma_aa[index]*t1580* \
                   t1578*t1579*1.0E2))/t1596-e*k*rho_a[index]*t1583*1/(t1596*t1596)*(t1590+t1588+C5*gamma_aa[index]*t1580* \
                   t1578*2.0)*(t1593+gamma_aa[index]*t1592*t1576*t1577+1.0);
            } else if (rho_a[index] > cutoff_) {
                double t2192 = rho_a[index]*2.0;
                double t2193 = 1/k;
                double t2194 = gamma_aa[index]*4.0;
                double t2195 = sqrt(t2194);
                double t2196 = 1/pow(t2192,4.0/3.0);
                double t2197 = 1/(k*k);
                double t2198 = 1/pow(t2192,8.0/3.0);
                double t2199 = 1/(k*k*k*k);
                double t2212 = gamma_aa[index]*t2197*t2198*1.0E2;
                double t2200 = exp(-t2212);
                double t2201 = 1/pow(t2192,1.6E1/3.0);
                ...
                double t2208 = 1/sqrt(t2207);
                double t2209 = C1*C2*t2197*t2198*t2208*(1.0/2.0);
                double t2210 = 1/sqrt(t2194);
                ...
                v_gamma_aa_[index] = (e*k*rho_a[index]*t2204*(t2211+t2209+t2197*t2198*t2213+C4*gamma_aa[index]*t2199* \
                   t2200*t2201*1.0E2))/t2217-e*k*rho_a[index]*t2204*1/(t2217*t2217)*(t2211+t2209+C5*gamma_aa[index]*t2199* \
                   t2201*2.0)*(t2214+gamma_aa[index]*t2197*t2198*t2213+1.0);
            } else if (rho_b[index] > cutoff_) {
                v_gamma_aa_[index] = 0.0;
            } else {
                v_gamma_aa_[index] = 0.0;
            ...
            if (rho_a[index] > cutoff_ && rho_b[index] > cutoff_) {
                ...
                double t1603 = 1/pow(t1599,4.0/3.0);
                double t1604 = 1/(k*k);
                double t1605 = 1/pow(t1599,8.0/3.0);
                double t1606 = 1/(k*k*k*k);
                double t1619 = gamma_bb[index]*t1604*t1605*1.0E2;
                double t1607 = exp(-t1619);
                double t1608 = 1/pow(t1599,1.6E1/3.0);
                ...
                double t1615 = 1/sqrt(t1614);
                double t1616 = C1*C2*t1604*t1605*t1615*(1.0/2.0);
                double t1617 = 1/sqrt(t1601);
                ...
                v_gamma_bb_[index] = (e*k*rho_b[index]*t1611*(t1616+t1618+t1620*t1604*t1605+C4*gamma_bb[index]*t1606* \
                   t1607*t1608*1.0E2))/t1624-e*k*rho_b[index]*t1611*1/(t1624*t1624)*(t1616+t1618+C5*gamma_bb[index]*t1606* \
                   t1608*2.0)*(t1621+gamma_bb[index]*t1620*t1604*t1605+1.0);
            } else if (rho_a[index] > cutoff_) {
                ...
                double t1965 = 1/pow(t1961,4.0/3.0);
                double t1966 = 1/(k*k);
                double t1967 = 1/pow(t1961,8.0/3.0);
                double t1968 = 1/(k*k*k*k);
                double t1981 = gamma_bb[index]*t1966*t1967*1.0E2;
                double t1969 = exp(-t1981);
                double t1970 = 1/pow(t1961,1.6E1/3.0);
                ...
                double t1977 = 1/sqrt(t1976);
                double t1978 = C1*C2*t1966*t1967*t1977*(1.0/2.0);
                double t1979 = 1/sqrt(t1963);
                ...
                v_gamma_bb_[index] = (e*k*rho_b[index]*t1973*(t1980+t1978+t1982*t1966*t1967+C4*gamma_bb[index]*t1970* \
                   t1968*t1969*1.0E2))/t1986-e*k*rho_b[index]*t1973*1/(t1986*t1986)*(t1980+t1978+C5*gamma_bb[index]*t1970* \
                   t1968*2.0)*(t1983+gamma_bb[index]*t1982*t1966*t1967+1.0);
            } else {
                v_gamma_bb_[index] = 0.0;
            } 
        }
    ...
    for (int index = 0; index < ntrue && deriv_ >= 2; index++) {
        ...
        if (rho_a[index] > cutoff_ && rho_b[index] > cutoff_) {
            ...
            double t1632 = 1/pow(t1628,4.0/3.0);
            double t1633 = 1/(k*k);
            double t1634 = gamma_aa[index]*gamma_aa[index];
            double t1635 = 1/(k*k*k*k);
            double t1636 = 1/pow(t1628,8.0/3.0);
            ...
            double t1660 = 1/pow(t1628,2.0/3.0);
            ...
            double t1664 = 1/pow(t1628,2.2E1/3.0);
            double t1665 = 1/pow(t1628,1.4E1/3.0);
            double t1666 = C5*t1634*t1635*t1649*(3.2E1/3.0);
            double t1667 = t1651+t1656+t1666;
            double t1668 = 1/(t1646*t1646);
            double t1669 = 1/pow(t1628,1.0E1/3.0);
            double t1670 = C1*t1631*t1629*t1639*t1669*(5.6E1/9.0);
            double t1671 = 1/pow(t1654,3.0/2.0);
            ...
            v_rho_a_rho_a_[index] = e*k*t1660*t1647*t1659*(4.0/3.0)-e*k*t1663*t1647*t1648*2.0+e*k*t1648*t1667* \
               ...
               9.0)+C4*t1634*t1635*t1637*t1664*9.6E3-C4*gamma_aa[index]*1/(k*k*k*k*k*k)*1/pow(rho_a[index],1.0E1) \
               *t1634*t1637*(2.5E3/9.0)-C1*C2*t1634*t1652*t1635*t1671*t1664*(6.4E1/9.0))-e*k*rho_a[index]*1/pow(t1628,5.0/ \
               3.0)*t1647*t1659*(8.0/9.0)-e*k*rho_a[index]*t1660*t1663*t1647*(4.0/3.0)+e*k*rho_a[index]*1/(t1646* \
            ...
            double t2227 = 1/pow(t2223,4.0/3.0);
            double t2228 = 1/(k*k);
            double t2229 = gamma_aa[index]*gamma_aa[index];
            double t2230 = 1/(k*k*k*k);
            double t2231 = 1/pow(t2223,8.0/3.0);
            ...
            double t2255 = 1/pow(t2223,2.0/3.0);
            ...
            double t2259 = 1/pow(t2223,2.2E1/3.0);
            double t2260 = 1/pow(t2223,1.4E1/3.0);
            double t2261 = C5*t2230*t2244*t2229*(3.2E1/3.0);
            double t2262 = t2251+t2261+t2246;
            double t2263 = 1/(t2241*t2241);
            double t2264 = 1/pow(t2223,1.0E1/3.0);
            double t2265 = C1*t2224*t2234*t2226*t2264*(5.6E1/9.0);
            double t2266 = 1/pow(t2249,3.0/2.0);
            ...
            v_rho_a_rho_a_[index] = e*k*t2242*t2254*t2255*(4.0/3.0)-e*k*t2242*t2243*t2258*2.0+e*k*t2243*t2262* \
               ...
               9.0)+C4*t2230*t2232*t2229*t2259*9.6E3-C4*gamma_aa[index]*1/(k*k*k*k*k*k)*1/pow(rho_a[index],1.0E1) \
               *t2232*t2229*(2.5E3/9.0)-C1*C2*t2230*t2229*t2247*t2266*t2259*(6.4E1/9.0))-e*k*rho_a[index]*1/pow(t2223,5.0/ \
               3.0)*t2242*t2254*(8.0/9.0)-e*k*rho_a[index]*t2242*t2255*t2258*(4.0/3.0)+e*k*rho_a[index]*1/(t2241* \
        ...
        if (rho_a[index] > cutoff_ && rho_b[index] > cutoff_) {
            ...
            double t1679 = 1/pow(t1675,4.0/3.0);
            double t1680 = 1/(k*k);
            double t1681 = gamma_bb[index]*gamma_bb[index];
            double t1682 = 1/(k*k*k*k);
            double t1683 = 1/pow(t1675,8.0/3.0);
            ...
            double t1707 = 1/pow(t1675,2.0/3.0);
            ...
            double t1711 = 1/pow(t1675,2.2E1/3.0);
            double t1712 = 1/pow(t1675,1.4E1/3.0);
            double t1713 = C5*t1681*t1682*t1696*(3.2E1/3.0);
            double t1714 = t1698+t1703+t1713;
            double t1715 = 1/(t1693*t1693);
            double t1716 = 1/pow(t1675,1.0E1/3.0);
            double t1717 = C1*t1676*t1686*t1678*t1716*(5.6E1/9.0);
            double t1718 = 1/pow(t1701,3.0/2.0);
            ...
            v_rho_b_rho_b_[index] = e*k*t1694*t1695*t1710*-2.0+e*k*t1694*t1706*t1707*(4.0/3.0)+e*k*t1695*t1714* \
               ...
               9.0)+C4*t1681*t1682*t1684*t1711*9.6E3-C4*gamma_bb[index]*1/(k*k*k*k*k*k)*1/pow(rho_b[index],1.0E1) \
               *t1681*t1684*(2.5E3/9.0)-C1*C2*t1681*t1682*t1699*t1711*t1718*(6.4E1/9.0))-e*k*rho_b[index]*1/pow(t1675,5.0/ \
               3.0)*t1694*t1706*(8.0/9.0)-e*k*rho_b[index]*t1694*t1710*t1707*(4.0/3.0)+e*k*rho_b[index]*1/(t1693* \
            ...
            double t1996 = 1/pow(t1992,4.0/3.0);
            double t1997 = 1/(k*k);
            double t1998 = gamma_bb[index]*gamma_bb[index];
            double t1999 = 1/(k*k*k*k);
            double t2000 = 1/pow(t1992,8.0/3.0);
            ...
            double t2024 = 1/pow(t1992,2.0/3.0);
            ...
            double t2028 = 1/pow(t1992,2.2E1/3.0);
            double t2029 = 1/pow(t1992,1.4E1/3.0);
            double t2030 = C5*t1998*t1999*t2013*(3.2E1/3.0);
            double t2031 = t2020+t2030+t2015;
            double t2032 = 1/(t2010*t2010);
            double t2033 = 1/pow(t1992,1.0E1/3.0);
            double t2034 = C1*t1993*t1995*t2003*t2033*(5.6E1/9.0);
            double t2035 = 1/pow(t2018,3.0/2.0);
            ...
            v_rho_b_rho_b_[index] = e*k*t2011*t2023*t2024*(4.0/3.0)-e*k*t2011*t2012*t2027*2.0+e*k*t2012*t2031* \
               ...
               9.0)+C4*t1998*t1999*t2001*t2028*9.6E3-C4*gamma_bb[index]*1/(k*k*k*k*k*k)*1/pow(rho_b[index],1.0E1) \
               *t1998*t2001*(2.5E3/9.0)-C1*C2*t1998*t1999*t2016*t2035*t2028*(6.4E1/9.0))-e*k*rho_b[index]*1/pow(t1992,5.0/ \
               3.0)*t2011*t2023*(8.0/9.0)-e*k*rho_b[index]*t2011*t2024*t2027*(4.0/3.0)+e*k*rho_b[index]*1/(t2010* \
        ...
        if (is_gga_) {
            ...
            if (rho_a[index] > cutoff_ && rho_b[index] > cutoff_) {
                ...
                double t1725 = 1/pow(t1721,4.0/3.0);
                double t1726 = 1/(k*k);
                double t1727 = 1/pow(t1721,8.0/3.0);
                double t1728 = 1/(k*k*k*k);
                double t1739 = gamma_aa[index]*t1726*t1727*1.0E2;
                double t1729 = exp(-t1739);
                double t1730 = 1/pow(t1721,1.6E1/3.0);
                ...
                double t1738 = 1/t1737;
                double t1748 = C4*t1729;
                double t1740 = C3-t1748;
                double t1741 = C2*C2;
                double t1742 = gamma_aa[index]*t1741*t1726*t1727;
                double t1743 = t1742+1.0;
                double t1744 = 1/sqrt(t1743);
                double t1745 = 1/pow(t1721,1.1E1/3.0);
                double t1746 = 1/sqrt(t1723);
                double t1747 = 1/pow(t1721,1.9E1/3.0);
                ...
                double t1754 = 1/pow(t1721,7.0/3.0);
                double t1755 = 1/(t1737*t1737);
                ...
                double t1760 = 1/pow(t1743,3.0/2.0);
                ...
                double t1765 = 1/pow(t1721,2.0/3.0);
                ...
                v_rho_a_gamma_aa_[index] = e*k*t1733*t1753*t1738-e*k*t1733*t1762*t1755*t1757-e*k*rho_a[index]*t1733* \
                   t1738*(t1758+t1759+t1740*t1726*t1745*(1.6E1/3.0)-C4*1/(k*k*k*k*k*k)*1/(rho_a[index]*rho_a[index]*rho_a[index]* \
                   rho_a[index]*rho_a[index]*rho_a[index]*rho_a[index]*rho_a[index]*rho_a[index])*t1734*t1729*(6.25E2/ \
                   6.0)+C4*gamma_aa[index]*t1728*t1729*t1747*1.6E3-C1*C2*gamma_aa[index]*t1741*t1760*t1728*t1747*(4.0/ \
                   3.0))+e*k*rho_a[index]*t1753*t1738*t1765*(2.0/3.0)+e*k*rho_a[index]*t1733*t1755*t1757*(t1758+t1759+ \
                   C5*gamma_aa[index]*t1728*t1747*(6.4E1/3.0)-C1*C2*gamma_aa[index]*t1741*t1760*t1728*t1747*(4.0/3.0) \
                   )+e*k*rho_a[index]*t1733*t1753*t1755*t1767-e*k*rho_a[index]*t1762*t1755*t1765*t1757*(2.0/3.0)+e*k* \
                   rho_a[index]*t1733*t1762*t1755*(t1763+t1764+gamma_aa[index]*t1740*t1726*t1745*(1.6E1/3.0)+C4*t1734* \
                   t1728*t1729*t1747*(1.6E3/3.0))-e*k*rho_a[index]*t1733*t1762*1/(t1737*t1737*t1737)*t1757*t1767*2.0;
            } else if (rho_a[index] > cutoff_) {
                double t2271 = rho_a[index]*2.0;
                double t2272 = 1/k;
                double t2273 = gamma_aa[index]*4.0;
                double t2274 = sqrt(t2273);
                double t2275 = 1/pow(t2271,4.0/3.0);
                double t2276 = 1/(k*k);
                double t2277 = 1/pow(t2271,8.0/3.0);
                double t2278 = 1/(k*k*k*k);
                double t2289 = gamma_aa[index]*t2276*t2277*1.0E2;
                double t2279 = exp(-t2289);
                double t2280 = 1/pow(t2271,1.6E1/3.0);
                ...
                double t2288 = 1/t2287;
                double t2298 = C4*t2279;
                double t2290 = C3-t2298;
                double t2291 = C2*C2;
                double t2292 = gamma_aa[index]*t2291*t2276*t2277;
                double t2293 = t2292+1.0;
                double t2294 = 1/sqrt(t2293);
                double t2295 = 1/pow(t2271,1.1E1/3.0);
                double t2296 = 1/sqrt(t2273);
                double t2297 = 1/pow(t2271,1.9E1/3.0);
                ...
                double t2304 = 1/pow(t2271,7.0/3.0);
                double t2305 = 1/(t2287*t2287);
                ...
                double t2310 = 1/pow(t2293,3.0/2.0);
                ...
                double t2315 = 1/pow(t2271,2.0/3.0);
                ...
                v_rho_a_gamma_aa_[index] = e*k*t2283*t2288*t2303-e*k*t2283*t2312*t2305*t2307-e*k*rho_a[index]*t2283* \
                   t2288*(t2308+t2309+t2290*t2276*t2295*(1.6E1/3.0)-C4*1/(k*k*k*k*k*k)*1/(rho_a[index]*rho_a[index]*rho_a[index]* \
                   rho_a[index]*rho_a[index]*rho_a[index]*rho_a[index]*rho_a[index]*rho_a[index])*t2284*t2279*(6.25E2/ \
                   6.0)+C4*gamma_aa[index]*t2278*t2279*t2297*1.6E3-C1*C2*gamma_aa[index]*t2291*t2278*t2297*t2310*(4.0/ \
                   3.0))+e*k*rho_a[index]*t2288*t2303*t2315*(2.0/3.0)+e*k*rho_a[index]*t2283*t2305*t2307*(t2308+t2309+ \
                   C5*gamma_aa[index]*t2278*t2297*(6.4E1/3.0)-C1*C2*gamma_aa[index]*t2291*t2278*t2297*t2310*(4.0/3.0) \
                   )+e*k*rho_a[index]*t2283*t2303*t2305*t2317-e*k*rho_a[index]*t2312*t2305*t2315*t2307*(2.0/3.0)+e*k* \
                   rho_a[index]*t2283*t2312*t2305*(t2313+t2314+gamma_aa[index]*t2290*t2276*t2295*(1.6E1/3.0)+C4*t2284* \
                   t2278*t2279*t2297*(1.6E3/3.0))-e*k*rho_a[index]*t2283*1/(t2287*t2287*t2287)*t2312*t2307*t2317*2.0;
            } else if (rho_b[index] > cutoff_) {
                v_rho_a_gamma_aa_[index] = 0.0;
            } else {
                v_rho_a_gamma_aa_[index] = 0.0;
            ...
            if (rho_a[index] > cutoff_ && rho_b[index] > cutoff_) {
                ...
                double t1777 = 1/pow(t1773,4.0/3.0);
                double t1778 = 1/(k*k);
                double t1779 = 1/pow(t1773,8.0/3.0);
                double t1780 = 1/(k*k*k*k);
                double t1791 = gamma_bb[index]*t1778*t1779*1.0E2;
                double t1781 = exp(-t1791);
                double t1782 = 1/pow(t1773,1.6E1/3.0);
                ...
                double t1790 = 1/t1789;
                double t1800 = C4*t1781;
                double t1792 = C3-t1800;
                double t1793 = C2*C2;
                double t1794 = gamma_bb[index]*t1793*t1778*t1779;
                double t1795 = t1794+1.0;
                double t1796 = 1/sqrt(t1795);
                double t1797 = 1/pow(t1773,1.1E1/3.0);
                double t1798 = 1/sqrt(t1775);
                double t1799 = 1/pow(t1773,1.9E1/3.0);
                ...
                double t1806 = 1/pow(t1773,7.0/3.0);
                double t1807 = 1/(t1789*t1789);
                ...
                double t1812 = 1/pow(t1795,3.0/2.0);
                ...
                double t1817 = 1/pow(t1773,2.0/3.0);
                ...
                v_rho_b_gamma_bb_[index] = e*k*t1790*t1785*t1805-e*k*t1785*t1814*t1807*t1809-e*k*rho_b[index]*t1790* \
                   t1785*(t1810+t1811+t1792*t1778*t1797*(1.6E1/3.0)-C4*1/(k*k*k*k*k*k)*1/(rho_b[index]*rho_b[index]*rho_b[index]* \
                   rho_b[index]*rho_b[index]*rho_b[index]*rho_b[index]*rho_b[index]*rho_b[index])*t1781*t1786*(6.25E2/ \
                   6.0)+C4*gamma_bb[index]*t1780*t1781*t1799*1.6E3-C1*C2*gamma_bb[index]*t1780*t1793*t1799*t1812*(4.0/ \
                   3.0))+e*k*rho_b[index]*t1790*t1805*t1817*(2.0/3.0)+e*k*rho_b[index]*t1785*t1807*t1809*(t1810+t1811+ \
                   C5*gamma_bb[index]*t1780*t1799*(6.4E1/3.0)-C1*C2*gamma_bb[index]*t1780*t1793*t1799*t1812*(4.0/3.0) \
                   )+e*k*rho_b[index]*t1785*t1805*t1807*t1819-e*k*rho_b[index]*t1814*t1807*t1817*t1809*(2.0/3.0)+e*k* \
                   rho_b[index]*t1785*t1814*t1807*(t1815+t1816+gamma_bb[index]*t1792*t1778*t1797*(1.6E1/3.0)+C4*t1780* \
                   t1781*t1786*t1799*(1.6E3/3.0))-e*k*rho_b[index]*t1785*1/(t1789*t1789*t1789)*t1814*t1809*t1819*2.0;
            } else if (rho_a[index] > cutoff_) {
                ...
                double t2047 = 1/pow(t2043,4.0/3.0);
                double t2048 = 1/(k*k);
                double t2049 = 1/pow(t2043,8.0/3.0);
                double t2050 = 1/(k*k*k*k);
                double t2061 = gamma_bb[index]*t2048*t2049*1.0E2;
                double t2051 = exp(-t2061);
                double t2052 = 1/pow(t2043,1.6E1/3.0);
                ...
                double t2060 = 1/t2059;
                double t2070 = C4*t2051;
                double t2062 = C3-t2070;
                double t2063 = C2*C2;
                double t2064 = gamma_bb[index]*t2063*t2048*t2049;
                double t2065 = t2064+1.0;
                double t2066 = 1/sqrt(t2065);
                double t2067 = 1/pow(t2043,1.1E1/3.0);
                double t2068 = 1/sqrt(t2045);
                double t2069 = 1/pow(t2043,1.9E1/3.0);
                ...
                double t2076 = 1/pow(t2043,7.0/3.0);
                double t2077 = 1/(t2059*t2059);
                ...
                double t2082 = 1/pow(t2065,3.0/2.0);
                ...
                double t2087 = 1/pow(t2043,2.0/3.0);
                ...
                v_rho_b_gamma_bb_[index] = e*k*t2060*t2055*t2075-e*k*t2055*t2084*t2077*t2079-e*k*rho_b[index]*t2060* \
                   t2055*(t2080+t2081+t2062*t2048*t2067*(1.6E1/3.0)-C4*1/(k*k*k*k*k*k)*1/(rho_b[index]*rho_b[index]*rho_b[index]* \
                   rho_b[index]*rho_b[index]*rho_b[index]*rho_b[index]*rho_b[index]*rho_b[index])*t2051*t2056*(6.25E2/ \
                   6.0)+C4*gamma_bb[index]*t2050*t2051*t2069*1.6E3-C1*C2*gamma_bb[index]*t2050*t2063*t2082*t2069*(4.0/ \
                   3.0))+e*k*rho_b[index]*t2060*t2075*t2087*(2.0/3.0)+e*k*rho_b[index]*t2055*t2077*t2079*(t2080+t2081+ \
                   C5*gamma_bb[index]*t2050*t2069*(6.4E1/3.0)-C1*C2*gamma_bb[index]*t2050*t2063*t2082*t2069*(4.0/3.0) \
                   )+e*k*rho_b[index]*t2055*t2075*t2077*t2089-e*k*rho_b[index]*t2084*t2077*t2087*t2079*(2.0/3.0)+e*k* \
                   rho_b[index]*t2055*t2084*t2077*(t2085+t2086+gamma_bb[index]*t2062*t2048*t2067*(1.6E1/3.0)+C4*t2050* \
                   t2051*t2056*t2069*(1.6E3/3.0))-e*k*rho_b[index]*t2055*t2084*1/(t2059*t2059*t2059)*t2079*t2089*2.0;
            } else {
                v_rho_b_gamma_bb_[index] = 0.0;
            } 
            ...
            if (rho_a[index] > cutoff_ && rho_b[index] > cutoff_) {
                ...
                double t1825 = 1/pow(t1821,4.0/3.0);
                double t1826 = 1/(k*k*k*k);
                double t1827 = 1/pow(t1821,1.6E1/3.0);
                double t1828 = C2*C2;
                double t1829 = 1/(k*k);
                double t1830 = 1/pow(t1821,8.0/3.0);
                ...
                double t1847 = 1/pow(t1835,3.0/2.0);
                double t1848 = C1*C2*t1826*t1827*t1828*t1847*(1.0/4.0);
                double t1849 = 1/pow(t1823,3.0/2.0);
                double t1850 = C1*t1822*t1833*t1825*t1849*2.0;
                double t1851 = 1/gamma_aa[index];
                double t1856 = 1/(t1843*t1843);
                v_gamma_aa_gamma_aa_[index] = -(e*k*rho_a[index]*t1836*(t1850+t1848-C4*t1831*t1826*t1827*2.0E2+C4* \
                   ...
                   ))/t1843+e*k*rho_a[index]*1/(t1843*t1843*t1843)*t1836*t1846*(t1838*t1838)*2.0-e*k*rho_a[index]*t1836* \
                ...
                double t2328 = 1/pow(t2324,4.0/3.0);
                double t2329 = 1/(k*k*k*k);
                double t2330 = 1/pow(t2324,1.6E1/3.0);
                double t2331 = C2*C2;
                double t2332 = 1/(k*k);
                double t2333 = 1/pow(t2324,8.0/3.0);
                ...
                double t2350 = 1/pow(t2338,3.0/2.0);
                double t2351 = C1*C2*t2330*t2331*t2350*t2329*(1.0/4.0);
                double t2352 = 1/pow(t2326,3.0/2.0);
                double t2353 = C1*t2325*t2352*t2336*t2328*2.0;
                double t2354 = 1/gamma_aa[index];
                double t2359 = 1/(t2346*t2346);
                v_gamma_aa_gamma_aa_[index] = -(e*k*rho_a[index]*t2339*(t2351+t2353-C4*t2330*t2334*t2329*2.0E2+C4* \
                   ...
                   ))/t2346+e*k*rho_a[index]*(t2341*t2341)*1/(t2346*t2346*t2346)*t2339*t2349*2.0-e*k*rho_a[index]*t2341* \
            ...
            if (rho_a[index] > cutoff_ && rho_b[index] > cutoff_) {
                ...
                double t1867 = 1/pow(t1863,4.0/3.0);
                double t1868 = 1/(k*k*k*k);
                double t1869 = 1/pow(t1863,1.6E1/3.0);
                double t1870 = C2*C2;
                double t1871 = 1/(k*k);
                double t1872 = 1/pow(t1863,8.0/3.0);
                ...
                double t1889 = 1/pow(t1877,3.0/2.0);
                double t1890 = C1*C2*t1870*t1868*t1869*t1889*(1.0/4.0);
                double t1891 = 1/pow(t1865,3.0/2.0);
                double t1892 = C1*t1864*t1891*t1875*t1867*2.0;
                double t1893 = 1/gamma_bb[index];
                double t1898 = 1/(t1885*t1885);
                v_gamma_bb_gamma_bb_[index] = -(e*k*rho_b[index]*t1878*(t1890+t1892-C4*t1873*t1868*t1869*2.0E2+C4* \
                   gamma_bb[index]*1/(k*k*k*k*k*k)*1/(rho_b[index]*rho_b[index]*rho_b[index]*rho_b[index]*rho_b[index]* \
                   rho_b[index]*rho_b[index]*rho_b[index])*t1873*(6.25E2/1.6E1)-C1*C2*t1871*t1872*t1893*t1879*(1.0/4.0) \
                   ))/t1885+e*k*rho_b[index]*(t1880*t1880)*1/(t1885*t1885*t1885)*t1878*t1888*2.0-e*k*rho_b[index]*t1880* \
                ...
                double t2100 = 1/pow(t2096,4.0/3.0);
                double t2101 = 1/(k*k*k*k);
                double t2102 = 1/pow(t2096,1.6E1/3.0);
                double t2103 = C2*C2;
                double t2104 = 1/(k*k);
                double t2105 = 1/pow(t2096,8.0/3.0);
                ...
                double t2122 = 1/pow(t2110,3.0/2.0);
                double t2123 = C1*C2*t2101*t2102*t2103*t2122*(1.0/4.0);
                double t2124 = 1/pow(t2098,3.0/2.0);
                double t2125 = C1*t2097*t2100*t2124*t2108*2.0;
                double t2126 = 1/gamma_bb[index];
                double t2131 = 1/(t2118*t2118);
                v_gamma_bb_gamma_bb_[index] = -(e*k*rho_b[index]*t2111*(t2123+t2125-C4*t2101*t2102*t2106*2.0E2+C4* \
                   ...
                   ))/t2118+e*k*rho_b[index]*t2111*t2121*(t2113*t2113)*1/(t2118*t2118*t2118)*2.0-e*k*rho_b[index]*t2111* \

...
void FT97B_X_Functional::computeRKSFunctional(boost::shared_ptr<Properties> prop)
{
    ...
    for (int index = 0; index < ntrue; index++) {
        ...
        if (rho_a[index] > cutoff_) {
            double t3301 = 1/pow(rho_a[index],8.0/3.0);
            ...
            double t3306 = 1/t3305;
            double t3307 = d1*gamma_aa[index]*t3306;
            double t3303 = d0+t3307;
            functional_[index] = c*pow(rho_a[index],4.0/3.0)*((gamma_aa[index]*t3301*t3303*1/sqrt(gamma_aa[index]* \
    ...
    for (int index = 0; index < ntrue && deriv_ >= 1; index++) {
        ...
        if (rho_a[index] > cutoff_) {
            ...
            double t3322 = 1/sqrt(t3321);
            double t3323 = 1/pow(rho_a[index],1.1E1/3.0);
            ...
            v_rho_a_[index] = c*pow(rho_a[index],1.0/3.0)*(gamma_aa[index]*t3311*t3322*t3316*t3309-1.0)*(-4.0/ \
               ...
               t3311*1/pow(t3321,3.0/2.0)*t3316*t3309*(gamma_aa[index]*t3323*t3318*t3319*2.4E1+1/pow(rho_a[index],1.9E1/ \
               3.0)*t3310*t3324*t3319*1/sqrt(1/pow(rho_a[index],1.6E1/3.0)*t3324+1.0)*4.8E1)*(1.0/2.0));
        } else {
            v_rho_a_[index] = 0.0;
        } 
        ...
        if (is_gga_) {
            ...
            if (rho_a[index] > cutoff_) {
                ...
                double t3339 = 1/sqrt(t3338);
                double t3340 = 1/pow(rho_a[index],1.6E1/3.0);
                double t3341 = d1*t3331;
                double t3342 = 1/(t3330*t3330);
                ...
                v_gamma_aa_[index] = c*pow(rho_a[index],4.0/3.0)*(t3333*t3326*t3328*t3339+gamma_aa[index]*t3333*t3343* \
                   t3326*t3339-gamma_aa[index]*t3333*t3326*t3328*1/pow(t3338,3.0/2.0)*(t3326*t3335*t3336*9.0+gamma_aa[index]* \
                   t3340*t3327*t3336*1/sqrt((gamma_aa[index]*gamma_aa[index])*t3340+1.0)*1.8E1+gamma_aa[index]*t3343* \
    ...
    for (int index = 0; index < ntrue && deriv_ >= 2; index++) {
        ...
        if (rho_a[index] > cutoff_) {
            ...
            double t3359 = 1/sqrt(t3358);
            double t3360 = 1/pow(rho_a[index],1.1E1/3.0);
            double t3361 = gamma_aa[index]*gamma_aa[index];
            double t3362 = 1/pow(t3358,3.0/2.0);
            double t3363 = 1/pow(rho_a[index],1.4E1/3.0);
            double t3364 = 1/pow(rho_a[index],1.6E1/3.0);
            double t3365 = t3361*t3364;
            double t3366 = t3365+1.0;
            double t3367 = 1/sqrt(t3366);
            double t3368 = gamma_aa[index]*t3360*t3355*t3356*2.4E1;
            double t3369 = 1/pow(rho_a[index],1.9E1/3.0);
            double t3370 = t3361*t3347*t3356*t3367*t3369*4.8E1;
            double t3371 = t3370+t3368;
            v_rho_a_rho_a_[index] = c*1/pow(rho_a[index],2.0/3.0)*(gamma_aa[index]*t3353*t3346*t3348*t3359-1.0) \
               *(-4.0/9.0)-c*pow(rho_a[index],4.0/3.0)*(gamma_aa[index]*t3353*t3363*t3348*t3359*(8.8E1/9.0)-gamma_aa[index]* \
               t3360*t3353*t3362*t3371*t3348*(8.0/3.0)-gamma_aa[index]*t3353*t3362*t3346*t3348*(gamma_aa[index]*t3363* \
               t3355*t3356*8.8E1+1/pow(rho_a[index],2.2E1/3.0)*t3361*t3347*t3356*t3367*4.32E2+(gamma_aa[index]*1/ \
               pow(rho_a[index],1.0E1)*t3361*t3356*1.28E2)/t3366-1/pow(rho_a[index],3.8E1/3.0)*(t3361*t3361)*t3347* \
               t3356*1/pow(t3366,3.0/2.0)*1.28E2)*(1.0/2.0)+gamma_aa[index]*t3353*(t3371*t3371)*t3346*t3348*1/pow(t3358,5.0/ \
               2.0)*(3.0/4.0))+c*pow(rho_a[index],1.0/3.0)*(gamma_aa[index]*t3360*t3353*t3348*t3359*(8.0/3.0)-gamma_aa[index]* \
               t3353*t3362*t3371*t3346*t3348*(1.0/2.0))*(8.0/3.0);
        } else {
        ...
        if (is_gga_) {
            ...
            if (rho_a[index] > cutoff_) {
                ...
                double t3386 = 1/sqrt(t3385);
                double t3387 = 1/pow(rho_a[index],1.6E1/3.0);
                double t3388 = d1*t3378;
                double t3389 = 1/(t3377*t3377);
                double t3397 = d1*gamma_aa[index]*t3389;
                double t3390 = t3388-t3397;
                double t3391 = 1/pow(rho_a[index],1.1E1/3.0);
                double t3392 = gamma_aa[index]*gamma_aa[index];
                double t3393 = t3392*t3387;
                double t3394 = t3393+1.0;
                double t3395 = 1/sqrt(t3394);
                double t3396 = 1/pow(t3385,3.0/2.0);
                double t3398 = 1/pow(rho_a[index],1.9E1/3.0);
                ...
                v_rho_a_gamma_aa_[index] = -c*pow(rho_a[index],4.0/3.0)*(t3380*t3391*t3375*t3386*(-8.0/3.0)-gamma_aa[index]* \
                   ...
                   t3380*t3373*t3375*t3396*(t3382*t3391*t3383*2.4E1+(1/(rho_a[index]*rho_a[index]*rho_a[index]*rho_a[index]* \
                   ...
                   t3395*t3398*9.6E1-gamma_aa[index]*1/pow(rho_a[index],3.5E1/3.0)*t3374*t3383*t3392*1/pow(t3394,3.0/ \
                   2.0)*4.8E1)*(1.0/2.0)-gamma_aa[index]*t3380*t3373*t3375*1/pow(t3385,5.0/2.0)*t3402*t3405*(3.0/4.0) \
            ...
            if (rho_a[index] > cutoff_) {
                ...
                double t3420 = 1/pow(rho_a[index],1.6E1/3.0);
                double t3421 = d1*t3411;
                double t3422 = 1/(t3408*t3408);
                double t3431 = d1*gamma_aa[index]*t3422;
                double t3423 = t3421-t3431;
                double t3424 = 1/sqrt(t3419);
                ...
                double t3434 = 1/pow(t3419,3.0/2.0);
                double t3435 = d1*t3422*2.0;
                double t3436 = 1/(t3408*t3408*t3408);
                ...
                v_gamma_aa_gamma_aa_[index] = c*pow(rho_a[index],4.0/3.0)*(t3413*t3423*t3424*t3409*-2.0+gamma_aa[index]* \
                   ...
                   gamma_aa[index]*(t3423*t3423)*t3415*t3409*1.8E1+(gamma_aa[index]*1/(rho_a[index]*rho_a[index]*rho_a[index]* \
                   rho_a[index]*rho_a[index]*rho_a[index]*rho_a[index]*rho_a[index])*t3417*1.8E1)/t3428-1/pow(rho_a[index],3.2E1/ \
                   3.0)*t3410*t3417*t3426*1/pow(t3428,3.0/2.0)*1.8E1-gamma_aa[index]*t3412*t3415*t3409*t3437*1.8E1+gamma_aa[index]* \
                   t3410*t3420*t3412*t3423*t3429*7.2E1)*(1.0/2.0)-gamma_aa[index]*t3412*t3413*(t3433*t3433)*t3409*1/pow(t3419,5.0/ \
                   2.0)*(3.0/4.0))*2.0;
            } else {
...
void FT97B_X_Functional::computeUKSFunctional(boost::shared_ptr<Properties> prop)
{
    int ntrue = prop->getTrueSize();
    ...
    for (int index = 0; index < ntrue; index++) {
        ...
        if (rho_a[index] > cutoff_ && rho_b[index] > cutoff_) {
            double t2633 = 1/pow(rho_a[index],8.0/3.0);
            ...
            double t2638 = 1/t2637;
            double t2639 = d1*gamma_aa[index]*t2638;
            double t2635 = d0+t2639;
            double t2640 = 1/c;
            double t2641 = 1/pow(rho_b[index],8.0/3.0);
            ...
            double t2645 = 1/t2644;
            double t2646 = d1*gamma_bb[index]*t2645;
            double t2643 = d0+t2646;
            functional_[index] = -c*pow(rho_a[index],4.0/3.0)*(gamma_aa[index]*t2640*t2633*t2635*1/sqrt(gamma_aa[index]* \
               t2633*(t2634*t2634)*(t2635*t2635)*9.0+1.0)-1.0)-c*pow(rho_b[index],4.0/3.0)*(gamma_bb[index]*t2640* \
               t2641*t2643*1/sqrt(gamma_bb[index]*t2641*(t2642*t2642)*(t2643*t2643)*9.0+1.0)-1.0);
        } else if (rho_a[index] > cutoff_) {
            double t3098 = 1/pow(rho_a[index],8.0/3.0);
            ...
            double t3103 = 1/t3102;
            double t3104 = d1*gamma_aa[index]*t3103;
            double t3100 = d0+t3104;
            functional_[index] = -c*pow(rho_a[index],4.0/3.0)*((gamma_aa[index]*t3098*t3100*1/sqrt(gamma_aa[index]* \
               t3098*(t3099*t3099)*(t3100*t3100)*9.0+1.0))/c-1.0);
        } else if (rho_b[index] > cutoff_) {
            double t2931 = 1/pow(rho_b[index],8.0/3.0);
            ...
            double t2936 = 1/t2935;
            double t2937 = d1*gamma_bb[index]*t2936;
            double t2933 = d0+t2937;
            functional_[index] = -c*pow(rho_b[index],4.0/3.0)*((gamma_bb[index]*t2931*t2933*1/sqrt(gamma_bb[index]* \
    ...
    for (int index = 0; index < ntrue && deriv_ >= 1; index++) {
        ...
        if (rho_a[index] > cutoff_ && rho_b[index] > cutoff_) {
            ...
            double t2661 = 1/sqrt(t2660);
            double t2662 = 1/pow(rho_a[index],1.1E1/3.0);
            ...
            v_rho_a_[index] = c*pow(rho_a[index],1.0/3.0)*(gamma_aa[index]*t2650*t2661*t2655*t2648-1.0)*(-4.0/ \
               ...
               t2650*1/pow(t2660,3.0/2.0)*t2655*t2648*(gamma_aa[index]*t2662*t2657*t2658*2.4E1+1/pow(rho_a[index],1.9E1/ \
               3.0)*t2663*t2649*t2658*1/sqrt(1/pow(rho_a[index],1.6E1/3.0)*t2663+1.0)*4.8E1)*(1.0/2.0));
        } else if (rho_a[index] > cutoff_) {
            double t3106 = 1/pow(rho_a[index],8.0/3.0);
            double t3114 = gamma_aa[index]*t3106;
            double t3107 = log(t3114+sqrt(t3114*t3114+1.0));
            double t3109 = d2*d2;
            double t3110 = gamma_aa[index]+t3109;
            double t3111 = 1/t3110;
            ...
            double t3119 = 1/sqrt(t3118);
            double t3120 = 1/pow(rho_a[index],1.1E1/3.0);
            ...
            v_rho_a_[index] = c*pow(rho_a[index],1.0/3.0)*(gamma_aa[index]*t3113*t3106*t3108*t3119-1.0)*(-4.0/ \
               ...
               t3113*t3106*t3108*1/pow(t3118,3.0/2.0)*(gamma_aa[index]*t3120*t3115*t3116*2.4E1+1/pow(rho_a[index],1.9E1/ \
               3.0)*t3121*t3107*t3116*1/sqrt(1/pow(rho_a[index],1.6E1/3.0)*t3121+1.0)*4.8E1)*(1.0/2.0));
        } else if (rho_b[index] > cutoff_) {
            v_rho_a_[index] = 0.0;
        } else {
            v_rho_a_[index] = 0.0;
        ...
        if (rho_a[index] > cutoff_ && rho_b[index] > cutoff_) {
            ...
            double t2678 = 1/sqrt(t2677);
            double t2679 = 1/pow(rho_b[index],1.1E1/3.0);
            ...
            v_rho_b_[index] = c*pow(rho_b[index],1.0/3.0)*(gamma_bb[index]*t2672*t2665*t2667*t2678-1.0)*(-4.0/ \
               ...
               t2672*t2665*t2667*1/pow(t2677,3.0/2.0)*(gamma_bb[index]*t2674*t2675*t2679*2.4E1+1/pow(rho_b[index],1.9E1/ \
               3.0)*t2680*t2666*t2675*1/sqrt(1/pow(rho_b[index],1.6E1/3.0)*t2680+1.0)*4.8E1)*(1.0/2.0));
        } else if (rho_a[index] > cutoff_) {
            v_rho_b_[index] = 0.0;
        } else if (rho_b[index] > cutoff_) {
            double t2940 = 1/pow(rho_b[index],8.0/3.0);
            double t2948 = gamma_bb[index]*t2940;
            double t2941 = log(t2948+sqrt(t2948*t2948+1.0));
            double t2943 = d2*d2;
            double t2944 = gamma_bb[index]+t2943;
            double t2945 = 1/t2944;
            ...
            double t2953 = 1/sqrt(t2952);
            double t2954 = 1/pow(rho_b[index],1.1E1/3.0);
            ...
            v_rho_b_[index] = c*pow(rho_b[index],1.0/3.0)*(gamma_bb[index]*t2940*t2942*t2953*t2947-1.0)*(-4.0/ \
               ...
               t2940*t2942*1/pow(t2952,3.0/2.0)*t2947*(gamma_bb[index]*t2950*t2954*t2949*2.4E1+1/pow(rho_b[index],1.9E1/ \
               3.0)*t2941*t2950*t2955*1/sqrt(1/pow(rho_b[index],1.6E1/3.0)*t2955+1.0)*4.8E1)*(1.0/2.0));
        } else {
            v_rho_b_[index] = 0.0;
        } 
        ...
        if (is_gga_) {
            ...
            if (rho_a[index] > cutoff_ && rho_b[index] > cutoff_) {
                ...
                double t2695 = 1/sqrt(t2694);
                double t2696 = 1/pow(rho_a[index],1.6E1/3.0);
                double t2697 = d1*t2687;
                double t2698 = 1/(t2686*t2686);
                ...
                v_gamma_aa_[index] = -c*pow(rho_a[index],4.0/3.0)*(t2682*t2684*t2695*t2689+gamma_aa[index]*t2682* \
                   t2695*t2689*t2699-gamma_aa[index]*t2682*t2684*1/pow(t2694,3.0/2.0)*t2689*(t2682*t2691*t2692*9.0+gamma_aa[index]* \
                   t2683*t2692*t2696*1/sqrt((gamma_aa[index]*gamma_aa[index])*t2696+1.0)*1.8E1+gamma_aa[index]*t2682* \
                   t2691*t2684*t2699*1.8E1)*(1.0/2.0));
            } else if (rho_a[index] > cutoff_) {
                double t3124 = 1/pow(rho_a[index],8.0/3.0);
                double t3132 = gamma_aa[index]*t3124;
                double t3125 = log(t3132+sqrt(t3132*t3132+1.0));
                double t3127 = d2*d2;
                double t3128 = gamma_aa[index]+t3127;
                double t3129 = 1/t3128;
                ...
                double t3137 = 1/sqrt(t3136);
                double t3138 = 1/pow(rho_a[index],1.6E1/3.0);
                double t3139 = d1*t3129;
                double t3140 = 1/(t3128*t3128);
                ...
                v_gamma_aa_[index] = -c*pow(rho_a[index],4.0/3.0)*(t3131*t3124*t3126*t3137+gamma_aa[index]*t3131* \
                   t3141*t3124*t3137-gamma_aa[index]*t3131*t3124*t3126*1/pow(t3136,3.0/2.0)*(t3124*t3133*t3134*9.0+gamma_aa[index]* \
                   t3125*t3134*t3138*1/sqrt((gamma_aa[index]*gamma_aa[index])*t3138+1.0)*1.8E1+gamma_aa[index]*t3141* \
                   t3124*t3133*t3126*1.8E1)*(1.0/2.0));
            } else if (rho_b[index] > cutoff_) {
                v_gamma_aa_[index] = 0.0;
            } else {
                v_gamma_aa_[index] = 0.0;
            ...
            if (rho_a[index] > cutoff_ && rho_b[index] > cutoff_) {
                ...
                double t2715 = 1/sqrt(t2714);
                double t2716 = 1/pow(rho_b[index],1.6E1/3.0);
                double t2717 = d1*t2707;
                double t2718 = 1/(t2706*t2706);
                ...
                v_gamma_bb_[index] = -c*pow(rho_b[index],4.0/3.0)*(t2702*t2704*t2715*t2709+gamma_bb[index]*t2702* \
                   t2715*t2709*t2719-gamma_bb[index]*t2702*t2704*1/pow(t2714,3.0/2.0)*t2709*(t2702*t2711*t2712*9.0+gamma_bb[index]* \
                   t2703*t2712*t2716*1/sqrt((gamma_bb[index]*gamma_bb[index])*t2716+1.0)*1.8E1+gamma_bb[index]*t2702* \
                   t2711*t2704*t2719*1.8E1)*(1.0/2.0));
            } else if (rho_a[index] > cutoff_) {
                v_gamma_bb_[index] = 0.0;
            } else if (rho_b[index] > cutoff_) {
                double t2959 = 1/pow(rho_b[index],8.0/3.0);
                double t2967 = gamma_bb[index]*t2959;
                double t2960 = log(t2967+sqrt(t2967*t2967+1.0));
                double t2962 = d2*d2;
                double t2963 = gamma_bb[index]+t2962;
                double t2964 = 1/t2963;
                ...
                double t2972 = 1/sqrt(t2971);
                double t2973 = 1/pow(rho_b[index],1.6E1/3.0);
                double t2974 = d1*t2964;
                double t2975 = 1/(t2963*t2963);
                ...
                v_gamma_bb_[index] = -c*pow(rho_b[index],4.0/3.0)*(t2961*t2972*t2966*t2959+gamma_bb[index]*t2972* \
                   t2966*t2976*t2959-gamma_bb[index]*t2961*1/pow(t2971,3.0/2.0)*t2966*t2959*(t2959*t2968*t2969*9.0+gamma_bb[index]* \
                   t2960*t2973*t2969*1/sqrt((gamma_bb[index]*gamma_bb[index])*t2973+1.0)*1.8E1+gamma_bb[index]*t2961* \
                   t2976*t2959*t2968*1.8E1)*(1.0/2.0));
            } else {
                v_gamma_bb_[index] = 0.0;
            } 
        }
    ...
    for (int index = 0; index < ntrue && deriv_ >= 2; index++) {
        ...
        if (rho_a[index] > cutoff_ && rho_b[index] > cutoff_) {
            ...
            double t2736 = 1/sqrt(t2735);
            double t2737 = 1/pow(rho_a[index],1.1E1/3.0);
            double t2738 = gamma_aa[index]*gamma_aa[index];
            double t2739 = 1/pow(t2735,3.0/2.0);
            double t2740 = 1/pow(rho_a[index],1.4E1/3.0);
            double t2741 = 1/pow(rho_a[index],1.6E1/3.0);
            double t2742 = t2741*t2738;
            double t2743 = t2742+1.0;
            double t2744 = 1/sqrt(t2743);
            double t2745 = gamma_aa[index]*t2732*t2733*t2737*2.4E1;
            double t2746 = 1/pow(rho_a[index],1.9E1/3.0);
            double t2747 = t2724*t2733*t2744*t2746*t2738*4.8E1;
            double t2748 = t2745+t2747;
            v_rho_a_rho_a_[index] = c*1/pow(rho_a[index],2.0/3.0)*(gamma_aa[index]*t2730*t2723*t2725*t2736-1.0) \
               *(-4.0/9.0)-c*pow(rho_a[index],4.0/3.0)*(gamma_aa[index]*t2730*t2740*t2725*t2736*(8.8E1/9.0)-gamma_aa[index]* \
               t2730*t2725*t2737*t2739*t2748*(8.0/3.0)-gamma_aa[index]*t2730*t2723*t2725*t2739*(gamma_aa[index]*t2740* \
               t2732*t2733*8.8E1+1/pow(rho_a[index],2.2E1/3.0)*t2724*t2733*t2744*t2738*4.32E2+(gamma_aa[index]*1/ \
               pow(rho_a[index],1.0E1)*t2733*t2738*1.28E2)/t2743-1/pow(rho_a[index],3.8E1/3.0)*t2724*t2733*1/pow(t2743,3.0/ \
               2.0)*(t2738*t2738)*1.28E2)*(1.0/2.0)+gamma_aa[index]*t2730*t2723*t2725*1/pow(t2735,5.0/2.0)*(t2748* \
               t2748)*(3.0/4.0))+c*pow(rho_a[index],1.0/3.0)*(gamma_aa[index]*t2730*t2725*t2736*t2737*(8.0/3.0)-gamma_aa[index]* \
               t2730*t2723*t2725*t2739*t2748*(1.0/2.0))*(8.0/3.0);
        } else if (rho_a[index] > cutoff_) {
            double t3147 = 1/pow(rho_a[index],8.0/3.0);
            double t3155 = gamma_aa[index]*t3147;
            double t3148 = log(t3155+sqrt(t3155*t3155+1.0));
            double t3150 = d2*d2;
            double t3151 = gamma_aa[index]+t3150;
            double t3152 = 1/t3151;
            ...
            double t3160 = 1/sqrt(t3159);
            double t3161 = 1/pow(rho_a[index],1.1E1/3.0);
            double t3162 = gamma_aa[index]*gamma_aa[index];
            double t3163 = 1/pow(t3159,3.0/2.0);
            double t3164 = 1/pow(rho_a[index],1.4E1/3.0);
            double t3165 = 1/pow(rho_a[index],1.6E1/3.0);
            double t3166 = t3162*t3165;
            double t3167 = t3166+1.0;
            double t3168 = 1/sqrt(t3167);
            double t3169 = gamma_aa[index]*t3161*t3156*t3157*2.4E1;
            double t3170 = 1/pow(rho_a[index],1.9E1/3.0);
            double t3171 = t3170*t3162*t3148*t3157*t3168*4.8E1;
            double t3172 = t3171+t3169;
            v_rho_a_rho_a_[index] = c*1/pow(rho_a[index],2.0/3.0)*(gamma_aa[index]*t3160*t3154*t3147*t3149-1.0) \
               *(-4.0/9.0)-c*pow(rho_a[index],4.0/3.0)*(gamma_aa[index]*t3160*t3154*t3164*t3149*(8.8E1/9.0)-gamma_aa[index]* \
               t3161*t3154*t3163*t3172*t3149*(8.0/3.0)-gamma_aa[index]*t3154*t3163*t3147*t3149*(gamma_aa[index]*t3164* \
               t3156*t3157*8.8E1+1/pow(rho_a[index],2.2E1/3.0)*t3162*t3148*t3157*t3168*4.32E2+(gamma_aa[index]*1/ \
               pow(rho_a[index],1.0E1)*t3162*t3157*1.28E2)/t3167-1/pow(rho_a[index],3.8E1/3.0)*(t3162*t3162)*t3148* \
               t3157*1/pow(t3167,3.0/2.0)*1.28E2)*(1.0/2.0)+gamma_aa[index]*t3154*(t3172*t3172)*t3147*t3149*1/pow(t3159,5.0/ \
               2.0)*(3.0/4.0))+c*pow(rho_a[index],1.0/3.0)*(gamma_aa[index]*t3160*t3161*t3154*t3149*(8.0/3.0)-gamma_aa[index]* \
               t3154*t3163*t3172*t3147*t3149*(1.0/2.0))*(8.0/3.0);
        } else if (rho_b[index] > cutoff_) {
            v_rho_a_rho_a_[index] = 0.0;
        } else {
            v_rho_a_rho_a_[index] = 0.0;
        ...
        if (rho_a[index] > cutoff_ && rho_b[index] > cutoff_) {
            ...
            double t2764 = 1/sqrt(t2763);
            double t2765 = 1/pow(rho_b[index],1.1E1/3.0);
            double t2766 = gamma_bb[index]*gamma_bb[index];
            double t2767 = 1/pow(t2763,3.0/2.0);
            double t2768 = 1/pow(rho_b[index],1.4E1/3.0);
            double t2769 = 1/pow(rho_b[index],1.6E1/3.0);
            double t2770 = t2766*t2769;
            double t2771 = t2770+1.0;
            double t2772 = 1/sqrt(t2771);
            double t2773 = gamma_bb[index]*t2760*t2761*t2765*2.4E1;
            double t2774 = 1/pow(rho_b[index],1.9E1/3.0);
            double t2775 = t2752*t2761*t2772*t2774*t2766*4.8E1;
            double t2776 = t2773+t2775;
            v_rho_b_rho_b_[index] = c*1/pow(rho_b[index],2.0/3.0)*(gamma_bb[index]*t2751*t2753*t2764*t2758-1.0) \
               *(-4.0/9.0)-c*pow(rho_b[index],4.0/3.0)*(gamma_bb[index]*t2753*t2764*t2758*t2768*(8.8E1/9.0)-gamma_bb[index]* \
               t2753*t2765*t2758*t2767*t2776*(8.0/3.0)-gamma_bb[index]*t2751*t2753*t2758*t2767*(gamma_bb[index]*t2760* \
               t2761*t2768*8.8E1+1/pow(rho_b[index],2.2E1/3.0)*t2752*t2761*t2772*t2766*4.32E2+(gamma_bb[index]*1/ \
               pow(rho_b[index],1.0E1)*t2761*t2766*1.28E2)/t2771-1/pow(rho_b[index],3.8E1/3.0)*t2752*t2761*1/pow(t2771,3.0/ \
               2.0)*(t2766*t2766)*1.28E2)*(1.0/2.0)+gamma_bb[index]*t2751*t2753*1/pow(t2763,5.0/2.0)*t2758*(t2776* \
               t2776)*(3.0/4.0))+c*pow(rho_b[index],1.0/3.0)*(gamma_bb[index]*t2753*t2764*t2765*t2758*(8.0/3.0)-gamma_bb[index]* \
               t2751*t2753*t2758*t2767*t2776*(1.0/2.0))*(8.0/3.0);
        } else if (rho_a[index] > cutoff_) {
            v_rho_b_rho_b_[index] = 0.0;
        } else if (rho_b[index] > cutoff_) {
            double t2982 = 1/pow(rho_b[index],8.0/3.0);
            double t2990 = gamma_bb[index]*t2982;
            double t2983 = log(t2990+sqrt(t2990*t2990+1.0));
            double t2985 = d2*d2;
            double t2986 = gamma_bb[index]+t2985;
            double t2987 = 1/t2986;
            ...
            double t2995 = 1/sqrt(t2994);
            double t2996 = 1/pow(rho_b[index],1.1E1/3.0);
            double t2997 = gamma_bb[index]*gamma_bb[index];
            double t2998 = 1/pow(t2994,3.0/2.0);
            double t2999 = 1/pow(rho_b[index],1.4E1/3.0);
            double t3000 = 1/pow(rho_b[index],1.6E1/3.0);
            double t3001 = t2997*t3000;
            double t3002 = t3001+1.0;
            double t3003 = 1/sqrt(t3002);
            double t3004 = gamma_bb[index]*t2991*t2992*t2996*2.4E1;
            double t3005 = 1/pow(rho_b[index],1.9E1/3.0);
            double t3006 = t2983*t2992*t2997*t3003*t3005*4.8E1;
            double t3007 = t3004+t3006;
            v_rho_b_rho_b_[index] = c*1/pow(rho_b[index],2.0/3.0)*(gamma_bb[index]*t2982*t2984*t2995*t2989-1.0) \
               *(-4.0/9.0)-c*pow(rho_b[index],4.0/3.0)*(gamma_bb[index]*t2984*t2995*t2989*t2999*(8.8E1/9.0)-gamma_bb[index]* \
               t2984*t2996*t2989*t2998*t3007*(8.0/3.0)-gamma_bb[index]*t2982*t2984*t2989*t2998*(gamma_bb[index]*t2991* \
               t2992*t2999*8.8E1+1/pow(rho_b[index],2.2E1/3.0)*t2983*t2992*t2997*t3003*4.32E2+(gamma_bb[index]*1/ \
               pow(rho_b[index],1.0E1)*t2992*t2997*1.28E2)/t3002-1/pow(rho_b[index],3.8E1/3.0)*t2983*t2992*(t2997* \
               t2997)*1/pow(t3002,3.0/2.0)*1.28E2)*(1.0/2.0)+gamma_bb[index]*t2982*t2984*1/pow(t2994,5.0/2.0)*t2989* \
               (t3007*t3007)*(3.0/4.0))+c*pow(rho_b[index],1.0/3.0)*(gamma_bb[index]*t2984*t2995*t2996*t2989*(8.0/ \
               3.0)-gamma_bb[index]*t2982*t2984*t2989*t2998*t3007*(1.0/2.0))*(8.0/3.0);
        } else {
            v_rho_b_rho_b_[index] = 0.0;
        } 
        ...
        if (is_gga_) {
            ...
            if (rho_a[index] > cutoff_ && rho_b[index] > cutoff_) {
                ...
                double t2791 = 1/sqrt(t2790);
                double t2792 = 1/pow(rho_a[index],1.6E1/3.0);
                double t2793 = d1*t2783;
                double t2794 = 1/(t2782*t2782);
                double t2802 = d1*gamma_aa[index]*t2794;
                double t2795 = t2793-t2802;
                double t2796 = 1/pow(rho_a[index],1.1E1/3.0);
                double t2797 = gamma_aa[index]*gamma_aa[index];
                double t2798 = t2792*t2797;
                double t2799 = t2798+1.0;
                double t2800 = 1/sqrt(t2799);
                double t2801 = 1/pow(t2790,3.0/2.0);
                double t2803 = 1/pow(rho_a[index],1.9E1/3.0);
                ...
                v_rho_a_gamma_aa_[index] = -c*pow(rho_a[index],4.0/3.0)*(t2780*t2791*t2785*t2796*(-8.0/3.0)-gamma_aa[index]* \
                   ...
                   t2780*t2785*t2778*t2801*(t2787*t2796*t2788*2.4E1+(1/(rho_a[index]*rho_a[index]*rho_a[index]*rho_a[index]* \
                   ...
                   t2800*t2803*9.6E1-gamma_aa[index]*1/pow(rho_a[index],3.5E1/3.0)*t2779*t2788*t2797*1/pow(t2799,3.0/ \
                   2.0)*4.8E1)*(1.0/2.0)-gamma_aa[index]*t2780*1/pow(t2790,5.0/2.0)*t2785*t2778*t2810*t2807*(3.0/4.0) \
                ...
                double t3189 = 1/sqrt(t3188);
                double t3190 = 1/pow(rho_a[index],1.6E1/3.0);
                double t3191 = d1*t3181;
                double t3192 = 1/(t3180*t3180);
                double t3200 = d1*gamma_aa[index]*t3192;
                double t3193 = t3191-t3200;
                double t3194 = 1/pow(rho_a[index],1.1E1/3.0);
                double t3195 = gamma_aa[index]*gamma_aa[index];
                double t3196 = t3190*t3195;
                double t3197 = t3196+1.0;
                double t3198 = 1/sqrt(t3197);
                double t3199 = 1/pow(t3188,3.0/2.0);
                double t3201 = 1/pow(rho_a[index],1.9E1/3.0);
                ...
                v_rho_a_gamma_aa_[index] = -c*pow(rho_a[index],4.0/3.0)*(t3183*t3194*t3178*t3189*(-8.0/3.0)-gamma_aa[index]* \
                   ...
                   t3183*t3176*t3178*t3199*(t3185*t3194*t3186*2.4E1+(1/(rho_a[index]*rho_a[index]*rho_a[index]*rho_a[index]* \
                   ...
                   t3198*t3201*9.6E1-gamma_aa[index]*1/pow(rho_a[index],3.5E1/3.0)*t3177*t3186*t3195*1/pow(t3197,3.0/ \
                   2.0)*4.8E1)*(1.0/2.0)-gamma_aa[index]*t3183*t3176*t3178*1/pow(t3188,5.0/2.0)*t3205*t3208*(3.0/4.0) \
            ...
            if (rho_a[index] > cutoff_ && rho_b[index] > cutoff_) {
                ...
                double t2829 = 1/sqrt(t2828);
                double t2830 = 1/pow(rho_b[index],1.6E1/3.0);
                double t2831 = d1*t2821;
                double t2832 = 1/(t2820*t2820);
                double t2840 = d1*gamma_bb[index]*t2832;
                double t2833 = t2831-t2840;
                double t2834 = 1/pow(rho_b[index],1.1E1/3.0);
                double t2835 = gamma_bb[index]*gamma_bb[index];
                double t2836 = t2830*t2835;
                double t2837 = t2836+1.0;
                double t2838 = 1/sqrt(t2837);
                double t2839 = 1/pow(t2828,3.0/2.0);
                double t2841 = 1/pow(rho_b[index],1.9E1/3.0);
                ...
                v_rho_b_gamma_bb_[index] = -c*pow(rho_b[index],4.0/3.0)*(t2823*t2834*t2818*t2829*(-8.0/3.0)-gamma_bb[index]* \
                   ...
                   t2823*t2816*t2818*t2839*(t2825*t2834*t2826*2.4E1+(1/(rho_b[index]*rho_b[index]*rho_b[index]*rho_b[index]* \
                   ...
                   t2818*t2838*9.6E1-gamma_bb[index]*1/pow(rho_b[index],3.5E1/3.0)*t2817*t2826*t2835*1/pow(t2837,3.0/ \
                   2.0)*4.8E1)*(1.0/2.0)-gamma_bb[index]*t2823*t2816*t2818*t2845*1/pow(t2828,5.0/2.0)*t2848*(3.0/4.0) \
                ...
                double t3027 = 1/sqrt(t3026);
                double t3028 = 1/pow(rho_b[index],1.6E1/3.0);
                double t3029 = d1*t3019;
                double t3030 = 1/(t3018*t3018);
                double t3038 = d1*gamma_bb[index]*t3030;
                double t3031 = t3029-t3038;
                double t3032 = 1/pow(rho_b[index],1.1E1/3.0);
                double t3033 = gamma_bb[index]*gamma_bb[index];
                double t3034 = t3033*t3028;
                double t3035 = t3034+1.0;
                double t3036 = 1/sqrt(t3035);
                double t3037 = 1/pow(t3026,3.0/2.0);
                double t3039 = 1/pow(rho_b[index],1.9E1/3.0);
                ...
                v_rho_b_gamma_bb_[index] = -c*pow(rho_b[index],4.0/3.0)*(t3021*t3032*t3016*t3027*(-8.0/3.0)-gamma_bb[index]* \
                   ...
                   t3021*t3014*t3016*t3037*(t3023*t3032*t3024*2.4E1+(1/(rho_b[index]*rho_b[index]*rho_b[index]*rho_b[index]* \
                   ...
                   t3036*t3039*9.6E1-gamma_bb[index]*1/pow(rho_b[index],3.5E1/3.0)*t3015*t3024*t3033*1/pow(t3035,3.0/ \
                   2.0)*4.8E1)*(1.0/2.0)-gamma_bb[index]*t3021*t3014*t3016*t3043*1/pow(t3026,5.0/2.0)*t3046*(3.0/4.0) \
            ...
            if (rho_a[index] > cutoff_ && rho_b[index] > cutoff_) {
                ...
                double t2863 = 1/pow(rho_a[index],1.6E1/3.0);
                double t2864 = d1*t2854;
                double t2865 = 1/(t2851*t2851);
                double t2874 = d1*gamma_aa[index]*t2865;
                double t2866 = t2864-t2874;
                double t2867 = 1/sqrt(t2862);
                ...
                double t2877 = 1/pow(t2862,3.0/2.0);
                double t2878 = d1*t2865*2.0;
                double t2879 = 1/(t2851*t2851*t2851);
                ...
                v_gamma_aa_gamma_aa_[index] = c*pow(rho_a[index],4.0/3.0)*(t2852*t2856*t2866*t2867*-2.0+gamma_aa[index]* \
                   ...
                   gamma_aa[index]*t2852*(t2866*t2866)*t2858*1.8E1+(gamma_aa[index]*1/(rho_a[index]*rho_a[index]*rho_a[index]* \
                   rho_a[index]*rho_a[index]*rho_a[index]*rho_a[index]*rho_a[index])*t2860*1.8E1)/t2871-1/pow(rho_a[index],3.2E1/ \
                   3.0)*t2860*t2853*1/pow(t2871,3.0/2.0)*t2869*1.8E1-gamma_aa[index]*t2852*t2880*t2855*t2858*1.8E1+gamma_aa[index]* \
                   t2853*t2863*t2872*t2855*t2866*7.2E1)*(1.0/2.0)-gamma_aa[index]*t2852*1/pow(t2862,5.0/2.0)*t2855*t2856* \
                   (t2876*t2876)*(3.0/4.0));
            } else if (rho_a[index] > cutoff_) {
                double t3215 = d2*d2;
                double t3216 = gamma_aa[index]+t3215;
                double t3217 = 1/pow(rho_a[index],8.0/3.0);
                double t3222 = gamma_aa[index]*t3217;
                double t3218 = log(t3222+sqrt(t3222*t3222+1.0));
                double t3219 = 1/t3216;
                ...
                double t3228 = 1/pow(rho_a[index],1.6E1/3.0);
                double t3229 = d1*t3219;
                double t3230 = 1/(t3216*t3216);
                double t3239 = d1*gamma_aa[index]*t3230;
                double t3231 = t3229-t3239;
                double t3232 = 1/sqrt(t3227);
                ...
                double t3242 = 1/pow(t3227,3.0/2.0);
                double t3243 = d1*t3230*2.0;
                double t3244 = 1/(t3216*t3216*t3216);
                ...
                v_gamma_aa_gamma_aa_[index] = c*pow(rho_a[index],4.0/3.0)*(t3221*t3231*t3232*t3217*-2.0+gamma_aa[index]* \
                   ...
                   gamma_aa[index]*(t3231*t3231)*t3223*t3217*1.8E1+(gamma_aa[index]*1/(rho_a[index]*rho_a[index]*rho_a[index]* \
                   rho_a[index]*rho_a[index]*rho_a[index]*rho_a[index]*rho_a[index])*t3225*1.8E1)/t3236-1/pow(rho_a[index],3.2E1/ \
                   3.0)*t3225*t3234*t3218*1/pow(t3236,3.0/2.0)*1.8E1-gamma_aa[index]*t3220*t3223*t3217*t3245*1.8E1+gamma_aa[index]* \
                   t3220*t3231*t3218*t3228*t3237*7.2E1)*(1.0/2.0)-gamma_aa[index]*t3220*t3221*(t3241*t3241)*t3217*1/pow(t3227,5.0/ \
                   2.0)*(3.0/4.0));
            } else if (rho_b[index] > cutoff_) {
                v_gamma_aa_gamma_aa_[index] = 0.0;
            } else {
            ...
            if (rho_a[index] > cutoff_ && rho_b[index] > cutoff_) {
                ...
                double t2899 = 1/pow(rho_b[index],1.6E1/3.0);
                double t2900 = d1*t2890;
                double t2901 = 1/(t2887*t2887);
                double t2910 = d1*gamma_bb[index]*t2901;
                double t2902 = t2900-t2910;
                double t2903 = 1/sqrt(t2898);
                ...
                double t2913 = 1/pow(t2898,3.0/2.0);
                double t2914 = d1*t2901*2.0;
                double t2915 = 1/(t2887*t2887*t2887);
                ...
                v_gamma_bb_gamma_bb_[index] = c*pow(rho_b[index],4.0/3.0)*(t2892*t2888*t2902*t2903*-2.0+gamma_bb[index]* \
                   ...
                   gamma_bb[index]*t2894*t2888*(t2902*t2902)*1.8E1+(gamma_bb[index]*1/(rho_b[index]*rho_b[index]*rho_b[index]* \
                   rho_b[index]*rho_b[index]*rho_b[index]*rho_b[index]*rho_b[index])*t2896*1.8E1)/t2907-1/pow(rho_b[index],3.2E1/ \
                   3.0)*t2896*t2889*t2905*1/pow(t2907,3.0/2.0)*1.8E1-gamma_bb[index]*t2891*t2894*t2888*t2916*1.8E1+gamma_bb[index]* \
                   t2891*t2889*t2899*t2902*t2908*7.2E1)*(1.0/2.0)-gamma_bb[index]*t2891*t2892*t2888*1/pow(t2898,5.0/2.0) \
                   *(t2912*t2912)*(3.0/4.0));
            } else if (rho_a[index] > cutoff_) {
                ...
                double t3066 = 1/pow(rho_b[index],1.6E1/3.0);
                double t3067 = d1*t3057;
                double t3068 = 1/(t3054*t3054);
                double t3077 = d1*gamma_bb[index]*t3068;
                double t3069 = t3067-t3077;
                double t3070 = 1/sqrt(t3065);
                ...
                double t3080 = 1/pow(t3065,3.0/2.0);
                double t3081 = d1*t3068*2.0;
                double t3082 = 1/(t3054*t3054*t3054);
                ...
                v_gamma_bb_gamma_bb_[index] = c*pow(rho_b[index],4.0/3.0)*(t3070*t3055*t3059*t3069*-2.0+gamma_bb[index]* \
                   ...
                   gamma_bb[index]*t3061*t3055*(t3069*t3069)*1.8E1+(gamma_bb[index]*1/(rho_b[index]*rho_b[index]*rho_b[index]* \
                   rho_b[index]*rho_b[index]*rho_b[index]*rho_b[index]*rho_b[index])*t3063*1.8E1)/t3074-1/pow(rho_b[index],3.2E1/ \
                   3.0)*t3063*t3072*t3056*1/pow(t3074,3.0/2.0)*1.8E1-gamma_bb[index]*t3061*t3055*t3083*t3058*1.8E1+gamma_bb[index]* \
                   t3056*t3066*t3075*t3058*t3069*7.2E1)*(1.0/2.0)-gamma_bb[index]*t3055*1/pow(t3065,5.0/2.0)*t3058*t3059* \
                   (t3079*t3079)*(3.0/4.0));
            } else {
                v_gamma_bb_gamma_bb_[index] = 0.0;
            } 

...
void EDF1_X_Functional::computeRKSFunctional(shared_ptr<Properties> prop)
{
    ...
    for (int index = 0; index < ntrue; index++) {
        ...
        if (rho_a[index] > cutoff_) {
            ...
            double t27689 = 1/pow(rho_a[index],4.0/3.0);
            double t27690 = 1/pow(rho_a[index],8.0/3.0);
    ...
    for (int index = 0; index < ntrue && deriv_ >= 1; index++) {
        ...
        if (rho_a[index] > cutoff_) {
            ...
            double t27695 = 1/pow(rho_a[index],4.0/3.0);
            double t27696 = 1/pow(rho_a[index],8.0/3.0);
            ...
            double t27701 = 1/t27700;
            double t27702 = 1/pow(rho_a[index],1.1E1/3.0);
            double t27703 = d2*t27694*t27695*t27698*6.0;
            double t27704 = t27703+1.0;
            double t27705 = 1/t27704;
            double t27706 = gamma_aa[index]*t27696;
            double t27707 = t27706+1.0;
            double t27708 = 1/sqrt(t27707);
            double t27709 = 1/pow(rho_a[index],7.0/3.0);
            v_rho_a_[index] = pow(rho_a[index],4.0/3.0)*(d1*e1*gamma_aa[index]*t27701*t27702*(8.0/3.0)+d2*e2* \
               gamma_aa[index]*t27702*t27705*(8.0/3.0)-d1*e1*gamma_aa[index]*1/(t27700*t27700)*t27696*(d1*gamma_aa[index]* \
               t27702*t27708*8.0+d1*t27709*t27694*t27698*8.0)-d2*e2*gamma_aa[index]*1/(t27704*t27704)*t27696*(d2* \
        ...
        if (is_gga_) {
            ...
            if (rho_a[index] > cutoff_) {
                ...
                double t27712 = 1/pow(rho_a[index],4.0/3.0);
                double t27713 = 1/pow(rho_a[index],8.0/3.0);
                ...
                double t27720 = 1/sqrt(t27719);
                double t27721 = 1/sqrt(gamma_aa[index]);
                ...
                v_gamma_aa_[index] = pow(rho_a[index],4.0/3.0)*((d1*e1*t27713)/t27717+(d2*e2*t27713)/t27723-d1*e1* \
                   gamma_aa[index]*t27713*1/(t27717*t27717)*(d1*t27720*t27713*3.0+d1*t27712*t27721*t27715*3.0)-d2*e2* \
                   gamma_aa[index]*t27713*1/(t27723*t27723)*(d2*t27720*t27713*3.0+d2*t27712*t27721*t27715*3.0))*-2.0;
            } else {
    ...
    for (int index = 0; index < ntrue && deriv_ >= 2; index++) {
        ...
        if (rho_a[index] > cutoff_) {
            ...
            double t27727 = 1/pow(rho_a[index],4.0/3.0);
            double t27728 = 1/pow(rho_a[index],8.0/3.0);
            ...
            double t27733 = 1/t27732;
            double t27734 = 1/pow(rho_a[index],1.1E1/3.0);
            double t27735 = d2*t27730*t27726*t27727*6.0;
            double t27736 = t27735+1.0;
            double t27737 = 1/t27736;
            double t27738 = gamma_aa[index]*t27728;
            double t27739 = t27738+1.0;
            double t27740 = 1/sqrt(t27739);
            double t27741 = 1/pow(rho_a[index],7.0/3.0);
            double t27742 = 1/pow(rho_a[index],1.4E1/3.0);
            double t27743 = 1/(t27732*t27732);
            double t27744 = d1*gamma_aa[index]*t27740*t27734*8.0;
            double t27745 = d1*t27730*t27741*t27726*8.0;
            double t27746 = t27744+t27745;
            double t27747 = 1/(t27736*t27736);
            ...
            double t27752 = 1/pow(rho_a[index],2.2E1/3.0);
            double t27753 = 1/pow(t27739,3.0/2.0);
            double t27754 = 1/pow(rho_a[index],1.0E1/3.0);
            v_rho_a_rho_a_[index] = -pow(rho_a[index],4.0/3.0)*(d1*e1*gamma_aa[index]*t27733*t27742*(8.8E1/9.0) \
               ...
               3.0)-d2*t27751*t27752*t27753*(3.2E1/3.0))+d1*e1*gamma_aa[index]*1/(t27732*t27732*t27732)*t27728*(t27746* \
               t27746)*2.0+d2*e2*gamma_aa[index]*(t27750*t27750)*1/(t27736*t27736*t27736)*t27728*2.0-d1*e1*gamma_aa[index]* \
               t27734*t27743*t27746*(1.6E1/3.0)-d2*e2*gamma_aa[index]*t27750*t27734*t27747*(1.6E1/3.0))+pow(rho_a[index],1.0/ \
               3.0)*(d1*e1*gamma_aa[index]*t27733*t27734*(8.0/3.0)+d2*e2*gamma_aa[index]*t27734*t27737*(8.0/3.0)- \
               d1*e1*gamma_aa[index]*t27743*t27728*t27746-d2*e2*gamma_aa[index]*t27750*t27728*t27747)*(8.0/3.0)-1/ \
               pow(rho_a[index],2.0/3.0)*(-c0*e0+d1*e1*gamma_aa[index]*t27733*t27728+d2*e2*gamma_aa[index]*t27728* \
               t27737)*(4.0/9.0);
        } else {
        ...
        if (is_gga_) {
            ...
            if (rho_a[index] > cutoff_) {
                ...
                double t27757 = 1/pow(rho_a[index],4.0/3.0);
                double t27758 = 1/pow(rho_a[index],8.0/3.0);
                ...
                double t27765 = 1/sqrt(t27764);
                double t27766 = 1/sqrt(gamma_aa[index]);
                double t27767 = d2*t27760*t27756*t27757*6.0;
                double t27768 = t27767+1.0;
                double t27769 = 1/t27762;
                double t27770 = 1/pow(rho_a[index],1.1E1/3.0);
                double t27771 = 1/t27768;
                double t27772 = 1/(t27762*t27762);
                double t27773 = 1/(t27768*t27768);
                double t27774 = 1/pow(rho_a[index],7.0/3.0);
                double t27775 = 1/pow(rho_a[index],1.9E1/3.0);
                double t27776 = 1/pow(t27764,3.0/2.0);
                ...
                v_rho_a_gamma_aa_[index] = -pow(rho_a[index],4.0/3.0)*(d1*e1*t27770*t27769*(-8.0/3.0)-d2*e2*t27770* \
                   ...
                   t27773*t27782*(8.0/3.0)-d1*e1*gamma_aa[index]*1/(t27762*t27762*t27762)*t27758*t27785*t27779*2.0-d2* \
                   e2*gamma_aa[index]*t27782*t27758*1/(t27768*t27768*t27768)*t27788*2.0)-pow(rho_a[index],1.0/3.0)*(d1* \
                   e1*t27758*t27769+d2*e2*t27771*t27758-d1*e1*gamma_aa[index]*t27772*t27758*t27779-d2*e2*gamma_aa[index]* \
            ...
            //V_gamma_aa_gamma_aa
            if (rho_a[index] > cutoff_) {
                double t27790 = 1/pow(rho_a[index],8.0/3.0);
                double t27791 = 1/pow(rho_a[index],4.0/3.0);
                ...
                double t27797 = 1/sqrt(t27796);
                double t27798 = 1/sqrt(gamma_aa[index]);
                ...
                double t27809 = 1/(t27803*t27803);
                double t27810 = 1/(t27808*t27808);
                double t27811 = 1/pow(rho_a[index],1.6E1/3.0);
                double t27812 = 1/pow(t27796,3.0/2.0);
                double t27813 = 1/gamma_aa[index];
                double t27814 = 1/pow(gamma_aa[index],3.0/2.0);
                v_gamma_aa_gamma_aa_[index] = pow(rho_a[index],4.0/3.0)*(d1*e1*t27801*t27790*t27809*-2.0-d2*e2*t27810* \
                   t27806*t27790*2.0+d1*e1*gamma_aa[index]*(t27801*t27801)*1/(t27803*t27803*t27803)*t27790*2.0+d2*e2* \
                   gamma_aa[index]*(t27806*t27806)*t27790*1/(t27808*t27808*t27808)*2.0+d1*e1*gamma_aa[index]*t27790*t27809* \
                   (d1*t27811*t27812*(3.0/2.0)+d1*t27814*t27791*t27794*(3.0/2.0)-d1*t27813*t27790*t27797*(3.0/2.0))+d2* \
                   e2*gamma_aa[index]*t27810*t27790*(d2*t27811*t27812*(3.0/2.0)+d2*t27814*t27791*t27794*(3.0/2.0)-d2* \
                   t27813*t27790*t27797*(3.0/2.0)))*-2.0;
            } else {
...
void EDF1_X_Functional::computeUKSFunctional(shared_ptr<Properties> prop)
{
    ...
    for (int index = 0; index < ntrue; index++) {
        ...
        if (rho_a[index] > cutoff_ && rho_b[index] > cutoff_) {
            ...
            double t27061 = 1/pow(rho_a[index],4.0/3.0);
            double t27062 = 1/pow(rho_a[index],8.0/3.0);
            double t27063 = t27060*t27061;
            double t27064 = log(t27063+sqrt(t27063*t27063+1.0));
            double t27065 = sqrt(gamma_bb[index]);
            double t27066 = 1/pow(rho_b[index],4.0/3.0);
            double t27067 = 1/pow(rho_b[index],8.0/3.0);
            ...
            double t27496 = 1/pow(rho_a[index],4.0/3.0);
            double t27497 = 1/pow(rho_a[index],8.0/3.0);
            ...
            double t27339 = 1/pow(rho_b[index],4.0/3.0);
            double t27340 = 1/pow(rho_b[index],8.0/3.0);
    ...
    for (int index = 0; index < ntrue && deriv_ >= 1; index++) {
        ...
        if (rho_a[index] > cutoff_ && rho_b[index] > cutoff_) {
            ...
            double t27072 = 1/pow(rho_a[index],4.0/3.0);
            double t27073 = 1/pow(rho_a[index],8.0/3.0);
            ...
            double t27078 = 1/t27077;
            double t27079 = 1/pow(rho_a[index],1.1E1/3.0);
            double t27080 = d2*t27071*t27072*t27075*6.0;
            double t27081 = t27080+1.0;
            double t27082 = 1/t27081;
            double t27083 = gamma_aa[index]*t27073;
            double t27084 = t27083+1.0;
            double t27085 = 1/sqrt(t27084);
            double t27086 = 1/pow(rho_a[index],7.0/3.0);
            v_rho_a_[index] = pow(rho_a[index],4.0/3.0)*(d1*e1*gamma_aa[index]*t27078*t27079*(8.0/3.0)+d2*e2* \
               gamma_aa[index]*t27082*t27079*(8.0/3.0)-d1*e1*gamma_aa[index]*t27073*1/(t27077*t27077)*(d1*gamma_aa[index]* \
               t27085*t27079*8.0+d1*t27071*t27075*t27086*8.0)-d2*e2*gamma_aa[index]*1/(t27081*t27081)*t27073*(d2* \
            ...
            double t27502 = 1/pow(rho_a[index],4.0/3.0);
            double t27503 = 1/pow(rho_a[index],8.0/3.0);
            ...
            double t27508 = 1/t27507;
            double t27509 = 1/pow(rho_a[index],1.1E1/3.0);
            ...
            double t27515 = 1/sqrt(t27514);
            double t27516 = 1/pow(rho_a[index],7.0/3.0);
            v_rho_a_[index] = pow(rho_a[index],4.0/3.0)*(d1*e1*gamma_aa[index]*t27508*t27509*(8.0/3.0)+d2*e2* \
               gamma_aa[index]*t27512*t27509*(8.0/3.0)-d1*e1*gamma_aa[index]*t27503*1/(t27507*t27507)*(d1*gamma_aa[index]* \
               t27515*t27509*8.0+d1*t27501*t27505*t27516*8.0)-d2*e2*gamma_aa[index]*1/(t27511*t27511)*t27503*(d2* \
        ...
        if (rho_a[index] > cutoff_ && rho_b[index] > cutoff_) {
            ...
            double t27089 = 1/pow(rho_b[index],4.0/3.0);
            double t27090 = 1/pow(rho_b[index],8.0/3.0);
            ...
            double t27095 = 1/t27094;
            double t27096 = 1/pow(rho_b[index],1.1E1/3.0);
            double t27097 = d2*t27092*t27088*t27089*6.0;
            double t27098 = t27097+1.0;
            double t27099 = 1/t27098;
            double t27100 = gamma_bb[index]*t27090;
            double t27101 = t27100+1.0;
            double t27102 = 1/sqrt(t27101);
            double t27103 = 1/pow(rho_b[index],7.0/3.0);
            v_rho_b_[index] = pow(rho_b[index],4.0/3.0)*(d1*e1*gamma_bb[index]*t27095*t27096*(8.0/3.0)+d2*e2* \
               gamma_bb[index]*t27096*t27099*(8.0/3.0)-d1*e1*gamma_bb[index]*t27090*1/(t27094*t27094)*(d1*gamma_bb[index]* \
               t27102*t27096*8.0+d1*t27103*t27092*t27088*8.0)-d2*e2*gamma_bb[index]*t27090*1/(t27098*t27098)*(d2* \
            ...
            double t27346 = 1/pow(rho_b[index],4.0/3.0);
            double t27347 = 1/pow(rho_b[index],8.0/3.0);
            ...
            double t27352 = 1/t27351;
            double t27353 = 1/pow(rho_b[index],1.1E1/3.0);
            double t27354 = d2*t27345*t27346*t27349*6.0;
            double t27355 = t27354+1.0;
            double t27356 = 1/t27355;
            double t27357 = gamma_bb[index]*t27347;
            double t27358 = t27357+1.0;
            double t27359 = 1/sqrt(t27358);
            double t27360 = 1/pow(rho_b[index],7.0/3.0);
            v_rho_b_[index] = pow(rho_b[index],4.0/3.0)*(d1*e1*gamma_bb[index]*t27352*t27353*(8.0/3.0)+d2*e2* \
               gamma_bb[index]*t27353*t27356*(8.0/3.0)-d1*e1*gamma_bb[index]*1/(t27351*t27351)*t27347*(d1*gamma_bb[index]* \
               t27353*t27359*8.0+d1*t27360*t27345*t27349*8.0)-d2*e2*gamma_bb[index]*1/(t27355*t27355)*t27347*(d2* \
        ...
        if (is_gga_) {
            ...
            if (rho_a[index] > cutoff_ && rho_b[index] > cutoff_) {
                ...
                double t27106 = 1/pow(rho_a[index],4.0/3.0);
                double t27107 = 1/pow(rho_a[index],8.0/3.0);
                ...
                double t27114 = 1/sqrt(t27113);
                double t27115 = 1/sqrt(gamma_aa[index]);
                ...
                v_gamma_aa_[index] = -pow(rho_a[index],4.0/3.0)*((d1*e1*t27107)/t27111+(d2*e2*t27107)/t27117-d1*e1* \
                   gamma_aa[index]*1/(t27111*t27111)*t27107*(d1*t27114*t27107*3.0+d1*t27106*t27115*t27109*3.0)-d2*e2* \
                   gamma_aa[index]*t27107*1/(t27117*t27117)*(d2*t27114*t27107*3.0+d2*t27106*t27115*t27109*3.0));
            } else if (rho_a[index] > cutoff_) {
                double t27519 = sqrt(gamma_aa[index]);
                double t27520 = 1/pow(rho_a[index],4.0/3.0);
                double t27521 = 1/pow(rho_a[index],8.0/3.0);
                ...
                double t27528 = 1/sqrt(t27527);
                double t27529 = 1/sqrt(gamma_aa[index]);
                ...
                v_gamma_aa_[index] = -pow(rho_a[index],4.0/3.0)*((d1*e1*t27521)/t27525+(d2*e2*t27521)/t27531-d1*e1* \
                   gamma_aa[index]*t27521*1/(t27525*t27525)*(d1*t27521*t27528*3.0+d1*t27520*t27523*t27529*3.0)-d2*e2* \
                   gamma_aa[index]*t27521*1/(t27531*t27531)*(d2*t27521*t27528*3.0+d2*t27520*t27523*t27529*3.0));
            } else if (rho_b[index] > cutoff_) {
                v_gamma_aa_[index] = 0.0;
            } else {
                v_gamma_aa_[index] = 0.0;
            ...
            if (rho_a[index] > cutoff_ && rho_b[index] > cutoff_) {
                ...
                double t27121 = 1/pow(rho_b[index],4.0/3.0);
                double t27122 = 1/pow(rho_b[index],8.0/3.0);
                ...
                double t27129 = 1/sqrt(t27128);
                double t27130 = 1/sqrt(gamma_bb[index]);
                ...
                v_gamma_bb_[index] = -pow(rho_b[index],4.0/3.0)*((d1*e1*t27122)/t27126+(d2*e2*t27122)/t27132-d1*e1* \
                   gamma_bb[index]*t27122*1/(t27126*t27126)*(d1*t27122*t27129*3.0+d1*t27121*t27130*t27124*3.0)-d2*e2* \
                   gamma_bb[index]*t27122*1/(t27132*t27132)*(d2*t27122*t27129*3.0+d2*t27121*t27130*t27124*3.0));
            } else if (rho_a[index] > cutoff_) {
                v_gamma_bb_[index] = 0.0;
            } else if (rho_b[index] > cutoff_) {
                double t27364 = sqrt(gamma_bb[index]);
                double t27365 = 1/pow(rho_b[index],4.0/3.0);
                double t27366 = 1/pow(rho_b[index],8.0/3.0);
                ...
                double t27373 = 1/sqrt(t27372);
                double t27374 = 1/sqrt(gamma_bb[index]);
                ...
                v_gamma_bb_[index] = -pow(rho_b[index],4.0/3.0)*((d1*e1*t27366)/t27370+(d2*e2*t27366)/t27376-d1*e1* \
                   gamma_bb[index]*1/(t27370*t27370)*t27366*(d1*t27373*t27366*3.0+d1*t27365*t27374*t27368*3.0)-d2*e2* \
                   gamma_bb[index]*t27366*1/(t27376*t27376)*(d2*t27373*t27366*3.0+d2*t27365*t27374*t27368*3.0));
            } else {
                v_gamma_bb_[index] = 0.0;
            } 
        }
    ...
    for (int index = 0; index < ntrue && deriv_ >= 2; index++) {
        ...
        if (rho_a[index] > cutoff_ && rho_b[index] > cutoff_) {
            ...
            double t27137 = 1/pow(rho_a[index],4.0/3.0);
            double t27138 = 1/pow(rho_a[index],8.0/3.0);
            ...
            double t27143 = 1/t27142;
            double t27144 = 1/pow(rho_a[index],1.1E1/3.0);
            double t27145 = d2*t27140*t27136*t27137*6.0;
            double t27146 = t27145+1.0;
            double t27147 = 1/t27146;
            double t27148 = gamma_aa[index]*t27138;
            double t27149 = t27148+1.0;
            double t27150 = 1/sqrt(t27149);
            double t27151 = 1/pow(rho_a[index],7.0/3.0);
            double t27152 = 1/pow(rho_a[index],1.4E1/3.0);
            double t27153 = 1/(t27142*t27142);
            double t27154 = d1*gamma_aa[index]*t27150*t27144*8.0;
            double t27155 = d1*t27140*t27151*t27136*8.0;
            double t27156 = t27154+t27155;
            double t27157 = 1/(t27146*t27146);
            ...
            double t27162 = 1/pow(rho_a[index],2.2E1/3.0);
            double t27163 = 1/pow(t27149,3.0/2.0);
            double t27164 = 1/pow(rho_a[index],1.0E1/3.0);
            v_rho_a_rho_a_[index] = -pow(rho_a[index],4.0/3.0)*(d1*e1*gamma_aa[index]*t27143*t27152*(8.8E1/9.0) \
               ...
               3.0)-d2*t27161*t27162*t27163*(3.2E1/3.0))+d1*e1*gamma_aa[index]*1/(t27142*t27142*t27142)*t27138*(t27156* \
               t27156)*2.0+d2*e2*gamma_aa[index]*(t27160*t27160)*1/(t27146*t27146*t27146)*t27138*2.0-d1*e1*gamma_aa[index]* \
               t27144*t27153*t27156*(1.6E1/3.0)-d2*e2*gamma_aa[index]*t27160*t27144*t27157*(1.6E1/3.0))+pow(rho_a[index],1.0/ \
               3.0)*(d1*e1*gamma_aa[index]*t27143*t27144*(8.0/3.0)+d2*e2*gamma_aa[index]*t27144*t27147*(8.0/3.0)- \
               d1*e1*gamma_aa[index]*t27153*t27138*t27156-d2*e2*gamma_aa[index]*t27160*t27138*t27157)*(8.0/3.0)-1/ \
               pow(rho_a[index],2.0/3.0)*(-c0*e0+d1*e1*gamma_aa[index]*t27143*t27138+d2*e2*gamma_aa[index]*t27138* \
               t27147)*(4.0/9.0);
        } else if (rho_a[index] > cutoff_) {
            double t27537 = sqrt(gamma_aa[index]);
            double t27538 = 1/pow(rho_a[index],4.0/3.0);
            double t27539 = 1/pow(rho_a[index],8.0/3.0);
            ...
            double t27563 = 1/pow(rho_a[index],2.2E1/3.0);
            double t27564 = 1/pow(t27550,3.0/2.0);
            double t27565 = 1/pow(rho_a[index],1.0E1/3.0);
            v_rho_a_rho_a_[index] = -pow(rho_a[index],4.0/3.0)*(d1*e1*gamma_aa[index]*t27544*t27553*(8.8E1/9.0) \
               ...
               3.0)-d2*t27562*t27563*t27564*(3.2E1/3.0))+d1*e1*gamma_aa[index]*1/(t27543*t27543*t27543)*t27539*(t27557* \
               t27557)*2.0+d2*e2*gamma_aa[index]*(t27561*t27561)*1/(t27547*t27547*t27547)*t27539*2.0-d1*e1*gamma_aa[index]* \
               t27545*t27554*t27557*(1.6E1/3.0)-d2*e2*gamma_aa[index]*t27561*t27545*t27558*(1.6E1/3.0))+pow(rho_a[index],1.0/ \
               3.0)*(d1*e1*gamma_aa[index]*t27544*t27545*(8.0/3.0)+d2*e2*gamma_aa[index]*t27545*t27548*(8.0/3.0)- \
               d1*e1*gamma_aa[index]*t27554*t27539*t27557-d2*e2*gamma_aa[index]*t27561*t27539*t27558)*(8.0/3.0)-1/ \
               pow(rho_a[index],2.0/3.0)*(-c0*e0+d1*e1*gamma_aa[index]*t27544*t27539+d2*e2*gamma_aa[index]*t27539* \
               t27548)*(4.0/9.0);
        } else if (rho_b[index] > cutoff_) {
            v_rho_a_rho_a_[index] = 0.0;
        } else {
        ...
        if (rho_a[index] > cutoff_ && rho_b[index] > cutoff_) {
            ...
            double t27168 = 1/pow(rho_b[index],4.0/3.0);
            double t27169 = 1/pow(rho_b[index],8.0/3.0);
            ...
            double t27174 = 1/t27173;
            double t27175 = 1/pow(rho_b[index],1.1E1/3.0);
            double t27176 = d2*t27171*t27167*t27168*6.0;
            double t27177 = t27176+1.0;
            double t27178 = 1/t27177;
            double t27179 = gamma_bb[index]*t27169;
            double t27180 = t27179+1.0;
            double t27181 = 1/sqrt(t27180);
            double t27182 = 1/pow(rho_b[index],7.0/3.0);
            double t27183 = 1/pow(rho_b[index],1.4E1/3.0);
            double t27184 = 1/(t27173*t27173);
            double t27185 = d1*gamma_bb[index]*t27181*t27175*8.0;
            double t27186 = d1*t27171*t27182*t27167*8.0;
            double t27187 = t27185+t27186;
            double t27188 = 1/(t27177*t27177);
            ...
            double t27193 = 1/pow(rho_b[index],2.2E1/3.0);
            double t27194 = 1/pow(t27180,3.0/2.0);
            double t27195 = 1/pow(rho_b[index],1.0E1/3.0);
            v_rho_b_rho_b_[index] = -pow(rho_b[index],4.0/3.0)*(d1*e1*gamma_bb[index]*t27174*t27183*(8.8E1/9.0) \
               ...
               3.0)-d2*t27192*t27193*t27194*(3.2E1/3.0))+d1*e1*gamma_bb[index]*1/(t27173*t27173*t27173)*t27169*(t27187* \
               t27187)*2.0+d2*e2*gamma_bb[index]*(t27191*t27191)*1/(t27177*t27177*t27177)*t27169*2.0-d1*e1*gamma_bb[index]* \
               t27175*t27184*t27187*(1.6E1/3.0)-d2*e2*gamma_bb[index]*t27191*t27175*t27188*(1.6E1/3.0))+pow(rho_b[index],1.0/ \
               3.0)*(d1*e1*gamma_bb[index]*t27174*t27175*(8.0/3.0)+d2*e2*gamma_bb[index]*t27175*t27178*(8.0/3.0)- \
               d1*e1*gamma_bb[index]*t27184*t27169*t27187-d2*e2*gamma_bb[index]*t27191*t27169*t27188)*(8.0/3.0)-1/ \
               pow(rho_b[index],2.0/3.0)*(-c0*e0+d1*e1*gamma_bb[index]*t27174*t27169+d2*e2*gamma_bb[index]*t27169* \
               t27178)*(4.0/9.0);
        } else if (rho_a[index] > cutoff_) {
            v_rho_b_rho_b_[index] = 0.0;
        } else if (rho_b[index] > cutoff_) {
            double t27382 = sqrt(gamma_bb[index]);
            double t27383 = 1/pow(rho_b[index],4.0/3.0);
            double t27384 = 1/pow(rho_b[index],8.0/3.0);
            ...
            double t27389 = 1/t27388;
            double t27390 = 1/pow(rho_b[index],1.1E1/3.0);
            double t27391 = d2*t27382*t27383*t27386*6.0;
            double t27392 = t27391+1.0;
            double t27393 = 1/t27392;
            double t27394 = gamma_bb[index]*t27384;
            double t27395 = t27394+1.0;
            double t27396 = 1/sqrt(t27395);
            double t27397 = 1/pow(rho_b[index],7.0/3.0);
            double t27398 = 1/pow(rho_b[index],1.4E1/3.0);
            double t27399 = 1/(t27388*t27388);
            double t27400 = d1*gamma_bb[index]*t27390*t27396*8.0;
            double t27401 = d1*t27382*t27386*t27397*8.0;
            double t27402 = t27400+t27401;
            double t27403 = 1/(t27392*t27392);
            ...
            double t27408 = 1/pow(rho_b[index],2.2E1/3.0);
            double t27409 = 1/pow(t27395,3.0/2.0);
            double t27410 = 1/pow(rho_b[index],1.0E1/3.0);
            v_rho_b_rho_b_[index] = -pow(rho_b[index],4.0/3.0)*(d1*e1*gamma_bb[index]*t27389*t27398*(8.8E1/9.0) \
               ...
               3.0)-d2*t27407*t27408*t27409*(3.2E1/3.0))+d1*e1*gamma_bb[index]*(t27402*t27402)*t27384*1/(t27388*t27388* \
               t27388)*2.0+d2*e2*gamma_bb[index]*(t27406*t27406)*1/(t27392*t27392*t27392)*t27384*2.0-d1*e1*gamma_bb[index]* \
               t27402*t27390*t27399*(1.6E1/3.0)-d2*e2*gamma_bb[index]*t27403*t27406*t27390*(1.6E1/3.0))+pow(rho_b[index],1.0/ \
               3.0)*(d1*e1*gamma_bb[index]*t27390*t27389*(8.0/3.0)+d2*e2*gamma_bb[index]*t27390*t27393*(8.0/3.0)- \
               d1*e1*gamma_bb[index]*t27402*t27384*t27399-d2*e2*gamma_bb[index]*t27403*t27406*t27384)*(8.0/3.0)-1/ \
               pow(rho_b[index],2.0/3.0)*(-c0*e0+d1*e1*gamma_bb[index]*t27384*t27389+d2*e2*gamma_bb[index]*t27384* \
               t27393)*(4.0/9.0);
        } else {
            v_rho_b_rho_b_[index] = 0.0;
        } 
        ...
        if (is_gga_) {
            ...
            if (rho_a[index] > cutoff_ && rho_b[index] > cutoff_) {
                ...
                double t27198 = 1/pow(rho_a[index],4.0/3.0);
                double t27199 = 1/pow(rho_a[index],8.0/3.0);
                ...
                double t27206 = 1/sqrt(t27205);
                double t27207 = 1/sqrt(gamma_aa[index]);
                double t27208 = d2*t27201*t27197*t27198*6.0;
                double t27209 = t27208+1.0;
                double t27210 = 1/t27203;
                double t27211 = 1/pow(rho_a[index],1.1E1/3.0);
                double t27212 = 1/t27209;
                double t27213 = 1/(t27203*t27203);
                double t27214 = 1/(t27209*t27209);
                double t27215 = 1/pow(rho_a[index],7.0/3.0);
                double t27216 = 1/pow(rho_a[index],1.9E1/3.0);
                double t27217 = 1/pow(t27205,3.0/2.0);
                ...
                v_rho_a_gamma_aa_[index] = -pow(rho_a[index],4.0/3.0)*(d1*e1*t27210*t27211*(-8.0/3.0)-d2*e2*t27211* \
                   ...
                   t27214*t27223*(8.0/3.0)-d1*e1*gamma_aa[index]*t27220*1/(t27203*t27203*t27203)*t27226*t27199*2.0-d2* \
                   e2*gamma_aa[index]*t27223*1/(t27209*t27209*t27209)*t27229*t27199*2.0)-pow(rho_a[index],1.0/3.0)*(d1* \
                   e1*t27210*t27199+d2*e2*t27212*t27199-d1*e1*gamma_aa[index]*t27220*t27213*t27199-d2*e2*gamma_aa[index]* \
                   t27214*t27223*t27199)*(4.0/3.0);
            } else if (rho_a[index] > cutoff_) {
                double t27569 = sqrt(gamma_aa[index]);
                double t27570 = 1/pow(rho_a[index],4.0/3.0);
                double t27571 = 1/pow(rho_a[index],8.0/3.0);
                ...
                double t27578 = 1/sqrt(t27577);
                double t27579 = 1/sqrt(gamma_aa[index]);
                double t27580 = d2*t27570*t27573*t27569*6.0;
                double t27581 = t27580+1.0;
                double t27582 = 1/t27575;
                double t27583 = 1/pow(rho_a[index],1.1E1/3.0);
                double t27584 = 1/t27581;
                double t27585 = 1/(t27575*t27575);
                double t27586 = 1/(t27581*t27581);
                double t27587 = 1/pow(rho_a[index],7.0/3.0);
                double t27588 = 1/pow(rho_a[index],1.9E1/3.0);
                double t27589 = 1/pow(t27577,3.0/2.0);
                ...
                v_rho_a_gamma_aa_[index] = -pow(rho_a[index],4.0/3.0)*(d1*e1*t27582*t27583*(-8.0/3.0)-d2*e2*t27583* \
                   ...
                   t27586*t27595*(8.0/3.0)-d1*e1*gamma_aa[index]*t27571*t27592*1/(t27575*t27575*t27575)*t27598*2.0-d2* \
                   e2*gamma_aa[index]*t27601*t27571*1/(t27581*t27581*t27581)*t27595*2.0)-pow(rho_a[index],1.0/3.0)*(d1* \
                   e1*t27571*t27582+d2*e2*t27571*t27584-d1*e1*gamma_aa[index]*t27571*t27592*t27585-d2*e2*gamma_aa[index]* \
            ...
            if (rho_a[index] > cutoff_ && rho_b[index] > cutoff_) {
                ...
                double t27236 = 1/pow(rho_b[index],4.0/3.0);
                double t27237 = 1/pow(rho_b[index],8.0/3.0);
                ...
                double t27244 = 1/sqrt(t27243);
                double t27245 = 1/sqrt(gamma_bb[index]);
                double t27246 = d2*t27235*t27236*t27239*6.0;
                double t27247 = t27246+1.0;
                double t27248 = 1/t27241;
                double t27249 = 1/pow(rho_b[index],1.1E1/3.0);
                double t27250 = 1/t27247;
                double t27251 = 1/(t27241*t27241);
                double t27252 = 1/(t27247*t27247);
                double t27253 = 1/pow(rho_b[index],7.0/3.0);
                double t27254 = 1/pow(rho_b[index],1.9E1/3.0);
                double t27255 = 1/pow(t27243,3.0/2.0);
                ...
                v_rho_b_gamma_bb_[index] = -pow(rho_b[index],4.0/3.0)*(d1*e1*t27248*t27249*(-8.0/3.0)-d2*e2*t27250* \
                   ...
                   t27261*t27249*(8.0/3.0)-d1*e1*gamma_bb[index]*1/(t27241*t27241*t27241)*t27237*t27264*t27258*2.0-d2* \
                   e2*gamma_bb[index]*t27261*t27237*1/(t27247*t27247*t27247)*t27267*2.0)-pow(rho_b[index],1.0/3.0)*(d1* \
                   e1*t27237*t27248+d2*e2*t27250*t27237-d1*e1*gamma_bb[index]*t27251*t27237*t27258-d2*e2*gamma_bb[index]* \
                   t27252*t27261*t27237)*(4.0/3.0);
            } else if (rho_a[index] > cutoff_) {
                v_rho_b_gamma_bb_[index] = 0.0;
            } else if (rho_b[index] > cutoff_) {
                double t27417 = sqrt(gamma_bb[index]);
                double t27418 = 1/pow(rho_b[index],4.0/3.0);
                double t27419 = 1/pow(rho_b[index],8.0/3.0);
                ...
                double t27426 = 1/sqrt(t27425);
                double t27427 = 1/sqrt(gamma_bb[index]);
                double t27428 = d2*t27421*t27417*t27418*6.0;
                double t27429 = t27428+1.0;
                double t27430 = 1/t27423;
                double t27431 = 1/pow(rho_b[index],1.1E1/3.0);
                double t27432 = 1/t27429;
                double t27433 = 1/(t27423*t27423);
                double t27434 = 1/(t27429*t27429);
                double t27435 = 1/pow(rho_b[index],7.0/3.0);
                double t27436 = 1/pow(rho_b[index],1.9E1/3.0);
                double t27437 = 1/pow(t27425,3.0/2.0);
                ...
                v_rho_b_gamma_bb_[index] = -pow(rho_b[index],4.0/3.0)*(d1*e1*t27430*t27431*(-8.0/3.0)-d2*e2*t27431* \
                   ...
                   t27434*t27443*(8.0/3.0)-d1*e1*gamma_bb[index]*t27440*1/(t27423*t27423*t27423)*t27419*t27446*2.0-d2* \
                   e2*gamma_bb[index]*t27443*t27419*1/(t27429*t27429*t27429)*t27449*2.0)-pow(rho_b[index],1.0/3.0)*(d1* \
                   e1*t27430*t27419+d2*e2*t27432*t27419-d1*e1*gamma_bb[index]*t27440*t27433*t27419-d2*e2*gamma_bb[index]* \
            ...
            //V_gamma_aa_gamma_aa
            if (rho_a[index] > cutoff_ && rho_b[index] > cutoff_) {
                double t27269 = 1/pow(rho_a[index],8.0/3.0);
                double t27270 = 1/pow(rho_a[index],4.0/3.0);
                ...
                double t27276 = 1/sqrt(t27275);
                double t27277 = 1/sqrt(gamma_aa[index]);
                ...
                double t27288 = 1/(t27282*t27282);
                double t27289 = 1/(t27287*t27287);
                double t27290 = 1/pow(rho_a[index],1.6E1/3.0);
                double t27291 = 1/pow(t27275,3.0/2.0);
                double t27292 = 1/gamma_aa[index];
                double t27293 = 1/pow(gamma_aa[index],3.0/2.0);
                v_gamma_aa_gamma_aa_[index] = -pow(rho_a[index],4.0/3.0)*(d1*e1*t27280*t27269*t27288*-2.0-d2*e2*t27285* \
                   t27269*t27289*2.0+d1*e1*gamma_aa[index]*(t27280*t27280)*1/(t27282*t27282*t27282)*t27269*2.0+d2*e2* \
                   gamma_aa[index]*(t27285*t27285)*t27269*1/(t27287*t27287*t27287)*2.0+d1*e1*gamma_aa[index]*t27269*t27288* \
                   (d1*t27290*t27291*(3.0/2.0)+d1*t27270*t27273*t27293*(3.0/2.0)-d1*t27292*t27276*t27269*(3.0/2.0))+d2* \
                   e2*gamma_aa[index]*t27269*t27289*(d2*t27290*t27291*(3.0/2.0)+d2*t27270*t27273*t27293*(3.0/2.0)-d2* \
                   t27292*t27276*t27269*(3.0/2.0)));
            } else if (rho_a[index] > cutoff_) {
                double t27608 = 1/pow(rho_a[index],8.0/3.0);
                double t27609 = 1/pow(rho_a[index],4.0/3.0);
                ...
                double t27615 = 1/sqrt(t27614);
                double t27616 = 1/sqrt(gamma_aa[index]);
                ...
                double t27627 = 1/(t27621*t27621);
                double t27628 = 1/(t27626*t27626);
                double t27629 = 1/pow(rho_a[index],1.6E1/3.0);
                double t27630 = 1/pow(t27614,3.0/2.0);
                double t27631 = 1/gamma_aa[index];
                double t27632 = 1/pow(gamma_aa[index],3.0/2.0);
                v_gamma_aa_gamma_aa_[index] = -pow(rho_a[index],4.0/3.0)*(d1*e1*t27608*t27627*t27619*-2.0-d2*e2*t27624* \
                   t27608*t27628*2.0+d1*e1*gamma_aa[index]*1/(t27621*t27621*t27621)*t27608*(t27619*t27619)*2.0+d2*e2* \
                   gamma_aa[index]*(t27624*t27624)*t27608*1/(t27626*t27626*t27626)*2.0+d1*e1*gamma_aa[index]*t27608*t27627* \
                   (d1*t27630*t27629*(3.0/2.0)+d1*t27612*t27632*t27609*(3.0/2.0)-d1*t27631*t27615*t27608*(3.0/2.0))+d2* \
                   e2*gamma_aa[index]*t27608*t27628*(d2*t27630*t27629*(3.0/2.0)+d2*t27612*t27632*t27609*(3.0/2.0)-d2* \
                   t27631*t27615*t27608*(3.0/2.0)));
            } else if (rho_b[index] > cutoff_) {
                v_gamma_aa_gamma_aa_[index] = 0.0;
            } else {
                v_gamma_aa_gamma_aa_[index] = 0.0;
            ...
            //V_gamma_bb_gamma_bb
            if (rho_a[index] > cutoff_ && rho_b[index] > cutoff_) {
                double t27299 = 1/pow(rho_b[index],8.0/3.0);
                double t27300 = 1/pow(rho_b[index],4.0/3.0);
                ...
                double t27306 = 1/sqrt(t27305);
                double t27307 = 1/sqrt(gamma_bb[index]);
                ...
                double t27318 = 1/(t27312*t27312);
                double t27319 = 1/(t27317*t27317);
                double t27320 = 1/pow(rho_b[index],1.6E1/3.0);
                double t27321 = 1/pow(t27305,3.0/2.0);
                double t27322 = 1/gamma_bb[index];
                double t27323 = 1/pow(gamma_bb[index],3.0/2.0);
                v_gamma_bb_gamma_bb_[index] = -pow(rho_b[index],4.0/3.0)*(d1*e1*t27310*t27318*t27299*-2.0-d2*e2*t27315* \
                   t27319*t27299*2.0+d1*e1*gamma_bb[index]*(t27310*t27310)*1/(t27312*t27312*t27312)*t27299*2.0+d2*e2* \
                   gamma_bb[index]*(t27315*t27315)*1/(t27317*t27317*t27317)*t27299*2.0+d1*e1*gamma_bb[index]*t27318*t27299* \
                   (d1*t27320*t27321*(3.0/2.0)+d1*t27300*t27303*t27323*(3.0/2.0)-d1*t27322*t27306*t27299*(3.0/2.0))+d2* \
                   e2*gamma_bb[index]*t27319*t27299*(d2*t27320*t27321*(3.0/2.0)+d2*t27300*t27303*t27323*(3.0/2.0)-d2* \
                   t27322*t27306*t27299*(3.0/2.0)));
            } else if (rho_a[index] > cutoff_) {
                v_gamma_bb_gamma_bb_[index] = 0.0;
            } else if (rho_b[index] > cutoff_) {
                double t27456 = 1/pow(rho_b[index],8.0/3.0);
                double t27457 = 1/pow(rho_b[index],4.0/3.0);
                ...
                double t27463 = 1/sqrt(t27462);
                double t27464 = 1/sqrt(gamma_bb[index]);
                ...
                double t27475 = 1/(t27469*t27469);
                double t27476 = 1/(t27474*t27474);
                double t27477 = 1/pow(rho_b[index],1.6E1/3.0);
                double t27478 = 1/pow(t27462,3.0/2.0);
                double t27479 = 1/gamma_bb[index];
                double t27480 = 1/pow(gamma_bb[index],3.0/2.0);
                v_gamma_bb_gamma_bb_[index] = -pow(rho_b[index],4.0/3.0)*(d1*e1*t27456*t27475*t27467*-2.0-d2*e2*t27472* \
                   t27456*t27476*2.0+d1*e1*gamma_bb[index]*t27456*(t27467*t27467)*1/(t27469*t27469*t27469)*2.0+d2*e2* \
                   gamma_bb[index]*(t27472*t27472)*t27456*1/(t27474*t27474*t27474)*2.0+d1*e1*gamma_bb[index]*t27456*t27475* \
                   (d1*t27477*t27478*(3.0/2.0)+d1*t27460*t27480*t27457*(3.0/2.0)-d1*t27463*t27456*t27479*(3.0/2.0))+d2* \
                   e2*gamma_bb[index]*t27456*t27476*(d2*t27477*t27478*(3.0/2.0)+d2*t27460*t27480*t27457*(3.0/2.0)-d2* \
                   t27463*t27456*t27479*(3.0/2.0)));
            } else {
                v_gamma_bb_gamma_bb_[index] = 0.0;
            } 

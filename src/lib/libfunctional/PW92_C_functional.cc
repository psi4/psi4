...
void PW92_C_Functional::computeRKSFunctional(boost::shared_ptr<Properties> prop)
{
...
void PW92_C_Functional::computeUKSFunctional(boost::shared_ptr<Properties> prop)
{
    int ntrue = prop->getTrueSize();

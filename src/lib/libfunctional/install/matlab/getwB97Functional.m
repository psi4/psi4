...
data.param_names = {'omega', 'c0', 'two_13', 'd2fz0', 'c'...
        ...
        'cx0', 'cx1', 'cx2', 'cx3', 'cx4'};
data.param_vals = [0.4, -3.0/8.0*3.0^(1.0/3.0)*4.0^(2.0/3.0)*pi^(-1.0/3.0), 2.0^(1.0/3.0), 1.709921, 1.0/4.0*3.0^(1.0/3.0)*4.0^(2.0/3.0)*pi^(-1.0/3.0),...
    ...
    0.006, 0.2, 0.004,...
    1.0,  3.99051E0, -1.70066E1,  1.07292E0,  8.88211E0,...
    1.0, -2.55352E0,  1.18926E1, -2.69452E1,  1.70927E1,...
    1.0,  1.13116E0, -2.74915E0,  1.20900E1, -5.71642E0,...    
    ]; 
...
data.description = 'wB97 Range-Corrected Power Series GGA';

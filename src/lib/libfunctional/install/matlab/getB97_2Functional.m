function data = getB97_2Functional()
...
data.param_vals = [-3.0/8.0*3.0^(1.0/3.0)*4.0^(2.0/3.0)*pi^(-1.0/3.0), 2.0^(1.0/3.0), 1.709921, 1.0/4.0*3.0^(1.0/3.0)*4.0^(2.0/3.0)*pi^(-1.0/3.0),...
    ...
    0.006, 0.2, 0.004,...
    0.999849, 1.40626, -7.44060,...
    0.585808, -0.691682, 0.394796,...
    0.827642, 0.0478400, 1.76125];
...
data.name = 'B97_2';
data.citation = 'P.J. Wilson et. al., J. Chem. Phys., 115(20), 9233-9242, 2001';
data.description = 'B97-2 Power Series GGA';

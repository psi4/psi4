function data = getBMKFunctional()
...
data.param_vals = [0.42, 3.0/5.0*(6.0*pi*pi)^(2.0/3.0),...
    ...
    0.006, 0.2, 0.004,...
    1.22334, -3.4631, 10.0731, -11.1974,...
    -2.19098, 23.8939, -44.3303, 22.5982,...
    0.474302, 2.77701, -11.4230, 11.7167,...
    -0.192212, 4.73936, -26.6188, 22.4891];
...
data.name = 'BMK';
data.citation = 'A.D. Boese and J.M.L. Martin, J. Chem. Phys., 121(8), 3405, 2004';
data.description = 'BMK Power Series Hybrid Meta-GGA';

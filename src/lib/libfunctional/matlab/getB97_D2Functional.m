function data = getB97_D2Functional()
...
data.param_vals = [-3.0/8.0*3.0^(1.0/3.0)*4.0^(2.0/3.0)*pi^(-1.0/3.0), 2.0^(1.0/3.0), 1.709921, 1.0/4.0*3.0^(1.0/3.0)*4.0^(2.0/3.0)*pi^(-1.0/3.0),...
    ...
    0.006, 0.2, 0.004,...
    0.69041, 6.30270, -14.9712,...
    0.22340, -1.56208, 1.94293,...
    1.08662, -0.52127, 3.25429];    
...
data.name = 'B97_D2';
data.citation = 'S. Grimme, J. Comput. Chem., 27, 1787-1799, 2006.';
data.description = 'B97-D2 Pure -D Functional';

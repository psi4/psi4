function data = getB974_CFunctional()
...
data.param_names = {'two_13', 'd2fz0', 'c'...
...
data.param_vals = [2.0^(1.0/3.0), 1.709921, 1.0/4.0*3.0^(1.0/3.0)*4.0^(2.0/3.0)*pi^(-1.0/3.0),...
...
% Synthesis
K = EcabLSDA*Gcab + EcaaLSDA*Gcaa + EcbbLSDA*Gcbb;
K_a0 = EcbbLSDA*Gcbb;  
K_b0 = EcaaLSDA*Gcaa;  
...
data.name = 'B974_C';
data.citation = 'A.D. Boese, et. al., J. Chem. Phys., 112(4), 1670-1678, 2000';
data.description = '4th-Order B97 Correlation Expansion';

function data = getB97_0Functional()
...
data.param_vals = [-3.0/8.0*3.0^(1.0/3.0)*4.0^(2.0/3.0)*pi^(-1.0/3.0), 2.0^(1.0/3.0), 1.709921, 1.0/4.0*3.0^(1.0/3.0)*4.0^(2.0/3.0)*pi^(-1.0/3.0),...
    ...
    0.006, 0.2, 0.004,...
    0.9454, 0.7471,-4.5961,...
    0.1737, 2.3487, -2.4868,...
    0.8094, 0.5073, 0.7481];
...
data.name = 'B97_0';
data.citation = 'A.D. Becke, J. Chem. Phys., 107(20), 8554-8560, 1997';
data.description = 'B97-0 Power Series GGA';

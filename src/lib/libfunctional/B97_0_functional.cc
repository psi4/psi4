...
void B97_0_Functional::computeRKSFunctional(boost::shared_ptr<Properties> prop)
{
...
void B97_0_Functional::computeUKSFunctional(boost::shared_ptr<Properties> prop)
{
    int ntrue = prop->getTrueSize();

...
void wB97X_Functional::computeRKSFunctional(boost::shared_ptr<Properties> prop)
{
...
void wB97X_Functional::computeUKSFunctional(boost::shared_ptr<Properties> prop)
{
    int ntrue = prop->getTrueSize();

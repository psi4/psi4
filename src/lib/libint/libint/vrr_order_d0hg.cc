...
#include "vrr_header.h"
  ...
  /* Computes quartets necessary to compute (d0|hg) integrals */

void vrr_order_d0hg(Libint_t * Libint, prim_data *Data)
{
 ...
 _BUILD_00h0(Data,vrr_stack+15, vrr_stack+218, vrr_stack+0, vrr_stack+39, vrr_stack+208, NULL);
 _BUILD_00i0(Data,vrr_stack+426, vrr_stack+1085, vrr_stack+15, vrr_stack+49, vrr_stack+218, NULL);
 am[0] = 0;  am[1] = 7;
 vrr_build_xxxx(am,Data,vrr_stack+208, vrr_stack+1106, vrr_stack+426, vrr_stack+694, vrr_stack+1085, NULL);
 am[0] = 0;  am[1] = 8;
 vrr_build_xxxx(am,Data,vrr_stack+0, vrr_stack+1134, vrr_stack+208, vrr_stack+715, vrr_stack+1106, NULL);
 am[0] = 0;  am[1] = 9;
 vrr_build_xxxx(am,Data,vrr_stack+1595, vrr_stack+1170, vrr_stack+0, vrr_stack+743, vrr_stack+1134, NULL);
 am[0] = 1;  am[1] = 9;
 vrr_build_xxxx(am,Data,vrr_stack+1650, vrr_stack+1485, vrr_stack+1595, NULL, NULL, vrr_stack+1170);
 am[0] = 1;  am[1] = 9;
 vrr_build_xxxx(am,Data,vrr_stack+1815, vrr_stack+1540, vrr_stack+1485, NULL, NULL, vrr_stack+995);
 ...
 _BUILD_d0i0(Data,vrr_stack+0, vrr_stack+538, vrr_stack+454, vrr_stack+398, vrr_stack+370, vrr_stack+244);
   ...
   for(i=0;i<168;i++)
     target_ptr[i] += tmp[i];
 am[0] = 2;  am[1] = 7;
 vrr_build_xxxx(am,Data,vrr_stack+168, vrr_stack+887, vrr_stack+779, vrr_stack+658, vrr_stack+622, vrr_stack+454);
   tmp = vrr_stack + 168;
   target_ptr = Libint->vrr_classes[2][7];
   for(i=0;i<216;i++)
     target_ptr[i] += tmp[i];
 am[0] = 2;  am[1] = 8;
 vrr_build_xxxx(am,Data,vrr_stack+384, vrr_stack+1350, vrr_stack+1215, vrr_stack+1040, vrr_stack+995, vrr_stack+779);
   tmp = vrr_stack + 384;
   target_ptr = Libint->vrr_classes[2][8];
   for(i=0;i<270;i++)
     target_ptr[i] += tmp[i];
 am[0] = 2;  am[1] = 9;
 vrr_build_xxxx(am,Data,vrr_stack+654, vrr_stack+1815, vrr_stack+1650, vrr_stack+1540, vrr_stack+1485, vrr_stack+1215);
   tmp = vrr_stack + 654;

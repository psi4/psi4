  /* These machine-generated functions compute a quartet of (is|fs) integrals */

#include "libint.h"

void _build_i0f0(prim_data *Data, REALTYPE *vp, const REALTYPE *I0, const REALTYPE *I1, const REALTYPE *I2, const REALTYPE *I3, const REALTYPE *I4)
{
...
*(vp++) = U01*I0[150] + U41*I1[150]
           + (fiveo2z)*(I2[100] - (lpoz)*I3[100]);
*(vp++) = U01*I0[151] + U41*I1[151]
           + (fiveo2z)*(I2[101] - (lpoz)*I3[101])
           + (oneo2zn)*I4[90];
*(vp++) = U01*I0[152] + U41*I1[152]
           + (fiveo2z)*(I2[102] - (lpoz)*I3[102]);
*(vp++) = U01*I0[153] + U41*I1[153]
           + (fiveo2z)*(I2[103] - (lpoz)*I3[103])
           + (twoo2zn)*I4[91];
*(vp++) = U01*I0[154] + U41*I1[154]
           + (fiveo2z)*(I2[104] - (lpoz)*I3[104])
           + (oneo2zn)*I4[92];
*(vp++) = U01*I0[155] + U41*I1[155]
           + (fiveo2z)*(I2[105] - (lpoz)*I3[105]);
*(vp++) = U01*I0[156] + U41*I1[156]
           + (fiveo2z)*(I2[106] - (lpoz)*I3[106])
           + (threeo2zn)*I4[93];
*(vp++) = U01*I0[157] + U41*I1[157]
           + (fiveo2z)*(I2[107] - (lpoz)*I3[107])
           + (twoo2zn)*I4[94];
*(vp++) = U01*I0[158] + U41*I1[158]
           + (fiveo2z)*(I2[108] - (lpoz)*I3[108])
           + (oneo2zn)*I4[95];
*(vp++) = U01*I0[159] + U41*I1[159]
           + (fiveo2z)*(I2[109] - (lpoz)*I3[109]);
*(vp++) = U01*I0[160] + U41*I1[160]
           + (fouro2z)*(I2[110] - (lpoz)*I3[110]);
*(vp++) = U01*I0[161] + U41*I1[161]
           + (fouro2z)*(I2[111] - (lpoz)*I3[111])
           + (oneo2zn)*I4[96];
*(vp++) = U01*I0[162] + U41*I1[162]
           + (fouro2z)*(I2[112] - (lpoz)*I3[112]);
*(vp++) = U01*I0[163] + U41*I1[163]
           + (fouro2z)*(I2[113] - (lpoz)*I3[113])
           + (twoo2zn)*I4[97];
*(vp++) = U01*I0[164] + U41*I1[164]
           + (fouro2z)*(I2[114] - (lpoz)*I3[114])
           + (oneo2zn)*I4[98];
*(vp++) = U01*I0[165] + U41*I1[165]
           + (fouro2z)*(I2[115] - (lpoz)*I3[115]);
*(vp++) = U01*I0[166] + U41*I1[166]
           + (fouro2z)*(I2[116] - (lpoz)*I3[116])
           + (threeo2zn)*I4[99];
*(vp++) = U01*I0[167] + U41*I1[167]
           + (fouro2z)*(I2[117] - (lpoz)*I3[117])
           + (twoo2zn)*I4[100];
*(vp++) = U01*I0[168] + U41*I1[168]
           + (fouro2z)*(I2[118] - (lpoz)*I3[118])
           + (oneo2zn)*I4[101];
*(vp++) = U01*I0[169] + U41*I1[169]
           + (fouro2z)*(I2[119] - (lpoz)*I3[119]);
...
*(vp++) = U02*I0[200] + U42*I1[200]
           + (fiveo2z)*(I2[140] - (lpoz)*I3[140]);
*(vp++) = U02*I0[201] + U42*I1[201]
           + (fiveo2z)*(I2[141] - (lpoz)*I3[141]);
*(vp++) = U02*I0[202] + U42*I1[202]
           + (fiveo2z)*(I2[142] - (lpoz)*I3[142])
           + (oneo2zn)*I4[120];
*(vp++) = U02*I0[203] + U42*I1[203]
           + (fiveo2z)*(I2[143] - (lpoz)*I3[143]);
*(vp++) = U02*I0[204] + U42*I1[204]
           + (fiveo2z)*(I2[144] - (lpoz)*I3[144])
           + (oneo2zn)*I4[121];
*(vp++) = U02*I0[205] + U42*I1[205]
           + (fiveo2z)*(I2[145] - (lpoz)*I3[145])
           + (twoo2zn)*I4[122];
*(vp++) = U02*I0[206] + U42*I1[206]
           + (fiveo2z)*(I2[146] - (lpoz)*I3[146]);
*(vp++) = U02*I0[207] + U42*I1[207]
           + (fiveo2z)*(I2[147] - (lpoz)*I3[147])
           + (oneo2zn)*I4[123];
*(vp++) = U02*I0[208] + U42*I1[208]
           + (fiveo2z)*(I2[148] - (lpoz)*I3[148])
           + (twoo2zn)*I4[124];
*(vp++) = U02*I0[209] + U42*I1[209]
           + (fiveo2z)*(I2[149] - (lpoz)*I3[149])
           + (threeo2zn)*I4[125];

}
/* Total number of FLOPs = 2016 */

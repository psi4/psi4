...
#include "vrr_header.h"
  ...
  /* Computes quartets necessary to compute (fp|hf) integrals */

void vrr_order_fphf(Libint_t * Libint, prim_data *Data)
{
 ...
 am[0] = 0;  am[1] = 8;
 vrr_build_xxxx(am,Data,vrr_stack+1190, vrr_stack+387, vrr_stack+2003, vrr_stack+21, vrr_stack+1029, NULL);
 am[0] = 1;  am[1] = 8;
 vrr_build_xxxx(am,Data,vrr_stack+4936, vrr_stack+1190, vrr_stack+70, NULL, NULL, vrr_stack+2003);
 am[0] = 2;  am[1] = 8;
 vrr_build_xxxx(am,Data,vrr_stack+5071, vrr_stack+4936, vrr_stack+4531, vrr_stack+1190, vrr_stack+70, vrr_stack+2947);
 ...
 _BUILD_00h0(Data,vrr_stack+986, vrr_stack+436, vrr_stack+2966, vrr_stack+734, vrr_stack+426, NULL);
 _BUILD_00i0(Data,vrr_stack+734, vrr_stack+451, vrr_stack+986, vrr_stack+0, vrr_stack+436, NULL);
 am[0] = 0;  am[1] = 7;
 vrr_build_xxxx(am,Data,vrr_stack+0, vrr_stack+472, vrr_stack+734, vrr_stack+49, vrr_stack+451, NULL);
 am[0] = 0;  am[1] = 8;
 vrr_build_xxxx(am,Data,vrr_stack+734, vrr_stack+289, vrr_stack+0, vrr_stack+261, vrr_stack+472, NULL);
 am[0] = 1;  am[1] = 8;
 vrr_build_xxxx(am,Data,vrr_stack+1190, vrr_stack+115, vrr_stack+734, NULL, NULL, vrr_stack+289);
 am[0] = 2;  am[1] = 8;
 vrr_build_xxxx(am,Data,vrr_stack+160, vrr_stack+2219, vrr_stack+1190, vrr_stack+1334, vrr_stack+115, vrr_stack+3487);
 am[0] = 3;  am[1] = 8;
 vrr_build_xxxx(am,Data,vrr_stack+5341, vrr_stack+4666, vrr_stack+160, vrr_stack+4531, vrr_stack+2219, vrr_stack+3595);
 am[0] = 3;  am[1] = 8;
 vrr_build_xxxx(am,Data,vrr_stack+0, vrr_stack+5071, vrr_stack+4666, vrr_stack+4936, vrr_stack+4531, vrr_stack+3055);
   tmp = vrr_stack + 0;
   target_ptr = Libint->vrr_classes[3][8];
   for(i=0;i<450;i++)
     target_ptr[i] += tmp[i];
 _BUILD_g0h0(Data,vrr_stack+3487, vrr_stack+1589, vrr_stack+1379, vrr_stack+1064, vrr_stack+860, vrr_stack+584);
   tmp = vrr_stack + 3487;
   target_ptr = Libint->vrr_classes[4][5];
   for(i=0;i<315;i++)
     target_ptr[i] += tmp[i];
 _BUILD_g0i0(Data,vrr_stack+450, vrr_stack+2667, vrr_stack+2387, vrr_stack+2051, vrr_stack+1799, vrr_stack+1379);
   tmp = vrr_stack + 450;
   target_ptr = Libint->vrr_classes[4][6];
   for(i=0;i<420;i++)
     target_ptr[i] += tmp[i];
 am[0] = 4;  am[1] = 7;
 vrr_build_xxxx(am,Data,vrr_stack+870, vrr_stack+4171, vrr_stack+3811, vrr_stack+3271, vrr_stack+3055, vrr_stack+2387);
   tmp = vrr_stack + 870;
   target_ptr = Libint->vrr_classes[4][7];
   for(i=0;i<540;i++)
     target_ptr[i] += tmp[i];
 am[0] = 4;  am[1] = 8;
 vrr_build_xxxx(am,Data,vrr_stack+1410, vrr_stack+0, vrr_stack+5341, vrr_stack+5071, vrr_stack+4666, vrr_stack+3811);
   tmp = vrr_stack + 1410;

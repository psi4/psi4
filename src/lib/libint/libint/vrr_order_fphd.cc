...
#include "vrr_header.h"
  ...
  /* Computes quartets necessary to compute (fp|hd) integrals */

void vrr_order_fphd(Libint_t * Libint, prim_data *Data)
{
 ...
 am[0] = 0;  am[1] = 7;
 vrr_build_xxxx(am,Data,vrr_stack+126, vrr_stack+21, vrr_stack+1029, vrr_stack+219, vrr_stack+105, NULL);
 am[0] = 1;  am[1] = 7;
 vrr_build_xxxx(am,Data,vrr_stack+317, vrr_stack+126, vrr_stack+2003, NULL, NULL, vrr_stack+1029);
 am[0] = 2;  am[1] = 7;
 vrr_build_xxxx(am,Data,vrr_stack+3271, vrr_stack+317, vrr_stack+2947, vrr_stack+126, vrr_stack+2003, vrr_stack+471);
 _BUILD_00p0(Data,vrr_stack+2003, Data->F+10, Data->F+11, NULL, NULL, NULL);
 _BUILD_00d0(Data,vrr_stack+2006, vrr_stack+986, vrr_stack+2003, Data->F+9, Data->F+10, NULL);
 _BUILD_00f0(Data,vrr_stack+2012, vrr_stack+989, vrr_stack+2006, vrr_stack+289, vrr_stack+986, NULL);
 _BUILD_00g0(Data,vrr_stack+2022, vrr_stack+734, vrr_stack+2012, vrr_stack+15, vrr_stack+989, NULL);
 _BUILD_00h0(Data,vrr_stack+15, vrr_stack+0, vrr_stack+2022, vrr_stack+292, vrr_stack+734, NULL);
 _BUILD_00i0(Data,vrr_stack+986, vrr_stack+49, vrr_stack+15, vrr_stack+302, vrr_stack+0, NULL);
 am[0] = 0;  am[1] = 7;
 vrr_build_xxxx(am,Data,vrr_stack+0, vrr_stack+261, vrr_stack+986, vrr_stack+240, vrr_stack+49, NULL);
 am[0] = 1;  am[1] = 7;
 vrr_build_xxxx(am,Data,vrr_stack+36, vrr_stack+1190, vrr_stack+0, NULL, NULL, vrr_stack+261);
 am[0] = 2;  am[1] = 7;
 vrr_build_xxxx(am,Data,vrr_stack+3487, vrr_stack+1226, vrr_stack+36, vrr_stack+1967, vrr_stack+1190, vrr_stack+744);
 am[0] = 3;  am[1] = 7;
 vrr_build_xxxx(am,Data,vrr_stack+3703, vrr_stack+3055, vrr_stack+3487, vrr_stack+2947, vrr_stack+1226, vrr_stack+2219);
 am[0] = 3;  am[1] = 7;
 vrr_build_xxxx(am,Data,vrr_stack+4063, vrr_stack+3271, vrr_stack+3055, vrr_stack+317, vrr_stack+2947, vrr_stack+1799);
   tmp = vrr_stack + 4063;
   target_ptr = Libint->vrr_classes[3][7];
   for(i=0;i<360;i++)
     target_ptr[i] += tmp[i];
 _BUILD_g0h0(Data,vrr_stack+0, vrr_stack+1589, vrr_stack+1379, vrr_stack+1064, vrr_stack+860, vrr_stack+584);
   tmp = vrr_stack + 0;
   target_ptr = Libint->vrr_classes[4][5];
   for(i=0;i<315;i++)
     target_ptr[i] += tmp[i];
 _BUILD_g0i0(Data,vrr_stack+315, vrr_stack+2667, vrr_stack+2387, vrr_stack+2051, vrr_stack+1799, vrr_stack+1379);
   tmp = vrr_stack + 315;
   target_ptr = Libint->vrr_classes[4][6];
   for(i=0;i<420;i++)
     target_ptr[i] += tmp[i];
 am[0] = 4;  am[1] = 7;
 vrr_build_xxxx(am,Data,vrr_stack+735, vrr_stack+4063, vrr_stack+3703, vrr_stack+3271, vrr_stack+3055, vrr_stack+2387);
   tmp = vrr_stack + 735;

...
#include "vrr_header.h"
  ...
  /* Computes quartets necessary to compute (f0|hg) integrals */

void vrr_order_f0hg(Libint_t * Libint, prim_data *Data)
{
 ...
 am[0] = 0;  am[1] = 9;
 vrr_build_xxxx(am,Data,vrr_stack+1018, vrr_stack+2502, vrr_stack+2322, vrr_stack+49, vrr_stack+1466, NULL);
 am[0] = 1;  am[1] = 9;
 vrr_build_xxxx(am,Data,vrr_stack+3577, vrr_stack+1018, vrr_stack+3357, NULL, NULL, vrr_stack+2322);
 _BUILD_00p0(Data,vrr_stack+2322, Data->F+11, Data->F+12, NULL, NULL, NULL);
 _BUILD_00d0(Data,vrr_stack+2325, vrr_stack+1091, vrr_stack+2322, Data->F+10, Data->F+11, NULL);
 _BUILD_00f0(Data,vrr_stack+2331, vrr_stack+1094, vrr_stack+2325, vrr_stack+331, vrr_stack+1091, NULL);
 _BUILD_00g0(Data,vrr_stack+15, vrr_stack+1100, vrr_stack+2331, vrr_stack+334, vrr_stack+1094, NULL);
 _BUILD_00h0(Data,vrr_stack+331, vrr_stack+0, vrr_stack+15, vrr_stack+30, vrr_stack+1100, NULL);
 _BUILD_00i0(Data,vrr_stack+15, vrr_stack+514, vrr_stack+331, vrr_stack+571, vrr_stack+0, NULL);
 am[0] = 0;  am[1] = 7;
 vrr_build_xxxx(am,Data,vrr_stack+1466, vrr_stack+415, vrr_stack+15, vrr_stack+126, vrr_stack+514, NULL);
 am[0] = 0;  am[1] = 8;
 vrr_build_xxxx(am,Data,vrr_stack+2322, vrr_stack+147, vrr_stack+1466, vrr_stack+1718, vrr_stack+415, NULL);
 am[0] = 0;  am[1] = 9;
 vrr_build_xxxx(am,Data,vrr_stack+514, vrr_stack+183, vrr_stack+2322, vrr_stack+1746, vrr_stack+147, NULL);
 am[0] = 1;  am[1] = 9;
 vrr_build_xxxx(am,Data,vrr_stack+0, vrr_stack+1782, vrr_stack+514, NULL, NULL, vrr_stack+183);
 am[0] = 2;  am[1] = 9;
 vrr_build_xxxx(am,Data,vrr_stack+3742, vrr_stack+3412, vrr_stack+0, vrr_stack+3357, vrr_stack+1782, vrr_stack+2682);
 am[0] = 2;  am[1] = 9;
 vrr_build_xxxx(am,Data,vrr_stack+4072, vrr_stack+3577, vrr_stack+3412, vrr_stack+1018, vrr_stack+3357, vrr_stack+2367);
 ...
 vrr_build_xxxx(am,Data,vrr_stack+850, vrr_stack+3087, vrr_stack+2817, vrr_stack+2547, vrr_stack+2367, vrr_stack+1890);
   ...
   for(i=0;i<450;i++)
     target_ptr[i] += tmp[i];
 am[0] = 3;  am[1] = 9;
 vrr_build_xxxx(am,Data,vrr_stack+1300, vrr_stack+4072, vrr_stack+3742, vrr_stack+3577, vrr_stack+3412, vrr_stack+2817);
   tmp = vrr_stack + 1300;

  /* These machine-generated functions compute a quartet of |gi) integrals */

#include "libint.h"

REALTYPE *_hrr3_build_gi_0(const REALTYPE *, REALTYPE *, REALTYPE *, REALTYPE *);
REALTYPE *_hrr3_build_gi_1(const REALTYPE *, REALTYPE *, REALTYPE *, REALTYPE *);

void hrr3_build_gi(const REALTYPE *CD, REALTYPE *vp, REALTYPE *I0, REALTYPE *I1, int ab_num)
{
  int ab;

  for(ab=0;ab<ab_num;ab++) {
    vp = _hrr3_build_gi_0(CD, vp, I0, I1);
    vp = _hrr3_build_gi_1(CD, vp, I0, I1);
    I0 += 441;
    I1 += 315;
  }
}

REALTYPE *_hrr3_build_gi_0(const REALTYPE *CD, REALTYPE *vp, REALTYPE *I0, REALTYPE *I1)
{
  ...
  const REALTYPE CD2 = CD[2];
    ...
    *(vp++) = I0[162] + CD1*I1[99];
    *(vp++) = I0[163] + CD1*I1[100];
    *(vp++) = I0[164] + CD1*I1[101];
    *(vp++) = I0[165] + CD1*I1[102];
    *(vp++) = I0[166] + CD1*I1[103];
    *(vp++) = I0[167] + CD1*I1[104];
    *(vp++) = I0[188] + CD2*I1[104];
    ...
    *(vp++) = I0[183] + CD1*I1[120];
    *(vp++) = I0[184] + CD1*I1[121];
    *(vp++) = I0[185] + CD1*I1[122];
    *(vp++) = I0[186] + CD1*I1[123];
    *(vp++) = I0[187] + CD1*I1[124];
    *(vp++) = I0[188] + CD1*I1[125];
    *(vp++) = I0[209] + CD2*I1[125];
    ...
    *(vp++) = I0[225] + CD1*I1[141];
    *(vp++) = I0[226] + CD1*I1[142];
    *(vp++) = I0[227] + CD1*I1[143];
    *(vp++) = I0[228] + CD1*I1[144];
    *(vp++) = I0[229] + CD1*I1[145];
    *(vp++) = I0[230] + CD1*I1[146];
    *(vp++) = I0[251] + CD2*I1[146];
...
REALTYPE *_hrr3_build_gi_1(const REALTYPE *CD, REALTYPE *vp, REALTYPE *I0, REALTYPE *I1)
{
  const REALTYPE CD0 = CD[0];
  const REALTYPE CD1 = CD[1];
  const REALTYPE CD2 = CD[2];
    ...
    *(vp++) = I0[246] + CD1*I1[162];
    *(vp++) = I0[247] + CD1*I1[163];
    *(vp++) = I0[248] + CD1*I1[164];
    *(vp++) = I0[249] + CD1*I1[165];
    *(vp++) = I0[250] + CD1*I1[166];
    *(vp++) = I0[251] + CD1*I1[167];
    *(vp++) = I0[272] + CD2*I1[167];
    ...
    *(vp++) = I0[267] + CD1*I1[183];
    *(vp++) = I0[268] + CD1*I1[184];
    *(vp++) = I0[269] + CD1*I1[185];
    *(vp++) = I0[270] + CD1*I1[186];
    *(vp++) = I0[271] + CD1*I1[187];
    *(vp++) = I0[272] + CD1*I1[188];
    *(vp++) = I0[293] + CD2*I1[188];
    ...
    *(vp++) = I0[288] + CD1*I1[204];
    *(vp++) = I0[289] + CD1*I1[205];
    *(vp++) = I0[290] + CD1*I1[206];
    *(vp++) = I0[291] + CD1*I1[207];
    *(vp++) = I0[292] + CD1*I1[208];
    *(vp++) = I0[293] + CD1*I1[209];
    *(vp++) = I0[314] + CD2*I1[209];
    ...
    *(vp++) = I0[330] + CD1*I1[225];
    *(vp++) = I0[331] + CD1*I1[226];
    *(vp++) = I0[332] + CD1*I1[227];
    *(vp++) = I0[333] + CD1*I1[228];
    *(vp++) = I0[334] + CD1*I1[229];
    *(vp++) = I0[335] + CD1*I1[230];
    *(vp++) = I0[356] + CD2*I1[230];
    ...
    *(vp++) = I0[351] + CD1*I1[246];
    *(vp++) = I0[352] + CD1*I1[247];
    *(vp++) = I0[353] + CD1*I1[248];
    *(vp++) = I0[354] + CD1*I1[249];
    *(vp++) = I0[355] + CD1*I1[250];
    *(vp++) = I0[356] + CD1*I1[251];
    *(vp++) = I0[377] + CD2*I1[251];
    ...
    *(vp++) = I0[372] + CD1*I1[267];
    *(vp++) = I0[373] + CD1*I1[268];
    *(vp++) = I0[374] + CD1*I1[269];
    *(vp++) = I0[375] + CD1*I1[270];
    *(vp++) = I0[376] + CD1*I1[271];
    *(vp++) = I0[377] + CD1*I1[272];
    *(vp++) = I0[398] + CD2*I1[272];
    ...
    *(vp++) = I0[393] + CD1*I1[288];
    *(vp++) = I0[394] + CD1*I1[289];
    *(vp++) = I0[395] + CD1*I1[290];
    *(vp++) = I0[396] + CD1*I1[291];
    *(vp++) = I0[397] + CD1*I1[292];
    *(vp++) = I0[398] + CD1*I1[293];
    *(vp++) = I0[419] + CD2*I1[293];
    ...
    *(vp++) = I0[414] + CD1*I1[309];
    *(vp++) = I0[415] + CD1*I1[310];
    *(vp++) = I0[416] + CD1*I1[311];
    *(vp++) = I0[417] + CD1*I1[312];
    *(vp++) = I0[418] + CD1*I1[313];
    *(vp++) = I0[419] + CD1*I1[314];
    *(vp++) = I0[440] + CD2*I1[314];
  return vp;
}
/* Total number of FLOPs = 840 * ab_num */

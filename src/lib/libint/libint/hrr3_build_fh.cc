  /* These machine-generated functions compute a quartet of |fh) integrals */

#include "libint.h"

void hrr3_build_fh(const REALTYPE *CD, REALTYPE *vp, REALTYPE *I0, REALTYPE *I1, int ab_num)
{

  /* These machine-generated functions compute a quartet of |gg) integrals */

#include "libint.h"

void hrr3_build_gg(const REALTYPE *CD, REALTYPE *vp, REALTYPE *I0, REALTYPE *I1, int ab_num)
{
...
/* Total number of FLOPs = 450 * ab_num */

...
#include "vrr_header.h"
  ...
  /* Computes quartets necessary to compute (fd|gg) integrals */

void vrr_order_fdgg(Libint_t * Libint, prim_data *Data)
{
 ...
 am[0] = 0;  am[1] = 7;
 vrr_build_xxxx(am,Data,vrr_stack+1286, vrr_stack+2546, vrr_stack+2181, vrr_stack+1349, vrr_stack+63, NULL);
 am[0] = 1;  am[1] = 7;
 vrr_build_xxxx(am,Data,vrr_stack+1022, vrr_stack+4338, vrr_stack+1286, NULL, NULL, vrr_stack+2546);
 am[0] = 2;  am[1] = 7;
 ...
 am[0] = 0;  am[1] = 7;
 vrr_build_xxxx(am,Data,vrr_stack+1526, vrr_stack+566, vrr_stack+2518, vrr_stack+141, vrr_stack+1328, NULL);
 am[0] = 1;  am[1] = 7;
 vrr_build_xxxx(am,Data,vrr_stack+1562, vrr_stack+1526, vrr_stack+4410, NULL, NULL, vrr_stack+2518);
 am[0] = 2;  am[1] = 7;
 vrr_build_xxxx(am,Data,vrr_stack+3638, vrr_stack+1562, vrr_stack+914, vrr_stack+1526, vrr_stack+4410, vrr_stack+305);
 am[0] = 3;  am[1] = 7;
 vrr_build_xxxx(am,Data,vrr_stack+6698, vrr_stack+3638, vrr_stack+6122, vrr_stack+1562, vrr_stack+914, vrr_stack+3890);
   tmp = vrr_stack + 6698;
   target_ptr = Libint->vrr_classes[3][7];
   for(i=0;i<360;i++)
     target_ptr[i] += tmp[i];
 _BUILD_00p0(Data,vrr_stack+1562, Data->F+11, Data->F+12, NULL, NULL, NULL);
 _BUILD_00d0(Data,vrr_stack+1130, vrr_stack+2126, vrr_stack+1562, Data->F+10, Data->F+11, NULL);
 _BUILD_00f0(Data,vrr_stack+1565, vrr_stack+2129, vrr_stack+1130, vrr_stack+911, vrr_stack+2126, NULL);
 _BUILD_00g0(Data,vrr_stack+1575, vrr_stack+2135, vrr_stack+1565, vrr_stack+1370, vrr_stack+2129, NULL);
 _BUILD_00h0(Data,vrr_stack+1590, vrr_stack+2145, vrr_stack+1575, vrr_stack+267, vrr_stack+2135, NULL);
 _BUILD_00i0(Data,vrr_stack+1611, vrr_stack+2160, vrr_stack+1590, vrr_stack+0, vrr_stack+2145, NULL);
 am[0] = 0;  am[1] = 7;
 vrr_build_xxxx(am,Data,vrr_stack+0, vrr_stack+2181, vrr_stack+1611, vrr_stack+63, vrr_stack+2160, NULL);
 am[0] = 1;  am[1] = 7;
 vrr_build_xxxx(am,Data,vrr_stack+36, vrr_stack+1286, vrr_stack+0, NULL, NULL, vrr_stack+2181);
 am[0] = 2;  am[1] = 7;
 vrr_build_xxxx(am,Data,vrr_stack+144, vrr_stack+1022, vrr_stack+36, vrr_stack+4338, vrr_stack+1286, vrr_stack+594);
 am[0] = 3;  am[1] = 7;
 vrr_build_xxxx(am,Data,vrr_stack+7058, vrr_stack+5906, vrr_stack+144, vrr_stack+2798, vrr_stack+1022, vrr_stack+389);
 am[0] = 4;  am[1] = 7;
 vrr_build_xxxx(am,Data,vrr_stack+7418, vrr_stack+6338, vrr_stack+7058, vrr_stack+6122, vrr_stack+5906, vrr_stack+4786);
 am[0] = 4;  am[1] = 7;
 vrr_build_xxxx(am,Data,vrr_stack+7958, vrr_stack+6698, vrr_stack+6338, vrr_stack+3638, vrr_stack+6122, vrr_stack+4058);
   tmp = vrr_stack + 7958;
   target_ptr = Libint->vrr_classes[4][7];
   for(i=0;i<540;i++)
     target_ptr[i] += tmp[i];
 am[0] = 0;  am[1] = 8;
 vrr_build_xxxx(am,Data,vrr_stack+3638, vrr_stack+4338, vrr_stack+1286, vrr_stack+2462, vrr_stack+2546, NULL);
 am[0] = 0;  am[1] = 8;
 vrr_build_xxxx(am,Data,vrr_stack+3683, vrr_stack+4374, vrr_stack+4338, vrr_stack+2490, vrr_stack+2462, NULL);
 am[0] = 1;  am[1] = 8;
 vrr_build_xxxx(am,Data,vrr_stack+3728, vrr_stack+3683, vrr_stack+3638, NULL, NULL, vrr_stack+4338);
 am[0] = 0;  am[1] = 8;
 vrr_build_xxxx(am,Data,vrr_stack+3863, vrr_stack+4410, vrr_stack+4374, vrr_stack+2518, vrr_stack+2490, NULL);
 am[0] = 1;  am[1] = 8;
 vrr_build_xxxx(am,Data,vrr_stack+3908, vrr_stack+3863, vrr_stack+3683, NULL, NULL, vrr_stack+4374);
 am[0] = 0;  am[1] = 8;
 vrr_build_xxxx(am,Data,vrr_stack+4338, vrr_stack+1286, vrr_stack+0, vrr_stack+2546, vrr_stack+2181, NULL);
 am[0] = 1;  am[1] = 8;
 vrr_build_xxxx(am,Data,vrr_stack+4786, vrr_stack+3638, vrr_stack+4338, NULL, NULL, vrr_stack+1286);
 am[0] = 2;  am[1] = 8;
 vrr_build_xxxx(am,Data,vrr_stack+8498, vrr_stack+3728, vrr_stack+4786, vrr_stack+3683, vrr_stack+3638, vrr_stack+1022);
 am[0] = 2;  am[1] = 8;
 vrr_build_xxxx(am,Data,vrr_stack+8768, vrr_stack+3908, vrr_stack+3728, vrr_stack+3863, vrr_stack+3683, vrr_stack+2798);
 am[0] = 3;  am[1] = 8;
 vrr_build_xxxx(am,Data,vrr_stack+9038, vrr_stack+8768, vrr_stack+8498, vrr_stack+3908, vrr_stack+3728, vrr_stack+5906);
 am[0] = 0;  am[1] = 8;
 vrr_build_xxxx(am,Data,vrr_stack+3683, vrr_stack+1526, vrr_stack+4410, vrr_stack+566, vrr_stack+2518, NULL);
 am[0] = 1;  am[1] = 8;
 vrr_build_xxxx(am,Data,vrr_stack+5906, vrr_stack+3683, vrr_stack+3863, NULL, NULL, vrr_stack+4410);
 am[0] = 2;  am[1] = 8;
 vrr_build_xxxx(am,Data,vrr_stack+360, vrr_stack+5906, vrr_stack+3908, vrr_stack+3683, vrr_stack+3863, vrr_stack+914);
 am[0] = 3;  am[1] = 8;
 vrr_build_xxxx(am,Data,vrr_stack+9488, vrr_stack+360, vrr_stack+8768, vrr_stack+5906, vrr_stack+3908, vrr_stack+6122);
   tmp = vrr_stack + 9488;
   target_ptr = Libint->vrr_classes[3][8];
   for(i=0;i<450;i++)
     target_ptr[i] += tmp[i];
 _BUILD_00p0(Data,vrr_stack+5906, Data->F+12, Data->F+13, NULL, NULL, NULL);
 _BUILD_00d0(Data,vrr_stack+5909, vrr_stack+1562, vrr_stack+5906, Data->F+11, Data->F+12, NULL);
 _BUILD_00f0(Data,vrr_stack+5915, vrr_stack+1130, vrr_stack+5909, vrr_stack+2126, vrr_stack+1562, NULL);
 _BUILD_00g0(Data,vrr_stack+5925, vrr_stack+1565, vrr_stack+5915, vrr_stack+2129, vrr_stack+1130, NULL);
 _BUILD_00h0(Data,vrr_stack+5940, vrr_stack+1575, vrr_stack+5925, vrr_stack+2135, vrr_stack+1565, NULL);
 _BUILD_00i0(Data,vrr_stack+5906, vrr_stack+1590, vrr_stack+5940, vrr_stack+2145, vrr_stack+1575, NULL);
 am[0] = 0;  am[1] = 7;
 vrr_build_xxxx(am,Data,vrr_stack+5934, vrr_stack+1611, vrr_stack+5906, vrr_stack+2160, vrr_stack+1590, NULL);
 am[0] = 0;  am[1] = 8;
 vrr_build_xxxx(am,Data,vrr_stack+3683, vrr_stack+0, vrr_stack+5934, vrr_stack+2181, vrr_stack+1611, NULL);
 am[0] = 1;  am[1] = 8;
 vrr_build_xxxx(am,Data,vrr_stack+5906, vrr_stack+4338, vrr_stack+3683, NULL, NULL, vrr_stack+0);
 am[0] = 2;  am[1] = 8;
 vrr_build_xxxx(am,Data,vrr_stack+6041, vrr_stack+4786, vrr_stack+5906, vrr_stack+3638, vrr_stack+4338, vrr_stack+36);
 am[0] = 3;  am[1] = 8;
 vrr_build_xxxx(am,Data,vrr_stack+9938, vrr_stack+8498, vrr_stack+6041, vrr_stack+3728, vrr_stack+4786, vrr_stack+144);
 am[0] = 4;  am[1] = 8;
 vrr_build_xxxx(am,Data,vrr_stack+10388, vrr_stack+9038, vrr_stack+9938, vrr_stack+8768, vrr_stack+8498, vrr_stack+7058);
 am[0] = 4;  am[1] = 8;
 vrr_build_xxxx(am,Data,vrr_stack+11063, vrr_stack+9488, vrr_stack+9038, vrr_stack+360, vrr_stack+8768, vrr_stack+6338);
   tmp = vrr_stack + 11063;
   target_ptr = Libint->vrr_classes[4][8];
   for(i=0;i<675;i++)
     target_ptr[i] += tmp[i];
 _BUILD_h0g0(Data,vrr_stack+7058, vrr_stack+1901, vrr_stack+1676, vrr_stack+1376, vrr_stack+1136, vrr_stack+761);
   tmp = vrr_stack + 7058;
   target_ptr = Libint->vrr_classes[5][4];
   for(i=0;i<315;i++)
     target_ptr[i] += tmp[i];
 _BUILD_h0h0(Data,vrr_stack+8498, vrr_stack+3323, vrr_stack+3008, vrr_stack+2588, vrr_stack+2252, vrr_stack+1676);
   tmp = vrr_stack + 8498;
   target_ptr = Libint->vrr_classes[5][5];
   for(i=0;i<441;i++)
     target_ptr[i] += tmp[i];
 _BUILD_h0i0(Data,vrr_stack+3323, vrr_stack+5486, vrr_stack+5066, vrr_stack+4506, vrr_stack+4058, vrr_stack+3008);
   tmp = vrr_stack + 3323;
   target_ptr = Libint->vrr_classes[5][6];
   for(i=0;i<588;i++)
     target_ptr[i] += tmp[i];
 am[0] = 5;  am[1] = 7;
 vrr_build_xxxx(am,Data,vrr_stack+5486, vrr_stack+7958, vrr_stack+7418, vrr_stack+6698, vrr_stack+6338, vrr_stack+5066);
   tmp = vrr_stack + 5486;
   target_ptr = Libint->vrr_classes[5][7];
   for(i=0;i<756;i++)
     target_ptr[i] += tmp[i];
 am[0] = 5;  am[1] = 8;
 vrr_build_xxxx(am,Data,vrr_stack+3911, vrr_stack+11063, vrr_stack+10388, vrr_stack+9488, vrr_stack+9038, vrr_stack+7418);
   tmp = vrr_stack + 3911;

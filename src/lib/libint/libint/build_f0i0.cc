  /* These machine-generated functions compute a quartet of (fs|is) integrals */

#include "libint.h"

void _build_f0i0(prim_data *Data, REALTYPE *vp, const REALTYPE *I0, const REALTYPE *I1, const REALTYPE *I2, const REALTYPE *I3, const REALTYPE *I4)
{
...
*(vp++) = U02*I0[149] + U42*I1[149]
           ...
           + (threeo2zn)*I4[110];
*(vp++) = U02*I0[150] + U42*I1[150]
           + (twoo2z)*(I2[66] - (lpoz)*I3[66]);
*(vp++) = U02*I0[151] + U42*I1[151]
           + (twoo2z)*(I2[67] - (lpoz)*I3[67])
           + (oneo2zn)*I4[111];
*(vp++) = U02*I0[152] + U42*I1[152]
           + (twoo2z)*(I2[68] - (lpoz)*I3[68])
           + (twoo2zn)*I4[112];
*(vp++) = U02*I0[153] + U42*I1[153]
           + (twoo2z)*(I2[69] - (lpoz)*I3[69])
           + (threeo2zn)*I4[113];
*(vp++) = U02*I0[154] + U42*I1[154]
           + (twoo2z)*(I2[70] - (lpoz)*I3[70])
           + (fouro2zn)*I4[114];
*(vp++) = U02*I0[155] + U42*I1[155]
           + (twoo2z)*(I2[71] - (lpoz)*I3[71]);
*(vp++) = U02*I0[156] + U42*I1[156]
           + (twoo2z)*(I2[72] - (lpoz)*I3[72])
           + (oneo2zn)*I4[115];
*(vp++) = U02*I0[157] + U42*I1[157]
           + (twoo2z)*(I2[73] - (lpoz)*I3[73])
           + (twoo2zn)*I4[116];
*(vp++) = U02*I0[158] + U42*I1[158]
           + (twoo2z)*(I2[74] - (lpoz)*I3[74])
           + (threeo2zn)*I4[117];
*(vp++) = U02*I0[159] + U42*I1[159]
           + (twoo2z)*(I2[75] - (lpoz)*I3[75])
           + (fouro2zn)*I4[118];
*(vp++) = U02*I0[160] + U42*I1[160]
           + (twoo2z)*(I2[76] - (lpoz)*I3[76])
           + (fiveo2zn)*I4[119];
*(vp++) = U02*I0[161] + U42*I1[161]
           + (twoo2z)*(I2[77] - (lpoz)*I3[77]);
*(vp++) = U02*I0[162] + U42*I1[162]
           + (twoo2z)*(I2[78] - (lpoz)*I3[78])
           + (oneo2zn)*I4[120];
*(vp++) = U02*I0[163] + U42*I1[163]
           + (twoo2z)*(I2[79] - (lpoz)*I3[79])
           + (twoo2zn)*I4[121];
*(vp++) = U02*I0[164] + U42*I1[164]
           + (twoo2z)*(I2[80] - (lpoz)*I3[80])
           + (threeo2zn)*I4[122];
*(vp++) = U02*I0[165] + U42*I1[165]
           + (twoo2z)*(I2[81] - (lpoz)*I3[81])
           + (fouro2zn)*I4[123];
*(vp++) = U02*I0[166] + U42*I1[166]
           + (twoo2z)*(I2[82] - (lpoz)*I3[82])
           + (fiveo2zn)*I4[124];
*(vp++) = U02*I0[167] + U42*I1[167]
           + (twoo2z)*(I2[83] - (lpoz)*I3[83])
           + (sixo2zn)*I4[125];

}
/* Total number of FLOPs = 1932 */

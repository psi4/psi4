  /* These machine-generated functions compute a quartet of |if) integrals */

#include "libint.h"

void hrr3_build_if(const REALTYPE *CD, REALTYPE *vp, REALTYPE *I0, REALTYPE *I1, int ab_num)
{
  ...
  for(ab=0;ab<ab_num;ab++) {
    ...
    *(vp++) = I0[135] + CD1*I1[99];
    *(vp++) = I0[136] + CD1*I1[100];
    *(vp++) = I0[137] + CD1*I1[101];
    *(vp++) = I0[143] + CD2*I1[101];
    ...
    *(vp++) = I0[141] + CD1*I1[105];
    *(vp++) = I0[142] + CD1*I1[106];
    *(vp++) = I0[143] + CD1*I1[107];
    *(vp++) = I0[149] + CD2*I1[107];
    ...
    *(vp++) = I0[147] + CD1*I1[111];
    *(vp++) = I0[148] + CD1*I1[112];
    *(vp++) = I0[149] + CD1*I1[113];
    *(vp++) = I0[155] + CD2*I1[113];
    ...
    *(vp++) = I0[153] + CD1*I1[117];
    *(vp++) = I0[154] + CD1*I1[118];
    *(vp++) = I0[155] + CD1*I1[119];
    *(vp++) = I0[161] + CD2*I1[119];
    ...
    *(vp++) = I0[159] + CD1*I1[123];
    *(vp++) = I0[160] + CD1*I1[124];
    *(vp++) = I0[161] + CD1*I1[125];
    *(vp++) = I0[167] + CD2*I1[125];
    ...
    *(vp++) = I0[171] + CD1*I1[129];
    *(vp++) = I0[172] + CD1*I1[130];
    *(vp++) = I0[173] + CD1*I1[131];
    *(vp++) = I0[179] + CD2*I1[131];
    ...
    *(vp++) = I0[177] + CD1*I1[135];
    *(vp++) = I0[178] + CD1*I1[136];
    *(vp++) = I0[179] + CD1*I1[137];
    *(vp++) = I0[185] + CD2*I1[137];
    ...
    *(vp++) = I0[183] + CD1*I1[141];
    *(vp++) = I0[184] + CD1*I1[142];
    *(vp++) = I0[185] + CD1*I1[143];
    *(vp++) = I0[191] + CD2*I1[143];
    ...
    *(vp++) = I0[189] + CD1*I1[147];
    *(vp++) = I0[190] + CD1*I1[148];
    *(vp++) = I0[191] + CD1*I1[149];
    *(vp++) = I0[197] + CD2*I1[149];
    ...
    *(vp++) = I0[195] + CD1*I1[153];
    *(vp++) = I0[196] + CD1*I1[154];
    *(vp++) = I0[197] + CD1*I1[155];
    *(vp++) = I0[203] + CD2*I1[155];
    ...
    *(vp++) = I0[201] + CD1*I1[159];
    *(vp++) = I0[202] + CD1*I1[160];
    *(vp++) = I0[203] + CD1*I1[161];
    *(vp++) = I0[209] + CD2*I1[161];
    ...
    *(vp++) = I0[207] + CD1*I1[165];
    *(vp++) = I0[208] + CD1*I1[166];
    *(vp++) = I0[209] + CD1*I1[167];
    *(vp++) = I0[215] + CD2*I1[167];
    I0 += 216;
    I1 += 168;
  }
}
/* Total number of FLOPs = 560 * ab_num */

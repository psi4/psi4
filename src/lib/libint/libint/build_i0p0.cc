  /* These machine-generated functions compute a quartet of (is|ps) integrals */

#include "libint.h"

void _build_i0p0(prim_data *Data, REALTYPE *vp, const REALTYPE *I0, const REALTYPE *I1, const REALTYPE *I2, const REALTYPE *I3, const REALTYPE *I4)
{
...
*(vp++) = U01*I0[45] + U41*I1[45]
           + (fiveo2z)*(I2[30] - (lpoz)*I3[30]);
*(vp++) = U01*I0[46] + U41*I1[46]
           + (fiveo2z)*(I2[31] - (lpoz)*I3[31])
           + (oneo2zn)*I4[15];
*(vp++) = U01*I0[47] + U41*I1[47]
           + (fiveo2z)*(I2[32] - (lpoz)*I3[32]);
...
*(vp++) = U02*I0[60] + U42*I1[60]
           + (fiveo2z)*(I2[42] - (lpoz)*I3[42]);
*(vp++) = U02*I0[61] + U42*I1[61]
           + (fiveo2z)*(I2[43] - (lpoz)*I3[43]);
*(vp++) = U02*I0[62] + U42*I1[62]
           + (fiveo2z)*(I2[44] - (lpoz)*I3[44])
           + (oneo2zn)*I4[20];

}
/* Total number of FLOPs = 560 */

...
#include "vrr_header.h"
  ...
  /* Computes quartets necessary to compute (g0|hh) integrals */

void vrr_order_g0hh(Libint_t * Libint, prim_data *Data)
{
 ...
 am[0] = 1;  am[1] = 9;
 vrr_build_xxxx(am,Data,vrr_stack+6646, vrr_stack+4991, vrr_stack+4936, NULL, NULL, vrr_stack+1334);
 am[0] = 2;  am[1] = 9;
 vrr_build_xxxx(am,Data,vrr_stack+6811, vrr_stack+6646, vrr_stack+3542, vrr_stack+4991, vrr_stack+4936, vrr_stack+2219);
 am[0] = 0;  am[1] = 9;
 vrr_build_xxxx(am,Data,vrr_stack+2219, vrr_stack+1226, vrr_stack+70, vrr_stack+387, vrr_stack+2003, NULL);
 am[0] = 1;  am[1] = 9;
 vrr_build_xxxx(am,Data,vrr_stack+7141, vrr_stack+2219, vrr_stack+4991, NULL, NULL, vrr_stack+70);
 am[0] = 2;  am[1] = 9;
 vrr_build_xxxx(am,Data,vrr_stack+7306, vrr_stack+7141, vrr_stack+6646, vrr_stack+2219, vrr_stack+4991, vrr_stack+4531);
 ...
 _BUILD_00i0(Data,vrr_stack+4586, vrr_stack+2981, vrr_stack+4565, vrr_stack+436, vrr_stack+2966, NULL);
 am[0] = 0;  am[1] = 7;
 vrr_build_xxxx(am,Data,vrr_stack+1190, vrr_stack+734, vrr_stack+4586, vrr_stack+451, vrr_stack+2981, NULL);
 am[0] = 0;  am[1] = 8;
 vrr_build_xxxx(am,Data,vrr_stack+4614, vrr_stack+0, vrr_stack+1190, vrr_stack+472, vrr_stack+734, NULL);
 am[0] = 0;  am[1] = 9;
 vrr_build_xxxx(am,Data,vrr_stack+2274, vrr_stack+762, vrr_stack+4614, vrr_stack+289, vrr_stack+0, NULL);
 am[0] = 1;  am[1] = 9;
 vrr_build_xxxx(am,Data,vrr_stack+160, vrr_stack+3487, vrr_stack+2274, NULL, NULL, vrr_stack+762);
 am[0] = 2;  am[1] = 9;
 vrr_build_xxxx(am,Data,vrr_stack+7636, vrr_stack+3542, vrr_stack+160, vrr_stack+4936, vrr_stack+3487, vrr_stack+5341);
 am[0] = 3;  am[1] = 9;
 vrr_build_xxxx(am,Data,vrr_stack+7966, vrr_stack+6811, vrr_stack+7636, vrr_stack+6646, vrr_stack+3542, vrr_stack+5476);
 am[0] = 3;  am[1] = 9;
 vrr_build_xxxx(am,Data,vrr_stack+8516, vrr_stack+7306, vrr_stack+6811, vrr_stack+7141, vrr_stack+6646, vrr_stack+4666);
 am[0] = 0;  am[1] = 10;
 vrr_build_xxxx(am,Data,vrr_stack+7141, vrr_stack+4936, vrr_stack+3487, vrr_stack+1334, vrr_stack+115, NULL);
 am[0] = 0;  am[1] = 10;
 vrr_build_xxxx(am,Data,vrr_stack+7207, vrr_stack+4991, vrr_stack+4936, vrr_stack+70, vrr_stack+1334, NULL);
 am[0] = 0;  am[1] = 10;
 vrr_build_xxxx(am,Data,vrr_stack+5341, vrr_stack+3487, vrr_stack+2274, vrr_stack+115, vrr_stack+762, NULL);
 am[0] = 1;  am[1] = 10;
 vrr_build_xxxx(am,Data,vrr_stack+5407, vrr_stack+7141, vrr_stack+5341, NULL, NULL, vrr_stack+3487);
 am[0] = 1;  am[1] = 10;
 vrr_build_xxxx(am,Data,vrr_stack+325, vrr_stack+7207, vrr_stack+7141, NULL, NULL, vrr_stack+4936);
 am[0] = 2;  am[1] = 10;
 vrr_build_xxxx(am,Data,vrr_stack+9066, vrr_stack+325, vrr_stack+5407, vrr_stack+7207, vrr_stack+7141, vrr_stack+3542);
 am[0] = 0;  am[1] = 10;
 vrr_build_xxxx(am,Data,vrr_stack+3487, vrr_stack+2219, vrr_stack+4991, vrr_stack+1226, vrr_stack+70, NULL);
 am[0] = 1;  am[1] = 10;
 vrr_build_xxxx(am,Data,vrr_stack+3553, vrr_stack+3487, vrr_stack+7207, NULL, NULL, vrr_stack+4991);
 am[0] = 2;  am[1] = 10;
 vrr_build_xxxx(am,Data,vrr_stack+9462, vrr_stack+3553, vrr_stack+325, vrr_stack+3487, vrr_stack+7207, vrr_stack+6646);
 _BUILD_00p0(Data,vrr_stack+6646, Data->F+13, Data->F+14, NULL, NULL, NULL);
 _BUILD_00d0(Data,vrr_stack+6649, vrr_stack+4531, vrr_stack+6646, Data->F+12, Data->F+13, NULL);
 _BUILD_00f0(Data,vrr_stack+6655, vrr_stack+4534, vrr_stack+6649, vrr_stack+2947, vrr_stack+4531, NULL);
 _BUILD_00g0(Data,vrr_stack+6665, vrr_stack+4540, vrr_stack+6655, vrr_stack+2950, vrr_stack+4534, NULL);
 _BUILD_00h0(Data,vrr_stack+6680, vrr_stack+4550, vrr_stack+6665, vrr_stack+2956, vrr_stack+4540, NULL);
 _BUILD_00i0(Data,vrr_stack+6646, vrr_stack+4565, vrr_stack+6680, vrr_stack+2966, vrr_stack+4550, NULL);
 am[0] = 0;  am[1] = 7;
 vrr_build_xxxx(am,Data,vrr_stack+6674, vrr_stack+4586, vrr_stack+6646, vrr_stack+2981, vrr_stack+4565, NULL);
 am[0] = 0;  am[1] = 8;
 vrr_build_xxxx(am,Data,vrr_stack+4531, vrr_stack+1190, vrr_stack+6674, vrr_stack+734, vrr_stack+4586, NULL);
 am[0] = 0;  am[1] = 9;
 vrr_build_xxxx(am,Data,vrr_stack+2219, vrr_stack+4614, vrr_stack+4531, vrr_stack+0, vrr_stack+1190, NULL);
 am[0] = 0;  am[1] = 10;
 vrr_build_xxxx(am,Data,vrr_stack+3487, vrr_stack+2274, vrr_stack+2219, vrr_stack+762, vrr_stack+4614, NULL);
 am[0] = 1;  am[1] = 10;
 vrr_build_xxxx(am,Data,vrr_stack+9858, vrr_stack+5341, vrr_stack+3487, NULL, NULL, vrr_stack+2274);
 am[0] = 2;  am[1] = 10;
 vrr_build_xxxx(am,Data,vrr_stack+10056, vrr_stack+5407, vrr_stack+9858, vrr_stack+7141, vrr_stack+5341, vrr_stack+160);
 am[0] = 3;  am[1] = 10;
 vrr_build_xxxx(am,Data,vrr_stack+10452, vrr_stack+9066, vrr_stack+10056, vrr_stack+325, vrr_stack+5407, vrr_stack+7636);
 am[0] = 3;  am[1] = 10;
 vrr_build_xxxx(am,Data,vrr_stack+11112, vrr_stack+9462, vrr_stack+9066, vrr_stack+3553, vrr_stack+325, vrr_stack+6811);
 _BUILD_g0h0(Data,vrr_stack+7636, vrr_stack+1589, vrr_stack+1379, vrr_stack+1064, vrr_stack+860, vrr_stack+584);
   tmp = vrr_stack + 7636;
   target_ptr = Libint->vrr_classes[4][5];
   for(i=0;i<315;i++)
     target_ptr[i] += tmp[i];
 _BUILD_g0i0(Data,vrr_stack+9858, vrr_stack+2667, vrr_stack+2387, vrr_stack+2051, vrr_stack+1799, vrr_stack+1379);
   tmp = vrr_stack + 9858;
   target_ptr = Libint->vrr_classes[4][6];
   for(i=0;i<420;i++)
     target_ptr[i] += tmp[i];
 am[0] = 4;  am[1] = 7;
 vrr_build_xxxx(am,Data,vrr_stack+0, vrr_stack+4171, vrr_stack+3811, vrr_stack+3271, vrr_stack+3055, vrr_stack+2387);
   tmp = vrr_stack + 0;
   target_ptr = Libint->vrr_classes[4][7];
   for(i=0;i<540;i++)
     target_ptr[i] += tmp[i];
 am[0] = 4;  am[1] = 8;
 vrr_build_xxxx(am,Data,vrr_stack+540, vrr_stack+6196, vrr_stack+5746, vrr_stack+5071, vrr_stack+4666, vrr_stack+3811);
   tmp = vrr_stack + 540;
   target_ptr = Libint->vrr_classes[4][8];
   for(i=0;i<675;i++)
     target_ptr[i] += tmp[i];
 am[0] = 4;  am[1] = 9;
 vrr_build_xxxx(am,Data,vrr_stack+1215, vrr_stack+8516, vrr_stack+7966, vrr_stack+7306, vrr_stack+6811, vrr_stack+5746);
   tmp = vrr_stack + 1215;
   target_ptr = Libint->vrr_classes[4][9];
   for(i=0;i<825;i++)
     target_ptr[i] += tmp[i];
 am[0] = 4;  am[1] = 10;
 vrr_build_xxxx(am,Data,vrr_stack+2040, vrr_stack+11112, vrr_stack+10452, vrr_stack+9462, vrr_stack+9066, vrr_stack+7966);
   tmp = vrr_stack + 2040;

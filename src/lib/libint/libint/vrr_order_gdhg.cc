...
#include "vrr_header.h"
  ...
  /* Computes quartets necessary to compute (gd|hg) integrals */

void vrr_order_gdhg(Libint_t * Libint, prim_data *Data)
{
 ...
 am[0] = 0;  am[1] = 9;
 vrr_build_xxxx(am,Data,vrr_stack+6869, vrr_stack+6187, vrr_stack+6824, vrr_stack+437, vrr_stack+6115, NULL);
 am[0] = 1;  am[1] = 9;
 vrr_build_xxxx(am,Data,vrr_stack+4967, vrr_stack+6869, vrr_stack+3897, NULL, NULL, vrr_stack+6824);
 am[0] = 2;  am[1] = 9;
 vrr_build_xxxx(am,Data,vrr_stack+5132, vrr_stack+4967, vrr_stack+10391, vrr_stack+6869, vrr_stack+3897, vrr_stack+7049);
 am[0] = 0;  am[1] = 9;
 vrr_build_xxxx(am,Data,vrr_stack+3897, vrr_stack+3797, vrr_stack+8488, vrr_stack+473, vrr_stack+4846, NULL);
 am[0] = 1;  am[1] = 9;
 vrr_build_xxxx(am,Data,vrr_stack+473, vrr_stack+3952, vrr_stack+3897, NULL, NULL, vrr_stack+3797);
 am[0] = 2;  am[1] = 9;
 ...
 am[0] = 1;  am[1] = 9;
 vrr_build_xxxx(am,Data,vrr_stack+10391, vrr_stack+12443, vrr_stack+6869, NULL, NULL, vrr_stack+6187);
 am[0] = 2;  am[1] = 9;
 vrr_build_xxxx(am,Data,vrr_stack+12498, vrr_stack+10391, vrr_stack+4967, vrr_stack+12443, vrr_stack+6869, vrr_stack+2648);
 am[0] = 3;  am[1] = 9;
 vrr_build_xxxx(am,Data,vrr_stack+2306, vrr_stack+12498, vrr_stack+5132, vrr_stack+10391, vrr_stack+4967, vrr_stack+63);
 am[0] = 4;  am[1] = 9;
 vrr_build_xxxx(am,Data,vrr_stack+19083, vrr_stack+2306, vrr_stack+638, vrr_stack+12498, vrr_stack+5132, vrr_stack+12893);
   tmp = vrr_stack + 19083;
   target_ptr = Libint->vrr_classes[4][9];
   for(i=0;i<825;i++)
     target_ptr[i] += tmp[i];
 _BUILD_00p0(Data,vrr_stack+10391, Data->F+14, Data->F+15, NULL, NULL, NULL);
 _BUILD_00d0(Data,vrr_stack+10394, vrr_stack+8420, vrr_stack+10391, Data->F+13, Data->F+14, NULL);
 _BUILD_00f0(Data,vrr_stack+10400, vrr_stack+8423, vrr_stack+10394, vrr_stack+4763, vrr_stack+8420, NULL);
 _BUILD_00g0(Data,vrr_stack+10410, vrr_stack+8429, vrr_stack+10400, vrr_stack+4766, vrr_stack+8423, NULL);
 _BUILD_00h0(Data,vrr_stack+10425, vrr_stack+7184, vrr_stack+10410, vrr_stack+4772, vrr_stack+8429, NULL);
 _BUILD_00i0(Data,vrr_stack+10391, vrr_stack+8439, vrr_stack+10425, vrr_stack+4782, vrr_stack+7184, NULL);
 am[0] = 0;  am[1] = 7;
 vrr_build_xxxx(am,Data,vrr_stack+10419, vrr_stack+8460, vrr_stack+10391, vrr_stack+4797, vrr_stack+8439, NULL);
 am[0] = 0;  am[1] = 8;
 vrr_build_xxxx(am,Data,vrr_stack+10886, vrr_stack+0, vrr_stack+10419, vrr_stack+4818, vrr_stack+8460, NULL);
 am[0] = 0;  am[1] = 9;
 vrr_build_xxxx(am,Data,vrr_stack+10391, vrr_stack+8488, vrr_stack+10886, vrr_stack+4846, vrr_stack+0, NULL);
 am[0] = 1;  am[1] = 9;
 vrr_build_xxxx(am,Data,vrr_stack+0, vrr_stack+3897, vrr_stack+10391, NULL, NULL, vrr_stack+8488);
 am[0] = 2;  am[1] = 9;
 vrr_build_xxxx(am,Data,vrr_stack+4763, vrr_stack+473, vrr_stack+0, vrr_stack+3952, vrr_stack+3897, vrr_stack+8533);
 am[0] = 3;  am[1] = 9;
 vrr_build_xxxx(am,Data,vrr_stack+5093, vrr_stack+8938, vrr_stack+4763, vrr_stack+4007, vrr_stack+473, vrr_stack+8668);
 am[0] = 4;  am[1] = 9;
 vrr_build_xxxx(am,Data,vrr_stack+12443, vrr_stack+17708, vrr_stack+5093, vrr_stack+10556, vrr_stack+8938, vrr_stack+14693);
 am[0] = 5;  am[1] = 9;
 vrr_build_xxxx(am,Data,vrr_stack+19908, vrr_stack+18258, vrr_stack+12443, vrr_stack+638, vrr_stack+17708, vrr_stack+15143);
 am[0] = 5;  am[1] = 9;
 vrr_build_xxxx(am,Data,vrr_stack+21063, vrr_stack+19083, vrr_stack+18258, vrr_stack+2306, vrr_stack+638, vrr_stack+13343);
   tmp = vrr_stack + 21063;
   target_ptr = Libint->vrr_classes[5][9];
   for(i=0;i<1155;i++)
     target_ptr[i] += tmp[i];
 _BUILD_i0h0(Data,vrr_stack+2306, vrr_stack+1400, vrr_stack+4322, vrr_stack+3482, vrr_stack+3167, vrr_stack+1991);
   tmp = vrr_stack + 2306;
   target_ptr = Libint->vrr_classes[6][5];
   for(i=0;i<588;i++)
     target_ptr[i] += tmp[i];
 _BUILD_i0i0(Data,vrr_stack+2894, vrr_stack+7787, vrr_stack+7199, vrr_stack+6359, vrr_stack+5659, vrr_stack+4322);
   tmp = vrr_stack + 2894;
 ...
 vrr_build_xxxx(am,Data,vrr_stack+11687, vrr_stack+16763, vrr_stack+15818, vrr_stack+14018, vrr_stack+13343, vrr_stack+10931);
   ...
   for(i=0;i<1260;i++)
     target_ptr[i] += tmp[i];
 am[0] = 6;  am[1] = 9;
 vrr_build_xxxx(am,Data,vrr_stack+12947, vrr_stack+21063, vrr_stack+19908, vrr_stack+19083, vrr_stack+18258, vrr_stack+15818);
   tmp = vrr_stack + 12947;

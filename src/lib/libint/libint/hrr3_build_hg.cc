  /* These machine-generated functions compute a quartet of |hg) integrals */

#include "libint.h"

REALTYPE *_hrr3_build_hg_0(const REALTYPE *, REALTYPE *, REALTYPE *, REALTYPE *);
REALTYPE *_hrr3_build_hg_1(const REALTYPE *, REALTYPE *, REALTYPE *, REALTYPE *);

void hrr3_build_hg(const REALTYPE *CD, REALTYPE *vp, REALTYPE *I0, REALTYPE *I1, int ab_num)
{
  int ab;

  for(ab=0;ab<ab_num;ab++) {
    vp = _hrr3_build_hg_0(CD, vp, I0, I1);
    vp = _hrr3_build_hg_1(CD, vp, I0, I1);
    I0 += 280;
    I1 += 210;
  }
}

REALTYPE *_hrr3_build_hg_0(const REALTYPE *CD, REALTYPE *vp, REALTYPE *I0, REALTYPE *I1)
{
...
REALTYPE *_hrr3_build_hg_1(const REALTYPE *CD, REALTYPE *vp, REALTYPE *I0, REALTYPE *I1)
{
  const REALTYPE CD0 = CD[0];
  const REALTYPE CD1 = CD[1];
  const REALTYPE CD2 = CD[2];
    ...
    *(vp++) = I0[156] + CD1*I1[106];
    *(vp++) = I0[157] + CD1*I1[107];
    *(vp++) = I0[158] + CD1*I1[108];
    *(vp++) = I0[159] + CD1*I1[109];
    *(vp++) = I0[169] + CD2*I1[109];
    ...
    *(vp++) = I0[166] + CD1*I1[116];
    *(vp++) = I0[167] + CD1*I1[117];
    *(vp++) = I0[168] + CD1*I1[118];
    *(vp++) = I0[169] + CD1*I1[119];
    *(vp++) = I0[179] + CD2*I1[119];
    ...
    *(vp++) = I0[176] + CD1*I1[126];
    *(vp++) = I0[177] + CD1*I1[127];
    *(vp++) = I0[178] + CD1*I1[128];
    *(vp++) = I0[179] + CD1*I1[129];
    *(vp++) = I0[189] + CD2*I1[129];
    ...
    *(vp++) = I0[186] + CD1*I1[136];
    *(vp++) = I0[187] + CD1*I1[137];
    *(vp++) = I0[188] + CD1*I1[138];
    *(vp++) = I0[189] + CD1*I1[139];
    *(vp++) = I0[199] + CD2*I1[139];
    ...
    *(vp++) = I0[196] + CD1*I1[146];
    *(vp++) = I0[197] + CD1*I1[147];
    *(vp++) = I0[198] + CD1*I1[148];
    *(vp++) = I0[199] + CD1*I1[149];
    *(vp++) = I0[209] + CD2*I1[149];
    ...
    *(vp++) = I0[216] + CD1*I1[156];
    *(vp++) = I0[217] + CD1*I1[157];
    *(vp++) = I0[218] + CD1*I1[158];
    *(vp++) = I0[219] + CD1*I1[159];
    *(vp++) = I0[229] + CD2*I1[159];
    ...
    *(vp++) = I0[226] + CD1*I1[166];
    *(vp++) = I0[227] + CD1*I1[167];
    *(vp++) = I0[228] + CD1*I1[168];
    *(vp++) = I0[229] + CD1*I1[169];
    *(vp++) = I0[239] + CD2*I1[169];
    ...
    *(vp++) = I0[236] + CD1*I1[176];
    *(vp++) = I0[237] + CD1*I1[177];
    *(vp++) = I0[238] + CD1*I1[178];
    *(vp++) = I0[239] + CD1*I1[179];
    *(vp++) = I0[249] + CD2*I1[179];
    ...
    *(vp++) = I0[246] + CD1*I1[186];
    *(vp++) = I0[247] + CD1*I1[187];
    *(vp++) = I0[248] + CD1*I1[188];
    *(vp++) = I0[249] + CD1*I1[189];
    *(vp++) = I0[259] + CD2*I1[189];
    ...
    *(vp++) = I0[256] + CD1*I1[196];
    *(vp++) = I0[257] + CD1*I1[197];
    *(vp++) = I0[258] + CD1*I1[198];
    *(vp++) = I0[259] + CD1*I1[199];
    *(vp++) = I0[269] + CD2*I1[199];
    ...
    *(vp++) = I0[266] + CD1*I1[206];
    *(vp++) = I0[267] + CD1*I1[207];
    *(vp++) = I0[268] + CD1*I1[208];
    *(vp++) = I0[269] + CD1*I1[209];
    *(vp++) = I0[279] + CD2*I1[209];
  return vp;
}
/* Total number of FLOPs = 630 * ab_num */

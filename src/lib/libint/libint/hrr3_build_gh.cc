  /* These machine-generated functions compute a quartet of |gh) integrals */

#include "libint.h"

REALTYPE *_hrr3_build_gh_0(const REALTYPE *, REALTYPE *, REALTYPE *, REALTYPE *);
REALTYPE *_hrr3_build_gh_1(const REALTYPE *, REALTYPE *, REALTYPE *, REALTYPE *);

void hrr3_build_gh(const REALTYPE *CD, REALTYPE *vp, REALTYPE *I0, REALTYPE *I1, int ab_num)
{
  int ab;

  for(ab=0;ab<ab_num;ab++) {
    vp = _hrr3_build_gh_0(CD, vp, I0, I1);
    vp = _hrr3_build_gh_1(CD, vp, I0, I1);
    I0 += 315;
    I1 += 225;
  }
}

REALTYPE *_hrr3_build_gh_0(const REALTYPE *CD, REALTYPE *vp, REALTYPE *I0, REALTYPE *I1)
{
...
REALTYPE *_hrr3_build_gh_1(const REALTYPE *CD, REALTYPE *vp, REALTYPE *I0, REALTYPE *I1)
{
  const REALTYPE CD0 = CD[0];
  const REALTYPE CD1 = CD[1];
  const REALTYPE CD2 = CD[2];

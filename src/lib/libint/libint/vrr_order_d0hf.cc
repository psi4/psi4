...
#include "vrr_header.h"
  ...
  /* Computes quartets necessary to compute (d0|hf) integrals */

void vrr_order_d0hf(Libint_t * Libint, prim_data *Data)
{
 ...
 _BUILD_00h0(Data,vrr_stack+15, vrr_stack+49, vrr_stack+218, vrr_stack+165, vrr_stack+39, NULL);
 _BUILD_00i0(Data,vrr_stack+208, vrr_stack+694, vrr_stack+15, vrr_stack+0, vrr_stack+49, NULL);
 am[0] = 0;  am[1] = 7;
 vrr_build_xxxx(am,Data,vrr_stack+0, vrr_stack+715, vrr_stack+208, vrr_stack+75, vrr_stack+694, NULL);
 am[0] = 0;  am[1] = 8;
 vrr_build_xxxx(am,Data,vrr_stack+36, vrr_stack+743, vrr_stack+0, vrr_stack+426, vrr_stack+715, NULL);
 am[0] = 1;  am[1] = 8;
 vrr_build_xxxx(am,Data,vrr_stack+1085, vrr_stack+995, vrr_stack+36, NULL, NULL, vrr_stack+743);
 am[0] = 1;  am[1] = 8;
 vrr_build_xxxx(am,Data,vrr_stack+1220, vrr_stack+1040, vrr_stack+995, NULL, NULL, vrr_stack+622);
 _BUILD_d0h0(Data,vrr_stack+1355, vrr_stack+307, vrr_stack+244, vrr_stack+187, vrr_stack+141, vrr_stack+96);
   tmp = vrr_stack + 1355;
 ...
 vrr_build_xxxx(am,Data,vrr_stack+168, vrr_stack+887, vrr_stack+779, vrr_stack+658, vrr_stack+622, vrr_stack+454);
   ...
   for(i=0;i<216;i++)
     target_ptr[i] += tmp[i];
 am[0] = 2;  am[1] = 8;
 vrr_build_xxxx(am,Data,vrr_stack+384, vrr_stack+1220, vrr_stack+1085, vrr_stack+1040, vrr_stack+995, vrr_stack+779);
   tmp = vrr_stack + 384;

  /* These machine-generated functions compute a quartet of (hs|is) integrals */

#include "libint.h"

REALTYPE *_build_h0i0_0(prim_data *Data, REALTYPE *vp, const REALTYPE *I0, const REALTYPE *I1, const REALTYPE *I2, const REALTYPE *I3, const REALTYPE *I4)
{
...
REALTYPE *_build_h0i0_1(prim_data *Data, REALTYPE *vp, const REALTYPE *I0, const REALTYPE *I1, const REALTYPE *I2, const REALTYPE *I3, const REALTYPE *I4)
{
  REALTYPE U00, U01, U02, U10, U11, U12, U20, U21, U22;
  REALTYPE U30, U31, U32, U40, U41, U42, U50, U51, U52;
  REALTYPE lpoz = Data->poz;
...
*(vp++) = U01*I0[292] + U41*I1[292]
           + (fouro2z)*(I2[180] - (lpoz)*I3[180])
           + (twoo2zn)*I4[218];
*(vp++) = U01*I0[293] + U41*I1[293]
           + (fouro2z)*(I2[181] - (lpoz)*I3[181])
           + (oneo2zn)*I4[219];
*(vp++) = U01*I0[294] + U41*I1[294]
           + (fouro2z)*(I2[182] - (lpoz)*I3[182]);
*(vp++) = U01*I0[295] + U41*I1[295]
           + (fouro2z)*(I2[183] - (lpoz)*I3[183])
           + (fiveo2zn)*I4[220];
*(vp++) = U01*I0[296] + U41*I1[296]
           + (fouro2z)*(I2[184] - (lpoz)*I3[184])
           + (fouro2zn)*I4[221];
*(vp++) = U01*I0[297] + U41*I1[297]
           + (fouro2z)*(I2[185] - (lpoz)*I3[185])
           + (threeo2zn)*I4[222];
*(vp++) = U01*I0[298] + U41*I1[298]
           + (fouro2z)*(I2[186] - (lpoz)*I3[186])
           + (twoo2zn)*I4[223];
*(vp++) = U01*I0[299] + U41*I1[299]
           + (fouro2z)*(I2[187] - (lpoz)*I3[187])
           + (oneo2zn)*I4[224];
*(vp++) = U01*I0[300] + U41*I1[300]
           + (fouro2z)*(I2[188] - (lpoz)*I3[188]);
...
*(vp++) = U01*I0[308] + U41*I1[308]
           + (threeo2z)*(I2[196] - (lpoz)*I3[196]);
*(vp++) = U01*I0[309] + U41*I1[309]
           + (threeo2z)*(I2[197] - (lpoz)*I3[197])
           + (oneo2zn)*I4[231];
*(vp++) = U01*I0[310] + U41*I1[310]
           + (threeo2z)*(I2[198] - (lpoz)*I3[198]);
*(vp++) = U01*I0[311] + U41*I1[311]
           + (threeo2z)*(I2[199] - (lpoz)*I3[199])
           + (twoo2zn)*I4[232];
*(vp++) = U01*I0[312] + U41*I1[312]
           + (threeo2z)*(I2[200] - (lpoz)*I3[200])
           + (oneo2zn)*I4[233];
*(vp++) = U01*I0[313] + U41*I1[313]
           + (threeo2z)*(I2[201] - (lpoz)*I3[201]);
*(vp++) = U01*I0[314] + U41*I1[314]
           + (threeo2z)*(I2[202] - (lpoz)*I3[202])
           + (threeo2zn)*I4[234];
*(vp++) = U01*I0[315] + U41*I1[315]
           + (threeo2z)*(I2[203] - (lpoz)*I3[203])
           + (twoo2zn)*I4[235];
*(vp++) = U01*I0[316] + U41*I1[316]
           + (threeo2z)*(I2[204] - (lpoz)*I3[204])
           + (oneo2zn)*I4[236];
*(vp++) = U01*I0[317] + U41*I1[317]
           + (threeo2z)*(I2[205] - (lpoz)*I3[205]);
*(vp++) = U01*I0[318] + U41*I1[318]
           + (threeo2z)*(I2[206] - (lpoz)*I3[206])
           + (fouro2zn)*I4[237];
*(vp++) = U01*I0[319] + U41*I1[319]
           + (threeo2z)*(I2[207] - (lpoz)*I3[207])
           + (threeo2zn)*I4[238];
*(vp++) = U01*I0[320] + U41*I1[320]
           + (threeo2z)*(I2[208] - (lpoz)*I3[208])
           + (twoo2zn)*I4[239];
*(vp++) = U01*I0[321] + U41*I1[321]
           + (threeo2z)*(I2[209] - (lpoz)*I3[209])
           + (oneo2zn)*I4[240];
*(vp++) = U01*I0[322] + U41*I1[322]
           + (threeo2z)*(I2[210] - (lpoz)*I3[210]);
*(vp++) = U01*I0[323] + U41*I1[323]
           + (threeo2z)*(I2[211] - (lpoz)*I3[211])
           + (fiveo2zn)*I4[241];
*(vp++) = U01*I0[324] + U41*I1[324]
           + (threeo2z)*(I2[212] - (lpoz)*I3[212])
           + (fouro2zn)*I4[242];
*(vp++) = U01*I0[325] + U41*I1[325]
           + (threeo2z)*(I2[213] - (lpoz)*I3[213])
           + (threeo2zn)*I4[243];
*(vp++) = U01*I0[326] + U41*I1[326]
           + (threeo2z)*(I2[214] - (lpoz)*I3[214])
           + (twoo2zn)*I4[244];
*(vp++) = U01*I0[327] + U41*I1[327]
           + (threeo2z)*(I2[215] - (lpoz)*I3[215])
           + (oneo2zn)*I4[245];
*(vp++) = U01*I0[328] + U41*I1[328]
           + (threeo2z)*(I2[216] - (lpoz)*I3[216]);
*(vp++) = U01*I0[329] + U41*I1[329]
           + (threeo2z)*(I2[217] - (lpoz)*I3[217])
           + (sixo2zn)*I4[246];
*(vp++) = U01*I0[330] + U41*I1[330]
           + (threeo2z)*(I2[218] - (lpoz)*I3[218])
           + (fiveo2zn)*I4[247];
*(vp++) = U01*I0[331] + U41*I1[331]
           + (threeo2z)*(I2[219] - (lpoz)*I3[219])
           + (fouro2zn)*I4[248];
*(vp++) = U01*I0[332] + U41*I1[332]
           + (threeo2z)*(I2[220] - (lpoz)*I3[220])
           + (threeo2zn)*I4[249];
*(vp++) = U01*I0[333] + U41*I1[333]
           + (threeo2z)*(I2[221] - (lpoz)*I3[221])
           + (twoo2zn)*I4[250];
*(vp++) = U01*I0[334] + U41*I1[334]
           + (threeo2z)*(I2[222] - (lpoz)*I3[222])
           + (oneo2zn)*I4[251];
*(vp++) = U01*I0[335] + U41*I1[335]
           + (threeo2z)*(I2[223] - (lpoz)*I3[223]);
...
*(vp++) = U02*I0[392] + U42*I1[392]
           + (fouro2z)*(I2[252] - (lpoz)*I3[252]);
*(vp++) = U02*I0[393] + U42*I1[393]
           + (fouro2z)*(I2[253] - (lpoz)*I3[253]);
*(vp++) = U02*I0[394] + U42*I1[394]
           + (fouro2z)*(I2[254] - (lpoz)*I3[254])
           + (oneo2zn)*I4[294];
*(vp++) = U02*I0[395] + U42*I1[395]
           + (fouro2z)*(I2[255] - (lpoz)*I3[255]);
*(vp++) = U02*I0[396] + U42*I1[396]
           + (fouro2z)*(I2[256] - (lpoz)*I3[256])
           + (oneo2zn)*I4[295];
*(vp++) = U02*I0[397] + U42*I1[397]
           + (fouro2z)*(I2[257] - (lpoz)*I3[257])
           + (twoo2zn)*I4[296];
*(vp++) = U02*I0[398] + U42*I1[398]
           + (fouro2z)*(I2[258] - (lpoz)*I3[258]);
*(vp++) = U02*I0[399] + U42*I1[399]
           + (fouro2z)*(I2[259] - (lpoz)*I3[259])
           + (oneo2zn)*I4[297];
*(vp++) = U02*I0[400] + U42*I1[400]
           + (fouro2z)*(I2[260] - (lpoz)*I3[260])
           + (twoo2zn)*I4[298];
*(vp++) = U02*I0[401] + U42*I1[401]
           + (fouro2z)*(I2[261] - (lpoz)*I3[261])
           + (threeo2zn)*I4[299];
*(vp++) = U02*I0[402] + U42*I1[402]
           + (fouro2z)*(I2[262] - (lpoz)*I3[262]);
*(vp++) = U02*I0[403] + U42*I1[403]
           + (fouro2z)*(I2[263] - (lpoz)*I3[263])
           + (oneo2zn)*I4[300];
*(vp++) = U02*I0[404] + U42*I1[404]
           + (fouro2z)*(I2[264] - (lpoz)*I3[264])
           + (twoo2zn)*I4[301];
*(vp++) = U02*I0[405] + U42*I1[405]
           + (fouro2z)*(I2[265] - (lpoz)*I3[265])
           + (threeo2zn)*I4[302];
*(vp++) = U02*I0[406] + U42*I1[406]
           + (fouro2z)*(I2[266] - (lpoz)*I3[266])
           + (fouro2zn)*I4[303];
*(vp++) = U02*I0[407] + U42*I1[407]
           + (fouro2z)*(I2[267] - (lpoz)*I3[267]);
*(vp++) = U02*I0[408] + U42*I1[408]
           + (fouro2z)*(I2[268] - (lpoz)*I3[268])
           + (oneo2zn)*I4[304];
*(vp++) = U02*I0[409] + U42*I1[409]
           + (fouro2z)*(I2[269] - (lpoz)*I3[269])
           + (twoo2zn)*I4[305];
*(vp++) = U02*I0[410] + U42*I1[410]
           + (fouro2z)*(I2[270] - (lpoz)*I3[270])
           + (threeo2zn)*I4[306];
*(vp++) = U02*I0[411] + U42*I1[411]
           + (fouro2z)*(I2[271] - (lpoz)*I3[271])
           + (fouro2zn)*I4[307];
*(vp++) = U02*I0[412] + U42*I1[412]
           + (fouro2z)*(I2[272] - (lpoz)*I3[272])
           + (fiveo2zn)*I4[308];
*(vp++) = U02*I0[413] + U42*I1[413]
           + (fouro2z)*(I2[273] - (lpoz)*I3[273]);
*(vp++) = U02*I0[414] + U42*I1[414]
           + (fouro2z)*(I2[274] - (lpoz)*I3[274])
           + (oneo2zn)*I4[309];
*(vp++) = U02*I0[415] + U42*I1[415]
           + (fouro2z)*(I2[275] - (lpoz)*I3[275])
           + (twoo2zn)*I4[310];
*(vp++) = U02*I0[416] + U42*I1[416]
           + (fouro2z)*(I2[276] - (lpoz)*I3[276])
           + (threeo2zn)*I4[311];
*(vp++) = U02*I0[417] + U42*I1[417]
           + (fouro2z)*(I2[277] - (lpoz)*I3[277])
           + (fouro2zn)*I4[312];
*(vp++) = U02*I0[418] + U42*I1[418]
           + (fouro2z)*(I2[278] - (lpoz)*I3[278])
           + (fiveo2zn)*I4[313];
*(vp++) = U02*I0[419] + U42*I1[419]
           + (fouro2z)*(I2[279] - (lpoz)*I3[279])
           + (sixo2zn)*I4[314];
return vp;
}
/* Total number of FLOPs = 4326 */

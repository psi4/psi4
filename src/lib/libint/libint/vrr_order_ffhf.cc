...
#include "vrr_header.h"
  ...
  /* Computes quartets necessary to compute (ff|hf) integrals */

void vrr_order_ffhf(Libint_t * Libint, prim_data *Data)
{
 ...
 am[0] = 0;  am[1] = 8;
 vrr_build_xxxx(am,Data,vrr_stack+6151, vrr_stack+437, vrr_stack+6115, vrr_stack+686, vrr_stack+381, NULL);
 am[0] = 1;  am[1] = 8;
 vrr_build_xxxx(am,Data,vrr_stack+6196, vrr_stack+6151, vrr_stack+6824, NULL, NULL, vrr_stack+6115);
 am[0] = 2;  am[1] = 8;
 vrr_build_xxxx(am,Data,vrr_stack+63, vrr_stack+6196, vrr_stack+7049, vrr_stack+6151, vrr_stack+6824, vrr_stack+3797);
 am[0] = 0;  am[1] = 8;
 vrr_build_xxxx(am,Data,vrr_stack+6824, vrr_stack+473, vrr_stack+4846, vrr_stack+714, vrr_stack+2350, NULL);
 am[0] = 1;  am[1] = 8;
 vrr_build_xxxx(am,Data,vrr_stack+714, vrr_stack+6869, vrr_stack+6824, NULL, NULL, vrr_stack+473);
 am[0] = 2;  am[1] = 8;
 ...
 am[0] = 3;  am[1] = 8;
 vrr_build_xxxx(am,Data,vrr_stack+12893, vrr_stack+63, vrr_stack+2378, vrr_stack+6196, vrr_stack+7049, vrr_stack+3905);
 am[0] = 4;  am[1] = 8;
 vrr_build_xxxx(am,Data,vrr_stack+13343, vrr_stack+12893, vrr_stack+12443, vrr_stack+63, vrr_stack+2378, vrr_stack+8591);
 am[0] = 0;  am[1] = 8;
 vrr_build_xxxx(am,Data,vrr_stack+6779, vrr_stack+4931, vrr_stack+437, vrr_stack+2306, vrr_stack+686, NULL);
 am[0] = 1;  am[1] = 8;
 vrr_build_xxxx(am,Data,vrr_stack+7049, vrr_stack+6779, vrr_stack+6151, NULL, NULL, vrr_stack+437);
 am[0] = 2;  am[1] = 8;
 vrr_build_xxxx(am,Data,vrr_stack+8375, vrr_stack+7049, vrr_stack+6196, vrr_stack+6779, vrr_stack+6151, vrr_stack+4121);
 am[0] = 3;  am[1] = 8;
 vrr_build_xxxx(am,Data,vrr_stack+3797, vrr_stack+8375, vrr_stack+63, vrr_stack+7049, vrr_stack+6196, vrr_stack+2910);
   tmp = vrr_stack + 3797;
   target_ptr = Libint->vrr_classes[3][8];
   for(i=0;i<450;i++)
     target_ptr[i] += tmp[i];
 am[0] = 4;  am[1] = 8;
 vrr_build_xxxx(am,Data,vrr_stack+14018, vrr_stack+3797, vrr_stack+12893, vrr_stack+8375, vrr_stack+63, vrr_stack+8951);
   tmp = vrr_stack + 14018;
   target_ptr = Libint->vrr_classes[4][8];
   for(i=0;i<675;i++)
     target_ptr[i] += tmp[i];
 _BUILD_00p0(Data,vrr_stack+63, Data->F+13, Data->F+14, NULL, NULL, NULL);
 _BUILD_00d0(Data,vrr_stack+66, vrr_stack+4763, vrr_stack+63, Data->F+12, Data->F+13, NULL);
 _BUILD_00f0(Data,vrr_stack+72, vrr_stack+4766, vrr_stack+66, vrr_stack+0, vrr_stack+4763, NULL);
 _BUILD_00g0(Data,vrr_stack+82, vrr_stack+4772, vrr_stack+72, vrr_stack+2334, vrr_stack+4766, NULL);
 _BUILD_00h0(Data,vrr_stack+97, vrr_stack+4782, vrr_stack+82, vrr_stack+2340, vrr_stack+4772, NULL);
 _BUILD_00i0(Data,vrr_stack+63, vrr_stack+4797, vrr_stack+97, vrr_stack+3, vrr_stack+4782, NULL);
 am[0] = 0;  am[1] = 7;
 vrr_build_xxxx(am,Data,vrr_stack+0, vrr_stack+4818, vrr_stack+63, vrr_stack+42, vrr_stack+4797, NULL);
 am[0] = 0;  am[1] = 8;
 vrr_build_xxxx(am,Data,vrr_stack+6779, vrr_stack+4846, vrr_stack+0, vrr_stack+2350, vrr_stack+4818, NULL);
 am[0] = 1;  am[1] = 8;
 vrr_build_xxxx(am,Data,vrr_stack+0, vrr_stack+6824, vrr_stack+6779, NULL, NULL, vrr_stack+4846);
 am[0] = 2;  am[1] = 8;
 vrr_build_xxxx(am,Data,vrr_stack+135, vrr_stack+714, vrr_stack+0, vrr_stack+6869, vrr_stack+6824, vrr_stack+4967);
 am[0] = 3;  am[1] = 8;
 vrr_build_xxxx(am,Data,vrr_stack+8375, vrr_stack+849, vrr_stack+135, vrr_stack+6914, vrr_stack+714, vrr_stack+5075);
 am[0] = 4;  am[1] = 8;
 vrr_build_xxxx(am,Data,vrr_stack+0, vrr_stack+12443, vrr_stack+8375, vrr_stack+2378, vrr_stack+849, vrr_stack+5291);
 am[0] = 5;  am[1] = 8;
 vrr_build_xxxx(am,Data,vrr_stack+14693, vrr_stack+13343, vrr_stack+0, vrr_stack+12893, vrr_stack+12443, vrr_stack+10391);
 am[0] = 5;  am[1] = 8;
 vrr_build_xxxx(am,Data,vrr_stack+0, vrr_stack+14018, vrr_stack+13343, vrr_stack+3797, vrr_stack+12893, vrr_stack+9311);
   tmp = vrr_stack + 0;
   target_ptr = Libint->vrr_classes[5][8];
   for(i=0;i<945;i++)
     target_ptr[i] += tmp[i];
 _BUILD_i0h0(Data,vrr_stack+12443, vrr_stack+1400, vrr_stack+4322, vrr_stack+3482, vrr_stack+3167, vrr_stack+1991);
   tmp = vrr_stack + 12443;
   target_ptr = Libint->vrr_classes[6][5];
   for(i=0;i<588;i++)
     target_ptr[i] += tmp[i];
 _BUILD_i0i0(Data,vrr_stack+945, vrr_stack+7787, vrr_stack+7199, vrr_stack+6359, vrr_stack+5659, vrr_stack+4322);
   tmp = vrr_stack + 945;
 ...
 vrr_build_xxxx(am,Data,vrr_stack+7787, vrr_stack+11687, vrr_stack+10931, vrr_stack+9851, vrr_stack+9311, vrr_stack+7199);
   ...
   for(i=0;i<1008;i++)
     target_ptr[i] += tmp[i];
 am[0] = 6;  am[1] = 8;
 vrr_build_xxxx(am,Data,vrr_stack+8795, vrr_stack+0, vrr_stack+14693, vrr_stack+14018, vrr_stack+13343, vrr_stack+10931);
   tmp = vrr_stack + 8795;

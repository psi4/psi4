...
#include "vrr_header.h"
  ...
  /* Computes quartets necessary to compute (p0|hf) integrals */

void vrr_order_p0hf(Libint_t * Libint, prim_data *Data)
{
 ...
 _BUILD_00i0(Data,vrr_stack+21, vrr_stack+255, vrr_stack+376, vrr_stack+6, vrr_stack+240, NULL);
 am[0] = 0;  am[1] = 7;
 vrr_build_xxxx(am,Data,vrr_stack+376, vrr_stack+276, vrr_stack+21, vrr_stack+163, vrr_stack+255, NULL);
 am[0] = 0;  am[1] = 8;
 vrr_build_xxxx(am,Data,vrr_stack+412, vrr_stack+304, vrr_stack+376, vrr_stack+184, vrr_stack+276, NULL);
 am[0] = 0;  am[1] = 8;
 vrr_build_xxxx(am,Data,vrr_stack+240, vrr_stack+340, vrr_stack+304, vrr_stack+212, vrr_stack+184, NULL);
 _BUILD_p0h0(Data,vrr_stack+457, vrr_stack+142, vrr_stack+96, NULL, NULL, vrr_stack+50);
   tmp = vrr_stack + 457;
   target_ptr = Libint->vrr_classes[1][5];
   for(i=0;i<63;i++)
     target_ptr[i] += tmp[i];
 _BUILD_p0i0(Data,vrr_stack+520, vrr_stack+212, vrr_stack+184, NULL, NULL, vrr_stack+96);
   tmp = vrr_stack + 520;
   target_ptr = Libint->vrr_classes[1][6];
   for(i=0;i<84;i++)
     target_ptr[i] += tmp[i];
 am[0] = 1;  am[1] = 7;
 vrr_build_xxxx(am,Data,vrr_stack+604, vrr_stack+340, vrr_stack+304, NULL, NULL, vrr_stack+184);
   tmp = vrr_stack + 604;
   target_ptr = Libint->vrr_classes[1][7];
   for(i=0;i<108;i++)
     target_ptr[i] += tmp[i];
 am[0] = 1;  am[1] = 8;
 vrr_build_xxxx(am,Data,vrr_stack+712, vrr_stack+240, vrr_stack+412, NULL, NULL, vrr_stack+304);
   tmp = vrr_stack + 712;

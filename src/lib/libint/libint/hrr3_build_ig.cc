  /* These machine-generated functions compute a quartet of |ig) integrals */

#include "libint.h"

REALTYPE *_hrr3_build_ig_0(const REALTYPE *, REALTYPE *, REALTYPE *, REALTYPE *);
REALTYPE *_hrr3_build_ig_1(const REALTYPE *, REALTYPE *, REALTYPE *, REALTYPE *);

void hrr3_build_ig(const REALTYPE *CD, REALTYPE *vp, REALTYPE *I0, REALTYPE *I1, int ab_num)
{
  int ab;

  for(ab=0;ab<ab_num;ab++) {
    vp = _hrr3_build_ig_0(CD, vp, I0, I1);
    vp = _hrr3_build_ig_1(CD, vp, I0, I1);
    I0 += 360;
    I1 += 280;
  }
}

REALTYPE *_hrr3_build_ig_0(const REALTYPE *CD, REALTYPE *vp, REALTYPE *I0, REALTYPE *I1)
{
...
REALTYPE *_hrr3_build_ig_1(const REALTYPE *CD, REALTYPE *vp, REALTYPE *I0, REALTYPE *I1)
{
  const REALTYPE CD0 = CD[0];
  const REALTYPE CD1 = CD[1];
  const REALTYPE CD2 = CD[2];
    ...
    *(vp++) = I0[286] + CD1*I1[216];
    *(vp++) = I0[287] + CD1*I1[217];
    *(vp++) = I0[288] + CD1*I1[218];
    *(vp++) = I0[289] + CD1*I1[219];
    *(vp++) = I0[299] + CD2*I1[219];
    ...
    *(vp++) = I0[296] + CD1*I1[226];
    *(vp++) = I0[297] + CD1*I1[227];
    *(vp++) = I0[298] + CD1*I1[228];
    *(vp++) = I0[299] + CD1*I1[229];
    *(vp++) = I0[309] + CD2*I1[229];
    ...
    *(vp++) = I0[306] + CD1*I1[236];
    *(vp++) = I0[307] + CD1*I1[237];
    *(vp++) = I0[308] + CD1*I1[238];
    *(vp++) = I0[309] + CD1*I1[239];
    *(vp++) = I0[319] + CD2*I1[239];
    ...
    *(vp++) = I0[316] + CD1*I1[246];
    *(vp++) = I0[317] + CD1*I1[247];
    *(vp++) = I0[318] + CD1*I1[248];
    *(vp++) = I0[319] + CD1*I1[249];
    *(vp++) = I0[329] + CD2*I1[249];
    ...
    *(vp++) = I0[326] + CD1*I1[256];
    *(vp++) = I0[327] + CD1*I1[257];
    *(vp++) = I0[328] + CD1*I1[258];
    *(vp++) = I0[329] + CD1*I1[259];
    *(vp++) = I0[339] + CD2*I1[259];
    ...
    *(vp++) = I0[336] + CD1*I1[266];
    *(vp++) = I0[337] + CD1*I1[267];
    *(vp++) = I0[338] + CD1*I1[268];
    *(vp++) = I0[339] + CD1*I1[269];
    *(vp++) = I0[349] + CD2*I1[269];
    ...
    *(vp++) = I0[346] + CD1*I1[276];
    *(vp++) = I0[347] + CD1*I1[277];
    *(vp++) = I0[348] + CD1*I1[278];
    *(vp++) = I0[349] + CD1*I1[279];
    *(vp++) = I0[359] + CD2*I1[279];
  return vp;
}

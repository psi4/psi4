...
#include "vrr_header.h"
  ...
  /* Computes quartets necessary to compute (p0|hg) integrals */

void vrr_order_p0hg(Libint_t * Libint, prim_data *Data)
{
 ...
 _BUILD_00g0(Data,vrr_stack+0, vrr_stack+65, vrr_stack+117, vrr_stack+130, vrr_stack+136, NULL);
 _BUILD_00h0(Data,vrr_stack+163, vrr_stack+75, vrr_stack+0, vrr_stack+21, vrr_stack+65, NULL);
 _BUILD_00i0(Data,vrr_stack+0, vrr_stack+376, vrr_stack+163, vrr_stack+240, vrr_stack+75, NULL);
 am[0] = 0;  am[1] = 7;
 vrr_build_xxxx(am,Data,vrr_stack+551, vrr_stack+397, vrr_stack+0, vrr_stack+255, vrr_stack+376, NULL);
 am[0] = 0;  am[1] = 8;
 vrr_build_xxxx(am,Data,vrr_stack+0, vrr_stack+425, vrr_stack+551, vrr_stack+276, vrr_stack+397, NULL);
 am[0] = 0;  am[1] = 9;
 vrr_build_xxxx(am,Data,vrr_stack+551, vrr_stack+461, vrr_stack+0, vrr_stack+304, vrr_stack+425, NULL);
 am[0] = 0;  am[1] = 9;
 vrr_build_xxxx(am,Data,vrr_stack+606, vrr_stack+506, vrr_stack+461, vrr_stack+340, vrr_stack+304, NULL);
 _BUILD_p0h0(Data,vrr_stack+661, vrr_stack+142, vrr_stack+96, NULL, NULL, vrr_stack+50);
   tmp = vrr_stack + 661;
   target_ptr = Libint->vrr_classes[1][5];
   for(i=0;i<63;i++)
     target_ptr[i] += tmp[i];
 _BUILD_p0i0(Data,vrr_stack+0, vrr_stack+212, vrr_stack+184, NULL, NULL, vrr_stack+96);
   tmp = vrr_stack + 0;
   target_ptr = Libint->vrr_classes[1][6];
   for(i=0;i<84;i++)
     target_ptr[i] += tmp[i];
 am[0] = 1;  am[1] = 7;
 vrr_build_xxxx(am,Data,vrr_stack+724, vrr_stack+340, vrr_stack+304, NULL, NULL, vrr_stack+184);
   tmp = vrr_stack + 724;
   target_ptr = Libint->vrr_classes[1][7];
   for(i=0;i<108;i++)
     target_ptr[i] += tmp[i];
 am[0] = 1;  am[1] = 8;
 vrr_build_xxxx(am,Data,vrr_stack+84, vrr_stack+506, vrr_stack+461, NULL, NULL, vrr_stack+304);
   tmp = vrr_stack + 84;
   target_ptr = Libint->vrr_classes[1][8];
   for(i=0;i<135;i++)
     target_ptr[i] += tmp[i];
 am[0] = 1;  am[1] = 9;
 vrr_build_xxxx(am,Data,vrr_stack+219, vrr_stack+606, vrr_stack+551, NULL, NULL, vrr_stack+461);
   tmp = vrr_stack + 219;

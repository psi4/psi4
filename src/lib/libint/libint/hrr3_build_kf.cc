  /* These machine-generated functions compute a quartet of |kf) integrals */

#include "libint.h"

REALTYPE *_hrr3_build_kf_0(const REALTYPE *, REALTYPE *, REALTYPE *, REALTYPE *);
REALTYPE *_hrr3_build_kf_1(const REALTYPE *, REALTYPE *, REALTYPE *, REALTYPE *);

void hrr3_build_kf(const REALTYPE *CD, REALTYPE *vp, REALTYPE *I0, REALTYPE *I1, int ab_num)
{
  int ab;

  for(ab=0;ab<ab_num;ab++) {
    vp = _hrr3_build_kf_0(CD, vp, I0, I1);
    vp = _hrr3_build_kf_1(CD, vp, I0, I1);
    I0 += 270;
    I1 += 216;
  }
}

REALTYPE *_hrr3_build_kf_0(const REALTYPE *CD, REALTYPE *vp, REALTYPE *I0, REALTYPE *I1)
{
...
REALTYPE *_hrr3_build_kf_1(const REALTYPE *CD, REALTYPE *vp, REALTYPE *I0, REALTYPE *I1)
{
  const REALTYPE CD0 = CD[0];
  const REALTYPE CD1 = CD[1];
  const REALTYPE CD2 = CD[2];
    ...
    *(vp++) = I0[219] + CD1*I1[171];
    *(vp++) = I0[220] + CD1*I1[172];
    *(vp++) = I0[221] + CD1*I1[173];
    *(vp++) = I0[227] + CD2*I1[173];
    ...
    *(vp++) = I0[225] + CD1*I1[177];
    *(vp++) = I0[226] + CD1*I1[178];
    *(vp++) = I0[227] + CD1*I1[179];
    *(vp++) = I0[233] + CD2*I1[179];
    ...
    *(vp++) = I0[231] + CD1*I1[183];
    *(vp++) = I0[232] + CD1*I1[184];
    *(vp++) = I0[233] + CD1*I1[185];
    *(vp++) = I0[239] + CD2*I1[185];
    ...
    *(vp++) = I0[237] + CD1*I1[189];
    *(vp++) = I0[238] + CD1*I1[190];
    *(vp++) = I0[239] + CD1*I1[191];
    *(vp++) = I0[245] + CD2*I1[191];
    ...
    *(vp++) = I0[243] + CD1*I1[195];
    *(vp++) = I0[244] + CD1*I1[196];
    *(vp++) = I0[245] + CD1*I1[197];
    *(vp++) = I0[251] + CD2*I1[197];
    ...
    *(vp++) = I0[249] + CD1*I1[201];
    *(vp++) = I0[250] + CD1*I1[202];
    *(vp++) = I0[251] + CD1*I1[203];
    *(vp++) = I0[257] + CD2*I1[203];
    ...
    *(vp++) = I0[255] + CD1*I1[207];
    *(vp++) = I0[256] + CD1*I1[208];
    *(vp++) = I0[257] + CD1*I1[209];
    *(vp++) = I0[263] + CD2*I1[209];
    ...
    *(vp++) = I0[261] + CD1*I1[213];
    *(vp++) = I0[262] + CD1*I1[214];
    *(vp++) = I0[263] + CD1*I1[215];
    *(vp++) = I0[269] + CD2*I1[215];
  return vp;
}
/* Total number of FLOPs = 720 * ab_num */

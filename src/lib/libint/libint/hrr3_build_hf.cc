  /* These machine-generated functions compute a quartet of |hf) integrals */

#include "libint.h"

void hrr3_build_hf(const REALTYPE *CD, REALTYPE *vp, REALTYPE *I0, REALTYPE *I1, int ab_num)
{
...
/* Total number of FLOPs = 420 * ab_num */

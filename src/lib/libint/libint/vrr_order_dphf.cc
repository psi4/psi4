...
#include "vrr_header.h"
  ...
  /* Computes quartets necessary to compute (dp|hf) integrals */

void vrr_order_dphf(Libint_t * Libint, prim_data *Data)
{
 ...
 am[0] = 0;  am[1] = 8;
 vrr_build_xxxx(am,Data,vrr_stack+514, vrr_stack+49, vrr_stack+1466, vrr_stack+207, vrr_stack+179, NULL);
 am[0] = 1;  am[1] = 8;
 vrr_build_xxxx(am,Data,vrr_stack+2502, vrr_stack+514, vrr_stack+2322, NULL, NULL, vrr_stack+1466);
 _BUILD_00p0(Data,vrr_stack+1466, Data->F+10, Data->F+11, NULL, NULL, NULL);
 _BUILD_00d0(Data,vrr_stack+1469, vrr_stack+331, vrr_stack+1466, Data->F+9, Data->F+10, NULL);
 _BUILD_00f0(Data,vrr_stack+1475, vrr_stack+334, vrr_stack+1469, vrr_stack+415, vrr_stack+331, NULL);
 _BUILD_00g0(Data,vrr_stack+0, vrr_stack+30, vrr_stack+1475, vrr_stack+235, vrr_stack+334, NULL);
 _BUILD_00h0(Data,vrr_stack+331, vrr_stack+571, vrr_stack+0, vrr_stack+418, vrr_stack+30, NULL);
 _BUILD_00i0(Data,vrr_stack+30, vrr_stack+126, vrr_stack+331, vrr_stack+15, vrr_stack+571, NULL);
 am[0] = 0;  am[1] = 7;
 vrr_build_xxxx(am,Data,vrr_stack+415, vrr_stack+1718, vrr_stack+30, vrr_stack+105, vrr_stack+126, NULL);
 am[0] = 0;  am[1] = 8;
 vrr_build_xxxx(am,Data,vrr_stack+0, vrr_stack+1746, vrr_stack+415, vrr_stack+1018, vrr_stack+1718, NULL);
 am[0] = 1;  am[1] = 8;
 vrr_build_xxxx(am,Data,vrr_stack+45, vrr_stack+1046, vrr_stack+0, NULL, NULL, vrr_stack+1746);
 am[0] = 2;  am[1] = 8;
 vrr_build_xxxx(am,Data,vrr_stack+2637, vrr_stack+2367, vrr_stack+45, vrr_stack+2322, vrr_stack+1046, vrr_stack+1782);
 am[0] = 2;  am[1] = 8;
 vrr_build_xxxx(am,Data,vrr_stack+2907, vrr_stack+2502, vrr_stack+2367, vrr_stack+514, vrr_stack+2322, vrr_stack+1502);
   tmp = vrr_stack + 2907;
 ...
 vrr_build_xxxx(am,Data,vrr_stack+490, vrr_stack+2106, vrr_stack+1890, vrr_stack+1610, vrr_stack+1502, vrr_stack+1130);
   ...
   for(i=0;i<360;i++)
     target_ptr[i] += tmp[i];
 am[0] = 3;  am[1] = 8;
 vrr_build_xxxx(am,Data,vrr_stack+850, vrr_stack+2907, vrr_stack+2637, vrr_stack+2502, vrr_stack+2367, vrr_stack+1890);
   tmp = vrr_stack + 850;

...
#include "vrr_header.h"
  ...
  /* Computes quartets necessary to compute (f0|gf) integrals */

void vrr_order_f0gf(Libint_t * Libint, prim_data *Data)
{
 ...
 am[0] = 0;  am[1] = 7;
 vrr_build_xxxx(am,Data,vrr_stack+334, vrr_stack+1158, vrr_stack+1046, vrr_stack+647, vrr_stack+105, NULL);
 am[0] = 1;  am[1] = 7;
 vrr_build_xxxx(am,Data,vrr_stack+1883, vrr_stack+334, vrr_stack+1739, NULL, NULL, vrr_stack+1046);
 _BUILD_00p0(Data,vrr_stack+1046, Data->F+9, Data->F+10, NULL, NULL, NULL);
 _BUILD_00d0(Data,vrr_stack+15, vrr_stack+204, vrr_stack+1046, Data->F+8, Data->F+9, NULL);
 _BUILD_00f0(Data,vrr_stack+1991, vrr_stack+207, vrr_stack+15, vrr_stack+264, vrr_stack+204, NULL);
 _BUILD_00g0(Data,vrr_stack+1046, vrr_stack+21, vrr_stack+1991, vrr_stack+267, vrr_stack+207, NULL);
 _BUILD_00h0(Data,vrr_stack+647, vrr_stack+387, vrr_stack+1046, vrr_stack+39, vrr_stack+21, NULL);
 _BUILD_00i0(Data,vrr_stack+1046, vrr_stack+1270, vrr_stack+647, vrr_stack+0, vrr_stack+387, NULL);
 am[0] = 0;  am[1] = 7;
 vrr_build_xxxx(am,Data,vrr_stack+0, vrr_stack+1291, vrr_stack+1046, vrr_stack+49, vrr_stack+1270, NULL);
 am[0] = 1;  am[1] = 7;
 vrr_build_xxxx(am,Data,vrr_stack+36, vrr_stack+731, vrr_stack+0, NULL, NULL, vrr_stack+1291);
 am[0] = 2;  am[1] = 7;
 vrr_build_xxxx(am,Data,vrr_stack+1991, vrr_stack+1775, vrr_stack+36, vrr_stack+1739, vrr_stack+731, vrr_stack+1319);
 am[0] = 2;  am[1] = 7;
 vrr_build_xxxx(am,Data,vrr_stack+2207, vrr_stack+1883, vrr_stack+1775, vrr_stack+334, vrr_stack+1739, vrr_stack+1074);
 _BUILD_f0g0(Data,vrr_stack+2423, vrr_stack+494, vrr_stack+404, vrr_stack+289, vrr_stack+219, vrr_stack+144);
   tmp = vrr_stack + 2423;
 ...
 _BUILD_f0i0(Data,vrr_stack+210, vrr_stack+1571, vrr_stack+1403, vrr_stack+1186, vrr_stack+1074, vrr_stack+794);
   ...
   for(i=0;i<280;i++)
     target_ptr[i] += tmp[i];
 am[0] = 3;  am[1] = 7;
 vrr_build_xxxx(am,Data,vrr_stack+490, vrr_stack+2207, vrr_stack+1991, vrr_stack+1883, vrr_stack+1775, vrr_stack+1403);
   tmp = vrr_stack + 490;

...
public:
  ...
  void        add_bool(const char* cstr_option,bool bool_default);
  void        add_int(const char* cstr_option,int int_default);
  void        add_double(const char* cstr_option,double double_default);
  void        add_str(const char* cstr_option,const char* cstr_default);
  void        add_str(const char* cstr_option,const char* cstr_default,const char* cstr_choices);

  bool        get_bool(const char* cstr_option);
  int         get_int(const char* cstr_option);
  double      get_double(const char* cstr_option);
  std::string get_str(const char* cstr_option);
  char *      get_cstr(const char* cstr_option);

  void        set_bool(const char* cstr_option, bool bool_value);
  void        set_int(const char* cstr_option,int int_value);
  void        set_double(const char* cstr_option,double double_value);
  void        set_str(const char* cstr_option,const char* cstr_value);
  void        clear(void);
private:

...
{
    //psi::fprintf(stderr, "TwoBodyAOInt object created with: %s, %s, %s, %s\n",
...
//        psi::fprintf(outfile, "2e_1: cart = %d pure = %d coef = %8.5f\n", sti.cartindex(), sti.pureindex(), sti.coef());
...
//        psi::fprintf(outfile, "2e_2: cart = %d pure = %d coef = %8.5f\n", sti.cartindex(), sti.pureindex(), sti.coef());
...
//        psi::fprintf(outfile, "2e_3: cart = %d pure = %d coef = %8.5f\n", sti.cartindex(), sti.pureindex(), sti.coef());
...
//        psi::fprintf(outfile, "2e_4: cart = %d pure = %d coef = %8.5f\n", sti.cartindex(), sti.pureindex(), sti.coef());

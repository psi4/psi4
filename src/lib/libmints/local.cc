...
{
    psi::fprintf(outfile, "  ==> Boys Localizer <==\n\n");
...
void BoysLocalizer::localize() 
{
    ...
    // => Iteration Print <= //
    psi::fprintf(outfile, "    Iteration %24s %14s\n", "Metric", "Residual");
    psi::fprintf(outfile, "    @Boys %4d %24.16E %14s\n", 0, metric, "-");
    ...
    for (int iter = 1; iter <= maxiter_; iter++) {
        ...
        for (int i2 = 0; i2 < nmo-1; i2++) {
            for (int j2 = i2+1; j2 < nmo; j2++) {
                ...
                if (debug_ > 3) {
                    psi::fprintf(outfile, "@Rotation, i = %4d, j = %4d, Theta = %24.16E\n", i, j,theta);
                    psi::fprintf(outfile, "@Info, a = %24.16E, b = %24.16E, c = %24.16E\n", a, b, c);
                }
        ...
        psi::fprintf(outfile, "    @Boys %4d %24.16E %14.6E\n", iter, metric, conv);
    ...
    psi::fprintf(outfile, "\n");
    if (converged_) {
        psi::fprintf(outfile, "    Boys Localizer converged.\n\n");
    } else {
        psi::fprintf(outfile, "    Boys Localizer failed.\n\n");
    }
...
{
    psi::fprintf(outfile, "  ==> Pipek-Mezey Localizer <==\n\n");
    psi::fprintf(outfile, "    Convergence = %11.3E\n", convergence_);
    psi::fprintf(outfile, "    Maxiter     = %11d\n", maxiter_);
    psi::fprintf(outfile, "\n");
    fflush(outfile);
...
void PMLocalizer::localize() 
{
    ...
    // => Iteration Print <= //
    psi::fprintf(outfile, "    Iteration %24s %14s\n", "Metric", "Residual");
    psi::fprintf(outfile, "    @PM %4d %24.16E %14s\n", 0, metric, "-");
    ...
    for (int iter = 1; iter <= maxiter_; iter++) {
        ...
        psi::fprintf(outfile, "    @PM %4d %24.16E %14.6E\n", iter, metric, conv);
    ...
    psi::fprintf(outfile, "\n");
    if (converged_) {
        psi::fprintf(outfile, "    PM Localizer converged.\n\n");
    } else {
        psi::fprintf(outfile, "    PM Localizer failed.\n\n");
    }

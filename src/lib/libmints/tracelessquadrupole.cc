...
TracelessQuadrupoleInt::TracelessQuadrupoleInt(std::vector<SphericalTransform>& st, shared_ptr<BasisSet> bs1, shared_ptr<BasisSet> bs2) :
...
void TracelessQuadrupoleInt::compute_pair(const shared_ptr<GaussianShell>& s1,

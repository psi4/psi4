...
{
//    psi::fprintf(outfile, "a = %d, b = %d, c = %d, coef = %f, cartindex = %d, pureindex = %d\n", a, b, c, coef, cartindex, pureindex);
    a_ = a;
    b_ = b;
    c_ = c;
    coef_ = coef;
...
//    psi::fprintf(outfile, "SphericalTransform: l = %d\n", l_);
//    coefmat.print();
...
//                psi::fprintf(outfile, "cart1 = %d, p+pureindex=%d\n", cart1, p+pureindex);

...
{
    if (print_) {
        psi::fprintf(outfile, "  ==> MatrixRHamiltonian (by Rob Parrish) <== \n\n");
    }
}
...
{
    if (print_) {
        psi::fprintf(outfile, "  ==> MatrixUHamiltonian (by Rob Parrish) <== \n\n");
    }
}
...
{
    if (print_) {
        psi::fprintf(outfile, "  ==> CISRHamiltonian (by Rob Parrish) <== \n\n");
    }
}
boost::shared_ptr<Vector> CISRHamiltonian::diagonal()
{
    ...
    if (exact_diagonal_) {
        try {
            ...
            psi::fprintf(outfile, "    CISR Hamiltonian: (ia|ia) integrals used to form exact diagonal.\n\n");
        } catch (...) {
            psi::fprintf(outfile, "    CISR Hamiltonian: (ia|ia) integrals not available for JK type.\n\n");
        }
    }
...
{
    if (print_) {
        psi::fprintf(outfile, "  ==> TDHFRHamiltonian (by Rob Parrish) <== \n\n");
    }
}
...
{
    if (print_) {
        psi::fprintf(outfile, "  ==> CPHFRHamiltonian (by Rob Parrish) <== \n\n");
    }
}
...
{
    if (print_) {
        psi::fprintf(outfile, "  ==> TDARHamiltonian (by Rob Parrish) <== \n\n");
    }
}
...
{
    if (print_) {
        psi::fprintf(outfile, "  ==> TDDFTHamiltonian (by Rob Parrish) <== \n\n");
    }
}
...
{
    if (print_) {
        psi::fprintf(outfile, "  ==> CPKSRHamiltonian (by Rob Parrish) <== \n\n");
    }
}

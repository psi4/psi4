...
{      
 ...
 if (reference_ == "RESTRICTED") {
    // G (IJ,AB) = 1/4 V(IB,AJ)  
    dpd_buf4_init(&V, PSIF_OCEPA_DENSITY, 0, ID("[O,V]"), ID("[V,O]"),
                  ID("[O,V]"), ID("[V,O]"), 0, "V <OV|VO>");
    dpd_buf4_sort(&V, PSIF_OCEPA_DENSITY , psrq, ID("[O,O]"), ID("[V,V]"), "TPDM <OO|VV>");
    dpd_buf4_close(&V);
    ...
    dpd_buf4_copy(&T, PSIF_OCEPA_DENSITY, "TPDM <OO|VV>");
    dpd_buf4_close(&T);
...
{      
 ...
 if (reference_ == "RESTRICTED") {
    ...
    dpd_buf4_init(&V, PSIF_OCEPA_DENSITY, 0, ID("[O,O]"), ID("[O,O]"),
                  ID("[O,O]"), ID("[O,O]"), 0, "V <OO|OO>");
    dpd_buf4_sort(&V, PSIF_OCEPA_DENSITY , psrq, ID("[O,O]"), ID("[O,O]"), "TPDM <OO|OO>");
    ...
    dpd_buf4_init(&V, PSIF_OCEPA_DENSITY, 0, ID("[O,O]"), ID("[O,O]"),
                  ID("[O,O]"), ID("[O,O]"), 0, "V <OO|OO>");
    dpd_buf4_copy(&V, PSIF_OCEPA_DENSITY, "TPDM <OO|OO>");
    dpd_buf4_close(&V);
...
{      
 ...
 if (reference_ == "RESTRICTED") {
    ...
    dpd_buf4_init(&T, PSIF_OCEPA_DPD, 0, ID("[O,O]"), ID("[V,V]"),
                  ID("[O,O]"), ID("[V,V]"), 0, "T2 <OO|VV>");
    dpd_buf4_init(&L, PSIF_OCEPA_DPD, 0, ID("[O,O]"), ID("[V,V]"),
                  ID("[O,O]"), ID("[V,V]"), 0, "Tau <OO|VV>");
    ...
    dpd_buf4_init(&G, PSIF_OCEPA_DENSITY, 0, ID("[V,V]"), ID("[V,V]"),
                  ID("[V,V]"), ID("[V,V]"), 0, "TPDM <VV|VV>");    
    dpd_buf4_sort(&G, PSIF_OCEPA_DENSITY , psrq, ID("[V,V]"), ID("[V,V]"), "TPDM <AD|CB>");
    dpd_buf4_close(&G);
    dpd_buf4_init(&G, PSIF_OCEPA_DENSITY, 0, ID("[V,V]"), ID("[V,V]"),
                  ID("[V,V]"), ID("[V,V]"), 0, "TPDM <VV|VV>");    
    dpd_buf4_init(&V, PSIF_OCEPA_DENSITY, 0, ID("[V,V]"), ID("[V,V]"),
...
{      
 ...
 if (reference_ == "RESTRICTED") {
    ...
    dpd_buf4_init(&V, PSIF_OCEPA_DENSITY, 0, ID("[O,V]"), ID("[O,V]"),
                  ID("[O,V]"), ID("[O,V]"), 0, "V <OV|OV>");
    dpd_buf4_sort(&V, PSIF_OCEPA_DENSITY , psrq, ID("[O,V]"), ID("[O,V]"), "TPDM <OV|OV>");
    ...
    dpd_buf4_init(&V, PSIF_OCEPA_DENSITY, 0, ID("[O,V]"), ID("[O,V]"),
                  ID("[O,V]"), ID("[O,V]"), 0, "V <OV|OV>");
    dpd_buf4_copy(&V, PSIF_OCEPA_DENSITY , "TPDM <OV|OV>");
    dpd_buf4_close(&V);
    dpd_buf4_init(&G, PSIF_OCEPA_DENSITY, 0, ID("[O,V]"), ID("[O,V]"),
                  ID("[O,V]"), ID("[O,V]"), 0, "TPDM <OV|OV>");
    dpd_buf4_scm(&G, -0.5);
...
{      
    ...
    dpd_buf4_init(&V, PSIF_OCEPA_DENSITY, 0, ID("[o,V]"), ID("[o,V]"),
                  ID("[o,V]"), ID("[o,V]"), 0, "V <oV|oV>");
    dpd_buf4_sort(&V, PSIF_OCEPA_DENSITY , qpsr, ID("[V,o]"), ID("[V,o]"), "TPDM <Vo|Vo>");
    dpd_buf4_close(&V);
...
{      
    ...
    dpd_buf4_init(&V, PSIF_OCEPA_DENSITY, 0, ID("[O,v]"), ID("[o,V]"),
                  ID("[O,v]"), ID("[o,V]"), 0, "V <Ov|oV>");
    dpd_buf4_sort(&V, PSIF_OCEPA_DENSITY , pqsr, ID("[O,v]"), ID("[V,o]"), "TPDM <Ov|Vo>");
    dpd_buf4_close(&V);
    ...
    dpd_buf4_init(&G, PSIF_OCEPA_DENSITY, 0, ID("[O,v]"), ID("[V,o]"),
                  ID("[O,v]"), ID("[V,o]"), 0, "TPDM <Ov|Vo>");
    dpd_buf4_sort(&G, PSIF_OCEPA_DENSITY , rspq, ID("[V,o]"), ID("[O,v]"), "TPDM <Vo|Ov>");
    dpd_buf4_close(&G);

...
if (reference_ == "RESTRICTED") {
    ...
    dpd_buf4_init(&T, PSIF_OCEPA_DPD, 0, ID("[O,V]"), ID("[O,V]"),
                  ID("[O,V]"), ID("[O,V]"), 0, "T2 (IA|JB)");
    dpd_buf4_init(&Tp, PSIF_OCEPA_DPD, 0, ID("[O,V]"), ID("[O,V]"),
    ...
    // T(IA,JB) => T_IJ^AB(2)
    dpd_buf4_sort(&T, PSIF_OCEPA_DPD , prqs, ID("[O,O]"), ID("[V,V]"), "T2 <IJ|AB>");
    dpd_buf4_close(&T);
    ...
    // T(JA,IB) => T_IJ^AB(2)
    dpd_buf4_sort(&T, PSIF_OCEPA_DPD , rpqs, ID("[O,O]"), ID("[V,V]"), "T2 (IJ|AB)");
    dpd_buf4_close(&T);    
    ...
    dpd_buf4_copy(&K, PSIF_OCEPA_DPD, "T2new <OO|VV>");
    dpd_buf4_close(&K);

    // T_IJ^AB += T(IA,JB)
    dpd_buf4_init(&T, PSIF_OCEPA_DPD, 0, ID("[O,O]"), ID("[V,V]"),
                  ID("[O,O]"), ID("[V,V]"), 0, "T2new <OO|VV>");
    dpd_buf4_init(&Tp, PSIF_OCEPA_DPD, 0, ID("[O,O]"), ID("[V,V]"),
    ...
    dpd_buf4_init(&T, PSIF_OCEPA_DPD, 0, ID("[V,V]"), ID("[O,O]"),
    ...
    dpd_buf4_close(&K);
    dpd_buf4_close(&TAA);
    dpd_buf4_sort(&T, PSIF_OCEPA_DPD , rspq, ID("[O,O]"), ID("[V,V]"), "Z2 <OO|VV>");
    dpd_buf4_close(&T);
    dpd_buf4_init(&T, PSIF_OCEPA_DPD, 0, ID("[O,O]"), ID("[V,V]"),
                  ID("[O,O]"), ID("[V,V]"), 0, "T2new <OO|VV>");
    dpd_buf4_init(&Tp, PSIF_OCEPA_DPD, 0, ID("[O,O]"), ID("[V,V]"),
    ...
    dpd_buf4_init(&Tnew, PSIF_OCEPA_DPD, 0, ID("[O,O]"), ID("[V,V]"),
                  ID("[O,O]"), ID("[V,V]"), 0, "T2new <OO|VV>");
    dpd_buf4_init(&T, PSIF_OCEPA_DPD, 0, ID("[O,O]"), ID("[V,V]"),
                  ID("[O,O]"), ID("[V,V]"), 0, "T2 <OO|VV>");
    ...
    dpd_buf4_init(&Tnew, PSIF_OCEPA_DPD, 0, ID("[O,O]"), ID("[V,V]"),
                  ID("[O,O]"), ID("[V,V]"), 0, "T2new <OO|VV>");
    dpd_buf4_copy(&Tnew, PSIF_OCEPA_DPD, "RT2 <OO|VV>");
    ...
    // Reset
    dpd_buf4_copy(&Tnew, PSIF_OCEPA_DPD, "T2 <OO|VV>");
    if (print_ > 3) dpd_buf4_print(&Tnew, outfile, 1);
    dpd_buf4_close(&Tnew);
    ...
    dpd_buf4_close(&T);
     ...
     dpd_buf4_init(&T, PSIF_OCEPA_DPD, 0, ID("[O,O]"), ID("[V,V]"),
                  ID("[O,O]"), ID("[V,V]"), 0, "T2 <OO|VV>");
     dpd_buf4_copy(&T, PSIF_OCEPA_DPD, "Tau <OO|VV>");
     dpd_buf4_copy(&T, PSIF_OCEPA_DPD, "T2AA <OO|VV>");
     dpd_buf4_sort(&T, PSIF_OCEPA_DPD, qprs, ID("[O,O]"), ID("[V,V]"), "T2jiab <OO|VV>");
     dpd_buf4_close(&T);
     dpd_buf4_init(&Tau, PSIF_OCEPA_DPD, 0, ID("[O,O]"), ID("[V,V]"),
                  ID("[O,O]"), ID("[V,V]"), 0, "Tau <OO|VV>");
     dpd_buf4_init(&Tp, PSIF_OCEPA_DPD, 0, ID("[O,O]"), ID("[V,V]"),
                  ID("[O,O]"), ID("[V,V]"), 0, "T2AA <OO|VV>");
     dpd_buf4_init(&Ttemp, PSIF_OCEPA_DPD, 0, ID("[O,O]"), ID("[V,V]"),
    ...
    dpd_buf4_init(&T, PSIF_OCEPA_DPD, 0, ID("[O,O]"), ID("[V,V]"),
                  ID("[O,O]"), ID("[V,V]"), 0, "T2 <OO|VV>");
    dpd_buf4_sort(&T, PSIF_OCEPA_DPD , prqs, ID("[O,V]"), ID("[O,V]"), "T2 (OV|OV)");
    dpd_buf4_sort(&T, PSIF_OCEPA_DPD , qrps, ID("[O,V]"), ID("[O,V]"), "T2pp (OV|OV)");
    dpd_buf4_close(&T);

    // Tau(IJ,AB) => Tau'(IA,JB), Tau"(JA,IB)
    dpd_buf4_init(&T, PSIF_OCEPA_DPD, 0, ID("[O,O]"), ID("[V,V]"),
                  ID("[O,O]"), ID("[V,V]"), 0, "Tau <OO|VV>");
    dpd_buf4_sort(&T, PSIF_OCEPA_DPD , prqs, ID("[O,V]"), ID("[O,V]"), "Tau (OV|OV)");
    dpd_buf4_sort(&T, PSIF_OCEPA_DPD , qrps, ID("[O,V]"), ID("[O,V]"), "Taupp (OV|OV)");
    dpd_buf4_close(&T);
...
/********************************************************************************************/        
    ...
    dpd_buf4_init(&TAA, PSIF_OCEPA_DPD, 0, ID("[O,O]"), ID("[V,V]"),
                  ID("[O,O]"), ID("[V,V]"), 0, "T2 <OO|VV>");
    //dpd_buf4_init(&W, PSIF_OCEPA_DPD, 0, ID("[O,O]"), ID("[O,O]"),
...
/********************************************************************************************/    
    ...
    dpd_buf4_init(&T, PSIF_OCEPA_DPD, 0, ID("[O,o]"), ID("[V,v]"),
                  ID("[O,o]"), ID("[V,v]"), 0, "T2 <Oo|Vv>");
    dpd_buf4_sort(&T, PSIF_OCEPA_DPD , prqs, ID("[O,V]"), ID("[o,v]"), "T2 (OV|ov)");
    dpd_buf4_sort(&T, PSIF_OCEPA_DPD , qrps, ID("[o,V]"), ID("[O,v]"), "T2 (oV|Ov)");
    dpd_buf4_close(&T);    
   
    // T(IA,jb) => T(jb,IA)   
    dpd_buf4_init(&T, PSIF_OCEPA_DPD, 0, ID("[O,V]"), ID("[o,v]"),
                  ID("[O,V]"), ID("[o,v]"), 0, "T2 (OV|ov)");
    dpd_buf4_sort(&T, PSIF_OCEPA_DPD , rspq, ID("[o,v]"), ID("[O,V]"), "T2 (ov|OV)");
    dpd_buf4_close(&T);

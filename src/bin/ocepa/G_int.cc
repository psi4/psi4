...
{  
 ...
 if (reference_ == "RESTRICTED") {
	...
	dpd_file2_init(&G, PSIF_OCEPA_DENSITY, 0, ID('O'), ID('O'), "G <O|O>");  
	...
	dpd_file2_init(&G, PSIF_OCEPA_DENSITY, 0, ID('V'), ID('V'), "G <V|V>");  
	...
	dpd_buf4_init(&TAB, PSIF_OCEPA_DPD, 0, ID("[O,o]"), ID("[V,v]"),
                  ID("[O,o]"), ID("[V,v]"), 0, "T2 <Oo|Vv>");
	dpd_buf4_init(&LAA, PSIF_OCEPA_DPD, 0, ID("[O,O]"), ID("[V,V]"),
                  ID("[O,O]"), ID("[V,V]"), 0, "T2 <OO|VV>");
	dpd_buf4_init(&LBB, PSIF_OCEPA_DPD, 0, ID("[o,o]"), ID("[v,v]"),
                  ID("[o,o]"), ID("[v,v]"), 0, "T2 <oo|vv>");
	dpd_buf4_init(&LAB, PSIF_OCEPA_DPD, 0, ID("[O,o]"), ID("[V,v]"),
                  ID("[O,o]"), ID("[V,v]"), 0, "T2 <Oo|Vv>");

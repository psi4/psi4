...
// dodoc == "GLOBALS" fake line to make document_options_and_tests.pl generate a GLOBALS doc section
   ...
   if (name=="DCFT"||options.read_globals()) {
      ...
      options.add_str("DCFT_FUNCTIONAL", "DC-06",
            "DC-06 DC-12 ODC-06 ODC-12 ODC-13 CEPA0");
   ...
   if (name=="SCF"||options.read_globals()) {
      ...
      /*- What algorithm to use for the SCF computation. See Table :ref:`SCF
       ...
       different calculation types. -*/
      options.add_str("SCF_TYPE", "PK",
            "DIRECT DF PK OUT_OF_CORE FAST_DF CD INDEPENDENT");
      /*- JK Independent options
       -*/
      options.add_str("INDEPENDENT_J_TYPE", "DIRECT_SCREENING",
            "DIRECT_SCREENING");
      options.add_str("INDEPENDENT_K_TYPE", "DIRECT_SCREENING",
            "DIRECT_SCREENING LINK");
      ...
      options.add_str("S_ORTHOGONALIZATION", "SYMMETRIC",
            "SYMMETRIC CANONICAL");
      ...
      options.add_str("PERTURB_WITH", "DIPOLE_X",
            "DIPOLE_X DIPOLE_Y DIPOLE_Z EMBPOT SPHERE DX");
      ...
      options.add_str("SAPT", "FALSE",
            "FALSE 2-DIMER 2-MONOMER_A 2-MONOMER_B 3-TRIMER 3-DIMER_AB 3-DIMER_BC 3-DIMER_AC 3-MONOMER_A 3-MONOMER_B 3-MONOMER_C");
      ...
      /*- Radial Scheme. -*/
      options.add_str("DFT_RADIAL_SCHEME", "TREUTLER",
            "TREUTLER BECKE MULTIEXP EM MURA");
      /*- Nuclear Scheme. -*/
      options.add_str("DFT_NUCLEAR_SCHEME", "TREUTLER",
            "TREUTLER BECKE NAIVE STRATMANN");
   ...
   if (name=="CPHF"||options.read_globals()) {
      ...
      /*- SCF Type
       -*/
      options.add_str("SCF_TYPE", "DIRECT",
            "DIRECT DF PK OUT_OF_CORE PS INDEPENDENT");
      /*- JK Independent options
       -*/
      options.add_str("INDEPENDENT_J_TYPE", "DIRECT_SCREENING",
            "DIRECT_SCREENING");
      ...
      /*- Solver precondition step type
       -*/
      options.add_str("SOLVER_PRECONDITION_STEPS", "TRIANGULAR",
            "CONSTANT TRIANGULAR");
...
//  }
   ...
   if (name=="TRANSQT"||options.read_globals()) {
      ...
      options.add_str("MP2R12A", "MP2R12AERI",
            "MP2R12AERI MP2R12AR12 MP2R12AR12T1");
      /*- Minimum absolute value below which integrals are neglected. -*/
      options.add_double("INTS_TOLERANCE", 1e-14);
...
//  }
   ...
   if (name=="CCRESPONSE"||options.read_globals()) {
      ...
      options.add_str("PROPERTY", "POLARIZABILITY",
            "POLARIZABILITY ROTATION ROA ALL");
      /*- Type of ABCD algorithm will be used -*/
      options.add_str("ABCD", "NEW");
...
//#warning CCEnergy ao_basis keyword type was changed.
      ...
      /*- The response property desired.  Acceptable values are ``POLARIZABILITY``
       ...
       ``ROA`` for Raman Optical Activity, and ``ALL`` for all of the above. -*/
      options.add_str("PROPERTY", "POLARIZABILITY",
            "POLARIZABILITY ROTATION MAGNETIZABILITY ROA ALL");
      /*- Type of ABCD algorithm will be used -*/
      options.add_str("ABCD", "NEW", "NEW OLD");
      /*- Do simulate the effects of local correlation techniques? -*/
      options.add_bool("LOCAL", 0);
...
//   }
   ...
   if (name=="PSIMRCC"||options.read_globals()) {
      ...
      options.add_str("TRIPLES_ALGORITHM", "RESTRICTED",
            "SPIN_ADAPTED RESTRICTED UNRESTRICTED");
   ...
   if (name=="OPTKING"||options.read_globals()) {
      ...
      options.add_str("OPT_COORDINATES", "INTERNAL",
            "REDUNDANT INTERNAL DELOCALIZED NATURAL CARTESIAN BOTH");
      ...
      options.add_str("G_CONVERGENCE", "QCHEM",
            "QCHEM MOLPRO GAU GAU_LOOSE GAU_TIGHT GAU_VERYTIGHT TURBOMOLE CFOUR NWCHEM_LOOSE");
      ...
      options.add_str("INTRAFRAG_HESS", "SCHLEGEL",
            "FISCHER SCHLEGEL SIMPLE LINDH LINDH_SIMPLE");
   ...
   if (name=="OCC"||options.read_globals()) {
      ...
      options.add_str("PCG_BETA_TYPE", "FLETCHER_REEVES",
   ...
   if (name=="DFOCC"||options.read_globals()) {
      ...
      options.add_str("HESS_TYPE", "HF",
            "APPROX_DIAG APPROX_DIAG_EKT APPROX_DIAG_HF HF");
      /*- Type of the SCS method -*/
      options.add_str("SCS_TYPE", "SCS", "SCS SCSN SCSVDW SCSMI");
      /*- Type of the SOS method -*/
      options.add_str("SOS_TYPE", "SOS", "SOS SOSPI");
      ...
      options.add_str("WFN_TYPE", "DF-OMP2",
            "DF-OMP2 DF-OMP3 DF-OCEPA(0) DF-OMP2.5 DFGRAD CD-OMP2");
      /*- CEPA type such as CEPA0, CEPA1 etc. currently we have only CEPA0. -*/
   ...
   if (name=="CFOUR"||options.read_globals()) {
      ...
      /*- Specifies treatment of anharmonc effects by calculating cubic
       ...
       all isotopologs. -*/
      options.add_str("CFOUR_ANHARMONIC", "OFF",
            "CUBIC VPT2 FULLQUARTIC VIBROT OFF");
      ...
      options.add_str("CFOUR_BASIS", "SPECIAL",
            "STO-3G 3-21G 4-31G 6-31G 6-31G* 6-31G** 6-311G 6-311G* 6-311G** DZ DZP TZ TZP TZ2P PVDZ PVTZ PVQZ PV5Z PV6Z PCVDZ PCVTZ PCVQZ PCV5Z PCV6Z AUG-PVDZ AUG-PVTZ AUG-PVTZ AUG-PVQZ AUG-PV5Z AUG-PV6Z D-AUG-PVDZ D-AUG-PVTZ D-AUG-PVQZ D-AUG-PV5Z D-AUG-PV6Z cc-pVDZ cc-pVTZ cc-pVQZ cc-pV5Z cc-pV6Z cc-pCVDZ cc-pCVTZ cc-pCVQZ cc-pCV5Z cc-pCV6Z PWCVDZ PWCVTZ PWCVQZ PWCV5Z PWCV6Z PwCVDZ PwCVTZ PwCVQZ PwCV5Z PwCV6Z svp dzp tzp tzp2p qz2p pz3d2f 13s9p4d3f WMR ANO0 ANO1 ANO2 EVEN_TEMPERED SPECIAL");
      ...
      options.add_str("CFOUR_CALC_LEVEL", "SCF",
            "SCF HF MBPT(2) MP2 MBPT(3) MP3 SDQ-MBPT(4) SDQ-MP4 MBPT(4) MP4 CCD CCSD CCSD(T) CCSDT-1 CCSDT-1b CCSDT-2 CCSDT-3 CCSDT-4 CCSDT CC2 CC3 QCISD QCISD(T) CID CISD UCC(4) B-CCD");
      ...
      options.add_str("CFOUR_CC_EXTRAPOLATION", "DIIS",
            "RLE DIIS NOJACOBI OFF");
      ...
      /*- Signifies that one or more "continuum" orbitals should be added
       ...
       initially occupied. -*/
      options.add_str("CFOUR_CONTINUUM", "NONE",
            "NONE VIRTUAL DVIRTUAL OCCUPIED DOCCUPIED");
      ...
      options.add_str("CFOUR_CONTRACTION", "GENERAL",
            "SEGMENTED GENERAL UNCONTRACTED");
      ...
      options.add_str("CFOUR_COORDINATES", "INTERNAL",
            "INTERNAL CARTESIAN XYZINT");
      ...
      options.add_str("CFOUR_ESTATE_PROP", "",
            "OFF EXPECTATION UNRELAXED RESPONSE");
      ...
      /*- Specifies the algorithm used to compute the harmonic force
       ...
       available. -*/
      options.add_str("CFOUR_FD_CALCTYPE", "GRADONLY",
            "GRADONLY ENERONLY MIXED");
      ...
      options.add_str("CFOUR_GEO_METHOD", "SINGLE_POINT",
            "NR RFA TS MANR SINGLE_POINT ENERONLY");
       ...
       **PSI4 Interface:** Keyword set from memory input command when
       given, always MB. -*/
      options.add_str("CFOUR_MEM_UNIT", "INTEGERWORDS",
            "INTEGERWORDS KB MB GB TB");
      ...
      options.add_str("CFOUR_METHOD", "SINGLE_POINT",
            "NR RFA TS MANR SINGLE_POINT");
      ...
      options.add_str("CFOUR_OPEN-SHELL", "SPIN-ORBITAL",
            "SPIN-ORBITAL SR-CC PSA-CC_FULL SR-CC_FULL TD-CC");
      ...
      /*- Specifies whether and which molecular property is calculated.
       ...
       Verdet constants. -*/
      options.add_str("CFOUR_PROPS", "OFF",
            "OFF FIRST_ORDER SECOND_ORDER NMR HYPERPOL DYN_HYP SHG OPT_REC VERDET");
      ...
      /*- Specifies the treatment of relativistic effects. The default is
       ...
       DPT2). -*/
      options.add_str("CFOUR_RELATIVISTIC", "OFF",
            "OFF MVD1 MVd2 DPT2 SF-DPT4 DPT4 SF-DPT6 SFREE X2C1E DPT");
      ...
      /*- Specifies an Abelian subgroup to be used in a calculation.
       ...
       subgroup. -*/
      options.add_str("CFOUR_SUBGROUP", "DEFAULT",
            "DEFAULT C1 C2 CS CI C2V C2H D2 D2H OFF");
      ...
      options.add_str("CFOUR_TREAT_PERT", "SIMULTANEOUS",
      ...
      options.add_str("CFOUR_VTRAN", "FULL/PARTIAL",

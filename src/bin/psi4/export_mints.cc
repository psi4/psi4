...
//            def("set_symbol", &PointGroup::set_symbol);
    ...
    class_<Molecule, boost::shared_ptr<Molecule> >("Molecule", "Class to store the elements, coordinates, fragmentation pattern, basis sets, charge, multiplicity, etc. of a molecule.").
            ...
            def("natom", &Molecule::natom, MolNatom("Number of real atoms")).
            ...
            def("print_out", &Molecule::print, MolPrint("Prints the molecule in Cartesians in input units")).
            ...
            def("nuclear_repulsion_energy", &Molecule::nuclear_repulsion_energy, MolNRE("Computes nuclear repulsion energy")).

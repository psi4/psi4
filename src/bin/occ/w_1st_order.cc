...
if (reference_ == "RESTRICTED") {
    ...
    global_dpd_->buf4_copy(&K, PSIF_OCC_DPD, "W_1 (OV|OV)");
...
//===========================================================================================
    ...
    */
    ...
    global_dpd_->buf4_sort(&K, PSIF_OCC_DPD , psqr, ID("[O,v]"), ID("[O,v]"), "W_1 (Ov|Ov)");
    global_dpd_->buf4_close(&K);
    global_dpd_->buf4_init(&W, PSIF_OCC_DPD, 0, ID("[O,v]"), ID("[O,v]"),
                  ID("[O,v]"), ID("[O,v]"), 0, "W_1 (Ov|Ov)");
    ...
    global_dpd_->buf4_sort(&K, PSIF_OCC_DPD , rqsp, ID("[o,V]"), ID("[o,V]"), "W_1 (oV|oV)");
    global_dpd_->buf4_close(&K);
    global_dpd_->buf4_init(&W, PSIF_OCC_DPD, 0, ID("[o,V]"), ID("[o,V]"),
                  ID("[o,V]"), ID("[o,V]"), 0, "W_1 (oV|oV)");
    global_dpd_->buf4_scm(&W, -1.0);
    ...
    global_dpd_->buf4_init(&W, PSIF_OCC_DPD, 0, ID("[O,V]"), ID("[o,v]"),
                  ID("[O,V]"), ID("[o,v]"), 0, "W_1 (OV|ov)");
    global_dpd_->buf4_sort(&W, PSIF_OCC_DPD , rspq, ID("[o,v]"), ID("[O,V]"), "W_1 (ov|OV)");
    global_dpd_->buf4_close(&W);

...
if (reference_ == "RESTRICTED") {
    ...
    dpd_->buf4_close(&D);
     ...
     dpd_->buf4_copy(&Tnew, PSIF_OCC_DPD, "Tau_1 <OO|VV>");
     dpd_->buf4_copy(&Tnew, PSIF_OCC_DPD, "T2_1AA <OO|VV>");
     dpd_->buf4_sort(&Tnew, PSIF_OCC_DPD, qprs, ID("[O,O]"), ID("[V,V]"), "T2_1jiab <OO|VV>");

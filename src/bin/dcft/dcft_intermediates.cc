...
DCFTSolver::compute_W_intermediate() {
    ...
    /*
     * 1. W_ijab = -2/3 P_(ij) [(Ft_il T_lk + T_il Ft_lk) Lambda_kjab] - 2/3 P_(ab) [(Ft_da T_cd + T_da Ft_cd) Lambda_ijcb]
     */
    ...
    /*
     * 2. W_ijab -= 1/6 P_(ij) [N_ikab T_jk]
     */

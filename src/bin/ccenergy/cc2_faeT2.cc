...
void cc2_faeT2(void) {
  ...
  if(params.ref == 0) { /** RHF **/
    ...
    dpd_file2_init(&fME, PSIF_CC_OEI, 0, 0, 1, "fIA");
    dpd_file2_init(&FAE, PSIF_CC2_HET1, 0, 1, 1, "CC2 FAE");
    ...
    dpd_file2_init(&fme, PSIF_CC_OEI, 0, 2, 3, "fia");
    dpd_file2_init(&Fae, PSIF_CC2_HET1, 0, 3, 3, "CC2 Fae");
    dpd_contract222(&tia, &fme, &Fae, 1, 1, -1, 0);
    dpd_file2_close(&Fae);
    dpd_file2_close(&fme);
    dpd_file2_close(&tia);

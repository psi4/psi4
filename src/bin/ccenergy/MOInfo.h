...
struct MOInfo {
  ...
  double escsmp2_ss;     /* Scaled-SS MP2 correlation energy*/
  double escsmp2_os;     /* Scaled-OS MP2 correlation energy*/
  ...
  double escscc_ss;      /* Scaled-SS coupled cluster correlation energy*/
  double escscc_os;      /* Scaled-OS coupled cluster energy*/

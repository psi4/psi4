...
void dijabT2(void)
{
  ...
  if(params.ref == 0) { /*** RHF ***/
    ...
    dpd_buf4_copy(&newtIjAb, PSIF_CC_TAMPS, "New tIjAb Increment");
    dpd_buf4_close(&newtIjAb);

    dpd_buf4_init(&newtIjAb, PSIF_CC_TAMPS, 0, 0, 5, 0, 5, 0, "New tIjAb Increment");
    if(params.local) {
    ...
    dpd_buf4_copy(&tIjAb, PSIF_CC_TAMPS, "New tIjAb");
    dpd_buf4_close(&tIjAb);
    dpd_buf4_init(&newtIjAb, PSIF_CC_TAMPS, 0, 0, 5, 0, 5, 0, "New tIjAb");
    dpd_buf4_init(&tIjAb, PSIF_CC_TAMPS, 0, 0, 5, 0, 5, 0, "New tIjAb Increment");
    dpd_buf4_axpy(&tIjAb, &newtIjAb, 1);
    dpd_buf4_close(&tIjAb);
    dpd_buf4_close(&newtIjAb);
  }
  else if(params.ref == 1) { /*** ROHF ***/
    dpd_buf4_init(&newtIJAB, PSIF_CC_TAMPS, 0, 2, 7, 2, 7, 0, "New tIJAB");
    ...
    dpd_buf4_init(&newtijab, PSIF_CC_TAMPS, 0, 12, 17, 12, 17, 0, "New tijab");

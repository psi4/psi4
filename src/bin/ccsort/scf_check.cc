...
void scf_check_uhf(void)
{
  ...
  outfile->Printf( "\tFrozen-core energy (transqt) =  %20.14f\n", moinfo.efzc);
...
void scf_check_rhf(void)
{
  ...
  outfile->Printf( "\n\tEFZC = %20.15f\n", moinfo.efzc);
  outfile->Printf( "\n\tE1A = %20.15f\n", E1A);
  outfile->Printf(   "\tE1B = %20.15f\n", E1B);
  outfile->Printf(   "\tE2AA = %20.15f\n", E2AA);
  outfile->Printf(   "\tE2BB = %20.15f\n", E2BB);
  outfile->Printf(   "\tE2AB = %20.15f\n", E2AB);
  */

  moinfo.eref = E1A+E1B+0.5*(E2AA+E2BB)+E2AB + moinfo.enuc + moinfo.efzc;

  outfile->Printf( "\tNuclear energy               =  %20.14f\n", moinfo.enuc);
  outfile->Printf( "\tOne-electron energy          =  %20.14f\n", E1A+E1B);
  outfile->Printf( "\tTwo-electron (AA) energy     =  %20.14f\n", E2AA);
  outfile->Printf( "\tTwo-electron (BB) energy     =  %20.14f\n", E2BB);
  outfile->Printf( "\tTwo-electron (AB) energy     =  %20.14f\n", E2AB);

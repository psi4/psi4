    ...
    for (i=0; i<intcos.size(); ++i) {
      ...
      switch (intcos[i]->g_type()) { 
        ...
        case (stre_type) :
          ...
          // in aJ/Ang^2, * _hartree2aJ / SQR(_bohr2angstroms);
          break;
        ...
        case (tors_type) :
          ...
          f[cnt++] = (A - (B*(rBC - rBCcov))); //* _hartree2aJ
          break;
      ...
      switch (intcos[i]->g_type()) { 
        ...
        case (bend_type) :
          ...
          f[cnt++] = A + B/(pow(rABcov*rBCcov, D)) *
            exp(-C*( rAB + rBC - rABcov - rBCcov)); // * _hartree2aJ;
          break;
        ...
        case (tors_type) :
          ...
          f[cnt++] = A + B * pow(L,D) / pow(rBC * rBCcov, E) * exp(-C * (rBC - rBCcov)); // * _hartree2aJ;
          break;
       } // end switch intcos
    } // end loop intcos
  } // end Fischer

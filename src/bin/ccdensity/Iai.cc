...
namespace psi { namespace ccdensity {
    ...
    */
	...
	dpd_file2_init(&D, PSIF_CC_OEI, 0, 0, 0, rho_params.DIJ_lbl);
	dpd_buf4_init(&Eints, PSIF_CC_EINTS, 0, 21, 0, 21, 0, 1, "E <AI|JK>");
	dpd_dot24(&D, &Eints, &I, 0, 0, 1.0, 1.0);
	dpd_dot24(&D, &Eints, &I, 1, 0, 1.0, 1.0);
	dpd_buf4_close(&Eints);
	dpd_file2_close(&D);
	...
	dpd_file2_init(&D, PSIF_CC_OEI, 0, 2, 2, rho_params.Dij_lbl);
	dpd_buf4_init(&Eints, PSIF_CC_EINTS, 0, 26, 22, 26, 22, 0, "E <Ai|Jk>");
	dpd_dot24(&D, &Eints, &I, 0, 0, 1.0, 1.0);
	dpd_dot24(&D, &Eints, &I, 1, 0, 1.0, 1.0);
	dpd_buf4_close(&Eints);
	dpd_file2_close(&D);
	...
	dpd_file2_init(&D, PSIF_CC_OEI, 0, 2, 2, rho_params.Dij_lbl);
	dpd_buf4_init(&Eints, PSIF_CC_EINTS, 0, 31, 10, 31, 10, 1, "E <ai|jk>");
	dpd_dot24(&D, &Eints, &I, 0, 0, 1.0, 1.0);
	dpd_dot24(&D, &Eints, &I, 1, 0, 1.0, 1.0);
	dpd_buf4_close(&Eints);
	dpd_file2_close(&D);
	...
	dpd_file2_init(&D, PSIF_CC_OEI, 0, 0, 0, rho_params.DIJ_lbl);
	dpd_buf4_init(&Eints, PSIF_CC_EINTS, 0, 24, 22, 24, 22, 0, "E <Ia|Jk>");
	...
	dpd_buf4_init(&Eints, PSIF_CC_EINTS, 0, 11, 2, 11, 0, 1, "E <ai|jk>");
	...
	dpd_buf4_init(&Eints, PSIF_CC_EINTS, 0, 21, 2, 21, 0, 1, "E <AI|JK>");
	dpd_buf4_init(&G, PSIF_CC_GAMMA, 0, 0, 2, 2, 2, 0, "GIJKL");
	dpd_contract442(&Eints, &G, &I, 0, 0, 2.0, 1.0);
	dpd_buf4_close(&G);
	dpd_buf4_close(&Eints);
	...
	dpd_buf4_init(&Eints, PSIF_CC_EINTS, 0, 31, 12, 31, 10, 1, "E <ai|jk>");
	...
	dpd_buf4_init(&Dints, PSIF_CC_DINTS, 0, 0, 5, 0, 5, 0, "D <ij|ab>");
	dpd_buf4_sort(&Dints, PSIF_CC_TMP0, rqps, 11, 10, "D <ij|ab> (aj,ib)");
	dpd_buf4_close(&Dints);
	dpd_buf4_init(&Dints, PSIF_CC_TMP0, 0, 11, 10, 11, 10, 0, "D <ij|ab> (aj,ib)");
	dpd_buf4_init(&G, PSIF_CC_GAMMA, 0, 0, 10, 0, 10, 0, "GIjKa");
	dpd_contract442(&Dints, &G, &I, 0, 0, 2.0, 1.0);
	dpd_buf4_close(&G);
	dpd_buf4_close(&Dints);
	...
	dpd_buf4_init(&Dints, PSIF_CC_DINTS, 0, 12, 15, 12, 15, 0, "D <ij||ab> (i>j,ab)");
	...
	dpd_buf4_sort(&G, PSIF_CC_TMP0, qpsr, 23, 29, "GiJaB");
	dpd_buf4_close(&G);
	dpd_buf4_init(&G, PSIF_CC_TMP0, 0, 23, 29, 23, 29, 0, "GiJaB");
	dpd_contract442(&Fints, &G, &I, 1, 1, 2.0, 1.0);
	dpd_buf4_close(&G);
	dpd_buf4_close(&Fints);
	...
	dpd_buf4_init(&G, PSIF_CC_GAMMA, 0, 10, 10, 10, 10, 0, "GIbjA");
	dpd_buf4_sort(&G, PSIF_CC_TMP0, rsqp, 10, 11, "GIbjA (jA,bI)");
	dpd_buf4_close(&G);
	dpd_buf4_init(&G, PSIF_CC_TMP0, 0, 10, 11, 10, 11, 0, "GIbjA (jA,bI)");
	dpd_buf4_init(&Fints, PSIF_CC_FINTS, 0, 10, 5, 10, 5, 0, "F <ia|bc>");
	...
	dpd_buf4_sort(&G, PSIF_CC_TMP0, rsqp, 27, 25, "GIbjA (jA,bI)");
	dpd_buf4_close(&G);
	dpd_buf4_init(&G, PSIF_CC_TMP0, 0, 27, 25, 27, 25, 0, "GIbjA (jA,bI)");
	dpd_buf4_init(&Fints, PSIF_CC_FINTS, 0, 27, 29, 27, 29, 0, "F <iA|bC>");
	dpd_contract442(&Fints, &G, &I, 3, 3, -2.0, 1.0);
	dpd_buf4_close(&Fints);
	dpd_buf4_close(&G);
	...
	dpd_buf4_sort(&G, PSIF_CC_TMP0, rsqp, 24, 26, "GiBJa (Ja,Bi)");
	dpd_buf4_close(&G);
	dpd_buf4_init(&G, PSIF_CC_TMP0, 0, 24, 26, 24, 26, 0, "GiBJa (Ja,Bi)");
	dpd_buf4_init(&Fints, PSIF_CC_FINTS, 0, 24, 28, 24, 28, 0, "F <Ia|Bc>");
	dpd_contract442(&Fints, &G, &I, 3, 3, -2.0, 1.0);
	dpd_buf4_close(&Fints);
	dpd_buf4_close(&G);
	...
	dpd_buf4_init(&Bints, PSIF_CC_BINTS, 0, 5, 7, 5, 5, 1, "B <ab|cd>");
	dpd_contract442(&Bints, &G, &I, 0, 0, -2.0, 1.0);
	dpd_buf4_close(&Bints);
	dpd_buf4_close(&G);

	dpd_buf4_init(&G, PSIF_CC_GAMMA, 0, 11, 5, 11, 5, 0, "GcIaB");
	dpd_buf4_sort(&G, PSIF_CC_TMP0, qpsr, 10, 5, "GIcAb");
	dpd_buf4_close(&G);
	dpd_buf4_init(&G, PSIF_CC_TMP0, 0, 10, 5, 10, 5, 0, "GIcAb");
	dpd_buf4_init(&Bints, PSIF_CC_BINTS, 0, 5, 5, 5, 5, 0, "B <ab|cd>");
	dpd_contract442(&Bints, &G, &I, 0, 0, 2.0, 1.0);
	dpd_buf4_close(&Bints);
	dpd_buf4_close(&G);
	...
	dpd_buf4_sort(&G, PSIF_CC_TMP0, qpsr, 24, 28, "GIcAb");
	dpd_buf4_close(&G);
	dpd_buf4_init(&G, PSIF_CC_TMP0, 0, 24, 28, 24, 28, 0, "GIcAb");
	dpd_buf4_init(&Bints, PSIF_CC_BINTS, 0, 28, 28, 28, 28, 0, "B <Ab|Cd>");
	dpd_contract442(&Bints, &G, &I, 0, 0, 2.0, 1.0);
	dpd_buf4_close(&Bints);
	dpd_buf4_close(&G);
	...
	dpd_buf4_init(&Bints, PSIF_CC_BINTS, 0, 15, 17, 15, 15, 1, "B <ab|cd>");
	dpd_contract442(&Bints, &G, &I, 0, 0, -2.0, 1.0);
	dpd_buf4_close(&Bints);
	dpd_buf4_close(&G);

	dpd_buf4_init(&G, PSIF_CC_GAMMA, 0, 26, 28, 26, 28, 0, "GCiAb");
	dpd_buf4_sort(&G, PSIF_CC_TMP0, rspq, 28, 26, "GAbCi");
	dpd_buf4_close(&G);
	dpd_buf4_init(&G, PSIF_CC_TMP0, 0, 28, 26, 28, 26, 0, "GAbCi");
	dpd_buf4_init(&Bints, PSIF_CC_BINTS, 0, 28, 28, 28, 28, 0, "B <Ab|Cd>");

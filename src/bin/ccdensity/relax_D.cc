...
void relax_D(struct RHO_Params rho_params)
{
  ...
  if(params.ref == 0) {
    dpd_file2_init(&D1, PSIF_CC_OEI, 0, 0, 1, rho_params.DAI_lbl);
    dpd_file2_init(&D2, PSIF_CC_OEI, 0, 1, 0, "D(orb)(A,I)");
    ...
    dpd_file2_init(&D1, PSIF_CC_OEI, 0, 2, 3, rho_params.Dai_lbl);
    dpd_file2_init(&D2, PSIF_CC_OEI, 0, 3, 2, "D(orb)(a,i)");
    dpd_file2_axpy(&D2, &D1, 1.0, 1);
    dpd_file2_close(&D2);
    dpd_file2_close(&D1);

    dpd_file2_init(&D1, PSIF_CC_OEI, 0, 2, 3, rho_params.Dia_lbl);
    dpd_file2_init(&D2, PSIF_CC_OEI, 0, 3, 2, "D(orb)(a,i)");
    dpd_file2_axpy(&D2, &D1, 1.0, 1);
    dpd_file2_close(&D2);
    dpd_file2_close(&D1);

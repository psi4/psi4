...
namespace psi { namespace ccdensity {
    ...
    ** */
	...
	dpd_buf4_init(&Aints, PSIF_CC_AINTS, 0, 2, 0, 0, 0, 1, "A <ij|kl>");
	...
	dpd_buf4_sort(&Aints, PSIF_CC_AINTS, qpsr, 23, 23, "A <iJ|kL>");
	dpd_buf4_close(&Aints);
	dpd_buf4_init(&Aints, PSIF_CC_AINTS, 0, 23, 23, 23, 23, 0, "A <iJ|kL>");
	...
	dpd_buf4_init(&Aints, PSIF_CC_AINTS, 0, 12, 10, 10, 10, 1, "A <ij|kl>");
	...
	dpd_buf4_init(&G, PSIF_CC_GAMMA, 0, 5, 7, 7, 7, 0, "GABCD");
	dpd_contract442(&Fints, &G, &I, 0, 0, 2.0, 1.0);
	dpd_buf4_close(&G);
	dpd_buf4_close(&Fints);
	...
	dpd_buf4_init(&Fints, PSIF_CC_FINTS, 0, 10, 5, 10, 5, 0, "F <ia|bc>");
	dpd_buf4_sort(&Fints, PSIF_CC_TMP0, srqp, 5, 11, "F <cb|ai>");
	dpd_buf4_close(&Fints);
	dpd_buf4_init(&Fints, PSIF_CC_TMP0, 0, 5, 11, 5, 11, 0, "F <cb|ai>");
	dpd_buf4_init(&G, PSIF_CC_GAMMA, 0, 5, 5, 5, 5, 0, "GAbCd");
	...
	dpd_buf4_init(&G, PSIF_CC_GAMMA, 0, 28, 28, 28, 28, 0, "GAbCd");
	dpd_contract442(&Fints, &G, &I, 0, 0, 2.0, 1.0);
	dpd_buf4_close(&G);
	dpd_buf4_close(&Fints);
	...
	dpd_buf4_init(&G, PSIF_CC_GAMMA, 0, 15, 17, 17, 17, 0, "Gabcd");
	dpd_contract442(&Fints, &G, &I, 0, 0, 2.0, 1.0);
	dpd_buf4_close(&G);
	dpd_buf4_close(&Fints);

	dpd_buf4_init(&Fints, PSIF_CC_FINTS, 0, 27, 29, 27, 29, 0, "F <iA|bC>");
	dpd_buf4_sort(&Fints, PSIF_CC_TMP0, srqp, 28, 26, "F <Cb|Ai>");
	dpd_buf4_close(&Fints);
	dpd_buf4_init(&Fints, PSIF_CC_TMP0, 0, 28, 26, 28, 26, 0, "F <Cb|Ai>");
	dpd_buf4_init(&G, PSIF_CC_GAMMA, 0, 28, 28, 28, 28, 0, "GAbCd");
	dpd_contract442(&Fints, &G, &I, 3, 3, 2.0, 1.0);
	dpd_buf4_close(&G);
	dpd_buf4_close(&Fints);
	...
	dpd_buf4_init(&G, PSIF_CC_GAMMA, 0, 10, 10, 10, 10, 0, "GiBJa");
	dpd_buf4_sort(&G, PSIF_CC_TMP0, qprs, 11, 10, "GiBJa (Bi,Ja)");
	dpd_buf4_close(&G);
	dpd_buf4_init(&G, PSIF_CC_TMP0, 0, 11, 10, 11, 10, 0, "GiBJa (Bi,Ja)");
	...
	dpd_buf4_sort(&G, PSIF_CC_TMP0, qprs, 26, 24, "GiBJa (Bi,Ja)");
	dpd_buf4_close(&G);
	dpd_buf4_init(&G, PSIF_CC_TMP0, 0, 26, 24, 26, 24, 0, "GiBJa (Bi,Ja)");
	...
	dpd_buf4_sort(&G, PSIF_CC_TMP0, qprs, 25, 27, "GIbjA (bI,jA)");
	dpd_buf4_close(&G);
	dpd_buf4_init(&G, PSIF_CC_TMP0, 0, 25, 27, 25, 27, 0, "GIbjA (bI,jA)");
	dpd_buf4_init(&Eints, PSIF_CC_EINTS, 0, 23, 27, 23, 27, 0, "E <iJ|kA>");
	dpd_contract442(&Eints, &G, &I, 0, 0, -2.0, 1.0);
	dpd_buf4_close(&Eints);
	dpd_buf4_close(&G);
	...
	dpd_buf4_init(&Eints, PSIF_CC_EINTS, 0, 22, 26, 22, 26, 0, "E <Ij|Ak>");
	dpd_buf4_init(&G, PSIF_CC_GAMMA, 0, 22, 28, 22, 28, 0, "GIjAb");
	...
	dpd_buf4_init(&G, PSIF_CC_GAMMA, 0, 11, 5, 11, 5, 0, "2 Gciab - Gciba");
	dpd_buf4_init(&Cints, PSIF_CC_CINTS, 0, 11, 11, 11, 11, 0, "C <ai|bj>");
	dpd_contract442(&Cints, &G, &I, 3, 3, 2.0, 1.0);
	dpd_buf4_close(&Cints);
	dpd_buf4_init(&Dints, PSIF_CC_DINTS, 0, 11, 10, 11, 10, 0, "D <ij|ab> (aj,ib)");
	...
	dpd_buf4_init(&G, PSIF_CC_GAMMA, 0, 11, 5, 11, 7, 0, "GCIAB");
	...
	dpd_buf4_init(&Dints, PSIF_CC_DINTS, 0, 0, 5, 0, 5, 0, "D <ij|ab>");
	dpd_buf4_sort(&Dints, PSIF_CC_TMP0, spqr, 11, 10, "D <ij|ab> (bi,ja)");
	dpd_buf4_close(&Dints);
	dpd_buf4_init(&Dints, PSIF_CC_TMP0, 0, 11, 10, 11, 10, 0, "D <ij|ab> (bi,ja)");
	dpd_buf4_init(&G, PSIF_CC_GAMMA, 0, 11, 5, 11, 5, 0, "GCiAb");
	dpd_contract442(&Dints, &G, &I, 2, 2, 2.0, 1.0);
	dpd_buf4_close(&G);
	dpd_buf4_close(&Dints);
	...
	dpd_buf4_init(&G, PSIF_CC_GAMMA, 0, 21, 5, 21, 7, 0, "GCIAB");
	dpd_buf4_sort(&G, PSIF_CC_TMP0, qpsr, 20, 5, "GICBA");
	dpd_buf4_close(&G);
	dpd_buf4_init(&G, PSIF_CC_TMP0, 0, 20, 5, 20, 5, 0, "GICBA");
	...
	dpd_buf4_init(&Dints, PSIF_CC_DINTS, 0, 22, 28, 22, 28, 0, "D <Ij|Ab>");
	dpd_buf4_sort(&Dints, PSIF_CC_TMP0, rqps, 26, 24, "D <Ij|Ab> (Aj,Ib)");
	dpd_buf4_close(&Dints);
	dpd_buf4_init(&Dints, PSIF_CC_TMP0, 0, 26, 24, 26, 24, 0, "D <Ij|Ab> (Aj,Ib)");
	dpd_buf4_init(&G, PSIF_CC_GAMMA, 0, 26, 28, 26, 28, 0, "GCiAb");
	dpd_contract442(&Dints, &G, &I, 2, 2, 2.0, 1.0);
	dpd_buf4_close(&G);
	dpd_buf4_close(&Dints);
	...
	dpd_buf4_init(&G, PSIF_CC_GAMMA, 0, 31, 15, 31, 17, 0, "Gciab");
	dpd_buf4_sort(&G, PSIF_CC_TMP0, qpsr, 30, 15, "Gicba");
	dpd_buf4_close(&G);
	dpd_buf4_init(&G, PSIF_CC_TMP0, 0, 30, 15, 30, 15, 0, "Gicba");
	...
	dpd_buf4_init(&Dints, PSIF_CC_DINTS, 0, 23, 29, 23, 29, 0, "D <iJ|aB>");
	dpd_buf4_sort(&Dints, PSIF_CC_TMP0, rqps, 25, 27, "D <iJ|aB> (aJ,iB)");
	dpd_buf4_close(&Dints);
	dpd_buf4_init(&Dints, PSIF_CC_TMP0, 0, 25, 27, 25, 27, 0, "D <iJ|aB> (aJ,iB)");
	dpd_buf4_init(&G, PSIF_CC_GAMMA, 0, 25, 29, 25, 29, 0, "GcIaB");
	dpd_contract442(&Dints, &G, &I, 2, 2, 2.0, 1.0);
	dpd_buf4_close(&G);
	dpd_buf4_close(&Dints);

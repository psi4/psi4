...
namespace psi { namespace ccdensity {
    ...
    */
	...
	dpd_buf4_init(&Fints, PSIF_CC_FINTS, 0, 10, 5, 10, 5, 0, "F <ia|bc>");
	dpd_buf4_sort(&Fints, PSIF_CC_TMP0, qpsr, 11, 5, "F(Ai,Cd)");
	dpd_buf4_close(&Fints);
	dpd_buf4_init(&Fints, PSIF_CC_TMP0, 0, 11, 5, 11, 5, 0, "F(Ai,Cd)");
	dpd_buf4_init(&G, PSIF_CC_GAMMA, 0, 11, 5, 11, 5, 0, "GCiAb");
	dpd_contract442(&Fints, &G, &I, 0, 0, 2.0, 1.0);
	dpd_buf4_close(&G);
	dpd_buf4_close(&Fints);
	...
	dpd_buf4_sort(&Fints, PSIF_CC_TMP0, qprs, 11, 5, "F (DI,CA)");
	dpd_buf4_close(&Fints);
	dpd_buf4_init(&Fints, PSIF_CC_TMP0, 0, 11, 5, 11, 5, 0, "F (DI,CA)");
	...
	dpd_buf4_init(&Fints, PSIF_CC_FINTS, 0, 10, 5, 10, 5, 0, "F <ia|bc>");
	dpd_buf4_sort(&Fints, PSIF_CC_TMP0, qpsr, 11, 5, "F (Di,Ac)");
	dpd_buf4_close(&Fints);
	dpd_buf4_init(&Fints, PSIF_CC_TMP0, 0, 11, 5, 11, 5, 0, "F (Di,Ac)");
	dpd_buf4_init(&G, PSIF_CC_GAMMA, 0, 11, 5, 11, 5, 0, "GCiAb");
	dpd_contract442(&Fints, &G, &I, 2, 2, 2.0, 1.0);
	dpd_buf4_close(&G);
	dpd_buf4_init(&G, PSIF_CC_GAMMA, 0, 11, 5, 11, 5, 0, "GcIaB");
	...
	dpd_buf4_init(&Fints, PSIF_CC_FINTS, 0, 21, 5, 21, 5, 1, "F <AI|BC>");
	...
	dpd_buf4_init(&Fints, PSIF_CC_FINTS, 0, 31, 15, 31, 15, 1, "F <ai|bc>");
	...
	dpd_buf4_init(&G, PSIF_CC_GAMMA, 0, 10, 10, 10, 10, 0, "GIbjA");
	dpd_buf4_sort(&G, PSIF_CC_TMP0, rpqs, 0, 5, "GIbjA (jI,bA)");
	dpd_buf4_close(&G);
	dpd_buf4_init(&G, PSIF_CC_TMP0, 0, 0, 5, 0, 5, 0, "GIbjA (jI,bA)");
	...
	dpd_buf4_sort(&G, PSIF_CC_TMP0, rpqs, 23, 29, "GIbjA (jI,bA)");
	dpd_buf4_close(&G);
	dpd_buf4_init(&G, PSIF_CC_TMP0, 0, 23, 29, 23, 29, 0, "GIbjA (jI,bA)");
	dpd_contract442(&Dints, &G, &I, 3, 3, -2.0, 1.0);
	dpd_buf4_close(&G);
	dpd_buf4_close(&Dints);
	...
	dpd_buf4_sort(&G, PSIF_CC_TMP0, rpqs, 22, 28, "GiBJa (Ji,Ba)");
	dpd_buf4_close(&G);
	dpd_buf4_init(&G, PSIF_CC_TMP0, 0, 22, 28, 22, 28, 0, "GiBJa (Ji,Ba)");
	dpd_contract442(&Dints, &G, &I, 3, 3, -2.0, 1.0);
	dpd_buf4_close(&G);
	dpd_buf4_close(&Dints);

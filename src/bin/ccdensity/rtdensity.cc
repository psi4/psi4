...
void rtdensity(struct TD_Params S)
{
  ...
  if(params.ref == 0 || params.ref == 1) { /** RHF/ROHF **/
    ...
    dpd_buf4_init(&L2, PSIF_CC_GL, S.irrep, 0, 7, 2, 7, 0, "LIJAB");
    ...
    dpd_file2_init(&L1, PSIF_CC_GL, S.irrep, 0, 1, "LIA");
    ...
    dpd_buf4_init(&L2, PSIF_CC_GL, S.irrep, 2, 5, 2, 7, 0, "LIJAB");
    ...
    dpd_file2_init(&L1, PSIF_CC_GL, S.irrep, 0, 1, "LIA");
    dpd_file2_init(&T1, PSIF_CC_OEI, 0, 0, 1, "tIA");
    dpd_file2_init(&Z, PSIF_CC_TMP0, S.irrep, 0, 0, "Z(I,M)");
    ...
    dpd_file2_init(&Z, PSIF_CC_TMP0, S.irrep, 1, 1, "Z(A,E)");
    dpd_buf4_init(&T2, PSIF_CC_TAMPS, 0, 2, 5, 2, 7, 0, "tIJAB");
    dpd_buf4_init(&L2, PSIF_CC_GL, S.irrep, 2, 5, 2, 7, 0, "LIJAB");
    ...
    dpd_file2_init(&L1, PSIF_CC_GL, S.irrep, 0, 1, "LIA");
    dpd_file2_copy(&L1, PSIF_CC_TMP, "RTDAI");
    dpd_file2_close(&L1);
    ...
    dpd_file2_init(&D, PSIF_CC_TMP, S.irrep, 2, 2, "RTDij");
    dpd_buf4_init(&T2, PSIF_CC_TAMPS, 0, 10, 17, 12, 17, 0, "tijab");
    dpd_buf4_init(&L2, PSIF_CC_GL, S.irrep, 10, 17, 12, 17, 0, "Lijab");
    dpd_contract442(&T2, &L2, &D, 0, 0, -1.0, 0.0);
    dpd_buf4_close(&L2);
    dpd_buf4_close(&T2);
    ...
    dpd_file2_init(&L1, PSIF_CC_GL, S.irrep, 2, 3, "Lia");
    dpd_contract222(&T1, &L1, &D, 0, 0, -1.0, 1.0);
    dpd_file2_close(&L1);
    dpd_file2_close(&T1);
    dpd_file2_close(&D);
    ...
    dpd_file2_init(&D, PSIF_CC_TMP, S.irrep, 3, 3, "RTDab");
    dpd_buf4_init(&L2, PSIF_CC_GL, S.irrep, 12, 15, 12, 17, 0, "Lijab");
    ...
    dpd_file2_init(&D, PSIF_CC_TMP, S.irrep, 2, 3, "RTDia");
    ...
    dpd_file2_init(&L1, PSIF_CC_GL, S.irrep, 2, 3, "Lia");
    dpd_file2_init(&T1, PSIF_CC_OEI, 0, 2, 3, "tia");
    dpd_file2_init(&Z, PSIF_CC_TMP0, S.irrep, 2, 2, "Z(i,m)");
    dpd_contract222(&T1, &L1, &Z, 0, 0, 1.0, 0.0);
    dpd_file2_close(&L1);
    dpd_contract222(&Z, &T1, &D, 0, 1, -1.0, 1.0);
    dpd_file2_close(&T1);
    ...
    dpd_file2_close(&Z);
    dpd_file2_close(&T1);
    dpd_file2_init(&Z, PSIF_CC_TMP0, S.irrep, 3, 3, "Z(a,e)");
    dpd_buf4_init(&T2, PSIF_CC_TAMPS, 0, 12, 15, 12, 17, 0, "tijab");
    dpd_buf4_init(&L2, PSIF_CC_GL, S.irrep, 12, 15, 12, 17, 0, "Lijab");
    dpd_contract442(&T2, &L2, &Z, 2, 2, 1.0, 0.0);
    dpd_buf4_close(&L2);

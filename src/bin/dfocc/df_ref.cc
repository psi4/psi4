...
void DFOCC::df_ref()
{   
    //psi::fprintf(outfile,"\tComputing DF-BASIS-SCF integrals... \n"); fflush(outfile);
  ...
  long int ntri_cd = function_pairs.size();
      ...
      if ( options_.get_str("SCF_TYPE") == "DF") {
          psi::fprintf(outfile,"\tReading DF integrals from disk ...\n");
  ...
  //psi::fprintf(outfile,"\tDF-BASIS-SCF integrals were done. \n"); fflush(outfile);
} // end df_ref

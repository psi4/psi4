...
void DFOCC::ccsd_WmbejT2()
{
    ...
    /*
    // print
    X = SharedTensor2d(new Tensor2d("W (MJ|BE)", naoccA, naoccA, navirA, navirA));
    // MEJB -> MJBE (1342)
    X->sort(1342, W, 1.0, 0.0);
    X->print();
    X.reset();
    */
...
void DFOCC::ccsd_WmbjeT2()
{
    ...
    /*
    // print
    X = SharedTensor2d(new Tensor2d("Wp (MJ|BE)", naoccA, naoccA, navirA, navirA));
    // MEJB -> MJBE (1342)
    X->sort(1342, W, 1.0, 0.0);
    X->print();
    X.reset();

...
void DFOCC::omp2_manager()
{
  ...
  if (conver == 1) {
	...
	fprintf(outfile,"\tDF-HF Energy (a.u.)                : %20.14f\n", Escf);
	fprintf(outfile,"\tREF Energy (a.u.)                  : %20.14f\n", Eref);
	fprintf(outfile,"\tDF-SCS-OMP2 Total Energy (a.u.)    : %20.14f\n", Escsmp2);
	fprintf(outfile,"\tDF-SOS-OMP2 Total Energy (a.u.)    : %20.14f\n", Esosmp2);
	fprintf(outfile,"\tDF-SCSN-OMP2 Total Energy (a.u.)   : %20.14f\n", Escsnmp2);

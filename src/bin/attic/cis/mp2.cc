...
void mp2(void)
{
  ...
  if(params.ref == 0) { /** RHF **/
    ...
    dpd_buf4_copy(&D, PSIF_CC_MISC, "MP2 tIjAb");
    dpd_buf4_close(&D);
    ...
    dpd_buf4_copy(&T2, PSIF_CC_MISC, "New MP2 tIjAb");
    dpd_buf4_close(&T2);
    ...
    for(iter=1; iter < params.maxiter; iter++) {
      ...
      dpd_buf4_init(&D, PSIF_CC_DINTS, 0, 0, 5, 0, 5, 0, "D <ij|ab>");
      dpd_buf4_copy(&D, PSIF_CC_MISC, "New MP2 tIjAb Increment");
      dpd_buf4_close(&D);

      dpd_buf4_init(&newT2, PSIF_CC_MISC, 0, 0, 5, 0, 5, 0, "New MP2 tIjAb Increment");
      dpd_buf4_init(&T2, PSIF_CC_MISC, 0, 0, 5, 0, 5, 0, "MP2 tIjAb");
	...
	dpd_buf4_close(&D);
      ...
      dpd_buf4_init(&newT2, PSIF_CC_MISC, 0, 0, 5, 0, 5, 0, "New MP2 tIjAb");
      dpd_buf4_init(&T2, PSIF_CC_MISC, 0, 0, 5, 0, 5, 0, "New MP2 tIjAb Increment");
	...
	dpd_buf4_init(&T2, PSIF_CC_MISC, 0, 0, 5, 0, 5, 0, "New MP2 tIjAb");
	dpd_buf4_copy(&T2, PSIF_CC_MISC, "MP2 tIjAb");
	dpd_buf4_close(&T2);
      }
    }
    ...
    dpd_buf4_init(&T2, PSIF_CC_MISC, 0, 0, 5, 0, 5, 0, "MP2 tIjAb");
    dpd_buf4_sort(&T2, PSIF_CC_TMP0, pqsr, 0, 5, "MP2 tIjbA");
    dpd_buf4_copy(&T2, PSIF_CC_MISC, "MP2 2 tIjAb - tIjbA");
    dpd_buf4_close(&T2);
    dpd_buf4_init(&T2, PSIF_CC_MISC, 0, 0, 5, 0, 5, 0, "MP2 2 tIjAb - tIjbA");
    dpd_buf4_scm(&T2, 2);
    dpd_buf4_init(&Z, PSIF_CC_TMP0, 0, 0, 5, 0, 5, 0, "MP2 tIjbA");
    ...
    dpd_buf4_copy(&D, PSIF_CC_MISC, "MP2 tIJAB");
    dpd_buf4_close(&D);
    dpd_buf4_init(&T2, PSIF_CC_MISC, 0, 2, 7, 2, 7, 0, "MP2 tIJAB");
    dpd_buf4_init(&D, PSIF_CC_DENOM, 0, 1, 6, 1, 6, 0, "dIJAB");
    dpd_buf4_dirprd(&D, &T2);
    dpd_buf4_close(&D);
    dpd_buf4_close(&T2);
    ...
    dpd_buf4_copy(&D, PSIF_CC_MISC, "MP2 tijab");
    dpd_buf4_close(&D);
    dpd_buf4_init(&T2, PSIF_CC_MISC, 0, 12, 17, 12, 17, 0, "MP2 tijab");
    dpd_buf4_init(&D, PSIF_CC_DENOM, 0, 11, 16, 11, 16, 0, "dijab");
    dpd_buf4_dirprd(&D, &T2);
    dpd_buf4_close(&D);
    dpd_buf4_close(&T2);
    ...
    dpd_buf4_init(&D, PSIF_CC_DENOM, 0, 22, 28, 22, 28, 0, "dIjAb");
    dpd_buf4_dirprd(&D, &T2);
    dpd_buf4_close(&D);
    dpd_buf4_close(&T2);
  }

...
*/
#ifndef _psi_src_bin_lmp2_moinfo_h_
#define _psi_src_bin_lmp2_moinfo_h_
...
struct aoinfo { 
  ...
  double *evals;         /* SCF Eigenvalues in tha AO basis */

  double **ovlp;         /* Overlap Matrix in the AO basis */
  double **F;            /* Fock matrix in the AO basis */
  double **D;            /* One-particle density matrix */

};

struct paoinfo {

  double **ovlp;	 /* Overlap matrix in the projected AO basis */
  double **F;		 /* Fock matrix in the projected AO basis */

...
prefix = Path(r"/storage/home/hcoda1/9/jpederson6/p-jmcdaniel43-0/rich_project_chem-mcdaniel/developmental/psi4/build/stage".replace("\\", "/"))
cmake_install_bindir = r"bin".replace("\\", "/")
cmake_install_datadir = r"share".replace("\\", "/")
cmake_install_libdir = r"lib".replace("\\", "/")
pymod_install_libdir = r"/".lstrip("/")
...
if "OFF".upper() in ["1", "ON", "YES", "TRUE", "Y"]:  # PCMSolver
    sys.path.insert(1, r"")
if "OFF".upper() in ["1", "ON", "YES", "TRUE", "Y"]:  # cppe
    sys.path.insert(1, r"")
if "OFF".upper() in ["1", "ON", "YES", "TRUE", "Y"]:  # pyddx
    sys.path.insert(1, r"")
if "OFF".upper() in ["1", "ON", "YES", "TRUE", "Y"]:  # pylibefp
    sys.path.insert(1, r"")
if "OFF".upper() in ["1", "ON", "YES", "TRUE", "Y"]:  # gdma
    sys.path.insert(1, r"")
if "".upper() in ["1", "ON", "YES", "TRUE", "Y"]:  # bse
    sys.path.insert(1, r"")

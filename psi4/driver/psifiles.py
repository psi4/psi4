...
PSIF_DFOCC_IABC_AAAA        =  283  # DFOCC <IA||BC>
PSIF_DFOCC_IJAB_AAAA        =  284  # DFOCC <IJ||AB>
PSIF_DFOCC_IABC_BBBB        =  285  # DFOCC <ia||bc>
PSIF_DFOCC_IJAB_BBBB        =  286  # DFOCC <ij||ab>
PSIF_DFOCC_IABC_BABA        =  287  # DFOCC <iA|bC>
PSIF_DFOCC_IABC_ABAB        =  288  # DFOCC <Ia|Bc>
PSIF_DFOCC_IJAB_ABAB        =  289  # DFOCC <Ij|Ab>
PSIF_DFOCC_MIABC_AAAA       =  290  # DFOCC M_IABC
PSIF_DFOCC_MIABC_BBBB       =  291  # DFOCC M_iabc
...
PSIF_DLPNO_QAB_PAO          =  310  # DLPNO (Q|uv)
PSIF_DLPNO_QIA_PNO          =  311  # DLPNO (Q_ij|m_ij a_ij)
PSIF_DLPNO_QAB_PNO          =  312  # DLPNO (Q_ij|a_ij b_ij)
PSIF_DLPNO_TRIPLES          =  313  # DLPNO X_{ijk}^{abc}

...
def run_adcc_property(name, **kwargs):
    ...
    for excitation in state.excitations:
        ...
        # wfn.set_variable("ADC ROOT 0 (IN h) -> ROOT m (IN i) EXCITATION ENERGY")       # P::e ADC
        ...
        # wfn.set_array_variable("ADC ROOT 0 (IN h) -> ROOT m (IN i) ELECTRIC TRANSITION DIPOLE MOMENT (LEN)")        # P::e ADC
        ...
        # wfn.set_array_variable("ADC ROOT m DIPOLE MOMENT")                # P::e ADC
        # wfn.set_array_variable("ADC ROOT m (IN i) DIPOLE MOMENT")                # P::e ADC
        # wfn.set_array_variable("ADC ROOT m (i) DIPOLE MOMENT")                # P::e ADC
        # wfn.set_array_variable("ADC ROOT m DIPOLE MOMENT - h TRANSITION")                # P::e ADC
        # wfn.set_variable("ADC ROOT 0 -> ROOT m OSCILLATOR STRENGTH (LEN)")               # P::e ADC
        # wfn.set_variable("ADC ROOT 0 (IN h) -> ROOT m (IN i) OSCILLATOR STRENGTH (LEN)")       # P::e ADC
        ...
        # wfn.set_variable("ADC ROOT 0 (IN h) -> ROOT m (IN i) OSCILLATOR STRENGTH (VEL)")       # P::e ADC
        ...
        # wfn.set_variable("ADC ROOT 0 (IN h) -> ROOT m (IN i) ROTATORY STRENGTH (VEL)")       # P::e ADC

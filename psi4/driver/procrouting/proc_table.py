...
procedures = {
    'energy': {
        ...
        'dlpno-mp2'     : proc.run_dlpno,
        'scs-dlpno-mp2' : proc.run_dlpno,
        ...
        'acpf'          : proc.run_cepa,
        'aqcc'          : proc.run_cepa,
        'dlpno-ccsd'    : proc.run_dlpno,
        'dlpno-ccsd(t0)': proc.run_dlpno,
        'dlpno-ccsd(t)' : proc.run_dlpno,
        'dlpno-ccsdt'   : proc.run_dlpno,

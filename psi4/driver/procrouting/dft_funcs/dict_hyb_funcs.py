...
funcs.append({
    ...
    "x_functionals": {"LDA_X": {"alpha": 0.08}, "GGA_X_B88": {"alpha": 0.42}},
    "x_hf": {"alpha": 0.50},
...
funcs.append({
    ...
    "x_functionals": {"GGA_X_HJS_PBE": {"omega": 0.3, "alpha": 0.75}},
    "x_hf": {"alpha": 0.25, "beta": 1.0, "omega": 0.3},
...
funcs.append({
    ...
    "citation": '    Henderson et. al., J. Chem. Phys., 128, 194105, 2008\n    Weintraub, Henderson, and Scuseria, J. Chem. Theory. Comput., 5, 754, 2009\n',
    "x_functionals": {"GGA_X_HJS_PBE": {"omega": 0.4}},
    "x_hf": {"alpha": 0.0, "beta": 1.0, "omega": 0.4},
    "c_functionals": {"GGA_C_PBE": {}},
})
...
funcs.append({
    ...
    "x_functionals": {"HYB_GGA_XC_WB97X": {"omega": 0.25}},
    "x_hf": {"alpha": 0.195728, "beta": 1.0, "omega": 0.25},
    "c_functionals": {},
    "dispersion": {"type": "d3zero", "params": {'s6': 1.0,  's8': 1.000, 'sr6': 1.281, 'sr8': 1.094, 'alpha6': 14.0}}
})
...
funcs.append({
    ...
    "x_functionals": {"GGA_X_PBE": {"tweak": [1.0245, 0.12345679], "alpha": 0.58}},
    "x_hf": {"alpha": 0.42},
...
funcs.append({
    ...
    "x_functionals": {"GGA_X_PW91": {"tweak": get_pw6b95_tweaks(), "alpha": 0.72}},
    "x_hf": {"alpha": 0.28},
    "c_functionals": {"MGGA_C_BC95": {"tweak": [0.03668, 0.00262]}},
})
...
funcs.append({
    ...
    "x_functionals": {"HYB_MGGA_X_DLDF": {"use_libxc": True}},
    "c_functionals": {"MGGA_C_DLDF": {}},
    "dispersion": {"type": "das2009", "params": {"s6": 1.0}}
})

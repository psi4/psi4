...
def davidson_solver(ax_function,
    ...
    print("options:")
    for k, v in dict(
            e_conv=e_conv, r_conv=r_conv, no_eigs=no_eigs, max_vecs_per_root=max_vecs_per_root,
            maxiter=maxiter).items():
        if v == None:
            v = 'None'
...
def non_hermitan_davidson_solver(pm_function,
                                 preconditioner,
                                 guess,
                                 e_conv=1.0E-8,
                                 r_conv=None,

...
from psi4.driver.procedures import *  # noqa: F403
...
def energy(name, **kwargs):
    ...
    :returns: (*float*, :py:class:`~psi4.core.Wavefunction`) |w--w| energy and
        wavefunction when **return_wfn** specified.
    ...
    """
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | name                    | calls method                                                                                                  |'  # noqa: E501
    '\n    +=========================+===============================================================================================================+'  # noqa: E501
    '\n    | efp                     | effective fragment potential (EFP) :ref:`[manual] <sec:libefp>`                                               |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | scf                     | Hartree--Fock (HF) or density functional theory (DFT) :ref:`[manual] <sec:scf>`                               |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | hf                      | HF self consistent field (SCF) :ref:`[manual] <sec:scf>`                                                      |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | dcft                    | density cumulant functional theory :ref:`[manual] <sec:dcft>`                                                 |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | mp2                     | 2nd-order |MollerPlesset| perturbation theory (MP2) :ref:`[manual] <sec:dfmp2>` :ref:`[details] <tlmp2>`      |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | mp3                     | 3rd-order |MollerPlesset| perturbation theory (MP3) :ref:`[manual] <sec:occ_nonoo>` :ref:`[details] <tlmp3>`  |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | fno-mp3                 | MP3 with frozen natural orbitals :ref:`[manual] <sec:fnocc>`                                                  |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | mp2.5                   | average of MP2 and MP3 :ref:`[manual] <sec:occ_nonoo>` :ref:`[details] <tlmp25>`                              |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | mp4(sdq)                | 4th-order MP perturbation theory (MP4) less triples :ref:`[manual] <sec:fnompn>`                              |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | fno-mp4(sdq)            | MP4 (less triples) with frozen natural orbitals :ref:`[manual] <sec:fnocc>`                                   |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | mp4                     | full MP4 :ref:`[manual] <sec:fnompn>` :ref:`[details] <tlmp4>`                                                |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | fno-mp4                 | full MP4 with frozen natural orbitals :ref:`[manual] <sec:fnocc>`                                             |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | mp\ *n*                 | *n*\ th-order |MollerPlesset| (MP) perturbation theory :ref:`[manual] <sec:arbpt>`                            |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | zapt\ *n*               | *n*\ th-order z-averaged perturbation theory (ZAPT) :ref:`[manual] <sec:arbpt>`                               |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | omp2                    | orbital-optimized second-order MP perturbation theory :ref:`[manual] <sec:occ_oo>`                            |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | scs-omp2                | spin-component scaled OMP2 :ref:`[manual] <sec:occ_oo>`                                                       |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | scs(n)-omp2             | a special version of SCS-OMP2 for nucleobase interactions :ref:`[manual] <sec:occ_oo>`                        |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | scs-omp2-vdw            | a special version of SCS-OMP2 (from ethene dimers) :ref:`[manual] <sec:occ_oo>`                               |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | sos-omp2                | spin-opposite scaled OMP2 :ref:`[manual] <sec:occ_oo>`                                                        |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | sos-pi-omp2             | A special version of SOS-OMP2 for pi systems :ref:`[manual] <sec:occ_oo>`                                     |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | omp3                    | orbital-optimized third-order MP perturbation theory :ref:`[manual] <sec:occ_oo>`                             |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | scs-omp3                | spin-component scaled OMP3 :ref:`[manual] <sec:occ_oo>`                                                       |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | scs(n)-omp3             | a special version of SCS-OMP3 for nucleobase interactions :ref:`[manual] <sec:occ_oo>`                        |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | scs-omp3-vdw            | a special version of SCS-OMP3 (from ethene dimers) :ref:`[manual] <sec:occ_oo>`                               |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | sos-omp3                | spin-opposite scaled OMP3 :ref:`[manual] <sec:occ_oo>`                                                        |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | sos-pi-omp3             | A special version of SOS-OMP3 for pi systems :ref:`[manual] <sec:occ_oo>`                                     |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | omp2.5                  | orbital-optimized MP2.5 :ref:`[manual] <sec:occ_oo>`                                                          |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | lccsd, cepa(0)          | coupled electron pair approximation variant 0 :ref:`[manual] <sec:fnocepa>` :ref:`[details] <tllccsd>`        |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | fno-lccsd, fno-cepa(0)  | CEPA(0) with frozen natural orbitals :ref:`[manual] <sec:fnocc>`                                              |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | cepa(1)                 | coupled electron pair approximation variant 1 :ref:`[manual] <sec:fnocepa>`                                   |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | fno-cepa(1)             | CEPA(1) with frozen natural orbitals :ref:`[manual] <sec:fnocc>`                                              |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | cepa(3)                 | coupled electron pair approximation variant 3 :ref:`[manual] <sec:fnocepa>`                                   |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | fno-cepa(3)             | CEPA(3) with frozen natural orbitals :ref:`[manual] <sec:fnocc>`                                              |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | acpf                    | averaged coupled-pair functional :ref:`[manual] <sec:fnocepa>`                                                |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | fno-acpf                | ACPF with frozen natural orbitals :ref:`[manual] <sec:fnocc>`                                                 |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | aqcc                    | averaged quadratic coupled cluster :ref:`[manual] <sec:fnocepa>`                                              |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | fno-aqcc                | AQCC with frozen natural orbitals :ref:`[manual] <sec:fnocc>`                                                 |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | qcisd                   | quadratic CI singles doubles (QCISD) :ref:`[manual] <sec:fnocc>`                                              |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | fno-qcisd               | QCISD with frozen natural orbitals :ref:`[manual] <sec:fnocc>`                                                |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | lccd                    | Linear CCD :ref:`[manual] <sec:occ_nonoo>` :ref:`[details] <tllccd>`                                          |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | fno-lccd                | LCCD with frozen natural orbitals :ref:`[manual] <sec:fnocc>`                                                 |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | olccd                   | orbital optimized LCCD :ref:`[manual] <sec:occ_oo>`                                                           |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | cc2                     | approximate coupled cluster singles and doubles (CC2) :ref:`[manual] <sec:cc>`                                |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | ccd                     | coupled cluster doubles  (CCD) :ref:`[manual] <sec:occ_nonoo>`                                                |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | ccsd                    | coupled cluster singles and doubles (CCSD) :ref:`[manual] <sec:cc>` :ref:`[details] <tlccsd>`                 |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | bccd                    | Brueckner coupled cluster doubles (BCCD) :ref:`[manual] <sec:cc>`                                             |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | fno-ccsd                | CCSD with frozen natural orbitals :ref:`[manual] <sec:fnocc>`                                                 |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | qcisd(t)                | QCISD with perturbative triples :ref:`[manual] <sec:fnocc>`                                                   |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | fno-qcisd(t)            | QCISD(T) with frozen natural orbitals :ref:`[manual] <sec:fnocc>`                                             |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | ccsd(t)                 | CCSD with perturbative triples (CCSD(T)) :ref:`[manual] <sec:cc>` :ref:`[details] <tlccsdt>`                  |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | ccsd(at)                | CCSD with asymmetric perturbative triples (CCSD(AT)) :ref:`[manual] <sec:cc>` :ref:`[details] <tlccsdat>`     |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | bccd(t)                 | BCCD with perturbative triples :ref:`[manual] <sec:cc>`                                                       |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | fno-ccsd(t)             | CCSD(T) with frozen natural orbitals :ref:`[manual] <sec:fnocc>`                                              |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | cc3                     | approximate CC singles, doubles, and triples (CC3) :ref:`[manual] <sec:cc>`                                   |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | ccenergy                | **expert** full control over ccenergy module                                                                  |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | dfocc                   | **expert** full control over dfocc module                                                                     |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | cisd                    | configuration interaction (CI) singles and doubles (CISD) :ref:`[manual] <sec:ci>` :ref:`[details] <tlcisd>`  |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | fno-cisd                | CISD with frozen natural orbitals :ref:`[manual] <sec:fnocc>`                                                 |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | cisdt                   | CI singles, doubles, and triples (CISDT) :ref:`[manual] <sec:ci>`                                             |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | cisdtq                  | CI singles, doubles, triples, and quadruples (CISDTQ) :ref:`[manual] <sec:ci>`                                |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | ci\ *n*                 | *n*\ th-order CI :ref:`[manual] <sec:ci>`                                                                     |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | fci                     | full configuration interaction (FCI) :ref:`[manual] <sec:ci>`                                                 |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | detci                   | **expert** full control over detci module                                                                     |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | casscf                  | complete active space self consistent field (CASSCF)  :ref:`[manual] <sec:ci>`                                |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | rasscf                  | restricted active space self consistent field (RASSCF)  :ref:`[manual] <sec:ci>`                              |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | mcscf                   | multiconfigurational self consistent field (SCF) :ref:`[manual] <sec:psimrcc>`                                |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | psimrcc                 | Mukherjee multireference coupled cluster (Mk-MRCC) :ref:`[manual] <sec:psimrcc>`                              |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | dmrg-scf                | density matrix renormalization group SCF :ref:`[manual] <sec:chemps2>`                                        |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | dmrg-caspt2             | density matrix renormalization group CASPT2 :ref:`[manual] <sec:chemps2>`                                     |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | dmrg-ci                 | density matrix renormalization group CI :ref:`[manual] <sec:chemps2>`                                         |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | sapt0                   | 0th-order symmetry adapted perturbation theory (SAPT) :ref:`[manual] <sec:sapt>`                              |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | ssapt0                  | 0th-order SAPT with special exchange scaling :ref:`[manual] <sec:sapt>`                                       |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | fisapt0                 | 0th-order functional and/or intramolecular SAPT :ref:`[manual] <sec:fisapt>`                                  |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | sapt2                   | 2nd-order SAPT, traditional definition :ref:`[manual] <sec:sapt>`                                             |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | sapt2+                  | SAPT including all 2nd-order terms :ref:`[manual] <sec:sapt>`                                                 |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | sapt2+(3)               | SAPT including perturbative triples :ref:`[manual] <sec:sapt>`                                                |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | sapt2+3                 | SAPT including all 3rd-order terms :ref:`[manual] <sec:sapt>`                                                 |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | sapt2+(ccd)             | SAPT2+ with CC-based dispersion :ref:`[manual] <sec:sapt>`                                                    |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | sapt2+(3)(ccd)          | SAPT2+(3) with CC-based dispersion :ref:`[manual] <sec:sapt>`                                                 |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | sapt2+3(ccd)            | SAPT2+3 with CC-based dispersion :ref:`[manual] <sec:sapt>`                                                   |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | sapt2+dmp2              | SAPT including all 2nd-order terms and MP2 correction :ref:`[manual] <sec:sapt>`                              |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | sapt2+(3)dmp2           | SAPT including perturbative triples and MP2 correction :ref:`[manual] <sec:sapt>`                             |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | sapt2+3dmp2             | SAPT including all 3rd-order terms and MP2 correction :ref:`[manual] <sec:sapt>`                              |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | sapt2+(ccd)dmp2         | SAPT2+ with CC-based dispersion and MP2 correction :ref:`[manual] <sec:sapt>`                                 |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | sapt2+(3)(ccd)dmp2      | SAPT2+(3) with CC-based dispersion and MP2 correction :ref:`[manual] <sec:sapt>`                              |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | sapt2+3(ccd)dmp2        | SAPT2+3 with CC-based dispersion and MP2 correction :ref:`[manual] <sec:sapt>`                                |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | sapt0-ct                | 0th-order SAPT plus charge transfer (CT) calculation :ref:`[manual] <sec:saptct>`                             |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | sapt2-ct                | SAPT2 plus CT :ref:`[manual] <sec:saptct>`                                                                    |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | sapt2+-ct               | SAPT2+ plus CT :ref:`[manual] <sec:saptct>`                                                                   |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | sapt2+(3)-ct            | SAPT2+(3) plus CT :ref:`[manual] <sec:saptct>`                                                                |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | sapt2+3-ct              | SAPT2+3 plus CT :ref:`[manual] <sec:saptct>`                                                                  |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | sapt2+(ccd)-ct          | SAPT2+(CCD) plus CT :ref:`[manual] <sec:saptct>`                                                              |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | sapt2+(3)(ccd)-ct       | SAPT2+(3)(CCD) plus CT :ref:`[manual] <sec:saptct>`                                                           |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | sapt2+3(ccd)-ct         | SAPT2+3(CCD) plus CT :ref:`[manual] <sec:saptct>`                                                             |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | adc                     | 2nd-order algebraic diagrammatic construction (ADC) :ref:`[manual] <sec:adc>`                                 |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | eom-cc2                 | EOM-CC2 :ref:`[manual] <sec:eomcc>`                                                                           |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | eom-ccsd                | equation of motion (EOM) CCSD :ref:`[manual] <sec:eomcc>`                                                     |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | eom-cc3                 | EOM-CC3 :ref:`[manual] <sec:eomcc>`                                                                           |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    """
...
def gradient(name, **kwargs):
    ...
    :returns: (:py:class:`~psi4.core.Matrix`, :py:class:`~psi4.core.Wavefunction`)
        |w--w| gradient and wavefunction when **return_wfn** specified.
...
def property(name, **kwargs):
    ...
    """
    '\n    +--------------------+-----------------------------------------------+----------------+---------------------------------------------------------------+'  # noqa: E501
    '\n    | Name               | Calls Method                                  | Reference      | Supported Properties                                          |'  # noqa: E501
    '\n    +====================+===============================================+================+===============================================================+'  # noqa: E501
    '\n    | scf                | Self-consistent field method(s)               | RHF/ROHF/UHF   | Listed :ref:`here <sec:oeprop>`                               |'  # noqa: E501
    '\n    +--------------------+-----------------------------------------------+----------------+---------------------------------------------------------------+'  # noqa: E501
    '\n    | hf                 | HF Self-consistent field method(s)            | RHF/ROHF/UHF   | Listed :ref:`here <sec:oeprop>`                               |'  # noqa: E501
    '\n    +--------------------+-----------------------------------------------+----------------+---------------------------------------------------------------+'  # noqa: E501
    '\n    | mp2                | MP2 with density fitting only (mp2_type df)   | RHF            | Listed :ref:`here <sec:oeprop>`                               |'  # noqa: E501
    '\n    +--------------------+-----------------------------------------------+----------------+---------------------------------------------------------------+'  # noqa: E501
    '\n    | cc2                | 2nd-order approximate CCSD                    | RHF            | dipole, quadrupole, polarizability, rotation, roa_tensor      |'  # noqa: E501
    '\n    +--------------------+-----------------------------------------------+----------------+---------------------------------------------------------------+'  # noqa: E501
    '\n    | ccsd               | Coupled cluster singles and doubles (CCSD)    | RHF            | dipole, quadrupole, polarizability, rotation, roa_tensor      |'  # noqa: E501
    '\n    +--------------------+-----------------------------------------------+----------------+---------------------------------------------------------------+'  # noqa: E501
    '\n    | eom-cc2            | 2nd-order approximate EOM-CCSD                | RHF            | oscillator_strength, rotational_strength                      |'  # noqa: E501
    '\n    +--------------------+-----------------------------------------------+----------------+---------------------------------------------------------------+'  # noqa: E501
    '\n    | eom-ccsd           | Equation-of-motion CCSD (EOM-CCSD)            | RHF            | oscillator_strength, rotational_strength                      |'  # noqa: E501
    '\n    +--------------------+-----------------------------------------------+----------------+---------------------------------------------------------------+'  # noqa: E501
    '\n    | cisd, cisdt,       | Configuration interaction                     | RHF/ROHF       | Listed :ref:`here <sec:oeprop>`, transition_dipole,           |'  # noqa: E501
    '\n    | cisdt, cisdtq,     |                                               |                | transition_quadrupole                                         |'  # noqa: E501
    '\n    | ci5, ..., fci      |                                               |                |                                                               |'  # noqa: E501
    '\n    +--------------------+-----------------------------------------------+----------------+---------------------------------------------------------------+'  # noqa: E501
    '\n    | casscf, rasscf     | Multi-configurational SCF                     | RHF/ROHF       | Listed :ref:`here <sec:oeprop>`, transition_dipole,           |'  # noqa: E501
    '\n    |                    |                                               |                | transition_quadrupole                                         |'  # noqa: E501
    '\n    +--------------------+-----------------------------------------------+----------------+---------------------------------------------------------------+'  # noqa: E501
    """
...
def optimize(name, **kwargs):
    ...
    '\n    | name                    | calls method                                                                                                  |'  # noqa: E501
    '\n    +=========================+===============================================================================================================+'  # noqa: E501
    '\n    | efp                     | efp-only optimizations                                                                                        |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | scf                     | Hartree--Fock (HF) or density functional theory (DFT) :ref:`[manual] <sec:scf>`                               |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    '\n    | hf                      | HF self consistent field (SCF) :ref:`[manual] <sec:scf>`                                                      |'  # noqa: E501
    ...
    while n <= core.get_option('OPTKING', 'GEOM_MAXITER'):
        ...
        if optking_rval == core.PsiReturnType.EndLoop:
            ...
            if core.get_option('OPTKING', 'INTCOS_GENERATE_EXIT') == False:  # noqa: E712
                if core.get_option('OPTKING', 'KEEP_INTCOS') == False:  # noqa: E712
                    core.opt_clean()
...
def hessian(name, **kwargs):
    ...
    :returns: :py:class:`~psi4.core.Matrix` |w--w| Total non-mass-weighted
        electronic Hessian in Hartrees/Bohr/Bohr.

    :returns: (:py:class:`~psi4.core.Matrix`, :py:class:`~psi4.core.Wavefunction`)
        |w--w| Hessian and wavefunction when **return_wfn** specified.
        ...
        for n, displacement in enumerate(displacements):
            ...
            # S/R: Write each displaced geometry to an input file
                ...
                with open('%s.in' % (rfile), 'wb') as freagent:
                    ...
                    freagent.write("""core.print_out('\\nHESSIAN RESULT: computation %d for item %d """ %
                                   (os.getpid(), n + 1))
            ...
            # S/R: Read energy from each displaced geometry output file and save in energies array
                ...
                exec(banners)
                core.set_variable('NUCLEAR REPULSION ENERGY', moleculeclone.nuclear_repulsion_energy())
                pygrad = p4util.extract_sowreap_from_output(rfile, 'HESSIAN', n, freq_linkage, True,
                                                            label='electronic gradient')
...
def frequency(name, **kwargs):
    ...
    '\n    | name                    | calls method                                                                                                  |'  # noqa: E501
    '\n    +=========================+===============================================================================================================+'  # noqa: E501
    '\n    | scf                     | Hartree--Fock (HF) :ref:`[manual] <sec:scf>`                                                                  |'  # noqa: E501
    '\n    +-------------------------+---------------------------------------------------------------------------------------------------------------+'  # noqa: E501
    """
    :examples:
    ...
    if old_global_basis is not None:
...
def molden(wfn, filename=None, density_a=None, density_b=None, dovirtual=None):
    ...
    :type dovirtual: bool
    :param dovirtual: do write all the MOs to the MOLDEN file (true) or discard
        the unoccupied MOs, not valid for NO's (false) (optional)

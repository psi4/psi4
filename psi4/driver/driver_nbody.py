...
#from . import driver_nbody_multilevel,
from . import p4util
...
def _old_sum_cluster_ptype_data(
    ptype: DriverEnum,
    ptype_dict: Dict,
...
def _old_print_nbody_energy(energy_body_dict: Dict[int, float], header: str, nfragments: int, embedding: bool = False):
...
def old_build_nbody_compute_list(
...
def old_assemble_nbody_components(
    ptype: DriverEnum,
...
class old_ManyBodyComputer(BaseComputer):
...
class new_BaseComputerQCNG(ProtoModel):
...
class replaced_in_p4_new_AtomicComputerQCNG(BaseComputer):
...
# comp_levels={1: 'mp2/sto-3g', 2: 'scf/sto-3g'}
# {'(auto)': {'program': 'psi4',
#             'specification': {'driver': <DriverEnum.energy: 'energy'>,
#                               'keywords': {'CC_TYPE': 'DF',
#                                            'DF_BASIS_MP2': 'DEF2-QZVPP-RI',
#                                            'function_kwargs': {}},
#                               'model': {'basis': '(auto)', 'method': ''}}}}

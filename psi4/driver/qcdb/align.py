...
def B787(cgeom,
    ...
    """
    warnings.warn(
        "Using `qcdb.align.B787` instead of `qcdb.molutil.B787` is deprecated, and in 1.5 it will stop working\n",
...
def compute_scramble(nat, do_resort=True, do_shift=True, do_rotate=True, deflection=1.0, do_mirror=False):
    ...
    """
    warnings.warn(
        "Using `qcdb.align.compute_scramble` instead of `qcdb.molutil.compute_scramble` is deprecated, and in 1.5 it will stop working\n",
        category=FutureWarning,
        stacklevel=2)

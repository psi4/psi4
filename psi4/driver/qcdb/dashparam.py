...
dashcoeff = {
    ...
    'd2gr': {
        ...
        'b2gpplyp'    : {'s6': 0.4,  'alpha6': 20.0},
        'dsd-blyp'    : {'s6': 0.41, 'alpha6': 60.0},
        'core-dsd-blyp'    : {'s6': 0.41, 'alpha6': 60.0},
    },
    'd3zero': {
        'hf'          : {'s6': 1.0,  's8': 1.746, 'sr6': 1.158, 'sr8': 1.000, 'alpha6': 14.0},
        'b1b95'       : {'s6': 1.0,  's8': 1.868, 'sr6': 1.613, 'sr8': 1.000, 'alpha6': 14.0},
        'b2gpplyp'    : {'s6': 0.56, 's8': 0.760, 'sr6': 1.586, 'sr8': 1.000, 'alpha6': 14.0},
        'b3lyp'       : {'s6': 1.0,  's8': 1.703, 'sr6': 1.261, 'sr8': 1.000, 'alpha6': 14.0},
        'b97-d'       : {'s6': 1.0,  's8': 0.909, 'sr6': 0.892, 'sr8': 1.000, 'alpha6': 14.0},
        'bhlyp'       : {'s6': 1.0,  's8': 1.442, 'sr6': 1.370, 'sr8': 1.000, 'alpha6': 14.0},
        'blyp'        : {'s6': 1.0,  's8': 1.682, 'sr6': 1.094, 'sr8': 1.000, 'alpha6': 14.0},
        'bp86'        : {'s6': 1.0,  's8': 1.683, 'sr6': 1.139, 'sr8': 1.000, 'alpha6': 14.0},
        'bpbe'        : {'s6': 1.0,  's8': 2.033, 'sr6': 1.087, 'sr8': 1.000, 'alpha6': 14.0},
        'mpwlyp'      : {'s6': 1.0,  's8': 1.098, 'sr6': 1.239, 'sr8': 1.000, 'alpha6': 14.0},
        ...
        'tpssh'       : {'s6': 1.0,  's8': 1.219, 'sr6': 1.223, 'sr8': 1.000, 'alpha6': 14.0},
        'bop'         : {'s6': 1.0,  's8': 1.975, 'sr6': 0.929, 'sr8': 1.000, 'alpha6': 14.0},
        'mpw1b95'     : {'s6': 1.0,  's8': 1.118, 'sr6': 1.605, 'sr8': 1.000, 'alpha6': 14.0},
        'mpwb1k'      : {'s6': 1.0,  's8': 1.061, 'sr6': 1.671, 'sr8': 1.000, 'alpha6': 14.0},
        'olyp'        : {'s6': 1.0,  's8': 1.764, 'sr6': 0.806, 'sr8': 1.000, 'alpha6': 14.0},
        'opbe'        : {'s6': 1.0,  's8': 2.055, 'sr6': 0.837, 'sr8': 1.000, 'alpha6': 14.0},
        ...
        'b3pw91'      : {'s6': 1.0,  's8': 1.775, 'sr6': 1.176, 'sr8': 1.000, 'alpha6': 14.0},
        'bmk'         : {'s6': 1.0,  's8': 2.168, 'sr6': 1.931, 'sr8': 1.000, 'alpha6': 14.0},
        'camb3lyp'    : {'s6': 1.0,  's8': 1.217, 'sr6': 1.378, 'sr8': 1.000, 'alpha6': 14.0},
        'lcwpbe'      : {'s6': 1.0,  's8': 1.279, 'sr6': 1.355, 'sr8': 1.000, 'alpha6': 14.0},
        'm05-2x'      : {'s6': 1.0,  's8': 0.00 , 'sr6': 1.417, 'sr8': 1.000, 'alpha6': 14.0},
        'm05'         : {'s6': 1.0,  's8': 0.595, 'sr6': 1.373, 'sr8': 1.000, 'alpha6': 14.0},
        'm06-2x'      : {'s6': 1.0,  's8': 0.00 , 'sr6': 1.619, 'sr8': 1.000, 'alpha6': 14.0},
        'm06hf'       : {'s6': 1.0,  's8': 0.00 , 'sr6': 1.446, 'sr8': 1.000, 'alpha6': 14.0},
        'm06-l'       : {'s6': 1.0,  's8': 0.00 , 'sr6': 1.581, 'sr8': 1.000, 'alpha6': 14.0},
        'm06'         : {'s6': 1.0,  's8': 0.00 , 'sr6': 1.325, 'sr8': 1.000, 'alpha6': 14.0},
        'hcth120'     : {'s6': 1.0,  's8': 1.206, 'sr6': 1.221, 'sr8': 1.000, 'alpha6': 14.0},
        'b2plyp'      : {'s6': 0.64, 's8': 1.022, 'sr6': 1.427, 'sr8': 1.000, 'alpha6': 14.0},
        'dsd-blyp'    : {'s6': 0.50, 's8': 0.705, 'sr6': 1.569, 'sr8': 1.000, 'alpha6': 14.0},
        'ptpss'       : {'s6': 0.75, 's8': 0.879, 'sr6': 1.541, 'sr8': 1.000, 'alpha6': 14.0},
        'pwpb95'      : {'s6': 0.82, 's8': 0.705, 'sr6': 1.557, 'sr8': 1.000, 'alpha6': 14.0},
        'revpbe0'     : {'s6': 1.0,  's8': 0.792, 'sr6': 0.949, 'sr8': 1.000, 'alpha6': 14.0},
        'revpbe38'    : {'s6': 1.0,  's8': 0.862, 'sr6': 1.021, 'sr8': 1.000, 'alpha6': 14.0},
        'rpw86pbe'    : {'s6': 1.0,  's8': 0.901, 'sr6': 1.224, 'sr8': 1.000, 'alpha6': 14.0},
        'wb97x'       : {'s6': 1.0,  's8': 1.000, 'sr6': 1.281, 'sr8': 1.094, 'alpha6': 14.0},
    },
    'd3bj': {

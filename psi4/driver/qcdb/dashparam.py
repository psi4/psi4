...
dashcoeff = {
    ...
    'd3zero': {
        'hf'          : {'s6': 1.0,  's8': 1.746, 'sr6': 1.158, 'rs8': 1.000, 'alpha6': 14.0},  
        'b1b95'       : {'s6': 1.0,  's8': 1.868, 'sr6': 1.613, 'rs8': 1.000, 'alpha6': 14.0},
        'b2gpplyp'    : {'s6': 0.56, 's8': 0.760, 'sr6': 1.586, 'rs8': 1.000, 'alpha6': 14.0},
        'b3lyp'       : {'s6': 1.0,  's8': 1.703, 'sr6': 1.261, 'rs8': 1.000, 'alpha6': 14.0},  
        'b97-d'       : {'s6': 1.0,  's8': 0.909, 'sr6': 0.892, 'rs8': 1.000, 'alpha6': 14.0},  
        'bhlyp'       : {'s6': 1.0,  's8': 1.442, 'sr6': 1.370, 'rs8': 1.000, 'alpha6': 14.0},
        'blyp'        : {'s6': 1.0,  's8': 1.682, 'sr6': 1.094, 'rs8': 1.000, 'alpha6': 14.0},  
        'bp86'        : {'s6': 1.0,  's8': 1.683, 'sr6': 1.139, 'rs8': 1.000, 'alpha6': 14.0},  
        'bpbe'        : {'s6': 1.0,  's8': 2.033, 'sr6': 1.087, 'rs8': 1.000, 'alpha6': 14.0},
        'mpwlyp'      : {'s6': 1.0,  's8': 1.098, 'sr6': 1.239, 'rs8': 1.000, 'alpha6': 14.0},
        'pbe'         : {'s6': 1.0,  's8': 0.722, 'sr6': 1.217, 'rs8': 1.000, 'alpha6': 14.0},  
        'pbe0'        : {'s6': 1.0,  's8': 0.928, 'sr6': 1.287, 'rs8': 1.000, 'alpha6': 14.0},  
        ...
        'm05-2x'      : {'s6': 1.0,  's8': 0.00 , 'sr6': 1.417, 'rs8': 1.000, 'alpha6': 14.0},  
        'm05'         : {'s6': 1.0,  's8': 0.595, 'sr6': 1.373, 'rs8': 1.000, 'alpha6': 14.0},  
        ...
        'hcth120'     : {'s6': 1.0,  's8': 1.206, 'sr6': 1.221, 'rs8': 1.000, 'alpha6': 14.0},  
        'b2plyp'      : {'s6': 0.64, 's8': 1.022, 'sr6': 1.427, 'rs8': 1.000, 'alpha6': 14.0},  
        'dsd-blyp'    : {'s6': 0.50, 's8': 0.705, 'sr6': 1.569, 'rs8': 1.000, 'alpha6': 14.0},  
    ...
    'd3bj': {
        ...
        #   'dsd-blyp'    : {'s6': 0.500, 's8':  0.2112, 'a1':  0.0009, 'a2': 5.9807},   # special params for frozen-core DSD-BLYP version; not published

...
dashcoeff = {
    'd2': {
        ...
        'definitions': {
            ...
            'b97'           : {'s6': 1.25, 'alpha6': 20.0, 'sr6': 1.1},  # formerly b97-d
            'revpbe'        : {'s6': 1.25, 'alpha6': 20.0, 'sr6': 1.1, "citation": '    S. Grimme, J. Antony, S. Ehrlich, H. Krieg, J. Chem. Phys 132, 154104, 2010\n'},
            ...
            'tpss0'         : {'s6': 0.85, 'alpha6': 20.0, 'sr6': 1.1, "citation": '    S. Grimme, J. Antony, S. Ehrlich, H. Krieg, J. Chem. Phys 132, 154104, 2010\n'},
    ...
    'd3zero': {
        ...
        'definitions' : {
            ...
            'pw6b95'      : {'s6': 1.0,  's8': 0.862,  'sr6': 1.532,  'alpha6': 14.0, 'sr8': 1.000},
            'b97'         : {'s6': 1.0,  's8': 0.909,  'sr6': 0.892,  'alpha6': 14.0, 'sr8': 1.000},  # formerly b97-d
            'revpbe'      : {'s6': 1.0,  's8': 1.010,  'sr6': 0.923,  'alpha6': 14.0, 'sr8': 1.000},
            'b3lyp'       : {'s6': 1.0,  's8': 1.703,  'sr6': 1.261,  'alpha6': 14.0, 'sr8': 1.000},
            'blyp'        : {'s6': 1.0,  's8': 1.682,  'sr6': 1.094,  'alpha6': 14.0, 'sr8': 1.000},
            'tpss0'       : {'s6': 1.0,  's8': 1.242,  'sr6': 1.252,  'alpha6': 14.0, 'sr8': 1.000},
            'pbe0'        : {'s6': 1.0,  's8': 0.928,  'sr6': 1.287,  'alpha6': 14.0, 'sr8': 1.000},
            'tpss'        : {'s6': 1.0,  's8': 1.105,  'sr6': 1.166,  'alpha6': 14.0, 'sr8': 1.000},
            'pbe'         : {'s6': 1.0,  's8': 0.722,  'sr6': 1.217,  'alpha6': 14.0, 'sr8': 1.000},
            'bp86'        : {'s6': 1.0,  's8': 1.683,  'sr6': 1.139,  'alpha6': 14.0, 'sr8': 1.000},
        # Later references
            'rpw86pbe'    : {'s6': 1.0,  's8': 0.901,  'sr6': 1.224,  'alpha6': 14.0, 'sr8': 1.000, "citation": '    S. Grimme, S. Ehrlich, L. Goerigk, J. Comput. Chem. 32, 1456-1465, 2011\n'},
            'b2plyp'      : {'s6': 0.64, 's8': 1.022,  'sr6': 1.427,  'alpha6': 14.0, 'sr8': 1.000, "citation": '    L. Goerigk, S. Grimme, J. Chem. Theory Comput. 7, 291-309, 2011\n'},
            'b2gpplyp'    : {'s6': 0.56, 's8': 0.760,  'sr6': 1.586,  'alpha6': 14.0, 'sr8': 1.000, "citation": '    L. Goerigk, S. Grimme, J. Chem. Theory Comput. 7, 291-309, 2011\n'},
            'pwpb95'      : {'s6': 0.82, 's8': 0.705,  'sr6': 1.557,  'alpha6': 14.0, 'sr8': 1.000, "citation": '    L. Goerigk, S. Grimme, J. Chem. Theory Comput. 7, 291-309, 2011\n'},
            'dsd-blyp'    : {'s6': 0.50, 's8': 0.705,  'sr6': 1.569,  'alpha6': 14.0, 'sr8': 1.000, "citation": '    L. Goerigk, S. Grimme, J. Chem. Theory Comput. 7, 291-309, 2011\n'},
            'bpbe'        : {'s6': 1.0,  's8': 2.033,  'sr6': 1.087,  'alpha6': 14.0, 'sr8': 1.000, "citation": '    L. Goerigk, S. Grimme, Phys. Chem. Chem. Phys. 13, 6670-6688, 2011\n'},
            'opbe'        : {'s6': 1.0,  's8': 2.055,  'sr6': 0.837,  'alpha6': 14.0, 'sr8': 1.000, "citation": '    L. Goerigk, S. Grimme, Phys. Chem. Chem. Phys. 13, 6670-6688, 2011\n'},
            'olyp'        : {'s6': 1.0,  's8': 1.764,  'sr6': 0.806,  'alpha6': 14.0, 'sr8': 1.000, "citation": '    L. Goerigk, S. Grimme, Phys. Chem. Chem. Phys. 13, 6670-6688, 2011\n'},
            'mpwlyp'      : {'s6': 1.0,  's8': 1.098,  'sr6': 1.239,  'alpha6': 14.0, 'sr8': 1.000, "citation": '    L. Goerigk, S. Grimme, Phys. Chem. Chem. Phys. 13, 6670-6688, 2011\n'},
            'bmk'         : {'s6': 1.0,  's8': 2.168,  'sr6': 1.931,  'alpha6': 14.0, 'sr8': 1.000, "citation": '    L. Goerigk, S. Grimme, Phys. Chem. Chem. Phys. 13, 6670-6688, 2011\n'},
            'm05-2x'      : {'s6': 1.0,  's8': 0.00 ,  'sr6': 1.417,  'alpha6': 14.0, 'sr8': 1.000, "citation": '    L. Goerigk, S. Grimme, Phys. Chem. Chem. Phys. 13, 6670-6688, 2011\n'},
            'm05'         : {'s6': 1.0,  's8': 0.595,  'sr6': 1.373,  'alpha6': 14.0, 'sr8': 1.000, "citation": '    L. Goerigk, S. Grimme, Phys. Chem. Chem. Phys. 13, 6670-6688, 2011\n'},
            'm06-2x'      : {'s6': 1.0,  's8': 0.00 ,  'sr6': 1.619,  'alpha6': 14.0, 'sr8': 1.000, "citation": '    L. Goerigk, S. Grimme, Phys. Chem. Chem. Phys. 13, 6670-6688, 2011\n'},
            'm06'         : {'s6': 1.0,  's8': 0.00 ,  'sr6': 1.325,  'alpha6': 14.0, 'sr8': 1.000, "citation": '    L. Goerigk, S. Grimme, Phys. Chem. Chem. Phys. 13, 6670-6688, 2011\n'},
            'm06-l'       : {'s6': 1.0,  's8': 0.00 ,  'sr6': 1.581,  'alpha6': 14.0, 'sr8': 1.000, "citation": '    L. Goerigk, S. Grimme, Phys. Chem. Chem. Phys. 13, 6670-6688, 2011\n'},
            'b3pw91'      : {'s6': 1.0,  's8': 1.775,  'sr6': 1.176,  'alpha6': 14.0, 'sr8': 1.000, "citation": '    L. Goerigk, S. Grimme, Phys. Chem. Chem. Phys. 13, 6670-6688, 2011\n'},
            'bhlyp'       : {'s6': 1.0,  's8': 1.442,  'sr6': 1.370,  'alpha6': 14.0, 'sr8': 1.000, "citation": '    L. Goerigk, S. Grimme, Phys. Chem. Chem. Phys. 13, 6670-6688, 2011\n'},
            'b1b95'       : {'s6': 1.0,  's8': 1.868,  'sr6': 1.613,  'alpha6': 14.0, 'sr8': 1.000, "citation": '    L. Goerigk, S. Grimme, Phys. Chem. Chem. Phys. 13, 6670-6688, 2011\n'},
            'mpw1b95'     : {'s6': 1.0,  's8': 1.118,  'sr6': 1.605,  'alpha6': 14.0, 'sr8': 1.000, "citation": '    L. Goerigk, S. Grimme, Phys. Chem. Chem. Phys. 13, 6670-6688, 2011\n'},
            'mpwb1k'      : {'s6': 1.0,  's8': 1.061,  'sr6': 1.671,  'alpha6': 14.0, 'sr8': 1.000, "citation": '    L. Goerigk, S. Grimme, Phys. Chem. Chem. Phys. 13, 6670-6688, 2011\n'},
            'tpssh'       : {'s6': 1.0,  's8': 1.219,  'sr6': 1.223,  'alpha6': 14.0, 'sr8': 1.000, "citation": '    L. Goerigk, S. Grimme, Phys. Chem. Chem. Phys. 13, 6670-6688, 2011\n'},
            'scan'        : {'s6': 1.0,  's8': 0.000,  'sr6': 1.324,  'alpha6': 14.0, 'sr8': 1.000, "citation": '    J.G. Brandenburg, J. E. Bates, J. Sun, J.P. Perdew, Phys. Rev. B 94, 115144, 2016\n'},
            'm11-l'       : {'s6': 1.0,  's8': 1.1129, 'sr6': 2.3933, 'alpha6': 14.0, 'sr8': 1.000, "citation": '    L. Goerigk, J. Phys. Chem. Lett. 6, 3891-3896, 2015\n'},
            'mn12-l'      : {'s6': 1.0,  's8': 0.9622, 'sr6': 2.2329, 'alpha6': 14.0, 'sr8': 1.000, "citation": '    L. Goerigk, J. Phys. Chem. Lett. 6, 3891-3896, 2015\n'},
            'n12'         : {'s6': 1.0,  's8': 2.3916, 'sr6': 1.3493, 'alpha6': 14.0, 'sr8': 1.000, "citation": '    L. Goerigk, J. Phys. Chem. Lett. 6, 3891-3896, 2015\n'},
            'sogga11-x'   : {'s6': 1.0,  's8': 1.8151, 'sr6': 1.5431, 'alpha6': 14.0, 'sr8': 1.000, "citation": '    L. Goerigk, J. Phys. Chem. Lett. 6, 3891-3896, 2015\n'},
            'm11'         : {'s6': 1.0,  's8': 0.6244, 'sr6': 2.2300, 'alpha6': 14.0, 'sr8': 1.000, "citation": '    L. Goerigk, J. Phys. Chem. Lett. 6, 3891-3896, 2015\n'},
            'mn12-sx'     : {'s6': 1.0,  's8': 0.8205, 'sr6': 1.9572, 'alpha6': 14.0, 'sr8': 1.000, "citation": '    L. Goerigk, J. Phys. Chem. Lett. 6, 3891-3896, 2015\n'},
            'n12-sx'      : {'s6': 1.0,  's8': 1.4713, 'sr6': 1.4597, 'alpha6': 14.0, 'sr8': 1.000, "citation": '    L. Goerigk, J. Phys. Chem. Lett. 6, 3891-3896, 2015\n'},
            'hse06'       : {'s6': 1.0,  's8': 0.1090, 'sr6': 1.1290, 'alpha6': 14.0, 'sr8': 1.000, "citation": '    J. Moellmann, S. Grimme, J. Chem. Phys. C 118, 7615-7621, 2014\n'},
            'wb97x'       : {'s6': 1.0,  's8': 1.0,    'sr6': 1.281,  'alpha6': 14.0, 'sr8': 1.094, "citation": '    Y.-S. Lin, G.-D. Li, S.-P. Mao, J.-D. Chai, Chem. Theory Comput. 9, 263-272, 2013\n'},
            'pbehpbe'     : {'s6': 1.0,  's8': 1.4010, 'sr6': 1.5703, 'alpha6': 14.0, 'sr8': 1.000, "citation": '    L. Goerigk, A. Hansen, C. Bauer, S. Ehrlich, A. Najibi, S. Grimme, Phys. Chem. Chem. Phys. 19, 32184-32215, 2017\n'},
            'rpbe'        : {'s6': 1.0,  's8': 0.5140, 'sr6': 0.8720, 'alpha6': 14.0, 'sr8': 1.000, "citation": '    L. Goerigk, A. Hansen, C. Bauer, S. Ehrlich, A. Najibi, S. Grimme, Phys. Chem. Chem. Phys. 19, 32184-32215, 2017\n'},
            'xlyp'        : {'s6': 1.0,  's8': 0.7447, 'sr6': 0.9384, 'alpha6': 14.0, 'sr8': 1.000, "citation": '    L. Goerigk, A. Hansen, C. Bauer, S. Ehrlich, A. Najibi, S. Grimme, Phys. Chem. Chem. Phys. 19, 32184-32215, 2017\n'},
            'pw91p86'     : {'s6': 1.0,  's8': 0.8747, 'sr6': 2.1040, 'alpha6': 14.0, 'sr8': 1.000, "citation": '    L. Goerigk, A. Hansen, C. Bauer, S. Ehrlich, A. Najibi, S. Grimme, Phys. Chem. Chem. Phys. 19, 32184-32215, 2017\n'},
            'mpwpw91'     : {'s6': 1.0,  's8': 1.9467, 'sr6': 1.3725, 'alpha6': 14.0, 'sr8': 1.000, "citation": '    L. Goerigk, A. Hansen, C. Bauer, S. Ehrlich, A. Najibi, S. Grimme, Phys. Chem. Chem. Phys. 19, 32184-32215, 2017\n'},
            'hcth407'     : {'s6': 1.0,  's8': 2.7694, 'sr6': 4.0426, 'alpha6': 14.0, 'sr8': 1.000, "citation": '    L. Goerigk, A. Hansen, C. Bauer, S. Ehrlich, A. Najibi, S. Grimme, Phys. Chem. Chem. Phys. 19, 32184-32215, 2017\n'},
            'pkzb'        : {'s6': 1.0,  's8': 0.0000, 'sr6': 0.6327, 'alpha6': 14.0, 'sr8': 1.000, "citation": '    L. Goerigk, A. Hansen, C. Bauer, S. Ehrlich, A. Najibi, S. Grimme, Phys. Chem. Chem. Phys. 19, 32184-32215, 2017\n'},
            'revtpss'     : {'s6': 1.0,  's8': 1.3666, 'sr6': 1.3491, 'alpha6': 14.0, 'sr8': 1.000, "citation": '    L. Goerigk, A. Hansen, C. Bauer, S. Ehrlich, A. Najibi, S. Grimme, Phys. Chem. Chem. Phys. 19, 32184-32215, 2017\n'},
            'thcth'       : {'s6': 1.0,  's8': 0.5662, 'sr6': 0.9320, 'alpha6': 14.0, 'sr8': 1.000, "citation": '    L. Goerigk, A. Hansen, C. Bauer, S. Ehrlich, A. Najibi, S. Grimme, Phys. Chem. Chem. Phys. 19, 32184-32215, 2017\n'},
            'mn15-l'      : {'s6': 1.0,  's8': 0.0000, 'sr6': 3.3388, 'alpha6': 14.0, 'sr8': 1.000, "citation": '    L. Goerigk, A. Hansen, C. Bauer, S. Ehrlich, A. Najibi, S. Grimme, Phys. Chem. Chem. Phys. 19, 32184-32215, 2017\n'},
            'b3p86'       : {'s6': 1.0,  's8': 1.1961, 'sr6': 1.1897, 'alpha6': 14.0, 'sr8': 1.000, "citation": '    L. Goerigk, A. Hansen, C. Bauer, S. Ehrlich, A. Najibi, S. Grimme, Phys. Chem. Chem. Phys. 19, 32184-32215, 2017\n'},
            'b1p96'       : {'s6': 1.0,  's8': 1.1209, 'sr6': 1.1815, 'alpha6': 14.0, 'sr8': 1.000, "citation": '    L. Goerigk, A. Hansen, C. Bauer, S. Ehrlich, A. Najibi, S. Grimme, Phys. Chem. Chem. Phys. 19, 32184-32215, 2017\n'},
            'b1lyp'       : {'s6': 1.0,  's8': 1.9467, 'sr6': 1.3725, 'alpha6': 14.0, 'sr8': 1.000, "citation": '    L. Goerigk, A. Hansen, C. Bauer, S. Ehrlich, A. Najibi, S. Grimme, Phys. Chem. Chem. Phys. 19, 32184-32215, 2017\n'},
            'mpw1lyp'     : {'s6': 1.0,  's8': 1.9529, 'sr6': 2.0512, 'alpha6': 14.0, 'sr8': 1.000, "citation": '    L. Goerigk, A. Hansen, C. Bauer, S. Ehrlich, A. Najibi, S. Grimme, Phys. Chem. Chem. Phys. 19, 32184-32215, 2017\n'},
            'mpw1pw91'    : {'s6': 1.0,  's8': 1.4758, 'sr6': 1.2892, 'alpha6': 14.0, 'sr8': 1.000, "citation": '    L. Goerigk, A. Hansen, C. Bauer, S. Ehrlich, A. Najibi, S. Grimme, Phys. Chem. Chem. Phys. 19, 32184-32215, 2017\n'},
            'pw1pw'       : {'s6': 1.0,  's8': 1.1786, 'sr6': 1.4968, 'alpha6': 14.0, 'sr8': 1.000, "citation": '    L. Goerigk, A. Hansen, C. Bauer, S. Ehrlich, A. Najibi, S. Grimme, Phys. Chem. Chem. Phys. 19, 32184-32215, 2017\n'},
            'mpw1kcis'    : {'s6': 1.0,  's8': 2.2917, 'sr6': 1.7231, 'alpha6': 14.0, 'sr8': 1.000, "citation": '    L. Goerigk, A. Hansen, C. Bauer, S. Ehrlich, A. Najibi, S. Grimme, Phys. Chem. Chem. Phys. 19, 32184-32215, 2017\n'},
            'mpwkcis1k'   : {'s6': 1.0,  's8': 1.7553, 'sr6': 1.4853, 'alpha6': 14.0, 'sr8': 1.000, "citation": '    L. Goerigk, A. Hansen, C. Bauer, S. Ehrlich, A. Najibi, S. Grimme, Phys. Chem. Chem. Phys. 19, 32184-32215, 2017\n'},
            'pbeh1pbe'    : {'s6': 1.0,  's8': 1.0430, 'sr6': 1.3719, 'alpha6': 14.0, 'sr8': 1.000, "citation": '    L. Goerigk, A. Hansen, C. Bauer, S. Ehrlich, A. Najibi, S. Grimme, Phys. Chem. Chem. Phys. 19, 32184-32215, 2017\n'},
            'pbe1kcis'    : {'s6': 1.0,  's8': 1.7934, 'sr6': 3.6355, 'alpha6': 14.0, 'sr8': 1.000, "citation": '    L. Goerigk, A. Hansen, C. Bauer, S. Ehrlich, A. Najibi, S. Grimme, Phys. Chem. Chem. Phys. 19, 32184-32215, 2017\n'},
            'x3lyp'       : {'s6': 1.0,  's8': 0.2990, 'sr6': 1.0000, 'alpha6': 14.0, 'sr8': 1.000, "citation": '    L. Goerigk, A. Hansen, C. Bauer, S. Ehrlich, A. Najibi, S. Grimme, Phys. Chem. Chem. Phys. 19, 32184-32215, 2017\n'},
            'o3lyp'       : {'s6': 1.0,  's8': 1.8058, 'sr6': 1.4060, 'alpha6': 14.0, 'sr8': 1.000, "citation": '    L. Goerigk, A. Hansen, C. Bauer, S. Ehrlich, A. Najibi, S. Grimme, Phys. Chem. Chem. Phys. 19, 32184-32215, 2017\n'},
            'b97-1'       : {'s6': 1.0,  's8': 1.6418, 'sr6': 3.7924, 'alpha6': 14.0, 'sr8': 1.000, "citation": '    L. Goerigk, A. Hansen, C. Bauer, S. Ehrlich, A. Najibi, S. Grimme, Phys. Chem. Chem. Phys. 19, 32184-32215, 2017\n'},
            'b97-2'       : {'s6': 1.0,  's8': 2.4661, 'sr6': 1.7066, 'alpha6': 14.0, 'sr8': 1.000, "citation": '    L. Goerigk, A. Hansen, C. Bauer, S. Ehrlich, A. Najibi, S. Grimme, Phys. Chem. Chem. Phys. 19, 32184-32215, 2017\n'},
            'b98'         : {'s6': 1.0,  's8': 1.9078, 'sr6': 2.6895, 'alpha6': 14.0, 'sr8': 1.000, "citation": '    L. Goerigk, A. Hansen, C. Bauer, S. Ehrlich, A. Najibi, S. Grimme, Phys. Chem. Chem. Phys. 19, 32184-32215, 2017\n'},
            'hiss'        : {'s6': 1.0,  's8': 0.7615, 'sr6': 1.3338, 'alpha6': 14.0, 'sr8': 1.000, "citation": '    L. Goerigk, A. Hansen, C. Bauer, S. Ehrlich, A. Najibi, S. Grimme, Phys. Chem. Chem. Phys. 19, 32184-32215, 2017\n'},
            'hse03'       : {'s6': 1.0,  's8': 1.0156, 'sr6': 1.3944, 'alpha6': 14.0, 'sr8': 1.000, "citation": '    L. Goerigk, A. Hansen, C. Bauer, S. Ehrlich, A. Najibi, S. Grimme, Phys. Chem. Chem. Phys. 19, 32184-32215, 2017\n'},
            'revtpssh'    : {'s6': 1.0,  's8': 1.2504, 'sr6': 1.3224, 'alpha6': 14.0, 'sr8': 1.000, "citation": '    L. Goerigk, A. Hansen, C. Bauer, S. Ehrlich, A. Najibi, S. Grimme, Phys. Chem. Chem. Phys. 19, 32184-32215, 2017\n'},
            'revtpss0'    : {'s6': 1.0,  's8': 1.0649, 'sr6': 1.2881, 'alpha6': 14.0, 'sr8': 1.000, "citation": '    L. Goerigk, A. Hansen, C. Bauer, S. Ehrlich, A. Najibi, S. Grimme, Phys. Chem. Chem. Phys. 19, 32184-32215, 2017\n'},
            'tpss1kcis'   : {'s6': 1.0,  's8': 2.0902, 'sr6': 1.7729, 'alpha6': 14.0, 'sr8': 1.000, "citation": '    L. Goerigk, A. Hansen, C. Bauer, S. Ehrlich, A. Najibi, S. Grimme, Phys. Chem. Chem. Phys. 19, 32184-32215, 2017\n'},
            'thcthhyb'    : {'s6': 1.0,  's8': 1.6302, 'sr6': 1.5001, 'alpha6': 14.0, 'sr8': 1.000, "citation": '    L. Goerigk, A. Hansen, C. Bauer, S. Ehrlich, A. Najibi, S. Grimme, Phys. Chem. Chem. Phys. 19, 32184-32215, 2017\n'},
            'm08-hx'      : {'s6': 1.0,  's8': 0.0000, 'sr6': 1.6247, 'alpha6': 14.0, 'sr8': 1.000, "citation": '    L. Goerigk, A. Hansen, C. Bauer, S. Ehrlich, A. Najibi, S. Grimme, Phys. Chem. Chem. Phys. 19, 32184-32215, 2017\n'},
            'lcwhpbe'     : {'s6': 1.0,  's8': 1.2797, 'sr6': 1.3846, 'alpha6': 14.0, 'sr8': 1.000, "citation": '    L. Goerigk, A. Hansen, C. Bauer, S. Ehrlich, A. Najibi, S. Grimme, Phys. Chem. Chem. Phys. 19, 32184-32215, 2017\n'},
            'mpw2plyp'    : {'s6': 0.66, 's8': 0.7529, 'sr6': 1.5527, 'alpha6': 14.0, 'sr8': 1.000, "citation": '    L. Goerigk, A. Hansen, C. Bauer, S. Ehrlich, A. Najibi, S. Grimme, Phys. Chem. Chem. Phys. 19, 32184-32215, 2017\n'},
        # https://www.chemie.uni-bonn.de/pctc/mulliken-center/software/dft-d3/functionals
            'pwb6k'       : {'s6': 1.0,  's8': 0.550,  'sr6': 1.660,  'alpha6': 14.0, 'sr8': 1.000},
            'revpbe'      : {'s6': 1.0,  's8': 1.010,  'sr6': 0.923,  'alpha6': 14.0, 'sr8': 1.000},
            'bop'         : {'s6': 1.0,  's8': 1.975,  'sr6': 0.929,  'alpha6': 14.0, 'sr8': 1.000},
            'otpss'       : {'s6': 1.0,  's8': 1.494,  'sr6': 1.128,  'alpha6': 14.0, 'sr8': 1.000},
            'pbe38'       : {'s6': 1.0,  's8': 0.998,  'sr6': 1.333,  'alpha6': 14.0, 'sr8': 1.000},
            'pbesol'      : {'s6': 1.0,  's8': 0.612,  'sr6': 1.345,  'alpha6': 14.0, 'sr8': 1.000},
            'revssb'      : {'s6': 1.0,  's8': 0.560,  'sr6': 1.221,  'alpha6': 14.0, 'sr8': 1.000},
            'ssb'         : {'s6': 1.0,  's8': 0.663,  'sr6': 1.215,  'alpha6': 14.0, 'sr8': 1.000},
            'cam-b3lyp'   : {'s6': 1.0,  's8': 1.217,  'sr6': 1.378,  'alpha6': 14.0, 'sr8': 1.000},
            'wpbe'        : {'s6': 1.0,  's8': 1.279,  'sr6': 1.355,  'alpha6': 14.0, 'sr8': 1.000},  # formerly lcwpbe
            'm06-hf'      : {'s6': 1.0,  's8': 0.00 ,  'sr6': 1.446,  'alpha6': 14.0, 'sr8': 1.000},
            'hcth120'     : {'s6': 1.0,  's8': 1.206,  'sr6': 1.221,  'alpha6': 14.0, 'sr8': 1.000},
            'ptpss'       : {'s6': 0.75, 's8': 0.879,  'sr6': 1.541,  'alpha6': 14.0, 'sr8': 1.000},
            'revpbe0'     : {'s6': 1.0,  's8': 0.792,  'sr6': 0.949,  'alpha6': 14.0, 'sr8': 1.000},
            'revpbe38'    : {'s6': 1.0,  's8': 0.862,  'sr6': 1.021,  'alpha6': 14.0, 'sr8': 1.000},
        # unreferenced
            'hf'          : {'s6': 1.0,  's8': 1.746,  'sr6': 1.158,  'alpha6': 14.0, 'sr8': 1.000},
        }
    },
    'd3bj': {
        'formal'            : "D3(BJ)",
        ...
        # S. Grimme, S. Ehrlich, L. Goerigk, J. Comput. Chem. 7, 3297-3305, 2011
            ...
            'b97'           : {'s6': 1.000, 's8':  2.2609, 'a1':  0.5545, 'a2': 3.2297},  # formerly b97-d
        ...
        # https://www.chemie.uni-bonn.de/pctc/mulliken-center/software/dft-d3/functionalsbj
            ...
            'wpbe'          : {'s6': 1.000, 's8':  1.8541, 'a1':  0.3919, 'a2': 5.0897},  # formerly lcwpbe
    ...
    'd3mzero': {
        ...
        'definitions' : {
            ...
            'b97'     : {'s6': 1.000, 's8':  1.020078, 'sr6': 1.151808, 'beta': 0.035964},  # formerly b97-d
            ...
            'wpbe'    : {'s6': 1.000, 's8':  1.280619, 'sr6': 1.366361, 'beta': 0.003160},  # formerly lcwpbe
        }
    },
    'd3mbj': {
        'formal'      : "D3M(BJ)",
        ...
        'definitions' : {
            ...
            'b97'     : {'s6': 1.000, 's8': 1.206988, 'a1': 0.240184, 'a2': 3.864426},  # formerly b97-d
            ...
            'wpbe'    : {'s6': 1.000, 's8': 0.906564, 'a1': 0.563761, 'a2': 3.593680},  # formerly lcwpbe
        }
    },
    'nl': {
        'formal'          : "NL",
...
def from_arrays(name_hint=None, level_hint=None, param_tweaks=None, dashcoeff_supplement=None, verbose=1):
    ...
    dashcoeff_supplement: dict, optional
        ...
        fctl-dashlvl. Used to validate dict_builder fctls with
    ...
    * Function intended to be idempotent.
    ...
    if name_hint is None:
        ...
        if name_hint in get_dispersion_aliases():
            ...
            name_key = name_hint
            disp_params = dashcoeff_supplement[dashlevel_candidate_2]['definitions'][name_hint]
            ...
            disp_params = dashcoeff[dashlevel_candidate_2]['definitions'][trial_split[0]]
        elif (level_hint is not None) and name_hint in dashcoeff[dashlevel_candidate_1]['definitions']:
            # case fctl: b3lyp
            dashlevel_candidate_2 = None
            name_key = name_hint
            disp_params = dashcoeff[dashlevel_candidate_1]['definitions'][name_hint]
        elif name_hint == '':
            dashlevel_candidate_2 = None
            name_key = None
            disp_params = {}
    ...
    # TODO citation = disp_params.pop('citation', None)
    ...
    if isinstance(param_tweaks, list):
        print('list', dashleveleff, allowed_params, param_tweaks)
        param_tweaks = dict(zip(allowed_params, param_tweaks))
        print('dictified', param_tweaks)
    ...
    if ((name_hint is not None) and (dashcoeff_supplement is not None)
            ...
            and (disp_params == dashcoeff_supplement[dashleveleff]['definitions'][name_key])):
        fctldasheff = name_key
    elif name_hint not in [None, ''] and (disp_params == dashcoeff[dashleveleff]['definitions'][name_key]):
    ...
    if verbose > 1:
        print('intf_dftd3.from_arrays RESOLVED:', dashleveleff, disp_params, fctldasheff)

    return {'dashlevel': dashleveleff, 'dashparams': disp_params, 'fctldash': fctldasheff}

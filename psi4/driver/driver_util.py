...
def _alternative_methods_message(method_name: str, dertype: str, *, messages: Dict[int, Any], proc: Dict) -> str:
    ...
    if messages:
        ...
        return f"Method={method_name} is not available for {dertype} derivative level. Some methods need dftd4-python>=3.5.0 and gcp-correction installed.{alternatives}"
    else:

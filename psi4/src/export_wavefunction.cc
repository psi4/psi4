...
void export_wavefunction(py::module& m) {
    ...
    py::class_<Wavefunction, std::shared_ptr<Wavefunction>>(m, "Wavefunction", "docstring", py::dynamic_attr())
        ...
        .def("has_variable", &Wavefunction::has_variable, "Returns 1 if the QC variable exists/is set.")
        .def("set_variable", &Wavefunction::set_variable, "Sets the requested QC variable.")
        .def("variable", &Wavefunction::variable, "Returns the requested QC variable.")
        .def("del_variable", &Wavefunction::del_variable, "Removes the requested QC variable.")

...
//              py::arg("name"), py::arg("symmetry"));
    ...
    py::class_<Molecule, std::shared_ptr<Molecule>>(m, "Molecule", py::dynamic_attr(),
        ...
        .def("Z", &Molecule::Z, py::return_value_policy::copy, "Nuclear charge of *atom* (0-indexed), by default ghost atoms return zero nuclear charge", py::arg("atom"), py::arg("zero_ghost") = true)
        ...
        .def("mass", &Molecule::mass, "Returns mass of *atom* (0-indexed), by default ghost atoms return non-zero mass", py::arg("atom"), py::arg("zero_ghost") = false)

...
void export_mints(py::module& m) {
    ...
    py::class_<Molecule, std::shared_ptr<Molecule>>(m, "Molecule", py::dynamic_attr(),
        ...
        .def("Z", &Molecule::Z, py::return_value_policy::copy,
             "Nuclear charge of *atom* (0-indexed), by default ghost atoms return zero nuclear charge", py::arg("atom"),
             py::arg("zero_ghost") = true)
        ...
        .def("set_mass", &Molecule::set_mass, "Sets mass of *atom* (0-indexed) to *mass*", py::arg("atom"),
             py::arg("mass"))

...
std::vector< SharedMatrix > fd_geoms_freq_0(boost::shared_ptr<Molecule> mol, Options &options, int irrep=-1);
std::vector< SharedMatrix > fd_geoms_freq_1(boost::shared_ptr<Molecule> mol, Options &options, int irrep=-1);
...
SharedMatrix fd_1_0(boost::shared_ptr<Molecule> mol, Options &options, const boost::python::list& energies);
//PsiReturnType fd_2_0(boost::shared_ptr<Molecule> mol, Options &options, const boost::python::list& energies);
SharedMatrix fd_freq_0(boost::shared_ptr<Molecule> mol, Options &options,
                      const boost::python::list& energies, int irrep=-1);
SharedMatrix fd_freq_1(boost::shared_ptr<Molecule> mol, Options &options,
                      const boost::python::list& E_list, int irrep=-1);
...
class VIBRATION {
  ...
  public:
    ...
    friend void print_vibrations(boost::shared_ptr<Molecule> mol, std::vector<VIBRATION *> modes);

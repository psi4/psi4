        ...
        */
        ...
        for (Gma = 0; Gma < moinfo.nirreps; Gma++) {
            ...
            for (ma = 0; ma < F.params->rowtot[Gma]; ma++) {
                ...
                if (nrows && ncols)
                    C_DGEMV('t', nrows, ncols, 1.0, &X[F.col_offset[Gma][Gf]], ncols, tIA.matrix[Gm][M], 1, 1.0,
                            FAE.matrix[Ga][A], 1);
            }
        ...
        for (h = 0; h < moinfo.nirreps; h++)
            for (a = 0; a < FAEt.params->rowtot[h]; a++) FAEt.matrix[h][a][a] = 0.0;
        ...
        for (h = 0; h < moinfo.nirreps; h++)
            for (a = 0; a < FMIt.params->rowtot[h]; a++) FMIt.matrix[h][a][a] = 0.0;
        ...
        if ((params.wfn == "CC2") || params.wfn == "EOM_CC2") {
            ...
            for (h = 0; h < moinfo.nirreps; h++) {
                for (e = 0; e < FAE.params->coltot[h]; e++) FAE.matrix[h][e][e] = 0;
                for (e = 0; e < Fae.params->coltot[h]; e++) Fae.matrix[h][e][e] = 0;
            }

...
void SCF::construct_G(SBlockMatrix& density, SBlockMatrix& G, double* integrals, int batch) {
    construct_G(density, G, integrals, batch, 1.0);
}

void SCF::construct_G(SBlockMatrix& density, SBlockMatrix& G, double* integrals, int batch, double factor) {
    double* D_vector;
    double* G_vector;

...
std::vector<SharedMatrix> CIWavefunction::tpdm(SharedCIVector Ivec, SharedCIVector Jvec,
  ...
  SharedVector tpdm_aa = std::make_shared<Vector>("MO-basis TPDM AA (ci order)", ntri2);
  SharedVector tpdm_ab(
      new Vector("MO-basis TPDM AB (ci order)", nact2 * nact2));
  SharedVector tpdm_bb = std::make_shared<Vector>("MO-basis TPDM BB (ci order)", ntri2);
  ...
  SharedMatrix tpdm_aam = std::make_shared<Matrix>("MO-basis TPDM AA", nact2, nact2);
  SharedMatrix tpdm_abm = std::make_shared<Matrix>("MO-basis TPDM AB", nact2, nact2);
  SharedMatrix tpdm_bbm = std::make_shared<Matrix>("MO-basis TPDM BB", nact2, nact2);
  ...
  SharedMatrix tpdm = std::make_shared<Matrix>("MO-basis TPDM", nact2, nact2);

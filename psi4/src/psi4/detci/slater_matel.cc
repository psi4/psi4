...
extern void common_orbs(int *same_alpha_, int *same_beta_, int cnt_alpha, int cnt_beta, int *common_docc_,
                        int *common_alpha_socc, int *common_beta_socc, int *cnt_docc, int *cnt_alpha_socc,
                        int *cnt_beta_socc);
...
double CIWavefunction::matrix_element(SlaterDeterminant *I, SlaterDeterminant *J) {
    ...
    alpha_diff = calc_orb_diff(nalp, I->Occs_[0], J->Occs_[0], I_diff_[0], J_diff_[0], &sign, same_alpha_, 0);
    beta_diff = calc_orb_diff(nbet, I->Occs_[1], J->Occs_[1], I_diff_[1], J_diff_[1], &sign, same_beta_, 0);
    ...
    */
    ...
    /* Differ by 1 spin orbital */
        ...
        common_orbs(same_alpha_, same_beta_, nalp_same, nbet_same, common_docc_, common_alp_socc_, common_bet_socc_,
                    &cnt_docc, &cnt_alp_socc, &cnt_bet_socc);

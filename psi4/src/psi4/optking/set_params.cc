...
#endif
{
    ...
    if (s == "MIN")
        Opt_params.opt_type = OPT_PARAMS::MIN;
    else if (s == "TS")
        Opt_params.opt_type = OPT_PARAMS::TS;
    else if (s == "IRC")
    ...
    if (options["STEP_TYPE"].has_changed()) {
        ...
        else if (s == "LINESEARCH_STATIC")
            Opt_params.step_type = OPT_PARAMS::LINESEARCH_STATIC;
    ...
    if (options["FRAG_REF_ATOMS"].has_changed() && !Opt_params.frag_ref_atoms.size()) {
        ...
        for (int F = 0; F < nfrag; ++F) {
            ...
            if (nref > 3) throw("Fragment can have only 3 reference atoms.\n");
    ...
    if (Opt_params.intrafragment_H == OPT_PARAMS::LINDH) {
        if (!options["H_GUESS_EVERY"].has_changed()) Opt_params.H_guess_every = true;
    }
    ...
    if (Opt_params.coordinates == OPT_PARAMS::CARTESIAN) {
        if (!options["INTRAFRAG_HESS"].has_changed()) Opt_params.intrafragment_H = OPT_PARAMS::LINDH;
        if (!options["H_GUESS_EVERY"].has_changed()) Opt_params.H_guess_every = false;
    }
    ...
    else if (s == "FISCHER_LIKE")
        Opt_params.interfragment_H = OPT_PARAMS::FISCHER_LIKE;
    ...
    if (s == "NONE")
        Opt_params.H_update = OPT_PARAMS::NONE;
    else if (s == "BFGS")
        Opt_params.H_update = OPT_PARAMS::BFGS;
    else if (s == "MS")
        Opt_params.H_update = OPT_PARAMS::MS;
    else if (s == "POWELL")
        Opt_params.H_update = OPT_PARAMS::POWELL;
    else if (s == "BOFILL")
    ...
    if (Opt_params.opt_type == OPT_PARAMS::TS || Opt_params.opt_type == OPT_PARAMS::IRC)
        if (!options["HESS_UPDATE"].has_changed()) Opt_params.H_update = OPT_PARAMS::BOFILL;
    ...
    if (s == "FORWARD")
        ...
        Opt_params.IRC_direction = OPT_PARAMS::BACKWARD;
    ...
    if (s == "STOP")
        ...
        Opt_params.IRC_stop = OPT_PARAMS::ASK;
    else if (s == "GO")
        Opt_params.IRC_stop = OPT_PARAMS::GO;
    ...
    if (Opt_params.general_conv == "QCHEM") {
        ...
        Opt_params.conv_max_DE = 1.0e-6;
        Opt_params.i_max_DE = true;
        Opt_params.conv_max_disp = 3.0e-4;
        Opt_params.i_max_disp = true;
    } else if (Opt_params.general_conv == "GAU") {
        Opt_params.i_untampered = true;
        Opt_params.conv_max_force = 4.5e-4;
        Opt_params.i_max_force = true;
        Opt_params.conv_rms_force = 3.0e-4;
        Opt_params.i_rms_force = true;
        Opt_params.conv_max_disp = 1.8e-3;
        Opt_params.i_max_disp = true;
        Opt_params.conv_rms_disp = 1.2e-3;
        Opt_params.i_rms_disp = true;
    } else if (Opt_params.general_conv == "GAU_TIGHT") {
        Opt_params.i_untampered = true;
        Opt_params.conv_max_force = 1.5e-5;
        Opt_params.i_max_force = true;
        Opt_params.conv_rms_force = 1.0e-5;
        Opt_params.i_rms_force = true;
        Opt_params.conv_max_disp = 6.0e-5;
        Opt_params.i_max_disp = true;
        Opt_params.conv_rms_disp = 4.0e-5;
        Opt_params.i_rms_disp = true;
        ...
        Opt_params.conv_rms_force = 1.0e-5;
        Opt_params.i_rms_force = true;
        Opt_params.conv_max_disp = 6.0e-4;
        Opt_params.i_max_disp = true;
        Opt_params.conv_rms_disp = 4.0e-4;
        Opt_params.i_rms_disp = true;
    } else if (Opt_params.general_conv == "GAU_VERYTIGHT") {
        Opt_params.i_untampered = true;
        Opt_params.conv_max_force = 2.0e-6;
        Opt_params.i_max_force = true;
        Opt_params.conv_rms_force = 1.0e-6;
        Opt_params.i_rms_force = true;
        Opt_params.conv_max_disp = 6.0e-6;
        Opt_params.i_max_disp = true;
        Opt_params.conv_rms_disp = 4.0e-6;
        Opt_params.i_rms_disp = true;
    } else if (Opt_params.general_conv == "GAU_LOOSE") {
        Opt_params.i_untampered = true;
        Opt_params.conv_max_force = 2.5e-3;
        Opt_params.i_max_force = true;
        Opt_params.conv_rms_force = 1.7e-3;
        Opt_params.i_rms_force = true;
        Opt_params.conv_max_disp = 1.0e-2;
        Opt_params.i_max_disp = true;
        Opt_params.conv_rms_disp = 6.7e-3;
        Opt_params.i_rms_disp = true;
    } else if (Opt_params.general_conv == "TURBOMOLE") {
        Opt_params.i_untampered = true;
        Opt_params.conv_max_force = 1.0e-3;
        Opt_params.i_max_force = true;
        Opt_params.conv_rms_force = 5.0e-4;
        Opt_params.i_rms_force = true;
        Opt_params.conv_max_DE = 1.0e-6;
        Opt_params.i_max_DE = true;
        Opt_params.conv_max_disp = 1.0e-3;
        Opt_params.i_max_disp = true;
        Opt_params.conv_rms_disp = 5.0e-4;
        Opt_params.i_rms_disp = true;
    } else if (Opt_params.general_conv == "CFOUR") {
        Opt_params.i_untampered = true;
        Opt_params.conv_rms_force = 1.0e-4;
        Opt_params.i_rms_force = true;
    } else if (Opt_params.general_conv == "NWCHEM_LOOSE") {
        Opt_params.i_untampered = true;
        Opt_params.conv_max_force = 4.5e-3;
        Opt_params.i_max_force = true;
        Opt_params.conv_rms_force = 3.0e-3;
        Opt_params.i_rms_force = true;
        Opt_params.conv_max_disp = 5.4e-3;
        Opt_params.i_max_disp = true;
        Opt_params.conv_rms_disp = 3.6e-3;
        Opt_params.i_rms_disp = true;
    }
    ...
    if (options.get_bool("FLEXIBLE_G_CONVERGENCE")) Opt_params.i_untampered = true;
    ...
    if ((Opt_params.opt_type == OPT_PARAMS::IRC) && (options["PRINT_TRAJECTORY_XYZ_FILE"].has_changed() == false))
    ...
    if (Opt_params.intcos_generate_exit && !options["KEEP_INTCOS"].has_changed()) Opt_params.keep_intcos = true;
    ...
    if (Opt_params.fragment_mode == OPT_PARAMS::MULTI && !(options["RFO_NORMALIZATION_MAX"].has_changed()))
...
// "frozen" means unchanging, while "fixed" means eq. value is specified
    ...
    if (rem_read(REM_GEOM_OPT2_FROZEN_DISTANCES) > 0) {
        ...
        for (int i = 0; i < 2 * n_frozen; ++i) atoms << (int)fd[i] << ' ';
    ...
    if (rem_read(REM_GEOM_OPT2_FROZEN_BENDS) > 0) {
        ...
        std::stringstream atoms;
        for (int i = 0; i < 3 * n_frozen; ++i) atoms << (int)fd[i] << ' ';
    ...
    if (rem_read(REM_GEOM_OPT2_FROZEN_DIHEDRALS) > 0) {
        ...
        std::stringstream atoms;
        for (int i = 0; i < 4 * n_frozen; ++i) atoms << (int)fd[i] << ' ';

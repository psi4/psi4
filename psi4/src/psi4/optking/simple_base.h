...
class SIMPLE_COORDINATE {
   ...
   public:
    ...
    virtual void print_disp(std::string psi_fp, FILE *qc_fp, const double old_q, const double f_q, const double dq,
                            const double new_q, int atom_offset = 0) const = 0;
    ...
    double fixed_eq_val(void) { return s_fixed_eq_val; }

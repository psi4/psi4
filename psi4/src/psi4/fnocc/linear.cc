    ...
    for (a = 0, id = 0; a < v; a++) {
        for (m = 0; m < o; m++) {
            for (n = 0; n < o; n++) {
                for (e = 0; e < v; e++) {
                    tempt[id++] =
                        2. * tb[e * v * o * o + a * o * o + m * o + n] - tb[a * v * o * o + e * o * o + m * o + n];
                }
            }
        }
    }
    ...
    for (f = 0, id = 0; f < v; f++) {
        for (m = 0; m < o; m++) {
            for (e = 0; e < v; e++) {
                for (i = 0; i < o; i++) {
                    tempt[id++] =
                        2. * tb[e * v * o * o + f * o * o + m * o + i] - tb[e * v * o * o + f * o * o + i * o + m];
                }
            }
        }
    }
        ...
        for (a = 0; a < v; a++) {
            for (b = 0; b < v; b++) {
                for (i = 0; i < o; i++) {
                    for (j = 0; j < o; j++) {
                        emp3_os +=
                            tb[a * o * o * v + b * o * o + i * o + j] * tempv[a * o * o * v + b * o * o + i * o + j];
                        emp3_ss +=
                            (tb[a * o * o * v + b * o * o + i * o + j] - tb[a * o * o * v + b * o * o + j * o + i]) *
            ...
            for (j = 0; j < o; j++) {
                for (a = o; a < rs; a++) {
                    for (b = o; b < rs; b++) {
                        ...
                        emp2_ss +=
                            (tempt[ijab] - tempt[(a - o) * o * o * v + (b - o) * o * o + j * o + i]) * integrals[iajb];
                    }
                }
            }
        }
            ...
            for (i = 0; i < o; i++) {
                for (j = 0; j < o; j++) {
                    if (i > j)
                        ...
                        sg = 1;
                    tempv[a * o * o * v + b * o * o + i * o + j] +=
                        .5 * sg2 * sg * tempt[Position(a, b) * o * (o + 1) / 2 + Position(i, j)];
                }
            }
        }
    }
...
void CoupledCluster::I2iabj_linear(CCTaskParams params) {
    ...
    for (j = 0, id = 0; j < o; j++) {
        for (b = 0; b < v; b++) {
            for (i = 0; i < o; i++) {
                for (a = 0; a < v; a++) {
                    tempt[id++] =
                        2 * tb[a * o * o * v + b * o * o + i * o + j] - tb[b * o * o * v + a * o * o + i * o + j];
                }
            }
        }
    }
    ...
    for (a = 0, id = 0; a < v; a++) {
        for (b = 0; b < v; b++) {
            for (i = 0; i < o; i++) {
                for (j = 0; j < o; j++) {
                    tempt[id++] = integrals[j * o * v * v + b * v * o + i * v + a] +
                                  integrals[i * o * v * v + a * v * o + j * v + b];
                }
            }
        }
    }
    ...
    for (a = 0, id = 0; a < v; a++) {
        for (b = 0; b < v; b++) {
            for (i = 0; i < o; i++) {
                for (j = 0; j < o; j++) {
                    integrals[id++] +=
                        tempv[j * o * v * v + b * v * o + i * v + a] + tempv[i * o * v * v + a * v * o + j * v + b];
                }
            }
        }
    }

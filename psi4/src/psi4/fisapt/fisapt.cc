...
void FISAPT::freeze_core()
{
    ...
    int nfocc0A = molA->nfrozen_core(reference_->basisset(), options_.get_str("FREEZE_CORE"));
    int nfocc0B = molB->nfrozen_core(reference_->basisset(), options_.get_str("FREEZE_CORE"));

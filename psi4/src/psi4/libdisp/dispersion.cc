...
std::shared_ptr <Dispersion> Dispersion::build(const std::string &name, double s6, double p1, double p2, double p3)
{
    ...
    if (to_upper_copy(name) == "-D1") {
        ...
        return disp;
    } else if (to_upper_copy(name) == "-D2GR") {
        std::shared_ptr <Dispersion> disp(new Dispersion());
        disp->name_ = "-D2GR";
        disp->description_ = "    Grimme's -D2 Dispersion Correction\n";
        disp->citation_ = "    Grimme, S. (2006),  J. Comp. Chem., 27: 1787-1799\n";
        ...
        disp->d_ = p1;
        return disp;
    } else if (to_upper_copy(name) == "-D3ZERO") {
        std::shared_ptr <Dispersion> disp(new Dispersion());
        disp->name_ = "-D3ZERO";
        ...
        disp->d_ = p3;
        return disp;
    } else if (to_upper_copy(name) == "-D3BJ") {
        std::shared_ptr <Dispersion> disp(new Dispersion());
        disp->name_ = "-D3BJ";
        ...
        disp->a2_ = p3;
        return disp;
    } else if (to_upper_copy(name) == "-D3MZERO") {
        std::shared_ptr <Dispersion> disp(new Dispersion());
        disp->name_ = "-D3MZERO";
        ...
        disp->d_ = p3;
        return disp;
    } else if (to_upper_copy(name) == "-D3MBJ") {
        std::shared_ptr <Dispersion> disp(new Dispersion());
        disp->name_ = "-D3MBJ";

...
double DCTSolver::compute_three_particle_energy() {
    outfile->Printf("\n\tEvaluating three-particle DCT energy correction...\n\n");

    // Tansform OOOV and VVVO two-electron integrals and two-particle cumulants to semicanonical basis
    dct_semicanonicalize();
...
void DCTSolver::dct_semicanonicalize() {
...
void DCTSolver::transform_integrals_triples() {
...
void DCTSolver::dump_semicanonical() {
...
void DCTSolver::semicanonicalize_dc() {
    dpdbuf4 L, Lt;
    dpdfile2 U_VV, U_OO, U_vv, U_oo;
...
double DCTSolver::compute_triples_aaa() {
    int h;
                        ...
                        for (k = 0; k < naoccpi_[Gk]; k++) {
                            ...
                            if (I > J && J > K) {
                                ...
                                global_dpd_->sort_3d(WBCA, WABC, nirrep_, Gijk, I_OVVV.params->coltot,
                                                     ...
                                                     I_OVVV.params->ssym, avir_off_.data(), avir_off_.data(), navirpi_.blocks().data(), avir_off_.data(),
...
double DCTSolver::compute_triples_aab() {
    int h;
    int Gi, Gj, Gk, Ga, Gb, Gc, Gd, Gl;
    int Gji, Gij, Gjk, Gkj, Gik, Gki, Gijk;
                    ...
                    for (j = 0; j < naoccpi_[Gj]; j++) {
                        ...
                        for (k = 0; k < nboccpi_[Gk]; k++) {
                            ...
                            if (I > J) {
                                ...
                                global_dpd_->sort_3d(WBcA, WABc, nirrep_, Gijk, I_OvVv.params->coltot,
                                                     I_OvVv.params->colidx, I_OvVv.params->colorb, I_OvVv.params->rsym,
                                                     I_OvVv.params->ssym, avir_off_.data(), bvir_off_.data(), navirpi_.blocks().data(), avir_off_.data(),
                                                     I_OVVV.params->colidx, cab, 1);
                                ...
                                global_dpd_->sort_3d(WcBA, WABc, nirrep_, Gijk, I_oVvV.params->coltot,
                                                     I_oVvV.params->colidx, I_oVvV.params->colorb, I_oVvV.params->rsym,
                                                     I_oVvV.params->ssym, bvir_off_.data(), avir_off_.data(), navirpi_.blocks().data(), avir_off_.data(),
...
double DCTSolver::compute_triples_abb() {
    int h;
    int Gi, Gj, Gk, Ga, Gb, Gc, Gd, Gl;
    int Gji, Gij, Gjk, Gkj, Gik, Gki, Gijk;
                    ...
                    for (j = 0; j < nboccpi_[Gj]; j++) {
                        ...
                        for (k = 0; k < nboccpi_[Gk]; k++) {
                            ...
                            if (J > K) {
                                ...
                                global_dpd_->sort_3d(WAcb, WAbc, nirrep_, Gijk, I_OvVv.params->coltot,
                                                     I_OvVv.params->colidx, I_OvVv.params->colorb, I_OvVv.params->rsym,
                                                     I_OvVv.params->ssym, avir_off_.data(), bvir_off_.data(), nbvirpi_.blocks().data(), bvir_off_.data(),
                                                     I_OvVv.params->colidx, acb, 1);
                                ...
                                global_dpd_->sort_3d(WbcA, WAbc, nirrep_, Gijk, I_ovvv.params->coltot,
                                                     I_ovvv.params->colidx, I_ovvv.params->colorb, I_ovvv.params->rsym,
                                                     I_ovvv.params->ssym, bvir_off_.data(), bvir_off_.data(), navirpi_.blocks().data(), avir_off_.data(),
                                                     I_OvVv.params->colidx, cab, 1);
                                ...
                                global_dpd_->sort_3d(WcAb, WAbc, nirrep_, Gijk, I_oVvV.params->coltot,
                                                     I_oVvV.params->colidx, I_oVvV.params->colorb, I_oVvV.params->rsym,
                                                     I_oVvV.params->ssym, bvir_off_.data(), avir_off_.data(), nbvirpi_.blocks().data(), bvir_off_.data(),
                                                     I_OvVv.params->colidx, bca, 1);
...
double DCTSolver::compute_triples_bbb() {
    int h;
    int Gi, Gj, Gk, Ga, Gb, Gc, Gd, Gl;
    int Gji, Gij, Gjk, Gkj, Gik, Gki, Gijk;
    int Gab, Gbc, Gac;
                    ...
                    for (j = 0; j < nboccpi_[Gj]; j++) {
                        ...
                        for (k = 0; k < nboccpi_[Gk]; k++) {
                            ...
                            if (I > J && J > K) {
                                ...
                                global_dpd_->sort_3d(WBCA, WABC, nirrep_, Gijk, I_ovvv.params->coltot,
                                                     I_ovvv.params->colidx, I_ovvv.params->colorb, I_ovvv.params->rsym,
                                                     I_ovvv.params->ssym, bvir_off_.data(), bvir_off_.data(), nbvirpi_.blocks().data(), bvir_off_.data(),
                                                     I_ovvv.params->colidx, cab, 1);

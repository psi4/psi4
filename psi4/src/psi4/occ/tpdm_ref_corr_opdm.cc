...
#pragma omp parallel for
            for (int ia = 0; ia < G.params->rowtot[h]; ++ia) {
                ...
                for (int jb = 0; jb < G.params->coltot[h]; ++jb) {
                    ...
                    if (i == j && ha == hb) {
                        if (wfn_type_ == "OMP2")
                            G.matrix[h][ia][jb] = 0.5 * gamma1corr->get(ha, aa, bb);
                        else
                            G.matrix[h][ia][jb] += 0.5 * gamma1corr->get(ha, aa, bb);
                    }
                }
...
#pragma omp parallel for
            for (int ia = 0; ia < G.params->rowtot[h]; ++ia) {
                ...
                for (int jb = 0; jb < G.params->coltot[h]; ++jb) {
                    ...
                    if (i == j && ha == hb) {
                        if (wfn_type_ == "OMP2")
                            G.matrix[h][ia][jb] = 0.25 * gamma1corrA->get(ha, aa, bb);
                        else
                            G.matrix[h][ia][jb] += 0.25 * gamma1corrA->get(ha, aa, bb);
                    }
                }
...
#pragma omp parallel for
            for (int ia = 0; ia < G.params->rowtot[h]; ++ia) {
                ...
                for (int jb = 0; jb < G.params->coltot[h]; ++jb) {
                    ...
                    if (i == j && ha == hb) {
                        if (wfn_type_ == "OMP2")
                            G.matrix[h][ia][jb] = 0.25 * gamma1corrB->get(ha, aa, bb);
                        else
                            G.matrix[h][ia][jb] += 0.25 * gamma1corrB->get(ha, aa, bb);
                    }
                }
...
#pragma omp parallel for
            for (int ai = 0; ai < G.params->rowtot[h]; ++ai) {
                ...
                for (int bj = 0; bj < G.params->coltot[h]; ++bj) {
                    ...
                    if (i == j && ha == hb) {
                        if (wfn_type_ == "OMP2")
                            G.matrix[h][ai][bj] = 0.25 * gamma1corrA->get(ha, aa, bb);
                        else
                            G.matrix[h][ai][bj] += 0.25 * gamma1corrA->get(ha, aa, bb);
                    }
                }

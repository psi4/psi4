...
void HF::MOM() {
    ...
    for (int h = 0; h < nirrep_; h++) {
        ...
        // ROHF/ROKS: select DOCC and SOCC against separate overlap pools (rather than one
        // combined occupied pool) so the DOCC/SOCC boundary survives near-degenerate orbitals.

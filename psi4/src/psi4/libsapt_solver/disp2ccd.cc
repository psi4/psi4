...
void SAPT2p::disp2ccd()  //!
{
    ...
    timer_on("CCD Prep           ");
    ccd_prep("T ARAR Amplitudes", "Theta ARAR Amplitudes", "G ARAR Integrals", "G ARRA Integrals", "AAAA Integrals",
             "ARAR Integrals", "AARR Integrals", "RRRR+ Integrals", "RRRR- Integrals", PSIF_SAPT_AA_DF_INTS,
             "AA RI Integrals", "AR RI Integrals", "RR RI Integrals", evalsA_, noccA_, nvirA_, foccA_, mo2noA,
             "T2 ARAR Amplitudes");
    timer_off("CCD Prep           ");
    ccd_iterate("T ARAR Amplitudes", "T ARAR Error", "Theta ARAR Amplitudes", "G ARAR Integrals", "G ARRA Integrals",
                "AAAA Integrals", "ARAR Integrals", "AARR Integrals", "RRRR+ Integrals", "RRRR- Integrals", evalsA_,
    ...
    timer_on("CCD Prep           ");
    ccd_prep("T BSBS Amplitudes", "Theta BSBS Amplitudes", "G BSBS Integrals", "G BSSB Integrals", "BBBB Integrals",
             "BSBS Integrals", "BBSS Integrals", "SSSS+ Integrals", "SSSS- Integrals", PSIF_SAPT_BB_DF_INTS,
             "BB RI Integrals", "BS RI Integrals", "SS RI Integrals", evalsB_, noccB_, nvirB_, foccB_, mo2noB,
             "T2 BSBS Amplitudes");
    timer_off("CCD Prep           ");
    ccd_iterate("T BSBS Amplitudes", "T BSBS Error", "Theta BSBS Amplitudes", "G BSBS Integrals", "G BSSB Integrals",
                "BBBB Integrals", "BSBS Integrals", "BBSS Integrals", "SSSS+ Integrals", "SSSS- Integrals", evalsB_,
    ...
    r_ccd_prep("T ARBS Amplitudes", "ARBS Integrals", "T ARBS (ARBS)", "T ARAR Amplitudes", "Theta ARAR Amplitudes",
               "T BSBS Amplitudes", "Theta BSBS Amplitudes", "G ARAR Integrals", "G BSBS Integrals", "Theta x G ARAR",
               "T x G ARAR", "T x G AA", "T x G RR", "Theta x G BSBS", "T x G BSBS", "T x G BB", "T x G SS",
               PSIF_SAPT_AA_DF_INTS, "AR RI Integrals", PSIF_SAPT_BB_DF_INTS, "BS RI Integrals", evalsA_, evalsB_,
               noccA_, nvirA_, foccA_, noccB_, nvirB_, foccB_);
    timer_off("CCD Disp Prep      ");
    double disp2_ccd =
        r_ccd_iterate("T ARBS Amplitudes", "T ARBS Error", "T ARBS (ARBS)", "G ARRA Integrals", "G BSSB Integrals",
                      "Theta x G ARAR", "T x G AA", "T x G RR", "Theta x G BSBS", "T x G BB", "T x G SS",
                      "ARBS Integrals", evalsA_, evalsB_, noccA_, nvirA_, foccA_, noccB_, nvirB_, foccB_);
    ...
    s_ccd_prep("S ARAR Amplitudes", "S ARAR (tARBS)", "T ARAR Amplitudes", "Theta ARAR Amplitudes", "T ARBS Amplitudes",
               "G BSBS Integrals", "ARBS Integrals", evalsA_, noccA_, nvirA_, foccA_, noccB_, nvirB_, foccB_);
    timer_off("CCD Intra Prep     ");
    disp2_ccd += s_ccd_iterate("S ARAR Amplitudes", "S ARAR Error", "S ARAR (tARBS)", "T ARAR Amplitudes",
                               "G ARAR Integrals", "G ARRA Integrals", "AAAA Integrals", "ARAR Integrals",
                               "AARR Integrals", "RRRR+ Integrals", "RRRR- Integrals", "Theta x G ARAR", "T x G ARAR",
                               "T x G AA", "T x G RR", evalsA_, noccA_, nvirA_, foccA_, mo2noA);
    ...
    timer_on("CCD Intra Prep     ");
    s_ccd_prep("S BSBS Amplitudes", "S BSBS (tBSAR)", "T BSBS Amplitudes", "Theta BSBS Amplitudes", "T BSAR Amplitudes",
               "G ARAR Integrals", "BSAR Integrals", evalsB_, noccB_, nvirB_, foccB_, noccA_, nvirA_, foccA_);
    timer_off("CCD Intra Prep     ");
    disp2_ccd += s_ccd_iterate("S BSBS Amplitudes", "S BSBS Error", "S BSBS (tBSAR)", "T BSBS Amplitudes",
                               "G BSBS Integrals", "G BSSB Integrals", "BBBB Integrals", "BSBS Integrals",
                               "BBSS Integrals", "SSSS+ Integrals", "SSSS- Integrals", "Theta x G BSBS", "T x G BSBS",
                               "T x G BB", "T x G SS", evalsB_, noccB_, nvirB_, foccB_, mo2noB);
    ...
    disp_s_prep("T AR Amplitudes", "T(BS) AR", "Theta ARAR Amplitudes", "T ARBS Amplitudes", PSIF_SAPT_AA_DF_INTS,
                "AA RI Integrals", "AR RI Integrals", "RR RI Integrals", PSIF_SAPT_BB_DF_INTS, "BS RI Integrals",
                evalsA_, noccA_, nvirA_, foccA_, noccB_, nvirB_, foccB_);
    double d220s = disp220s(PSIF_SAPT_CCD, "T AR Amplitudes", "T(BS) AR", PSIF_SAPT_AA_DF_INTS, "AA RI Integrals",
                            "RR RI Integrals", foccA_, noccA_, nvirA_);

    disp_s_prep("T BS Amplitudes", "T(AR) BS", "Theta BSBS Amplitudes", "T BSAR Amplitudes", PSIF_SAPT_BB_DF_INTS,
                "BB RI Integrals", "BS RI Integrals", "SS RI Integrals", PSIF_SAPT_AA_DF_INTS, "AR RI Integrals",
                evalsB_, noccB_, nvirB_, foccB_, noccA_, nvirA_, foccA_);
    double d202s = disp220s(PSIF_SAPT_CCD, "T BS Amplitudes", "T(AR) BS", PSIF_SAPT_BB_DF_INTS, "BB RI Integrals",
...
void SAPT2p::r_ccd_prep(const char *TARBS, const char *ARBS, const char *CA_RBS, const char *TARAR,  //!
                        const char *ThetaARAR, const char *TBSBS, const char *ThetaBSBS, const char *GARAR,
    ...
    C_DGEMM('N', 'T', occA * virA, occB * virB, ndf_, 1.0, &(B_p_AR[0][0]), ndf_, &(B_p_BS[0][0]), ndf_, 0.0,
            &(vARBS[0][0]), occB * virB);

    psio_->write_entry(PSIF_SAPT_CCD, ARBS, (char *)&(vARBS[0][0]), occA * virA * occB * virB * (size_t)sizeof(double));
    ...
    C_DGEMM('N', 'N', occA * virA, occB * virB, occA * virA, 1.0, thARAR[0], occA * virA, vARBS[0], occB * virB, 1.0,
            tARBS[0], occB * virB);
    ...
    C_DGEMM('N', 'N', occA * virA, occB * virB, occB * virB, 1.0, vARBS[0], occB * virB, thBSBS[0], occB * virB, 1.0,
            tARBS[0], occB * virB);

    double **xARBS = block_matrix(occA * virA, occB * virB);  //!

    C_DGEMM('N', 'N', occA * virA, occB * virB, occA * virA, 1.0, thARAR[0], occA * virA, vARBS[0], occB * virB, 0.0,
            xARBS[0], occB * virB);

    C_DGEMM('N', 'N', occA * virA, occB * virB, occB * virB, 1.0, xARBS[0], occB * virB, thBSBS[0], occB * virB, 1.0,
            tARBS[0], occB * virB);
        ...
        for (int r1 = 0; r1 < virA; r1++, a1r1++) {
            for (int b1 = 0, b1s1 = 0; b1 < occB; b1++) {
                for (int s1 = 0; s1 < virB; s1++, b1s1++) {
                    double denom =
                        evalsA_[a1 + foccA_] + evalsB_[b1 + foccB_] - evalsA_[r1 + noccA_] - evalsB_[s1 + noccB_];
    ...
    psio_->read_entry(PSIF_SAPT_CCD, GARAR, (char *)&(gARAR[0][0]), occA * virA * occA * virA * (size_t)sizeof(double));

    C_DGEMM('N', 'N', occA * virA, occA * virA, occA * virA, 1.0, thARAR[0], occA * virA, gARAR[0], occA * virA, 0.0,
            xARAR[0], occA * virA);
    ...
    psio_->read_entry(PSIF_SAPT_CCD, GBSBS, (char *)&(gBSBS[0][0]), occB * virB * occB * virB * (size_t)sizeof(double));

    C_DGEMM('N', 'N', occB * virB, occB * virB, occB * virB, 1.0, thBSBS[0], occB * virB, gBSBS[0], occB * virB, 0.0,
            xBSBS[0], occB * virB);
    ...
    psio_->read_entry(PSIF_SAPT_CCD, TARAR, (char *)&(tARAR[0][0]), occA * virA * occA * virA * (size_t)sizeof(double));

    C_DGEMM('N', 'N', occA * virA, occA * virA, occA * virA, 1.0, tARAR[0], occA * virA, gARAR[0], occA * virA, 0.0,
            yARAR[0], occA * virA);
    ...
    C_DGEMM('N', 'T', occA, occA, virA * occA * virA, 1.0, tARAR[0], virA * occA * virA, gARAR[0], virA * occA * virA,
            0.0, xAA[0], occA);

    C_DGEMM('T', 'N', virA, virA, occA * virA * occA, 1.0, gARAR[0], virA, tARAR[0], virA, 0.0, xRR[0], virA);

    psio_->write_entry(PSIF_SAPT_CCD, XAA, (char *)&(xAA[0][0]), occA * occA * (size_t)sizeof(double));
    psio_->write_entry(PSIF_SAPT_CCD, XRR, (char *)&(xRR[0][0]), virA * virA * (size_t)sizeof(double));
    ...
    psio_->read_entry(PSIF_SAPT_CCD, TBSBS, (char *)&(tBSBS[0][0]), occB * virB * occB * virB * (size_t)sizeof(double));

    C_DGEMM('N', 'N', occB * virB, occB * virB, occB * virB, 1.0, tBSBS[0], occB * virB, gBSBS[0], occB * virB, 0.0,
            yBSBS[0], occB * virB);
    ...
    C_DGEMM('N', 'T', occB, occB, virB * occB * virB, 1.0, tBSBS[0], virB * occB * virB, gBSBS[0], virB * occB * virB,
            0.0, xBB[0], occB);

    C_DGEMM('T', 'N', virB, virB, occB * virB * occB, 1.0, gBSBS[0], virB, tBSBS[0], virB, 0.0, xSS[0], virB);

    psio_->write_entry(PSIF_SAPT_CCD, XBB, (char *)&(xBB[0][0]), occB * occB * (size_t)sizeof(double));
    psio_->write_entry(PSIF_SAPT_CCD, XSS, (char *)&(xSS[0][0]), virB * virB * (size_t)sizeof(double));
...
double SAPT2p::r_ccd_energy(const char *TARBS, const char *ARBS, size_t occA, size_t virA,  //!
    ...
    psio_->read_entry(PSIF_SAPT_CCD, ARBS, (char *)&(vARBS[0][0]), occA * virA * occB * virB * (size_t)sizeof(double));
    psio_->read_entry(PSIF_SAPT_CCD, TARBS, (char *)&(tARBS[0][0]), occA * virA * occB * virB * (size_t)sizeof(double));

    double energy = C_DDOT((size_t)occA * virA * occB * virB, &(vARBS[0][0]), 1, &(tARBS[0][0]), 1);
...
double SAPT2p::r_ccd_iterate(const char *TARBS, const char *TARBSerr, const char *CA_RBS,  //!
                             const char *GARRA, const char *GBSSB, const char *XARAR, const char *XAA, const char *XRR,
                             const char *XBSBS, const char *XBB, const char *XSS, const char *ARBS, double *evalsA_,
    ...
    SAPTDIIS diis(PSIF_SAPT_CCD, TARBS, TARBSerr, (size_t)occA * virA * occB * virB, max_ccd_vecs_, psio_);

    do {
        E_new = r_ccd_energy(TARBS, ARBS, occA, virA, occB, virB);
        outfile->Printf("%4d %16.8lf %17.9lf %17.9lf", iter, E_new * 4000.0, (E_old - E_new) * 4000.0, RMS * 4000.0);

        if (iter > 1 && (4000.0 * std::fabs(E_old - E_new) < ccd_e_conv_ && 4000.0 * RMS < ccd_t_conv_)) {
        ...
        RMS = r_ccd_amplitudes(TARBS, TARBSerr, CA_RBS, GARRA, GBSSB, XARAR, XAA, XRR, XBSBS, XBB, XSS, evalsA_,
                               evalsB_, noccA_, virA, foccA_, noccB_, virB, foccB_);
...
double SAPT2p::r_ccd_amplitudes(const char *TARBS, const char *TARBSerr, const char *CA_RBS,  //!
    ...
    psio_->read_entry(PSIF_SAPT_CCD, GARRA, (char *)&(gARRA[0][0]), occA * virA * occA * virA * (size_t)sizeof(double));

    C_DGEMM('N', 'N', occA * virA, occB * virB, occA * virA, 1.0, gARRA[0], occA * virA, tARBS[0], occB * virB, 1.0,
            t2ARBS[0], occB * virB);
    ...
    psio_->read_entry(PSIF_SAPT_CCD, GBSSB, (char *)&(gBSSB[0][0]), occB * virB * occB * virB * (size_t)sizeof(double));

    C_DGEMM('N', 'N', occA * virA, occB * virB, occB * virB, 1.0, tARBS[0], occB * virB, gBSSB[0], occB * virB, 1.0,
            t2ARBS[0], occB * virB);
    ...
    psio_->read_entry(PSIF_SAPT_CCD, XARAR, (char *)&(xARAR[0][0]), occA * virA * occA * virA * (size_t)sizeof(double));

    double **xAA = block_matrix(occA, occA);
    double **xRR = block_matrix(virA, virA);

    psio_->read_entry(PSIF_SAPT_CCD, XAA, (char *)&(xAA[0][0]), occA * occA * (size_t)sizeof(double));
    psio_->read_entry(PSIF_SAPT_CCD, XRR, (char *)&(xRR[0][0]), virA * virA * (size_t)sizeof(double));

    C_DGEMM('N', 'N', occA * virA, occB * virB, occA * virA, 1.0, xARAR[0], occA * virA, tARBS[0], occB * virB, 1.0,
            t2ARBS[0], occB * virB);

    free_block(xARAR);  //!

    C_DGEMM('N', 'N', occA, virA * occB * virB, occA, -1.0, xAA[0], occA, tARBS[0], virA * occB * virB, 1.0, t2ARBS[0],
            virA * occB * virB);

    for (int a1 = 0; a1 < occA; a1++) {
        C_DGEMM('T', 'N', virA, occB * virB, virA, -1.0, xRR[0], virA, tARBS[a1 * virA], occB * virB, 1.0,
                t2ARBS[a1 * virA], occB * virB);
    }
    ...
    psio_->read_entry(PSIF_SAPT_CCD, XBSBS, (char *)&(xBSBS[0][0]), occB * virB * occB * virB * (size_t)sizeof(double));

    double **xBB = block_matrix(occB, occB);
    double **xSS = block_matrix(virB, virB);

    psio_->read_entry(PSIF_SAPT_CCD, XBB, (char *)&(xBB[0][0]), occB * occB * (size_t)sizeof(double));
    psio_->read_entry(PSIF_SAPT_CCD, XSS, (char *)&(xSS[0][0]), virB * virB * (size_t)sizeof(double));

    C_DGEMM('N', 'T', occA * virA, occB * virB, occB * virB, 1.0, tARBS[0], occB * virB, xBSBS[0], occB * virB, 1.0,
            t2ARBS[0], occB * virB);
    ...
    for (int a1 = 0, a1r1 = 0; a1 < occA; a1++) {
        for (int r1 = 0; r1 < virA; r1++, a1r1++) {
            C_DGEMM('N', 'N', occB, virB, occB, -1.0, xBB[0], occB, tARBS[a1r1], virB, 1.0, t2ARBS[a1r1], virB);
        }
    }

    C_DGEMM('N', 'N', occA * virA * occB, virB, virB, -1.0, tARBS[0], virB, xSS[0], virB, 1.0, t2ARBS[0], virB);
...
void SAPT2p::s_ccd_prep(const char *SARAR, const char *CA_RAR, const char *TARAR, const char *ThetaARAR,  //!
    ...
    C_DGEMM('N', 'T', occA * virA, occA * virA, occB * virB, 2.0, tARBS[0], occB * virB, vARBS[0], occB * virB, 0.0,
            sARAR[0], occA * virA);

    double **xARAR = block_matrix(occA * virA, occA * virA);  //!

    C_DGEMM('N', 'T', occA * virA, occA * virA, occB * virB, 1.0, tARBS[0], occB * virB, vARBS[0], occB * virB, 0.0,
            xARAR[0], occA * virA);
    ...
    C_DGEMM('N', 'N', occA * virA, occA * virA, occA * virA, 2.0, xARAR[0], occA * virA, thARAR[0], occA * virA, 1.0,
            sARAR[0], occA * virA);
    ...
    C_DGEMM('N', 'N', occA, virA * occA * virA, occA, -2.0, xAA[0], occA, tARAR[0], virA * occA * virA, 1.0, sARAR[0],
            virA * occA * virA);

    C_DGEMM('N', 'T', occA * virA * occA, virA, virA, -2.0, tARAR[0], virA, xRR[0], virA, 1.0, sARAR[0], virA);
    ...
    C_DGEMM('N', 'N', occA * virA, occB * virB, occB * virB, 1.0, tARBS[0], occB * virB, gBSBS[0], occB * virB, 0.0,
            xARBS[0], occB * virB);

    C_DGEMM('N', 'T', occA * virA, occA * virA, occB * virB, 1.0, xARBS[0], occB * virB, tARBS[0], occB * virB, 1.0,
            sARAR[0], occA * virA);
        ...
        for (int r1 = 0; r1 < virA; r1++, a1r1++) {
            for (int a2 = 0, a2r2 = 0; a2 < occA; a2++) {
                for (int r2 = 0; r2 < virA; r2++, a2r2++) {
                    double denom =
                        evalsA_[a1 + foccA_] + evalsA_[a2 + foccA_] - evalsA_[r1 + noccA_] - evalsA_[r2 + noccA_];
...
double SAPT2p::s_ccd_iterate(const char *SARAR, const char *SARARerr, const char *CA_RAR, const char *TARAR,  //!
                             const char *GARAR, const char *GARRA, const char *AAAA, const char *ARAR, const char *AARR,
                             const char *RRRRp, const char *RRRRm, const char *XARAR, const char *YARAR,
                             const char *XAA, const char *XRR, double *evalsA_, int noccA_, int virA, int foccA_,
    ...
    SAPTDIIS diis(PSIF_SAPT_CCD, SARAR, SARARerr, (size_t)occA * virA * occA * virA, max_ccd_vecs_, psio_);

    do {
        E_new = ccd_energy(SARAR, GARAR, occA, virA);
        outfile->Printf("%4d %16.8lf %17.9lf %17.9lf", iter, E_new * 1000.0, (E_old - E_new) * 1000.0, RMS * 1000.0);

        if (iter > 1 && (1000.0 * std::fabs(E_old - E_new) < ccd_e_conv_ && 1000.0 * RMS < ccd_t_conv_)) {
            if (iter > min_ccd_vecs_) {
                outfile->Printf("  DIIS\n");
            }
            break;
        ...
        RMS = s_ccd_amplitudes(SARAR, SARARerr, CA_RAR, TARAR, GARAR, GARRA, AAAA, ARAR, AARR, RRRRp, RRRRm, XARAR,
                               YARAR, XAA, XRR, evalsA_, noccA_, virA, foccA_, mo2no);
...
double SAPT2p::s_ccd_amplitudes(const char *SARAR, const char *SARARerr, const char *CA_RAR,  //!
    ...
    psio_->read_entry(PSIF_SAPT_CCD, GARRA, (char *)&(gARRA[0][0]), occA * virA * occA * virA * (size_t)sizeof(double));
    psio_->read_entry(PSIF_SAPT_CCD, SARAR, (char *)&(sARAR[0][0]), occA * virA * occA * virA * (size_t)sizeof(double));

    C_DGEMM('N', 'N', occA * virA, occA * virA, occA * virA, 1.0, gARRA[0], occA * virA, sARAR[0], occA * virA, 1.0,
            s2ARAR[0], occA * virA);
    ...
    psio_->read_entry(PSIF_SAPT_CCD, AAAA, (char *)&(vAAAA[0][0]), occA * occA * occA * occA * (size_t)sizeof(double));

    C_DGEMM('N', 'N', occA * occA, virA * virA, occA * occA, 0.5, vAAAA[0], occA * occA, sAARR[0], virA * virA, 0.5,
            s2AARR[0], virA * virA);
    ...
    psio_->read_entry(PSIF_SAPT_CCD, ARAR, (char *)&(vARAR[0][0]), occA * virA * occA * virA * (size_t)sizeof(double));

    C_DGEMM('N', 'N', occA * virA, occA * virA, occA * virA, -1.0, sARRA[0], occA * virA, vARAR[0], occA * virA, 1.0,
            s2ARAR[0], occA * virA);

    double **vAARR = block_matrix(occA * virA, occA * virA);  //!

    psio_->read_entry(PSIF_SAPT_CCD, AARR, (char *)&(vAARR[0][0]), occA * virA * occA * virA * (size_t)sizeof(double));

    C_DGEMM('N', 'N', occA * virA, occA * virA, occA * virA, -1.0, sARRA[0], occA * virA, vAARR[0], occA * virA, 0.0,
            vARAR[0], occA * virA);
    ...
    C_DGEMM('N', 'N', occA * virA, occA * virA, occA * virA, 1.0, xARAR[0], occA * virA, sARAR[0], occA * virA, 1.0,
            s2ARAR[0], occA * virA);

    psio_->read_entry(PSIF_SAPT_CCD, YARAR, (char *)&(xARAR[0][0]), occA * virA * occA * virA * (size_t)sizeof(double));

    C_DGEMM('N', 'N', occA * virA, occA * virA, occA * virA, -1.0, xARAR[0], occA * virA, sARRA[0], occA * virA, 1.0,
            s2ARAR[0], occA * virA);
    ...
    C_DGEMM('N', 'N', occA, virA * occA * virA, occA, -1.0, xAA[0], occA, sARAR[0], virA * occA * virA, 1.0, s2ARAR[0],
            virA * occA * virA);

    C_DGEMM('N', 'N', occA * virA * occA, virA, virA, -1.0, sARAR[0], virA, xRR[0], virA, 1.0, s2ARAR[0], virA);

    C_DGEMM('N', 'T', occA, occA, virA * occA * virA, 1.0, sARAR[0], virA * occA * virA, gARAR[0], virA * occA * virA,
            0.0, xAA[0], occA);

    C_DGEMM('T', 'N', virA, virA, occA * virA * occA, 1.0, gARAR[0], virA, sARAR[0], virA, 0.0, xRR[0], virA);

    free_block(gARAR);  //!

    C_DGEMM('N', 'N', occA, virA * occA * virA, occA, -1.0, xAA[0], occA, tARAR[0], virA * occA * virA, 1.0, s2ARAR[0],
            virA * occA * virA);

    C_DGEMM('N', 'N', occA * virA * occA, virA, virA, -1.0, tARAR[0], virA, xRR[0], virA, 1.0, s2ARAR[0], virA);
    ...
    C_DGEMM('N', 'N', occA * virA, occA * virA, occA * virA, 1.0, tARRA[0], occA * virA, vARAR[0], occA * virA, 0.0,
            xARAR[0], occA * virA);
    ...
    C_DGEMM('N', 'N', occA * virA, occA * virA, occA * virA, 1.0, tARRA[0], occA * virA, vARRA[0], occA * virA, 0.0,
            xARAR[0], occA * virA);

    free_block(vARRA);                               //!
    vARAR = block_matrix(occA * virA, occA * virA);  //!

    C_DGEMM('N', 'N', occA * virA, occA * virA, occA * virA, 1.0, xARAR[0], occA * virA, sARRA[0], occA * virA, 0.0,
            vARAR[0], occA * virA);
    ...
    psio_->read_entry(PSIF_SAPT_CCD, ARAR, (char *)&(vARRA[0][0]), occA * virA * occA * virA * (size_t)sizeof(double));
    for (int a1 = 0, a1r1 = 0; a1 < occA; a1++) {
        for (int r1 = 0; r1 < virA; r1++, a1r1++) {
            for (int a2 = 0, a2r2 = 0; a2 < occA; a2++) {
                for (int r2 = 0; r2 < virA; r2++, a2r2++) {
    ...
    psio_->read_entry(PSIF_SAPT_CCD, SARAR, (char *)&(sARRA[0][0]), occA * virA * occA * virA * (size_t)sizeof(double));
    for (int a1 = 0, a1r1 = 0; a1 < occA; a1++) {
        for (int r1 = 0; r1 < virA; r1++, a1r1++) {
            for (int a2 = 0, a2r2 = 0; a2 < occA; a2++) {
                for (int r2 = 0; r2 < virA; r2++, a2r2++) {
    ...
    psio_->read_entry(PSIF_SAPT_CCD, TARAR, (char *)&(tARRA[0][0]), occA * virA * occA * virA * (size_t)sizeof(double));
    ...
    C_DGEMM('N', 'T', occA * occA, occA * occA, virA * virA, 1.0, tAARR[0], virA * virA, vAARR[0], virA * virA, 0.0,
            xAAAA[0], occA * occA);

    C_DGEMM('N', 'N', occA * occA, virA * virA, occA * occA, 0.5, xAAAA[0], occA * occA, sAARR[0], virA * virA, 0.0,
            s2AARR[0], virA * virA);

    C_DGEMM('N', 'T', occA * occA, occA * occA, virA * virA, 1.0, sAARR[0], virA * virA, vAARR[0], virA * virA, 0.0,
            xAAAA[0], occA * occA);

    C_DGEMM('N', 'N', occA * occA, virA * virA, occA * occA, 0.5, xAAAA[0], occA * occA, tAARR[0], virA * virA, 1.0,
            s2AARR[0], virA * virA);
...
void SAPT2p::disp_s_prep(const char *TAR, const char *TpAR, const char *ThetaARAR,  //!
    ...
    C_DGEMM('N', 'N', occA * virA, ndf_, occA * virA, 1.0, thARAR[0], occA * virA, B_p_AR[0], ndf_, 0.0, T_p_AR[0],
            ndf_);
    ...
    C_DGEMM('N', 'T', occA, virA, virA * ndf_, 1.0, &(T_p_AR[0][0]), virA * ndf_, &(B_p_RR[0][0]), virA * ndf_, 0.0,
            &(T[0][0]), virA);

    for (int a = 0; a < occA; a++) {
        C_DGEMM('N', 'T', occA, virA, ndf_, -1.0, &(B_p_AA[a * occA][0]), ndf_, &(T_p_AR[a * virA][0]), ndf_, 1.0,
                &(T[0][0]), virA);
    }
    ...
    C_DGEMM('N', 'N', occA * virA, ndf_, occB * virB, 1.0, tARBS[0], occB * virB, B_p_BS[0], ndf_, 0.0, T_p_AR2[0],
            ndf_ + 3);
...
void SAPT2p::vvvv_prep(const char *RRRRp, const char *RRRRm,  //!
                       double **B_p_RR, int virA, int ndf, std::shared_ptr<Matrix> mo2no) {
    timer_on("v^4 Prep           ");
    ...
    if (mo2no) {
        ...
        C_DGEMM('T', 'N', virA2, virA * ndf, virA, 1.0, Vp[0], virA2, B_p_RR[0], virA * ndf, 0.0, B_p_RR3[0],
                virA * ndf);
        for (int a = 0; a < virA2; a++) {
            C_DGEMM('T', 'N', virA2, ndf, virA, 1.0, Vp[0], virA2, B_p_RR3[a * virA], ndf, 0.0, B_p_RR2[a * virA2],
                    ndf);
        }
        B3.reset();
    } else {
    ...
    for (int r1 = 0; r1 < virA2; r1++) {
        for (int r2 = 0; r2 <= r1; r2++) {
            C_DGEMM('N', 'T', virA2, virA2, ndf, 1.0, &(B_p_RR2[r1 * virA2][0]), ndf, &(B_p_RR2[r2 * virA2][0]), ndf,
                    0.0, &(RR[0][0]), virA2);
            ...
            psio_->write(PSIF_SAPT_CCD, RRRRp, (char *)&(xRR[0]), virtri * (size_t)sizeof(double), next_RRRRp,
                         &next_RRRRp);
            ...
            if (r1 != r2) {
                ...
                psio_->write(PSIF_SAPT_CCD, RRRRm, (char *)&(yRR[0]), svirtri * (size_t)sizeof(double), next_RRRRm,
                             &next_RRRRm);
            }
        }
    }
...
#pragma omp parallel for
        for (int i = 0; i < occA; i++) {
            C_DGEMM('T', 'N', virA2, occA * virA2, virA, 1.0, Vp[0], virA2, T2[i * virA], occA * virA2, 0.0,
                    tARAR[i * virA2], occA * virA2);
        }
        free_block(T2);
    } else {
        virA2 = virA;
    ...
    psio_->read(PSIF_SAPT_CCD, RRRRp, (char *)&(vRRRRp[0][0][0]), blocksize * virtri * (size_t)sizeof(double),
                next_RRRRp, &next_RRRRp);
    ...
    for (int r_read = 0; r_read < loopsize; r_read++) {
        ...
        C_DGEMM('N', 'T', occtri, blocksize, virtri, 1.0, tpAARR[0], virtri, vRRRRp[r_read % 2][0], virtri, 1.0,
                &(sAARR[0][r_read * blocksize]), virtri);

        if (r_read < loopsize - 1) aio->synchronize();
    }
    ...
    psio_->read(PSIF_SAPT_CCD, RRRRm, (char *)&(vRRRRm[0][0][0]), blocksize * svirtri * (size_t)sizeof(double),
                next_RRRRm, &next_RRRRm);
    ...
    for (int r_read = 0; r_read < loopsize; r_read++) {
        ...
        C_DGEMM('N', 'T', occtri, blocksize, svirtri, 1.0, tmAARR[0], svirtri, vRRRRm[r_read % 2][0], svirtri, 1.0,
                &(aAARR[0][r_read * blocksize]), svirtri);
...
void SAPT2p::ccd_prep(const char *TARAR, const char *ThetaARAR, const char *GARAR, const char *GARRA,  //!
    ...
    for (int a1 = 0, a1a2 = 0; a1 < occA; a1++) {
        for (int a2 = 0; a2 < occA; a2++, a1a2++) {
            C_DGEMM('N', 'T', occA, occA, ndf_, 1.0, &(B_p_AA[a1 * occA][0]), ndf_, &(B_p_AA[a2 * occA][0]), ndf_, 0.0,
                    &(vAAAA[a1a2][0]), occA);
        }
    }

    psio_->write_entry(PSIF_SAPT_CCD, AAAA, (char *)&(vAAAA[0][0]), occA * occA * occA * occA * (size_t)sizeof(double));
    free_block(vAAAA);
    ...
    for (int a1 = 0, a1r1 = 0; a1 < occA; a1++) {
        for (int r1 = 0; r1 < virA; r1++, a1r1++) {
            C_DGEMM('N', 'T', occA, virA, ndf_, 1.0, &(B_p_AA[a1 * occA][0]), ndf_, &(B_p_RR[r1 * virA][0]), ndf_, 0.0,
                    &(vAARR[a1r1][0]), virA);
        }
    }

    psio_->write_entry(PSIF_SAPT_CCD, AARR, (char *)&(vAARR[0][0]), occA * virA * occA * virA * (size_t)sizeof(double));
    ...
    C_DGEMM('N', 'T', occA * virA, occA * virA, ndf_, 1.0, &(B_p_AR[0][0]), ndf_, &(B_p_AR[0][0]), ndf_, 0.0,
            &(vARAR[0][0]), occA * virA);

    psio_->write_entry(PSIF_SAPT_CCD, ARAR, (char *)&(vARAR[0][0]), occA * virA * occA * virA * (size_t)sizeof(double));
    ...
    for (int a1 = 0, a1r1 = 0; a1 < occA; a1++) {
        for (int r1 = 0; r1 < virA; r1++, a1r1++) {
            for (int a2 = 0, a2r2 = 0; a2 < occA; a2++) {
                for (int r2 = 0; r2 < virA; r2++, a2r2++) {
                    double denom = evals[a1 + foccA] + evals[a2 + foccA] - evals[r1 + noccA] - evals[r2 + noccA];
    ...
    C_DGEMM('N', 'N', occA * occA, virA * virA, occA * occA, 0.5, vAAAA[0], occA * occA, tAARR[0], virA * virA, 0.5,
            t2AARR[0], virA * virA);
    ...
    C_DGEMM('N', 'T', occA * virA, occA * virA, occA * virA, -1.0, tARAR[0], occA * virA, vAARR[0], occA * virA, 1.0,
            t2ARAR[0], occA * virA);
    ...
    C_DGEMM('N', 'T', occA * virA, occA * virA, occA * virA, -1.0, tARRA[0], occA * virA, vAARR[0], occA * virA, 0.0,
            tARAR[0], occA * virA);
    ...
    psio_->read_entry(PSIF_SAPT_CCD, ARAR, (char *)&(vAARR[0][0]), occA * virA * occA * virA * (size_t)sizeof(double));

    psio_->read_entry(PSIF_SAPT_CCD, ThetaARAR, (char *)&(tARAR[0][0]),
                      occA * virA * occA * virA * (size_t)sizeof(double));

    C_DGEMM('N', 'T', occA * virA, occA * virA, occA * virA, 1.0, tARAR[0], occA * virA, vARAR[0], occA * virA, 1.0,
            t2ARAR[0], occA * virA);
...
void SAPT2p::ccd_iterate(const char *TARAR, const char *TARARerr, const char *ThetaARAR,  //!
                         const char *GARAR, const char *GARRA, const char *AAAA, const char *ARAR, const char *AARR,
                         const char *RRRRp, const char *RRRRm, double *evals, int noccA, int virA, int foccA,
                         std::shared_ptr<Matrix> mo2no) {
    ...
    SAPTDIIS diis(PSIF_SAPT_CCD, TARAR, TARARerr, (size_t)occA * virA * occA * virA, max_ccd_vecs_, psio_);

    do {
        E_new = ccd_energy(TARAR, GARAR, occA, virA);
        outfile->Printf("%4d %16.8lf %17.9lf %17.9lf", iter, E_new, E_old - E_new, RMS);

        if (iter > 1 && (std::fabs(E_old - E_new) < ccd_e_conv_ && RMS < ccd_t_conv_)) {
            if (iter > min_ccd_vecs_) {
                outfile->Printf("  DIIS\n");
            }
            break;
        ...
        timer_on("CCD Amps           ");
        RMS = ccd_amplitudes(TARAR, TARARerr, ThetaARAR, GARAR, GARRA, AAAA, ARAR, AARR, RRRRp, RRRRm, evals, noccA,
                             virA, foccA, mo2no);
        timer_off("CCD Amps           ");
...
double SAPT2p::ccd_energy(const char *TARAR, const char *GARAR, size_t occA, size_t virA)  //!
{
    ...
    double energy = C_DDOT((size_t)occA * virA * occA * virA, &(gARAR[0][0]), 1, &(tARAR[0][0]), 1);
...
double SAPT2p::ccd_amplitudes(const char *TARAR, const char *TARARerr, const char *ThetaARAR,  //!
    ...
    psio_->read_entry(PSIF_SAPT_CCD, ARAR, (char *)&(t2ARAR[0][0]), occA * virA * occA * virA * (size_t)sizeof(double));
    ...
    C_DGEMM('N', 'N', occA * virA, occA * virA, occA * virA, 1.0, gARRA[0], occA * virA, tARAR[0], occA * virA, 1.0,
            t2ARAR[0], occA * virA);
    ...
    C_DGEMM('N', 'N', occA * virA, occA * virA, occA * virA, -1.0, tARRA[0], occA * virA, vARAR[0], occA * virA, 1.0,
            t2ARAR[0], occA * virA);
    ...
    C_DGEMM('N', 'N', occA * virA, occA * virA, occA * virA, -1.0, tARRA[0], occA * virA, vAARR[0], occA * virA, 0.0,
            vARAR[0], occA * virA);
    ...
    C_DGEMM('N', 'T', occA * virA, occA * virA, occA * virA, 1.0, tARAR[0], occA * virA, gARAR[0], occA * virA, 0.0,
            xARAR[0], occA * virA);
    ...
    C_DGEMM('N', 'N', occA, virA * occA * virA, occA, -1.0, xAA[0], occA, tARAR[0], virA * occA * virA, 1.0, t2ARAR[0],
            virA * occA * virA);

    C_DGEMM('N', 'N', occA * virA * occA, virA, virA, -1.0, tARAR[0], virA, xRR[0], virA, 1.0, t2ARAR[0], virA);
    ...
    C_DGEMM('N', 'T', occA * virA, occA * virA, occA * virA, 0.5, thARAR[0], occA * virA, xARAR[0], occA * virA, 1.0,
            t2ARAR[0], occA * virA);

    free_block(thARAR);  //!

    C_DGEMM('N', 'T', occA * virA, occA * virA, occA * virA, -0.5, xARAR[0], occA * virA, tARRA[0], occA * virA, 1.0,
            t2ARAR[0], occA * virA);
    ...
    C_DGEMM('N', 'T', occA * virA, occA * virA, occA * virA, 1.0, tARRA[0], occA * virA, vARAR[0], occA * virA, 0.0,
            xARAR[0], occA * virA);
    ...
    C_DGEMM('N', 'N', occA * virA, occA * virA, occA * virA, 1.0, tARRA[0], occA * virA, xARAR[0], occA * virA, 0.0,
            yARAR[0], occA * virA);

    C_DGEMM('N', 'N', occA * virA, occA * virA, occA * virA, 0.5, yARAR[0], occA * virA, tARRA[0], occA * virA, 0.0,
            xARAR[0], occA * virA);
    ...
    C_DGEMM('N', 'T', occA * occA, occA * occA, virA * virA, 1.0, vAARR[0], virA * virA, tAARR[0], virA * virA, 0.0,
            tAAAA[0], occA * occA);

    C_DGEMM('N', 'N', occA * occA, virA * virA, occA * occA, 0.5, tAAAA[0], occA * occA, tAARR[0], virA * virA, 0.0,
            vAARR[0], virA * virA);
...
double **SAPT2p::read_IJKL(int filenum, char *label, int length_IJ, int length_KL) {
    double **A = block_matrix(length_IJ, length_KL);

    psio_->read_entry(filenum, label, (char *)&(A[0][0]), sizeof(double) * length_IJ * (size_t)length_KL);

    return (A);
}

void SAPT2p::write_IJKL(double **A, int filenum, const char *label, int length_IJ, int length_KL) {
    psio_->write_entry(filenum, label, (char *)&(A[0][0]), sizeof(double) * length_IJ * (size_t)length_KL);

    free_block(A);
}

SAPTDIIS::SAPTDIIS(int ampfile, const char *amplabel, const char *errlabel, size_t length, int maxvec,
                   std::shared_ptr<PSIO> psio)
    : psio_(psio), vec_label_(amplabel), err_label_(errlabel) {
    diis_file_ = 56;
...
std::shared_ptr<Matrix> SAPT2p::mo2no(int ampfile, const char *VV_opdm, int nvir, double cutoff) {
    ...
    double **Dp = D->pointer();
    psio_->read_entry(ampfile, VV_opdm, (char *)Dp[0], sizeof(double) * nvir * nvir);
    D->scale(2.0);

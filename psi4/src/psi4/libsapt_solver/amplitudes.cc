...
void SAPT2::amplitudes() {
    tOVOV(PSIF_SAPT_AA_DF_INTS, "AR RI Integrals", foccA_, noccA_, nvirA_, evalsA_, PSIF_SAPT_AA_DF_INTS,
          "AR RI Integrals", foccA_, noccA_, nvirA_, evalsA_, PSIF_SAPT_AMPS, "tARAR Amplitudes");
    tOVOV(PSIF_SAPT_BB_DF_INTS, "BS RI Integrals", foccB_, noccB_, nvirB_, evalsB_, PSIF_SAPT_BB_DF_INTS,
          "BS RI Integrals", foccB_, noccB_, nvirB_, evalsB_, PSIF_SAPT_AMPS, "tBSBS Amplitudes");

    tOVOV(PSIF_SAPT_AA_DF_INTS, "AR RI Integrals", foccA_, noccA_, nvirA_, evalsA_, PSIF_SAPT_BB_DF_INTS,
          "BS RI Integrals", foccB_, noccB_, nvirB_, evalsB_, PSIF_SAPT_AMPS, "tARBS Amplitudes");

    pOOpVV(PSIF_SAPT_AMPS, "tARAR Amplitudes", "tARAR Amplitudes", aoccA_, nvirA_, PSIF_SAPT_AMPS, "pAA Density Matrix",
           "pRR Density Matrix");
    pOOpVV(PSIF_SAPT_AMPS, "tBSBS Amplitudes", "tBSBS Amplitudes", aoccB_, nvirB_, PSIF_SAPT_AMPS, "pBB Density Matrix",
           "pSS Density Matrix");

    if (nat_orbs_t3_ || nat_orbs_t2_) {
        natural_orbitalify(PSIF_SAPT_AMPS, "pRR Density Matrix", evalsA_, foccA_, noccA_, nvirA_, 'A');
        natural_orbitalify(PSIF_SAPT_AMPS, "pSS Density Matrix", evalsB_, foccB_, noccB_, nvirB_, 'B');
        natural_orbitalify_df_ints();
        tOVOV(PSIF_SAPT_AA_DF_INTS, "AR NO RI Integrals", foccA_, noccA_, no_nvirA_, no_evalsA_, PSIF_SAPT_AA_DF_INTS,
              "AR NO RI Integrals", foccA_, noccA_, no_nvirA_, no_evalsA_, PSIF_SAPT_AMPS, "tARAR NO Amplitudes");
        tOVOV(PSIF_SAPT_BB_DF_INTS, "BS NO RI Integrals", foccB_, noccB_, no_nvirB_, no_evalsB_, PSIF_SAPT_BB_DF_INTS,
              "BS NO RI Integrals", foccB_, noccB_, no_nvirB_, no_evalsB_, PSIF_SAPT_AMPS, "tBSBS NO Amplitudes");
        if (print_) outfile->Printf("\n");
    }

    theta(PSIF_SAPT_AMPS, "tARAR Amplitudes", 'N', true, aoccA_, nvirA_, aoccA_, nvirA_, "AR RI Integrals",
          PSIF_SAPT_AMPS, "Theta AR Intermediates");
    theta(PSIF_SAPT_AMPS, "tBSBS Amplitudes", 'N', true, aoccB_, nvirB_, aoccB_, nvirB_, "BS RI Integrals",
          PSIF_SAPT_AMPS, "Theta BS Intermediates");
    ...
    Y2(PSIF_SAPT_AA_DF_INTS, "AA RI Integrals", "AR RI Integrals", "RR RI Integrals", PSIF_SAPT_AMPS,
       "pAA Density Matrix", "pRR Density Matrix", "Theta AR Intermediates", foccA_, noccA_, nvirA_, evalsA_,
       PSIF_SAPT_AMPS, "Y2 AR Amplitudes", "T2 AR Amplitudes");
    Y2(PSIF_SAPT_BB_DF_INTS, "BB RI Integrals", "BS RI Integrals", "SS RI Integrals", PSIF_SAPT_AMPS,
    ...
    if (nat_orbs_t2_) {
        t2OVOV(PSIF_SAPT_AMPS, "tARAR Amplitudes", "tARAR NO Amplitudes", "Theta AR Intermediates",
               PSIF_SAPT_AA_DF_INTS, "AA RI Integrals", "AR RI Integrals", "RR RI Integrals", "RR NO RI Integrals",
               foccA_, noccA_, nvirA_, no_nvirA_, evalsA_, no_CA_, PSIF_SAPT_AMPS, "t2ARAR Amplitudes");
        t2OVOV(PSIF_SAPT_AMPS, "tBSBS Amplitudes", "tBSBS NO Amplitudes", "Theta BS Intermediates",
               PSIF_SAPT_BB_DF_INTS, "BB RI Integrals", "BS RI Integrals", "SS RI Integrals", "SS NO RI Integrals",
               foccB_, noccB_, nvirB_, no_nvirB_, evalsB_, no_CB_, PSIF_SAPT_AMPS, "t2BSBS Amplitudes");
    } else {
        t2OVOV(PSIF_SAPT_AMPS, "tARAR Amplitudes", "Theta AR Intermediates", PSIF_SAPT_AA_DF_INTS, "AA RI Integrals",
               "AR RI Integrals", "RR RI Integrals", foccA_, noccA_, nvirA_, evalsA_, PSIF_SAPT_AMPS,
               "t2ARAR Amplitudes");
        t2OVOV(PSIF_SAPT_AMPS, "tBSBS Amplitudes", "Theta BS Intermediates", PSIF_SAPT_BB_DF_INTS, "BB RI Integrals",
               "BS RI Integrals", "SS RI Integrals", foccB_, noccB_, nvirB_, evalsB_, PSIF_SAPT_AMPS,
               "t2BSBS Amplitudes");
    }

    theta(PSIF_SAPT_AMPS, "t2ARAR Amplitudes", 'N', true, aoccA_, nvirA_, aoccA_, nvirA_, "AR RI Integrals",
          PSIF_SAPT_AMPS, "Theta 2 AR Intermediates");
    theta(PSIF_SAPT_AMPS, "t2BSBS Amplitudes", 'N', true, aoccB_, nvirB_, aoccB_, nvirB_, "BS RI Integrals",
        ...
        for (int r = 0; r < nvirA; r++, ar++) {
            for (int b = 0, bs = 0; b < aoccB; b++) {
                for (int s = 0; s < nvirB; s++, bs++) {
                    tARBS[ar][bs] /= evalsA[a + foccA] + evalsB[b + foccB] - evalsA[r + noccA] - evalsB[s + noccB];
                }
            }
        }
    }

    psio_->write_entry(ampout, amplabel, (char *)tARBS[0], sizeof(double) * aoccA * nvirA * aoccB * nvirB);
...
void SAPT2::pOOpVV(int ampfile, const char *amplabel, const char *thetalabel, size_t aoccA, size_t nvirA, size_t ampout,
    ...
    C_DGEMM('N', 'T', aoccA, aoccA, nvirA * aoccA * nvirA, 1.0, tARAR[0], nvirA * aoccA * nvirA, thetaARAR[0],
            nvirA * aoccA * nvirA, 0.0, pOO[0], aoccA);

    C_DGEMM('T', 'N', nvirA, nvirA, aoccA * nvirA * aoccA, 1.0, tARAR[0], nvirA, thetaARAR[0], nvirA, 0.0, pVV[0],
            nvirA);

    psio_->write_entry(ampout, OOlabel, (char *)pOO[0], sizeof(double) * aoccA * aoccA);
    psio_->write_entry(ampout, VVlabel, (char *)pVV[0], sizeof(double) * nvirA * nvirA);
...
void SAPT2::theta(int ampfile, const char *amplabel, const char trans, bool antisymmetrized, size_t aoccA, size_t nvirA,
    ...
    if (trans == 'N' || trans == 'n') {
        ...
        psio_->write_entry(ampout, thetalabel, (char *)T_p_OV[0], sizeof(double) * aoccA * nvirA * (ndf_ + 3));
        ...
        psio_->write_entry(ampout, thetalabel, (char *)T_p_OV[0], sizeof(double) * aoccB * nvirB * (ndf_ + 3));
...
void SAPT2::Y2(int intfile, const char *AAlabel, const char *ARlabel, const char *RRlabel, int ampfile,
    ...
    psio_->write_entry(ampfile, tlabel, (char *)tAR[0], sizeof(double) * aoccA * nvirA);
    ...
    psio_->write_entry(ampout, Ylabel, (char *)yAR[0], sizeof(double) * aoccA * nvirA);
...
void SAPT2::Y2_1(double **yAR, int intfile, const char *ARlabel, const char *RRlabel, int ampfile, const char *pRRlabel,
    ...
    for (int a = 0; a < aoccA; a++) {
        C_DGEMM('T', 'N', nvirA, ndf_ + 3, nvirA, 1.0, pRR[0], nvirA, B_p_AR[a * nvirA], ndf_ + 3, 0.0,
                C_p_AR[a * nvirA], ndf_ + 3);
    }

    C_DGEMV('n', aoccA * nvirA, ndf_ + 3, 2.0, B_p_AR[0], ndf_ + 3, X, 1, 1.0, yAR[0], 1);

    C_DGEMM('N', 'T', aoccA, nvirA, nvirA * (ndf_ + 3), -1.0, C_p_AR[0], nvirA * (ndf_ + 3), B_p_RR[0],
            nvirA * (ndf_ + 3), 1.0, yAR[0], nvirA);
...
void SAPT2::Y2_2(double **yAR, int intfile, const char *AAlabel, const char *ARlabel, int ampfile, const char *pAAlabel,
    ...
    C_DGEMM('N', 'N', aoccA, aoccA * (ndf_ + 3), aoccA, 1.0, pAA[0], aoccA, B_p_AA[0], aoccA * (ndf_ + 3), 0.0,
            C_p_AA[0], aoccA * (ndf_ + 3));

    C_DGEMV('n', aoccA * nvirA, ndf_ + 3, -2.0, B_p_AR[0], ndf_ + 3, X, 1, 1.0, yAR[0], 1);

    for (int a = 0; a < aoccA; a++) {
        C_DGEMM('N', 'T', aoccA, nvirA, ndf_ + 3, 1.0, C_p_AA[a * aoccA], ndf_ + 3, B_p_AR[a * nvirA], ndf_ + 3, 1.0,
                yAR[0], nvirA);
    }
...
void SAPT2::t2OVOV(int ampfile, const char *tlabel, const char *thetalabel, int intfile, const char *AAlabel,
    ...
    C_DGEMM('N', 'T', aoccA * nvirA, aoccA * nvirA, aoccA * nvirA, -1.0, tARAR, aoccA * nvirA, vAARR[0], aoccA * nvirA,
            0.0, t2ARAR, aoccA * nvirA);

    OVOpVp_to_OVpOpV(tARAR, aoccA, nvirA);
    OVOpVp_to_OVpOpV(t2ARAR, aoccA, nvirA);

    C_DGEMM('N', 'T', aoccA * nvirA, aoccA * nvirA, aoccA * nvirA, -1.0, tARAR, aoccA * nvirA, vAARR[0], aoccA * nvirA,
            1.0, t2ARAR, aoccA * nvirA);
    ...
    for (int a = 0, aa1 = 0; a < aoccA; a++) {
        for (int a1 = 0; a1 < aoccA; a1++, aa1++) {
            C_DGEMM('N', 'T', aoccA, aoccA, ndf_ + 3, 1.0, B_p_AA[a * aoccA], ndf_ + 3, B_p_AA[a1 * aoccA], ndf_ + 3,
                    0.0, vAAAA[aa1], aoccA);
        }
    }
    ...
    C_DGEMM('N', 'N', aoccA * aoccA, nvirA * nvirA, aoccA * aoccA, 0.5, vAAAA[0], aoccA * aoccA, tARAR, nvirA * nvirA,
            1.0, t2ARAR, nvirA * nvirA);
    ...
    for (int r = 0; r < nvirA; r++) {
        C_DGEMM('N', 'T', nvirA, nvirA * nvirA, ndf_ + 3, 1.0, &(B_p_RR[r * nvirA][0]), ndf_ + 3, &(B_p_RR[0][0]),
                ndf_ + 3, 0.0, &(xRRR[0][0]), nvirA * nvirA);
        C_DGEMM('N', 'T', aoccA * aoccA, nvirA * nvirA, nvirA, 0.5, &(tARAR[r * nvirA]), nvirA * nvirA, &(xRRR[0][0]),
                nvirA, 1.0, &(t2ARAR[0]), nvirA * nvirA);
    }
        ...
        for (int r = 0; r < nvirA; r++) {
            for (int a1 = 0; a1 < aoccA; a1++) {
                for (int r1 = 0; r1 < nvirA; r1++) {
                    ...
                    t2ARAR[ara1r1] /= evalsA[a + foccA] + evalsA[a1 + foccA] - evalsA[r + noccA] - evalsA[r1 + noccA];
                }
            }
        }
    }

    psio_->write_entry(ampout, t2label, (char *)t2ARAR, sizeof(double) * aoccA * nvirA * aoccA * nvirA);
...
void SAPT2::t2OVOV(int ampfile, const char *tlabel, const char *no_tlabel, const char *thetalabel, int intfile,
    ...
    for (int a = 0, aaa = 0; a < aoccA; a++) {
        for (int aa = 0; aa < aoccA; aa++, aaa++) {
            ...
            C_DGEMM('N', 'N', nvirA, no_nvirA, nvirA, 1.0, &(t2ARAR[aarr]), nvirA, CA[0], no_nvirA, 0.0, xRR, no_nvirA);
            C_DGEMM('T', 'N', no_nvirA, no_nvirA, nvirA, 1.0, CA[0], no_nvirA, xRR, no_nvirA, 0.0, t2AArr[aaa],
                    no_nvirA);
        }
    }
    ...
    psio_->read_entry(ampfile, no_tlabel, (char *)tArAr, sizeof(double) * aoccA * no_nvirA * aoccA * no_nvirA);
    ...
    for (int r = 0; r < no_nvirA; r++) {
        C_DGEMM('N', 'T', no_nvirA, no_nvirA * no_nvirA, ndf_ + 3, 1.0, &(B_p_RR[r * no_nvirA][0]), ndf_ + 3,
                &(B_p_RR[0][0]), ndf_ + 3, 0.0, &(xRRR[0][0]), no_nvirA * no_nvirA);
        C_DGEMM('N', 'T', aoccA * aoccA, no_nvirA * no_nvirA, no_nvirA, 0.5, &(tArAr[r * no_nvirA]),
                no_nvirA * no_nvirA, &(xRRR[0][0]), no_nvirA, 1.0, &(t2AArr[0][0]), no_nvirA * no_nvirA);
    }
    ...
    for (int a = 0, aaa = 0; a < aoccA; a++) {
        for (int aa = 0; aa < aoccA; aa++, aaa++) {
            long int aarr = (long int)aaa * nvirA * nvirA;
            C_DGEMM('N', 'N', nvirA, no_nvirA, no_nvirA, 1.0, CA[0], no_nvirA, t2AArr[aaa], no_nvirA, 0.0, xRR,
                    no_nvirA);
            C_DGEMM('N', 'T', nvirA, nvirA, no_nvirA, 1.0, xRR, no_nvirA, CA[0], no_nvirA, 0.0, &(t2ARAR[aarr]), nvirA);
        }
    }
...
void SAPT2p::amplitudes() {
    ...
    gARARxtARBS(PSIF_SAPT_AMPS, "tARBS Amplitudes", 'N', PSIF_SAPT_AA_DF_INTS, "AA RI Integrals", "AR RI Integrals",
                "RR RI Integrals", foccA_, noccA_, nvirA_, foccB_, noccB_, nvirB_, PSIF_SAPT_AMPS, "gARAR x tARBS");
    gARARxtARBS(PSIF_SAPT_AMPS, "tARBS Amplitudes", 'T', PSIF_SAPT_BB_DF_INTS, "BB RI Integrals", "BS RI Integrals",
                "SS RI Integrals", foccB_, noccB_, nvirB_, foccA_, noccA_, nvirA_, PSIF_SAPT_AMPS, "gBSBS x tARBS");
}
...
void SAPT2p::gARARxtARBS(int ampfile, const char *tlabel, const char trans, int intfile, const char *AAlabel,
    ...
    if (trans == 'n' || trans == 'N') {
        ...
        C_DGEMM('N', 'N', aoccB * nvirB, aoccA * nvirA, aoccA * nvirA, 1.0, tARBS[0], aoccA * nvirA, gARAR[0],
                aoccA * nvirA, 0.0, xARBS[0], aoccA * nvirA);
    } else
        throw PsiException("You want me to do what to that matrix?", __FILE__, __LINE__);

    psio_->write_entry(ampout, labelout, (char *)xARBS[0], sizeof(double) * aoccA * nvirA * aoccB * nvirB);
...
void SAPT2p3::amplitudes() {
    ...
    pOOpVV(PSIF_SAPT_AMPS, "tARAR Amplitudes", "t2ARAR Amplitudes", aoccA_, nvirA_, PSIF_SAPT_AMPS,
           "qAA Density Matrix", "qRR Density Matrix");
    pOOpVV(PSIF_SAPT_AMPS, "tBSBS Amplitudes", "t2BSBS Amplitudes", aoccB_, nvirB_, PSIF_SAPT_AMPS,
           "qBB Density Matrix", "qSS Density Matrix");

    pOOpVV(PSIF_SAPT_AMPS, "t2ARAR Amplitudes", "tARAR Amplitudes", aoccA_, nvirA_, PSIF_SAPT_AMPS,
           "qbarAA Density Matrix", "qbarRR Density Matrix");
    pOOpVV(PSIF_SAPT_AMPS, "t2BSBS Amplitudes", "tBSBS Amplitudes", aoccB_, nvirB_, PSIF_SAPT_AMPS,
           "qbarBB Density Matrix", "qbarSS Density Matrix");

    Y3(PSIF_SAPT_AA_DF_INTS, "AA RI Integrals", "AR RI Integrals", "RR RI Integrals", PSIF_SAPT_AMPS,
       "qAA Density Matrix", "qRR Density Matrix", "qbarAA Density Matrix", "qbarRR Density Matrix",
       "Theta 2 AR Intermediates", "tARAR Amplitudes", foccA_, noccA_, nvirA_, evalsA_, PSIF_SAPT_AMPS,
       "Y3 AR Amplitudes");
    Y3(PSIF_SAPT_BB_DF_INTS, "BB RI Integrals", "BS RI Integrals", "SS RI Integrals", PSIF_SAPT_AMPS,
       "qBB Density Matrix", "qSS Density Matrix", "qbarBB Density Matrix", "qbarSS Density Matrix",
       "Theta 2 BS Intermediates", "tBSBS Amplitudes", foccB_, noccB_, nvirB_, evalsB_, PSIF_SAPT_AMPS,
       "Y3 BS Amplitudes");
    ...
    if (third_order_) {
        ...
        ind30_amps(PSIF_SAPT_BB_DF_INTS, "BS RI Integrals", PSIF_SAPT_AA_DF_INTS, "AR RI Integrals", wABB_, wABS_,
                   wASS_, wBAR_, noccB_, nvirB_, evalsB_, noccA_, nvirA_, evalsA_, PSIF_SAPT_AMPS,
...
void SAPT2p3::Y3_1(double **yAR, int intfile, const char *AAlabel, const char *ARlabel, int ampfile, const char *tlabel,
    ...
    C_DGEMM('N', 'T', aoccA * aoccA, aoccA * aoccA, nvirA * nvirA, 1.0, tARAR, nvirA * nvirA, tARAR, nvirA * nvirA, 0.0,
            yAAAA, aoccA * aoccA);
    ...
    C_DGEMM('N', 'N', aoccA, nvirA, aoccA * aoccA * aoccA, 1.0, yAAAA, aoccA * aoccA * aoccA, gAAAR[0], nvirA, 1.0,
            yAR[0], nvirA);
...
void SAPT2p3::Y3_2(double **yAR, int intfile, const char *ARlabel, const char *RRlabel, int ampfile, const char *tlabel,
    ...
    for (int r1 = 0, r1r2 = 0; r1 < nvirA; r1++) {
        for (int r2 = 0; r2 <= r1; r2++, r1r2++) {
            ...
            psio_->read(intfile, RRlabel, (char *)&(B_p_RR[r1r2][0]), sizeof(double) * (ndf_ + 3), next_DF_RR,
                        &next_DF_RR);
        }
    }

    for (int a = 0; a < aoccA; a++) {
        C_DGEMM('N', 'T', virtri, nvirA, ndf_ + 3, 1.0, B_p_RR[0], ndf_ + 3, B_p_AR[a * nvirA], ndf_ + 3, 0.0,
                &(RRR[0][0]), nvirA);
        ...
        C_DGEMM('N', 'T', aoccA * aoccA, nvirA, nvirA * nvirA, 1.0, &(tARAR[0]), nvirA * nvirA, &(xRRR[0][0]),
                nvirA * nvirA, 0.0, &(AAAR[a][0]), nvirA);
    }
    ...
    C_DGEMM('N', 'N', aoccA, nvirA, aoccA * aoccA * nvirA, 1.0, &(AAAR[0][0]), aoccA * aoccA * nvirA, &(tARAR[0]),
            nvirA, 1.0, &(yAR[0][0]), nvirA);
...
void SAPT2p3::Y3_3(double **yAR, int intfile, const char *AAlabel, const char *ARlabel, const char *RRlabel,
    ...
    C_DGEMM('N', 'T', aoccA * nvirA, aoccA * nvirA, aoccA * nvirA, 1.0, thetaARAR, aoccA * nvirA, tARAR, aoccA * nvirA,
            0.0, yARAR, aoccA * nvirA);

    C_DCOPY((long int)aoccA * nvirA * aoccA * nvirA, tARAR, 1, thetaARAR, 1);
    OVOpVp_to_OVpOpV(tARAR, aoccA, nvirA);

    C_DGEMM('N', 'T', aoccA * nvirA, aoccA * nvirA, aoccA * nvirA, -1.0, thetaARAR, aoccA * nvirA, tARAR, aoccA * nvirA,
            1.0, yARAR, aoccA * nvirA);
    ...
    C_DGEMM('N', 'T', aoccA, nvirA, nvirA * (ndf_ + 3), 2.0, Y_p_AR[0], nvirA * (ndf_ + 3), B_p_RR[0],
            nvirA * (ndf_ + 3), 1.0, yAR[0], nvirA);

    for (int a = 0; a < aoccA; a++) {
        C_DGEMM('N', 'T', aoccA, nvirA, ndf_ + 3, -2.0, B_p_AA[a * aoccA], ndf_ + 3, Y_p_AR[a * nvirA], ndf_ + 3, 1.0,
                yAR[0], nvirA);
    }
    ...
    C_DGEMM('N', 'N', aoccA * aoccA, ndf_ + 3, nvirA * nvirA, 1.0, yARAR, nvirA * nvirA, B_p_RR[0], ndf_ + 3, 0.0,
            Y_p_AA[0], ndf_ + 3);

    for (int a = 0; a < aoccA; a++) {
        C_DGEMM('N', 'T', aoccA, nvirA, ndf_ + 3, -1.0, Y_p_AA[a * aoccA], ndf_ + 3, B_p_AR[a * nvirA], ndf_ + 3, 1.0,
                yAR[0], nvirA);
    }

    free_block(Y_p_AA);

    C_DGEMM('T', 'N', nvirA * nvirA, ndf_ + 3, aoccA * aoccA, 1.0, yARAR, nvirA * nvirA, B_p_AA[0], ndf_ + 3, 0.0,
            B_p_RR[0], ndf_ + 3);

    C_DGEMM('N', 'T', aoccA, nvirA, nvirA * (ndf_ + 3), 1.0, B_p_AR[0], nvirA * (ndf_ + 3), B_p_RR[0],
            nvirA * (ndf_ + 3), 1.0, yAR[0], nvirA);
...
void SAPT2p3::Y3_4(double **yAR, int intfile, const char *AAlabel, const char *ARlabel, const char *RRlabel,
    ...
    C_DGEMM('N', 'T', aoccA * nvirA, aoccA * nvirA, aoccA * nvirA, 1.0, tARAR, aoccA * nvirA, tARAR, aoccA * nvirA, 0.0,
            yARAR, aoccA * nvirA);
    ...
    C_DGEMM('N', 'T', aoccA, nvirA, nvirA * (ndf_ + 3), 1.0, Y_p_AR[0], nvirA * (ndf_ + 3), B_p_RR[0],
            nvirA * (ndf_ + 3), 1.0, yAR[0], nvirA);

    for (int a = 0; a < aoccA; a++) {
        C_DGEMM('N', 'T', aoccA, nvirA, ndf_ + 3, -1.0, B_p_AA[a * aoccA], ndf_ + 3, Y_p_AR[a * nvirA], ndf_ + 3, 1.0,
                yAR[0], nvirA);
    }
    ...
    for (int a = 0; a < aoccA; a++) {
        C_DGEMM('N', 'T', aoccA, nvirA, ndf_ + 3, -2.0, Y_p_AA[a * aoccA], ndf_ + 3, B_p_AR[a * nvirA], ndf_ + 3, 1.0,
                yAR[0], nvirA);
    }
    ...
    C_DGEMM('N', 'T', aoccA, nvirA, nvirA * (ndf_ + 3), 2.0, B_p_AR[0], nvirA * (ndf_ + 3), B_p_RR[0],
            nvirA * (ndf_ + 3), 1.0, yAR[0], nvirA);
    ...
    for (int a = 0, ar = 0; a < noccA; a++) {
        for (int r = 0; r < nvirA; r++, ar++) {
            for (int b = 0, bs = 0; b < noccB; b++) {
                for (int s = 0; s < nvirB; s++, bs++) {
                    tARBS[ar][bs] /= evalsA[a] + evalsB[b] - evalsA[r + noccA] - evalsB[s + noccB];
                }
            }
        }
    }
...
void SAPT2p3::inddisp30_amps() {
    inddisp30_ov(PSIF_SAPT_AA_DF_INTS, "AA RI Integrals", "RR RI Integrals", PSIF_SAPT_AMPS, "T AR Intermediates",
                 foccA_, noccA_, nvirA_, evalsA_, PSIF_SAPT_AMPS, "IndDisp30 uAR Amplitudes");
    inddisp30_ov(PSIF_SAPT_BB_DF_INTS, "BB RI Integrals", "SS RI Integrals", PSIF_SAPT_AMPS, "T BS Intermediates",
                 foccB_, noccB_, nvirB_, evalsB_, PSIF_SAPT_AMPS, "IndDisp30 uBS Amplitudes");
    inddisp30_ovov();
}
...
void SAPT2p3::inddisp30_ov(int AAfile, const char *AAlabel, const char *RRlabel, int ampfile, const char *Tlabel,
    ...
    C_DGEMM('N', 'T', aoccA, nvirA, nvirA * (ndf_ + 3), 2.0, T_p_AR[0], nvirA * (ndf_ + 3), B_p_RR[0],
            nvirA * (ndf_ + 3), 0.0, uAR[0], nvirA);

    for (int a = 0; a < aoccA; a++) {
        C_DGEMM('N', 'T', aoccA, nvirA, ndf_ + 3, -2.0, B_p_AA[a * aoccA], ndf_ + 3, T_p_AR[a * nvirA], ndf_ + 3, 1.0,
                uAR[0], nvirA);
    }
    ...
    psio_->write_entry(ampout, amplabel, (char *)uAR[0], sizeof(double) * aoccA * nvirA);
...
void SAPT2p3::inddisp30_ovov() {
    ...
    double **B_p_AA = get_DF_ints(PSIF_SAPT_AA_DF_INTS, "AA RI Integrals", foccA_, noccA_, foccA_, noccA_);
    double **B_p_RR = get_DF_ints(PSIF_SAPT_AA_DF_INTS, "RR RI Integrals", 0, nvirA_, 0, nvirA_);
    ...
    C_DGEMM('N', 'N', aoccA_, nvirA_ * (ndf_ + 3), nvirA_, 1.0, sAR[0], nvirA_, B_p_RR[0], nvirA_ * (ndf_ + 3), 0.0,
            X_p_AR[0], nvirA_ * (ndf_ + 3));

    for (int a = 0; a < aoccA_; a++) {
        C_DGEMM('T', 'N', nvirA_, ndf_ + 3, aoccA_, -1.0, sAR[0], nvirA_, B_p_AA[a * aoccA_], ndf_ + 3, 1.0,
                X_p_AR[a * nvirA_], ndf_ + 3);
    }

    C_DGEMM('N', 'T', aoccA_ * nvirA_, aoccB_ * nvirB_, ndf_ + 3, 1.0, X_p_AR[0], ndf_ + 3, B_p_BS[0], ndf_ + 3, 0.0,
            uARBS[0], aoccB_ * nvirB_);
    ...
    double **B_p_BB = get_DF_ints(PSIF_SAPT_BB_DF_INTS, "BB RI Integrals", foccB_, noccB_, foccB_, noccB_);
    double **B_p_SS = get_DF_ints(PSIF_SAPT_BB_DF_INTS, "SS RI Integrals", 0, nvirB_, 0, nvirB_);
    ...
    C_DGEMM('N', 'N', aoccB_, nvirB_ * (ndf_ + 3), nvirB_, 1.0, sBS[0], nvirB_, B_p_SS[0], nvirB_ * (ndf_ + 3), 0.0,
            X_p_BS[0], nvirB_ * (ndf_ + 3));

    for (int b = 0; b < aoccB_; b++) {
        C_DGEMM('T', 'N', nvirB_, ndf_ + 3, aoccB_, -1.0, sBS[0], nvirB_, B_p_BB[b * aoccB_], ndf_ + 3, 1.0,
                X_p_BS[b * nvirB_], ndf_ + 3);
    }

    C_DGEMM('N', 'T', aoccA_ * nvirA_, aoccB_ * nvirB_, ndf_ + 3, 1.0, B_p_AR[0], ndf_ + 3, X_p_BS[0], ndf_ + 3, 1.0,
            uARBS[0], aoccB_ * nvirB_);
    ...
    C_DGEMM('N', 'N', aoccA_, nvirA_ * aoccB_ * nvirB_, aoccA_, -1.0, &(wBAA_[foccA_][foccA_]), noccA_, tARBS[0],
            nvirA_ * aoccB_ * nvirB_, 1.0, uARBS[0], nvirA_ * aoccB_ * nvirB_);

    for (int a = 0; a < aoccA_; a++) {
        C_DGEMM('N', 'N', nvirA_, aoccB_ * nvirB_, nvirA_, 1.0, wBRR_[0], nvirA_, tARBS[a * nvirA_], aoccB_ * nvirB_,
                1.0, uARBS[a * nvirA_], aoccB_ * nvirB_);
    }

    for (int a = 0, ar = 0; a < aoccA_; a++) {
        for (int r = 0; r < nvirA_; r++, ar++) {
            C_DGEMM('N', 'N', aoccB_, nvirB_, aoccB_, -1.0, &(wABB_[foccB_][foccB_]), noccB_, tARBS[ar], nvirB_, 1.0,
                    uARBS[ar], nvirB_);
        }
    }

    C_DGEMM('N', 'N', aoccA_ * nvirA_ * aoccB_, nvirB_, nvirB_, 1.0, tARBS[0], nvirB_, wASS_[0], nvirB_, 1.0, uARBS[0],
            nvirB_);
    ...
    psio_->write_entry(PSIF_SAPT_AMPS, "IndDisp30 uARBS Amplitudes", (char *)uARBS[0],
                       sizeof(double) * aoccA_ * nvirA_ * aoccB_ * nvirB_);
...
void SAPT2p3::disp30_amps(int ampfile, const char *amplabel, int AAintfile, const char *AAlabel, const char *RRlabel,
    ...
    for (int r = 0; r < nvirA; r++) {
        ...
        C_DGEMM('N', 'T', nvirA, nvirB * nvirB, ndf_ + 3, 1.0, B_p_RR[0], ndf_ + 3, &(B_p_SS[0][0]), ndf_ + 3, 0.0,
                &(X_RS[0][0]), nvirB * nvirB);
        C_DGEMM('T', 'T', nvirB, aoccA * aoccB, nvirA * nvirB, 1.0, X_RS[0], nvirB, tABRS[0], nvirA * nvirB, 0.0,
                t2RSAB[r * nvirB], aoccA * aoccB);
    }
    ...
    C_DGEMM('N', 'N', aoccB * nvirA, aoccA * nvirB, aoccB * nvirA, -1.0, &(BRBR[0][0]), aoccB * nvirA, &(tBRAS[0][0]),
            aoccA * nvirB, 1.0, &(t2BRAS[0][0]), aoccA * nvirB);
    ...
    C_DGEMM('N', 'N', aoccB * nvirA, aoccA * nvirB, aoccA * nvirB, -1.0, &(tBRAS[0][0]), aoccA * nvirB, &(ASAS[0][0]),
            aoccA * nvirB, 1.0, &(t2BRAS[0][0]), aoccA * nvirB);
    ...
    psio_->write_entry(ampout, tlabel, (char *)tARBS[0], sizeof(double) * aoccA_ * nvirA_ * aoccB_ * nvirB_);

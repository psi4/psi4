...
void fock_uhf(std::shared_ptr<Wavefunction> ref, Dimension &aoccpi, Dimension &boccpi, Dimension &avirpi,
    ...
    global_dpd_->file2_copy(&fa, PSIF_CC_OEI, "fIJ original");
    global_dpd_->file2_copy(&fb, PSIF_CC_OEI, "fij original");
    ...
    global_dpd_->file2_copy(&fa, PSIF_CC_OEI, "fAB original");
    global_dpd_->file2_copy(&fb, PSIF_CC_OEI, "fab original");
    global_dpd_->file2_close(&fa);
    global_dpd_->file2_close(&fb);
    ...
    global_dpd_->file2_copy(&fa, PSIF_CC_OEI, "fIA original");
    global_dpd_->file2_copy(&fb, PSIF_CC_OEI, "fia original");
    global_dpd_->file2_close(&fa);
    global_dpd_->file2_close(&fb);
}

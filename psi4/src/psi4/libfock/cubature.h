...
class MolecularGrid {
   ...
   public:
    ...
    /// Set of spatially sieved blocks of points of a given atom, generated by sieve() internally
    ...
    /// Set the atomic grids for the blocker.
    void set_atomic_grids(std::vector<std::vector<MassPoint>> grids) { atomic_grids_ = grids; }

...
void DFOCC::lccd_pdm_3index_intr() {
    ...
    if (reference_ == "RESTRICTED") {
        ...
        U.reset();
        L = std::make_shared<Tensor2d>("T2 <IJ|AB>", naoccA, naoccA, navirA, navirA);
        ...
        L = std::make_shared<Tensor2d>("T2 <Ij|Ab>", naoccA, naoccB, navirA, navirB);
        ...
        X = std::make_shared<Tensor2d>("T2 <Ij|bA>", naoccA, naoccB, navirB, navirA);
        ...
        T->read_anti_symm(psio_, PSIF_DFOCC_AMPS);
        L = std::make_shared<Tensor2d>("T2 <ij|ab>", naoccB, naoccB, navirB, navirB);
        L->read_anti_symm(psio_, PSIF_DFOCC_AMPS);
        ...
        T.reset();
        Y = std::make_shared<Tensor2d>("T2 <jI|Ab>", naoccB, naoccA, navirA, navirB);
        ...
        U = std::make_shared<Tensor2d>("T2 <IJ|AB>", naoccA, naoccA, navirA, navirA);
        U->read_anti_symm(psio_, PSIF_DFOCC_AMPS);
        T = std::make_shared<Tensor2d>("T2 (IB|JA)", naoccA, navirA, naoccA, navirA);
        T->sort(1324, U, 1.0, 0.0);
        U.reset();
        X = std::make_shared<Tensor2d>("X (IB|JA)", naoccA, navirA, naoccA, navirA);
        X->gemm(false, false, T, T, 0.5, 0.0);
        ...
        U = std::make_shared<Tensor2d>("T2 <Ij|Ab>", naoccA, naoccB, navirA, navirB);
        U->read(psio_, PSIF_DFOCC_AMPS);
        T = std::make_shared<Tensor2d>("T2 (IA|jb)", naoccA, navirA, naoccB, navirB);
        T->sort(1324, U, 1.0, 0.0);
        U.reset();
        ...
        U = std::make_shared<Tensor2d>("T2 <ij|ab>", naoccB, naoccB, navirB, navirB);
        U->read_anti_symm(psio_, PSIF_DFOCC_AMPS);
        T = std::make_shared<Tensor2d>("T2 (ib|ja)", naoccB, navirB, naoccB, navirB);
        T->sort(1324, U, 1.0, 0.0);
        U.reset();
        ...
        U = std::make_shared<Tensor2d>("T2 <Ij|Ab>", naoccA, naoccB, navirA, navirB);
        U->read(psio_, PSIF_DFOCC_AMPS);
        T = std::make_shared<Tensor2d>("T2p (Ib|jA)", naoccA, navirB, naoccB, navirA);
        ...
        U = std::make_shared<Tensor2d>("T2 <Ij|Ab>", naoccA, naoccB, navirA, navirB);
        U->read(psio_, PSIF_DFOCC_AMPS);
        L = std::make_shared<Tensor2d>("T2 (IA|jb)", naoccA, navirA, naoccB, navirB);

...
/*!
 * \file
 * \brief Function signatures for wrappers to LAPACK subroutines
 * \ingroup QT
 */
 ...
 **/
PSI_API
int C_DGETRI(int n, double* a, int lda, int* ipiv);
...
int C_DGGSVP(char jobu, char jobv, char jobq, int m, int p, int n, double* a, int lda, double* b, int ldb, double tola,
             double tolb, int* k, int* l, double* u, int ldu, double* v, int ldv, double* q, int ldq, double* tau);
 ...
 **/
PSI_API
int C_DSBEVD(char jobz, char uplo, int n, int kd, double* ab, int ldab, double* w, double* z, int ldz, int* iwork);
 ...
 **/
PSI_API
int C_DSPTRI(char uplo, int n, double* ap, int* ipiv);
 ...
 **/
PSI_API
int C_DSYGVD(int itype, char jobz, char uplo, int n, double* a, int lda, double* b, int ldb, double* w, int* iwork);
 ...
 **/
PSI_API
int C_DTGEVC(char side, char howmny, lapack_logical* select, int n, double* s, int lds, double* p, int ldp, double* vl,
 ...
 **/
PSI_API
int C_DTGEXC(lapack_logical* wantq, lapack_logical* wnatz, int n, double* a, int lda, double* b, int ldb, double* q,
...
int C_DTRSEN(char job, char compq, const lapack_logical* select, int n, double* t, int ldt, double* q, int ldq,
             double* wr, double* wi, int* m, double* s, double* sep);

    ...
    if (L_params.ground || L_params.irrep == 0) {
        if (params.ref == 0) { /** RHF **/
            if (!params.restart || !psio_tocscan(PSIF_CC_LAMBDA, "LIA")) {
                ...
                outfile->Printf("\tUsing old L1 amplitudes.\n");
            ...
            if (!params.restart || !psio_tocscan(PSIF_CC_LAMBDA, "LIjAb")) {
                ...
                outfile->Printf("\tUsing old L2 amplitudes.\n");
            ...
            if (!params.restart || !psio_tocscan(PSIF_CC_LAMBDA, "LIA") || !psio_tocscan(PSIF_CC_LAMBDA, "Lia")) {
                global_dpd_->file2_init(&T1, PSIF_CC_OEI, 0, 0, 1, "tIA");
                global_dpd_->file2_copy(&T1, PSIF_CC_LAMBDA, "LIA");
                global_dpd_->file2_close(&T1);
            ...
            if (!params.restart || !psio_tocscan(PSIF_CC_LAMBDA, "LIjAb") || !psio_tocscan(PSIF_CC_LAMBDA, "LIJAB") ||

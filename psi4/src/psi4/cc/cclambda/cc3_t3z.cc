                ...
                for (i = 0; i < occpi[Gi]; i++) {
                    ...
                    for (j = 0; j < occpi[Gj]; j++) {
                        ...
                        for (k = 0; k < occpi[Gk]; k++) {
                            ...
                            global_dpd_->T3_AAA(W1, nirreps, I, Gi, J, Gj, K, Gk, &T2, &F, &E, &fIJ, &fAB, occpi,
                                                occ_off, virtpi, vir_off, 0.0);
                            ...
                            for (Gm = 0; Gm < nirreps; Gm++) {
                                ...
                                if (nrows && ncols) {
                                    for (m = 0; m < occpi[Gm]; m++) {
                                        ...
                                        C_DGEMV('t', nrows, ncols, 0.5, W1[Gab][0], ncols, Dints.matrix[Gmj][mj], 1,
                                                0.0, Z, 1);
                ...
                for (i = 0; i < occpi[Gi]; i++) {
                    ...
                    for (j = 0; j < occpi[Gj]; j++) {
                        ...
                        for (k = 0; k < occpi[Gk]; k++) {
                            ...
                            global_dpd_->T3_AAB(W1, nirreps, I, Gi, J, Gj, K, Gk, &T2AA, &T2AB, &T2BA, &FAA, &FAB, &FBA,
                                                &EAA, &EAB, &EBA, &fIJ, &fij, &fAB, &fab, occpi, occ_off, occpi,
                                                occ_off, virtpi, vir_off, virtpi, vir_off, 0.0);
                            ...
                            for (Gm = 0; Gm < nirreps; Gm++) {
                                ...
                                if (nrows && ncols) {
                                    for (m = 0; m < occpi[Gm]; m++) {
                                        ...
                                        C_DGEMV('n', nrows, ncols, 1.0, W2[Ga][0], ncols, Dints.matrix[Gmk][mk], 1, 0.0,
                                                Z, 1);
                            ...
                            for (Gm = 0; Gm < nirreps; Gm++) {
                                ...
                                if (nrows && ncols) {
                                    for (m = 0; m < occpi[Gm]; m++) {
                                        ...
                                        C_DGEMV('n', nrows, ncols, 1.0, W2[Gb][0], ncols, Dints.matrix[Gmi][mi], 1, 0.0,
                                                Z, 1);
                            ...
                            for (Gm = 0; Gm < nirreps; Gm++) {
                                ...
                                if (nrows && ncols) {
                                    for (m = 0; m < occpi[Gm]; m++) {
                                        ...
                                        C_DGEMV('t', nrows, ncols, 0.5, W1[Gab][0], ncols, DAAints.matrix[Gmj][mj], 1,
                                                0.0, Z, 1);
                                        for (c = 0; c < virtpi[Gc]; c++) {
                                            C = vir_off[Gc] + c;
                                            mc = ZIfLn.params->rowidx[M][C];
                            ...
                            for (Ge = 0; Ge < nirreps; Ge++) {
                                ...
                                if (nrows && ncols && nlinks)
                                    C_DGEMM('n', 'n', nrows, ncols, nlinks, -0.5, &(DAAints.matrix[Gij][ij][eb]),
                                            nlinks, W2[Gb][0], ncols, 1.0, ZDfAn.matrix[Gke][0], ncols);

        ...
        for (h = 0; h < nirreps; h++) {
            ...
            for (ij = 0; ij < DIjAb.params->rowtot[h]; ij++) {
                ...
                for (ab = 0; ab < DIjAb.params->coltot[h ^ C_irr]; ab++) {
                    ...
                    A = a - vir_off[asym];
                    B = b - vir_off[bsym];
                    DIjAb.matrix[h][ij][ab] = FAE.matrix[asym][A][A] + FAE.matrix[bsym][B][B] - FMI.matrix[isym][I][I] -
                                              FMI.matrix[jsym][J][J];
                }
            }
        ...
        for (h = 0; h < nirreps; h++) {
            ...
            for (ij = 0; ij < DIJAB.params->rowtot[h]; ij++) {
                ...
                for (ab = 0; ab < DIJAB.params->coltot[h ^ C_irr]; ab++) {
                    ...
                    A = a - vir_off[asym];
                    B = b - vir_off[bsym];
                    tval = FAE.matrix[asym][A][A] + FAE.matrix[bsym][B][B] - FMI.matrix[isym][I][I] -
                           FMI.matrix[jsym][J][J];
                    DIJAB.matrix[h][ij][ab] =
                        ((A >= (virtpi[asym] - openpi[asym])) || (B >= (virtpi[bsym] - openpi[bsym])) ? 0.0 : tval);
                }
            }
            global_dpd_->buf4_mat_irrep_wrt(&DIJAB, h);
            global_dpd_->buf4_mat_irrep_close(&DIJAB, h);
            ...
            for (ij = 0; ij < Dijab.params->rowtot[h]; ij++) {
                ...
                for (ab = 0; ab < Dijab.params->coltot[h ^ C_irr]; ab++) {
                    ...
                    tval = Fae.matrix[asym][A][A] + Fae.matrix[bsym][B][B] - Fmi.matrix[isym][I][I] -
                           Fmi.matrix[jsym][J][J];
                    Dijab.matrix[h][ij][ab] =
                        ((I >= (occpi[isym] - openpi[isym])) || (J >= (occpi[jsym] - openpi[jsym])) ? 0.0 : tval);
                }
            }
            global_dpd_->buf4_mat_irrep_wrt(&Dijab, h);
            global_dpd_->buf4_mat_irrep_close(&Dijab, h);
            ...
            for (ij = 0; ij < DIjAb.params->rowtot[h]; ij++) {
                ...
                for (ab = 0; ab < DIjAb.params->coltot[h ^ C_irr]; ab++) {
                    ...
                    tval = FAE.matrix[asym][A][A] + Fae.matrix[bsym][B][B] - FMI.matrix[isym][I][I] -
                           Fmi.matrix[jsym][J][J];
                    DIjAb.matrix[h][ij][ab] =
                        ((A >= (virtpi[asym] - openpi[asym])) || (J >= (occpi[jsym] - openpi[jsym])) ? 0.0 : tval);
                }
            }
            global_dpd_->buf4_mat_irrep_wrt(&DIjAb, h);
            global_dpd_->buf4_mat_irrep_close(&DIjAb, h);
        ...
        for (h = 0; h < nirreps; h++) {
            ...
            for (ij = 0; ij < DIJAB.params->rowtot[h]; ij++) {
                ...
                for (ab = 0; ab < DIJAB.params->coltot[h ^ C_irr]; ab++) {
                    ...
                    tval = FAE.matrix[asym][A][A] + FAE.matrix[bsym][B][B] - FMI.matrix[isym][I][I] -
                           FMI.matrix[jsym][J][J];
                    DIJAB.matrix[h][ij][ab] = (((A >= avirtpi[asym]) || (B >= avirtpi[bsym])) ? 0.0 : tval);
                }
            }
            global_dpd_->buf4_mat_irrep_wrt(&DIJAB, h);
            global_dpd_->buf4_mat_irrep_close(&DIJAB, h);
        ...
        for (h = 0; h < nirreps; h++) {
            ...
            for (ij = 0; ij < Dijab.params->rowtot[h]; ij++) {
                ...
                for (ab = 0; ab < Dijab.params->coltot[h ^ C_irr]; ab++) {
                    ...
                    tval = Fae.matrix[asym][A][A] + Fae.matrix[bsym][B][B] - Fmi.matrix[isym][I][I] -
                           Fmi.matrix[jsym][J][J];
                    Dijab.matrix[h][ij][ab] = (((I >= boccpi[isym]) || (J >= boccpi[jsym])) ? 0.0 : tval);
                }
            }
            global_dpd_->buf4_mat_irrep_wrt(&Dijab, h);
            global_dpd_->buf4_mat_irrep_close(&Dijab, h);
        ...
        for (h = 0; h < nirreps; h++) {
            ...
            for (ij = 0; ij < DIjAb.params->rowtot[h]; ij++) {
                ...
                for (ab = 0; ab < DIjAb.params->coltot[h ^ C_irr]; ab++) {
                    ...
                    tval = FAE.matrix[asym][A][A] + Fae.matrix[bsym][B][B] - FMI.matrix[isym][I][I] -
                           Fmi.matrix[jsym][J][J];
                    DIjAb.matrix[h][ij][ab] = (((A >= avirtpi[asym]) || (J >= boccpi[jsym])) ? 0.0 : tval);
                }
            }
            global_dpd_->buf4_mat_irrep_wrt(&DIjAb, h);
            global_dpd_->buf4_mat_irrep_close(&DIjAb, h);

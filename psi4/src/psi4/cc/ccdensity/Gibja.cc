            ...
            for (row = 0; row < G.params->rowtot[h]; row++) {
                ...
                for (col = 0; col < G.params->coltot[h]; col++) {
                    ...
                    if ((Isym == Asym) && (Jsym == Bsym))
                        G.matrix[h][row][col] += L1A.matrix[Isym][I][A] * T1A.matrix[Jsym][J][B];
                }
            }
        ...
        for (h = 0; h < nirreps; h++) {
            ...
            for (row = 0; row < G.params->rowtot[h]; row++) {
                ...
                for (col = 0; col < G.params->coltot[h]; col++) {
                    ...
                    if ((Isym == Asym) && (Jsym == Bsym))
                        G.matrix[h][row][col] += L1B.matrix[Isym][I][A] * T1B.matrix[Jsym][J][B];
                }
            }
        ...
        for (h = 0; h < nirreps; h++) {
            ...
            for (row = 0; row < G.params->rowtot[h]; row++) {
                ...
                for (col = 0; col < G.params->coltot[h]; col++) {
                    ...
                    if ((Isym == Asym) && (Jsym == Bsym))
                        G.matrix[h][row][col] += L1A.matrix[Isym][I][A] * T1B.matrix[Jsym][J][B];
                }
            }
        ...
        for (h = 0; h < nirreps; h++) {
            ...
            for (row = 0; row < G.params->rowtot[h]; row++) {
                ...
                for (col = 0; col < G.params->coltot[h]; col++) {
                    ...
                    if ((Isym == Asym) && (Jsym == Bsym))
                        G.matrix[h][row][col] += L1B.matrix[Isym][I][A] * T1A.matrix[Jsym][J][B];
                }
            }

...
class PSI_API MintsHelper {
   ...
   public:
    ...
    /// Electric Field Operator/Induction Operator TODO: use better name
    SharedMatrix electric_field_operator(SharedMatrix coords, SharedMatrix moment);
    /// Electric Field Value at given sites TODO: use better name
    SharedVector electric_field_value(SharedMatrix coords, SharedMatrix D);

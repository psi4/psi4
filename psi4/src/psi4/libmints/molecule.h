...
class PSI_API Molecule {
   ...
   public:
    ...
    /// z position of atom
    double fz(int atom) const;
    /// Returns a Vector3<double> with x, y, z position of atom
    Vector3<double> xyz(int atom) const;
    Vector3<double> fxyz(int atom) const;
    ...
    int atom_at_position2(Vector3<double>, double tol = 0.05) const;
    ...
    Vector3<double> center_of_mass() const;
    ...
    Vector3<double> nuclear_dipole() const;
    /// The dipole generated by the nuclear charges evaluated using a given origin.
    Vector3<double> nuclear_dipole(const Vector3<double>& origin) const;
    ...
    void translate(const Vector3<double>& r);
    ...
    /// Symmetry
    /// @{
    bool has_symmetry_element(Vector3<double>& op, double tol = DEFAULT_SYM_TOL) const;
    ...
    bool has_inversion(Vector3<double>& origin, double tol = DEFAULT_SYM_TOL) const;
    /// Is a plane?
    bool is_plane(Vector3<double>& origin, Vector3<double>& uperp, double tol = DEFAULT_SYM_TOL) const;
    /// Is an axis?
    bool is_axis(Vector3<double>& origin, Vector3<double>& axis, int order, double tol = DEFAULT_SYM_TOL) const;

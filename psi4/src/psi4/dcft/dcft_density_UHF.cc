...
DCFTSolver::write_molden_file() {
    ...
    SharedMatrix aAONO = std::make_shared<Matrix>("NOs (Alpha)", nirrep_, nsopi_, nmopi_);
    SharedMatrix bAONO = std::make_shared<Matrix>("NOs (Beta)", nirrep_, nsopi_, nmopi_);
    ...
    SharedVector dummy_a = std::make_shared<Vector>("Dummy Vector Alpha", nirrep_, nmopi_);
    SharedVector dummy_b = std::make_shared<Vector>("Dummy Vector Beta", nirrep_, nmopi_);

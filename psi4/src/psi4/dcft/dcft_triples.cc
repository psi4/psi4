...
double DCFTSolver::compute_three_particle_energy() {
...
void DCFTSolver::dcft_semicanonicalize() {
...
void DCFTSolver::transform_integrals_triples() {
...
void DCFTSolver::dump_semicanonical() {
    ...
    SharedMatrix a_evecs = std::make_shared<Matrix>("F0 Eigenvectors (Alpha)", nirrep_, nmopi_, nmopi_);
    SharedMatrix b_evecs = std::make_shared<Matrix>("F0 Eigenvectors (Beta)", nirrep_, nmopi_, nmopi_);
    SharedVector a_evals = std::make_shared<Vector>("F0 Eigenvalues (Alpha)", nirrep_, nmopi_);
    SharedVector b_evals = std::make_shared<Vector>("F0 Eigenvalues (Beta)", nirrep_, nmopi_);
...
void DCFTSolver::semicanonicalize_gbar_ovvv() {
    psio_->open(PSIF_LIBTRANS_DPD, PSIO_OPEN_OLD);
    ...
    global_dpd_->buf4_init(&I, PSIF_LIBTRANS_DPD, 0, ID("[O,V]"), ID("[V,V]"), ID("[O,V]"), ID("[V,V]"), 1,
                           "MO Ints <OV|VV>");
    global_dpd_->buf4_init(&It, PSIF_LIBTRANS_DPD, 0, ID("[O,V]"), ID("[V,V]"), ID("[O,V]"), ID("[V,V]"), 0,
                           "MO Ints <OV||VV'>");
...
void DCFTSolver::semicanonicalize_gbar_ooov() {
    psio_->open(PSIF_LIBTRANS_DPD, PSIO_OPEN_OLD);
    ...
    global_dpd_->buf4_init(&I, PSIF_LIBTRANS_DPD, 0, ID("[V,O]"), ID("[O,O]"), ID("[V,O]"), ID("[O,O]"), 1,
                           "MO Ints <VO|OO>");
    global_dpd_->buf4_init(&It, PSIF_LIBTRANS_DPD, 0, ID("[V,O]"), ID("[O,O]"), ID("[V,O]"), ID("[O,O]"), 0,
                           "MO Ints <VO||OO'>");
    ...
    global_dpd_->buf4_init(&I, PSIF_LIBTRANS_DPD, 0, ID("[O,v]"), ID("[O,o]"), ID("[O,v]"), ID("[O,o]"), 0,
                           "MO Ints <Ov|Oo>");
    global_dpd_->buf4_init(&It, PSIF_LIBTRANS_DPD, 0, ID("[O,v]"), ID("[O,o]"), ID("[O,v]"), ID("[O,o]"), 0,
                           "MO Ints <Ov|Oo'>");
    global_dpd_->contract424(&I, &U_oo, &It, 3, 0, 0, 1.0, 0.0);
    global_dpd_->buf4_close(&It);
    global_dpd_->buf4_close(&I);
...
void DCFTSolver::semicanonicalize_dc() {
    dpdbuf4 L, Lt;
    dpdfile2 U_VV, U_OO, U_vv, U_oo;
    ...
    global_dpd_->buf4_init(&L, PSIF_DCFT_DPD, 0, ID("[O,O]"), ID("[V,V]"), ID("[O>O]-"), ID("[V>V]-"), 0,
                           "Lambda <OO|VV>");
    global_dpd_->buf4_init(&Lt, PSIF_DCFT_DPD, 0, ID("[O,O]"), ID("[V,V]"), ID("[O,O]"), ID("[V,V]"), 0,
                           "Lambda <OO|VV'>");
...
double DCFTSolver::compute_triples_aaa() {
    int h;
                    ...
                    for (j = 0; j < naoccpi_[Gj]; j++) {
                        ...
                        for (k = 0; k < naoccpi_[Gk]; k++) {
                            ...
                            if (I > J && J > K) {
                                ...
                                dijk = 0.0;
                                if (Ftilde_a_->rowspi()[Gi]) dijk += Ftilde_a_->get(Gi, i, i);
                                if (Ftilde_a_->rowspi()[Gj]) dijk += Ftilde_a_->get(Gj, j, j);
                                if (Ftilde_a_->rowspi()[Gk]) dijk += Ftilde_a_->get(Gk, k, k);
                                ...
                                for (Gd = 0; Gd < nirrep_; Gd++) {
                                    ...
                                    I_OVVV.matrix[Gid] =
                                        global_dpd_->dpd_block_matrix(navirpi_[Gd], I_OVVV.params->coltot[Gid]);
                                    ...
                                    if (nrows && ncols && nlinks)
                                        C_DGEMM('t', 't', nrows, ncols, nlinks, -1.0, &(I_OVVV.matrix[Gid][0][0]),
                                                nrows, &(L.matrix[Gjk][jk][cd]), nlinks, 1.0, &(WABC[Gab][0][0]),
                                                ncols);

                                    global_dpd_->free_dpd_block(I_OVVV.matrix[Gid], navirpi_[Gd],
                                                                I_OVVV.params->coltot[Gid]);
                                    ...
                                    I_OVVV.matrix[Gjd] =
                                        global_dpd_->dpd_block_matrix(navirpi_[Gd], I_OVVV.params->coltot[Gjd]);
                                    ...
                                    if (nrows && ncols && nlinks)
                                        C_DGEMM('t', 't', nrows, ncols, nlinks, 1.0, &(I_OVVV.matrix[Gjd][0][0]), nrows,
                                                &(L.matrix[Gik][ik][cd]), nlinks, 1.0, &(WABC[Gab][0][0]), ncols);

                                    global_dpd_->free_dpd_block(I_OVVV.matrix[Gjd], navirpi_[Gd],
                                                                I_OVVV.params->coltot[Gjd]);
                                    ...
                                    I_OVVV.matrix[Gkd] =
                                        global_dpd_->dpd_block_matrix(navirpi_[Gd], I_OVVV.params->coltot[Gkd]);
                                    ...
                                    if (nrows && ncols && nlinks)
                                        C_DGEMM('t', 't', nrows, ncols, nlinks, 1.0, &(I_OVVV.matrix[Gkd][0][0]), nrows,
                                                &(L.matrix[Gji][ji][cd]), nlinks, 1.0, &(WABC[Gab][0][0]), ncols);

                                    global_dpd_->free_dpd_block(I_OVVV.matrix[Gkd], navirpi_[Gd],
                                                                I_OVVV.params->coltot[Gkd]);
                                }
                                ...
                                for (Gl = 0; Gl < nirrep_; Gl++) {
                                    ...
                                    if (nrows && ncols && nlinks)
                                        C_DGEMM('t', 'n', nrows, ncols, nlinks, -1.0, &(L.matrix[Gil][il][0]), nrows,
                                                &(I_OOOV.matrix[Gjk][jk][lc]), ncols, 1.0, &(WABC[Gab][0][0]), ncols);
                                    ...
                                    if (nrows && ncols && nlinks)
                                        C_DGEMM('t', 'n', nrows, ncols, nlinks, 1.0, &(L.matrix[Gjl][jl][0]), nrows,
                                                &(I_OOOV.matrix[Gik][ik][lc]), ncols, 1.0, &(WABC[Gab][0][0]), ncols);
                                    ...
                                    if (nrows && ncols && nlinks)
                                        C_DGEMM('t', 'n', nrows, ncols, nlinks, 1.0, &(L.matrix[Gkl][kl][0]), nrows,
                                                &(I_OOOV.matrix[Gji][ji][lc]), ncols, 1.0, &(WABC[Gab][0][0]), ncols);
                                }
                                ...
                                for (Gd = 0; Gd < nirrep_; Gd++) {
                                    ...
                                    if (nrows && ncols && nlinks)
                                        C_DGEMM('t', 't', nrows, ncols, nlinks, -1.0, &(I_OVVV.matrix[Gid][0][0]),
                                                nrows, &(L.matrix[Gjk][jk][ad]), nlinks, 1.0, &(WBCA[Gbc][0][0]),
                                                ncols);
                                    ...
                                    if (nrows && ncols && nlinks)
                                        C_DGEMM('t', 't', nrows, ncols, nlinks, 1.0, &(I_OVVV.matrix[Gjd][0][0]), nrows,
                                                &(L.matrix[Gik][ik][ad]), nlinks, 1.0, &(WBCA[Gbc][0][0]), ncols);
                                    ...
                                    if (nrows && ncols && nlinks)
                                        C_DGEMM('t', 't', nrows, ncols, nlinks, 1.0, &(I_OVVV.matrix[Gkd][0][0]), nrows,
                                                &(L.matrix[Gji][ji][ad]), nlinks, 1.0, &(WBCA[Gbc][0][0]), ncols);
                                ...
                                for (Gl = 0; Gl < nirrep_; Gl++) {
                                    ...
                                    if (nrows && ncols && nlinks)
                                        C_DGEMM('t', 'n', nrows, ncols, nlinks, -1.0, &(L.matrix[Gil][il][0]), nrows,
                                                &(I_OOOV.matrix[Gjk][jk][la]), ncols, 1.0, &(WBCA[Gbc][0][0]), ncols);
                                    ...
                                    if (nrows && ncols && nlinks)
                                        C_DGEMM('t', 'n', nrows, ncols, nlinks, 1.0, &(L.matrix[Gjl][jl][0]), nrows,
                                                &(I_OOOV.matrix[Gik][ik][la]), ncols, 1.0, &(WBCA[Gbc][0][0]), ncols);
                                    ...
                                    if (nrows && ncols && nlinks)
                                        C_DGEMM('t', 'n', nrows, ncols, nlinks, 1.0, &(L.matrix[Gkl][kl][0]), nrows,
                                                &(I_OOOV.matrix[Gji][ji][la]), ncols, 1.0, &(WBCA[Gbc][0][0]), ncols);
                                }
                                ...
                                for (Gd = 0; Gd < nirrep_; Gd++) {
                                    ...
                                    if (nrows && ncols && nlinks)
                                        C_DGEMM('t', 't', nrows, ncols, nlinks, 1.0, &(I_OVVV.matrix[Gid][0][0]), nrows,
                                                &(L.matrix[Gjk][jk][bd]), nlinks, 1.0, &(WACB[Gac][0][0]), ncols);
                                    ...
                                    if (nrows && ncols && nlinks)
                                        C_DGEMM('t', 't', nrows, ncols, nlinks, -1.0, &(I_OVVV.matrix[Gjd][0][0]),
                                                nrows, &(L.matrix[Gik][ik][bd]), nlinks, 1.0, &(WACB[Gac][0][0]),
                                                ncols);
                                    ...
                                    if (nrows && ncols && nlinks)
                                        C_DGEMM('t', 't', nrows, ncols, nlinks, -1.0, &(I_OVVV.matrix[Gkd][0][0]),
                                                nrows, &(L.matrix[Gji][ji][bd]), nlinks, 1.0, &(WACB[Gac][0][0]),
                                                ncols);
                                ...
                                for (Gl = 0; Gl < nirrep_; Gl++) {
                                    ...
                                    if (nrows && ncols && nlinks)
                                        C_DGEMM('t', 'n', nrows, ncols, nlinks, 1.0, &(L.matrix[Gil][il][0]), nrows,
                                                &(I_OOOV.matrix[Gjk][jk][lb]), ncols, 1.0, &(WACB[Gac][0][0]), ncols);
                                    ...
                                    if (nrows && ncols && nlinks)
                                        C_DGEMM('t', 'n', nrows, ncols, nlinks, -1.0, &(L.matrix[Gjl][jl][0]), nrows,
                                                &(I_OOOV.matrix[Gik][ik][lb]), ncols, 1.0, &(WACB[Gac][0][0]), ncols);
                                    ...
                                    if (nrows && ncols && nlinks)
                                        C_DGEMM('t', 'n', nrows, ncols, nlinks, -1.0, &(L.matrix[Gkl][kl][0]), nrows,
                                                &(I_OOOV.matrix[Gji][ji][lb]), ncols, 1.0, &(WACB[Gac][0][0]), ncols);
                                }
                                ...
                                for (Gab = 0; Gab < nirrep_; Gab++) {
                                    Gc = Gab ^ Gijk;
                                    ET_aaa += dot_block(LABC[Gab], WABC[Gab], I_OVVV.params->coltot[Gab], navirpi_[Gc],
                                                        1.0 / 6.0);
...
double DCFTSolver::compute_triples_aab() {
    int h;
    int Gi, Gj, Gk, Ga, Gb, Gc, Gd, Gl;
    int Gji, Gij, Gjk, Gkj, Gik, Gki, Gijk;
    ...
    global_dpd_->buf4_init(&L_AA, PSIF_DCFT_DPD, 0, ID("[O,O]"), ID("[V,V]"), ID("[O,O]"), ID("[V,V]"), 0,
                           "Lambda <O'O'|V'V'>");
    global_dpd_->buf4_init(&L_AB, PSIF_DCFT_DPD, 0, ID("[O,o]"), ID("[V,v]"), ID("[O,o]"), ID("[V,v]"), 0,
                           "Lambda <O'o'|V'v'>");
    global_dpd_->buf4_init(&L_BA, PSIF_DCFT_DPD, 0, ID("[o,O]"), ID("[v,V]"), ID("[o,O]"), ID("[v,V]"), 0,
                           "Lambda <o'O'|v'V'>");
                    ...
                    for (j = 0; j < naoccpi_[Gj]; j++) {
                        ...
                        for (k = 0; k < nboccpi_[Gk]; k++) {
                            ...
                            if (I > J) {
                                ...
                                if (Ftilde_a_->rowspi()[Gi]) dijk += Ftilde_a_->get(Gi, i, i);
                                if (Ftilde_a_->rowspi()[Gj]) dijk += Ftilde_a_->get(Gj, j, j);
                                if (Ftilde_b_->rowspi()[Gk]) dijk += Ftilde_b_->get(Gk, k, k);
                                ...
                                for (Gd = 0; Gd < nirrep_; Gd++) {
                                    ...
                                    if (nrows && ncols && nlinks)
                                        C_DGEMM('t', 'n', nrows, ncols, nlinks, 1.0, &(I_OVVV.matrix[Gid][0][0]), nrows,
                                                &(L_AB.matrix[Gjk][jk][dc]), ncols, 1.0, &(WABc[Gab][0][0]), ncols);
                                    ...
                                    if (nrows && ncols && nlinks)
                                        C_DGEMM('t', 'n', nrows, ncols, nlinks, -1.0, &(I_OVVV.matrix[Gjd][0][0]),
                                                nrows, &(L_AB.matrix[Gik][ik][dc]), ncols, 1.0, &(WABc[Gab][0][0]),
                                                ncols);
                                ...
                                for (Gl = 0; Gl < nirrep_; Gl++) {
                                    ...
                                    if (nrows && ncols && nlinks)
                                        C_DGEMM('t', 'n', nrows, ncols, nlinks, -1.0, &(L_AA.matrix[Gil][il][0]), nrows,
                                                &(I_OoOv.matrix[Gjk][jk][lc]), ncols, 1.0, &(WABc[Gab][0][0]), ncols);
                                    ...
                                    if (nrows && ncols && nlinks)
                                        C_DGEMM('t', 'n', nrows, ncols, nlinks, 1.0, &(L_AA.matrix[Gjl][jl][0]), nrows,
                                                &(I_OoOv.matrix[Gik][ik][lc]), ncols, 1.0, &(WABc[Gab][0][0]), ncols);
                                }
                                ...
                                for (Gd = 0; Gd < nirrep_; Gd++) {
                                    ...
                                    I_OvVv.matrix[Gid] =
                                        global_dpd_->dpd_block_matrix(nbvirpi_[Gd], I_OvVv.params->coltot[Gid]);
                                    ...
                                    if (nrows && ncols && nlinks)
                                        C_DGEMM('t', 't', nrows, ncols, nlinks, -1.0, &(I_OvVv.matrix[Gid][0][0]),
                                                nrows, &(L_AB.matrix[Gjk][jk][ad]), nlinks, 1.0, &(WBcA[Gbc][0][0]),
                                                ncols);

                                    global_dpd_->free_dpd_block(I_OvVv.matrix[Gid], nbvirpi_[Gd],
                                                                I_OvVv.params->coltot[Gid]);
                                    ...
                                    I_OvVv.matrix[Gjd] =
                                        global_dpd_->dpd_block_matrix(nbvirpi_[Gd], I_OvVv.params->coltot[Gjd]);
                                    ...
                                    if (nrows && ncols && nlinks)
                                        C_DGEMM('t', 't', nrows, ncols, nlinks, 1.0, &(I_OvVv.matrix[Gjd][0][0]), nrows,
                                                &(L_AB.matrix[Gik][ik][ad]), nlinks, 1.0, &(WBcA[Gbc][0][0]), ncols);

                                    global_dpd_->free_dpd_block(I_OvVv.matrix[Gjd], nbvirpi_[Gd],
                                                                I_OvVv.params->coltot[Gjd]);
                                }
                                ...
                                for (Gl = 0; Gl < nirrep_; Gl++) {
                                    ...
                                    if (nrows && ncols && nlinks)
                                        C_DGEMM('t', 'n', nrows, ncols, nlinks, 1.0, &(L_AB.matrix[Gil][il][0]), nrows,
                                                &(I_oOoV.matrix[Gkj][kj][la]), ncols, 1.0, &(WBcA[Gbc][0][0]), ncols);
                                    ...
                                    if (nrows && ncols && nlinks)
                                        C_DGEMM('t', 'n', nrows, ncols, nlinks, -1.0, &(L_AB.matrix[Gjl][jl][0]), nrows,
                                                &(I_oOoV.matrix[Gki][ki][la]), ncols, 1.0, &(WBcA[Gbc][0][0]), ncols);
                                }
                                ...
                                for (Gd = 0; Gd < nirrep_; Gd++) {
                                    ...
                                    if (nrows && ncols && nlinks)
                                        C_DGEMM('t', 't', nrows, ncols, nlinks, 1.0, &(I_OvVv.matrix[Gid][0][0]), nrows,
                                                &(L_AB.matrix[Gjk][jk][bd]), nlinks, 1.0, &(WAcB[Gac][0][0]), ncols);
                                    ...
                                    if (nrows && ncols && nlinks)
                                        C_DGEMM('t', 't', nrows, ncols, nlinks, -1.0, &(I_OvVv.matrix[Gjd][0][0]),
                                                nrows, &(L_AB.matrix[Gik][ik][bd]), nlinks, 1.0, &(WAcB[Gac][0][0]),
                                                ncols);
                                ...
                                for (Gl = 0; Gl < nirrep_; Gl++) {
                                    ...
                                    if (nrows && ncols && nlinks)
                                        C_DGEMM('t', 'n', nrows, ncols, nlinks, -1.0, &(L_AB.matrix[Gil][il][0]), nrows,
                                                &(I_oOoV.matrix[Gkj][kj][lb]), ncols, 1.0, &(WAcB[Gac][0][0]), ncols);
                                    ...
                                    if (nrows && ncols && nlinks)
                                        C_DGEMM('t', 'n', nrows, ncols, nlinks, 1.0, &(L_AB.matrix[Gjl][jl][0]), nrows,
                                                &(I_oOoV.matrix[Gki][ki][lb]), ncols, 1.0, &(WAcB[Gac][0][0]), ncols);
                                }
                                ...
                                for (Gd = 0; Gd < nirrep_; Gd++) {
                                    ...
                                    if (nrows && ncols && nlinks)
                                        C_DGEMM('t', 't', nrows, ncols, nlinks, -1.0, &(I_oVvV.matrix[Gkd][0][0]),
                                                nrows, &(L_AA.matrix[Gji][ji][ad]), nlinks, 1.0, &(WcBA[Gcb][0][0]),
                                                ncols);
                                ...
                                for (Gl = 0; Gl < nirrep_; Gl++) {
                                    ...
                                    if (nrows && ncols && nlinks)
                                        C_DGEMM('t', 'n', nrows, ncols, nlinks, -1.0, &(L_BA.matrix[Gkl][kl][0]), nrows,
                                                &(I_OOOV.matrix[Gji][ji][la]), ncols, 1.0, &(WcBA[Gcb][0][0]), ncols);
                                }
                                ...
                                for (Gd = 0; Gd < nirrep_; Gd++) {
                                    ...
                                    if (nrows && ncols && nlinks)
                                        C_DGEMM('t', 't', nrows, ncols, nlinks, 1.0, &(I_oVvV.matrix[Gkd][0][0]), nrows,
                                                &(L_AA.matrix[Gji][ji][bd]), nlinks, 1.0, &(WcAB[Gca][0][0]), ncols);
                                ...
                                for (Gl = 0; Gl < nirrep_; Gl++) {
                                    ...
                                    if (nrows && ncols && nlinks)
                                        C_DGEMM('t', 'n', nrows, ncols, nlinks, 1.0, &(L_BA.matrix[Gkl][kl][0]), nrows,
                                                &(I_OOOV.matrix[Gji][ji][lb]), ncols, 1.0, &(WcAB[Gca][0][0]), ncols);
                                }
                                ...
                                for (Gab = 0; Gab < nirrep_; Gab++) {
                                    Gc = Gab ^ Gijk;
                                    ET_aab +=
                                        dot_block(LABc[Gab], WABc[Gab], I_OVVV.params->coltot[Gab], nbvirpi_[Gc], 0.5);
                                }
...
double DCFTSolver::compute_triples_abb() {
    int h;
    int Gi, Gj, Gk, Ga, Gb, Gc, Gd, Gl;
    int Gji, Gij, Gjk, Gkj, Gik, Gki, Gijk;
    ...
    global_dpd_->buf4_init(&L_BB, PSIF_DCFT_DPD, 0, ID("[o,o]"), ID("[v,v]"), ID("[o,o]"), ID("[v,v]"), 0,
                           "Lambda <o'o'|v'v'>");
    global_dpd_->buf4_init(&L_AB, PSIF_DCFT_DPD, 0, ID("[O,o]"), ID("[V,v]"), ID("[O,o]"), ID("[V,v]"), 0,
                           "Lambda <O'o'|V'v'>");
    global_dpd_->buf4_init(&L_BA, PSIF_DCFT_DPD, 0, ID("[o,O]"), ID("[v,V]"), ID("[o,O]"), ID("[v,V]"), 0,
                    ...
                    for (j = 0; j < nboccpi_[Gj]; j++) {
                        ...
                        for (k = 0; k < nboccpi_[Gk]; k++) {
                            ...
                            if (J > K) {
                                ...
                                dijk = 0.0;
                                if (Ftilde_a_->rowspi()[Gi]) dijk += Ftilde_a_->get(Gi, i, i);
                                if (Ftilde_b_->rowspi()[Gj]) dijk += Ftilde_b_->get(Gj, j, j);
                                if (Ftilde_b_->rowspi()[Gk]) dijk += Ftilde_b_->get(Gk, k, k);
                                ...
                                for (Gd = 0; Gd < nirrep_; Gd++) {
                                    ...
                                    if (nrows && ncols && nlinks)
                                        C_DGEMM('t', 't', nrows, ncols, nlinks, -1.0, &(I_OvVv.matrix[Gid][0][0]),
                                                nrows, &(L_BB.matrix[Gjk][jk][cd]), nlinks, 1.0, &(WAbc[Gab][0][0]),
                                                ncols);
                                ...
                                for (Gd = 0; Gd < nirrep_; Gd++) {
                                    ...
                                    if (nrows && ncols && nlinks)
                                        C_DGEMM('t', 't', nrows, ncols, nlinks, 1.0, &(I_OvVv.matrix[Gid][0][0]), nrows,
                                                &(L_BB.matrix[Gjk][jk][bd]), nlinks, 1.0, &(WAcb[Gac][0][0]), ncols);
                                ...
                                for (Gd = 0; Gd < nirrep_; Gd++) {
                                    ...
                                    I_ovvv.matrix[Gkd] =
                                        global_dpd_->dpd_block_matrix(nbvirpi_[Gd], I_ovvv.params->coltot[Gkd]);
                                    ...
                                    if (nrows && ncols && nlinks)
                                        C_DGEMM('t', 't', nrows, ncols, nlinks, -1.0, &(I_ovvv.matrix[Gkd][0][0]),
                                                nrows, &(L_AB.matrix[Gij][ij][ad]), nlinks, 1.0, &(WbcA[Gbc][0][0]),
                                                ncols);

                                    global_dpd_->free_dpd_block(I_ovvv.matrix[Gkd], nbvirpi_[Gd],
                                                                I_ovvv.params->coltot[Gkd]);
                                }
                                ...
                                for (Gl = 0; Gl < nirrep_; Gl++) {
                                    ...
                                    if (nrows && ncols && nlinks)
                                        C_DGEMM('t', 'n', nrows, ncols, nlinks, -1.0, &(L_BB.matrix[Gjl][jl][0]), nrows,
                                                &(I_oOoV.matrix[Gki][ki][la]), ncols, 1.0, &(WbcA[Gbc][0][0]), ncols);
                                    ...
                                    if (nrows && ncols && nlinks)
                                        C_DGEMM('t', 'n', nrows, ncols, nlinks, 1.0, &(L_BB.matrix[Gkl][kl][0]), nrows,
                                                &(I_oOoV.matrix[Gji][ji][la]), ncols, 1.0, &(WbcA[Gbc][0][0]), ncols);
                                }
                                ...
                                for (Gd = 0; Gd < nirrep_; Gd++) {
                                    ...
                                    if (nrows && ncols && nlinks)
                                        C_DGEMM('t', 'n', nrows, ncols, nlinks, -1.0, &(I_oVvV.matrix[Gjd][0][0]),
                                                nrows, &(L_AB.matrix[Gik][ik][db]), ncols, 1.0, &(WcAb[Gca][0][0]),
                                                ncols);
                                    ...
                                    if (nrows && ncols && nlinks)
                                        C_DGEMM('t', 'n', nrows, ncols, nlinks, 1.0, &(I_oVvV.matrix[Gkd][0][0]), nrows,
                                                &(L_AB.matrix[Gij][ij][db]), ncols, 1.0, &(WcAb[Gca][0][0]), ncols);
                                ...
                                for (Gl = 0; Gl < nirrep_; Gl++) {
                                    ...
                                    if (nrows && ncols && nlinks)
                                        C_DGEMM('t', 'n', nrows, ncols, nlinks, 1.0, &(L_BA.matrix[Gjl][jl][0]), nrows,
                                                &(I_OoOv.matrix[Gik][ik][lb]), ncols, 1.0, &(WcAb[Gca][0][0]), ncols);
                                    ...
                                    if (nrows && ncols && nlinks)
                                        C_DGEMM('t', 'n', nrows, ncols, nlinks, -1.0, &(L_BA.matrix[Gkl][kl][0]), nrows,
                                                &(I_OoOv.matrix[Gij][ij][lb]), ncols, 1.0, &(WcAb[Gca][0][0]), ncols);
                                }
                                ...
                                for (Gd = 0; Gd < nirrep_; Gd++) {
                                    ...
                                    if (nrows && ncols && nlinks)
                                        C_DGEMM('t', 'n', nrows, ncols, nlinks, 1.0, &(I_oVvV.matrix[Gjd][0][0]), nrows,
                                                &(L_AB.matrix[Gik][ik][dc]), ncols, 1.0, &(WbAc[Gba][0][0]), ncols);
                                    ...
                                    if (nrows && ncols && nlinks)
                                        C_DGEMM('t', 'n', nrows, ncols, nlinks, -1.0, &(I_oVvV.matrix[Gkd][0][0]),
                                                nrows, &(L_AB.matrix[Gij][ij][dc]), ncols, 1.0, &(WbAc[Gba][0][0]),
                                                ncols);
                                ...
                                for (Gl = 0; Gl < nirrep_; Gl++) {
                                    ...
                                    if (nrows && ncols && nlinks)
                                        C_DGEMM('t', 'n', nrows, ncols, nlinks, -1.0, &(L_BA.matrix[Gjl][jl][0]), nrows,
                                                &(I_OoOv.matrix[Gik][ik][lc]), ncols, 1.0, &(WbAc[Gba][0][0]), ncols);
                                    ...
                                    if (nrows && ncols && nlinks)
                                        C_DGEMM('t', 'n', nrows, ncols, nlinks, 1.0, &(L_BA.matrix[Gkl][kl][0]), nrows,
                                                &(I_OoOv.matrix[Gij][ij][lc]), ncols, 1.0, &(WbAc[Gba][0][0]), ncols);
                                }
...
double DCFTSolver::compute_triples_bbb() {
    int h;
    int Gi, Gj, Gk, Ga, Gb, Gc, Gd, Gl;
    int Gji, Gij, Gjk, Gkj, Gik, Gki, Gijk;
    int Gab, Gbc, Gac;
                    ...
                    for (j = 0; j < nboccpi_[Gj]; j++) {
                        ...
                        for (k = 0; k < nboccpi_[Gk]; k++) {
                            ...
                            if (I > J && J > K) {
                                ...
                                dijk = 0.0;
                                if (Ftilde_b_->rowspi()[Gi]) dijk += Ftilde_b_->get(Gi, i, i);
                                if (Ftilde_b_->rowspi()[Gj]) dijk += Ftilde_b_->get(Gj, j, j);
                                if (Ftilde_b_->rowspi()[Gk]) dijk += Ftilde_b_->get(Gk, k, k);
                                ...
                                for (Gab = 0; Gab < nirrep_; Gab++) {
                                    Gc = Gab ^ Gijk;
                                    ET_bbb += dot_block(LABC[Gab], WABC[Gab], I_ovvv.params->coltot[Gab], nbvirpi_[Gc],
                                                        1.0 / 6.0);
                                    global_dpd_->free_dpd_block(WABC[Gab], I_ovvv.params->coltot[Gab], nbvirpi_[Gc]);
                                    global_dpd_->free_dpd_block(LABC[Gab], I_ovvv.params->coltot[Gab], nbvirpi_[Gc]);
                                }

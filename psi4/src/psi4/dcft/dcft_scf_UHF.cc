 ...
 */
bool DCFTSolver::correct_mo_phases(bool dieOnError) {
 ...
 */
void DCFTSolver::print_orbital_energies() {
 ...
 */
void DCFTSolver::compute_scf_energy() {
 ...
 * @return RMS error
 */
double DCFTSolver::compute_scf_error_vector() {
 ...
 */
double DCFTSolver::update_scf_density(bool damp) {
 ...
 */
void DCFTSolver::process_so_ints() {
    ...
    if (buildTensors) {
        ...
        /********** AA ***********/
        global_dpd_->buf4_init(&lambda, PSIF_DCFT_DPD, 0, ID("[O,O]"), ID("[V,V]"), ID("[O>O]-"), ID("[V>V]-"), 0,
                               "Lambda <OO|VV>");
        global_dpd_->buf4_init(&tau1_AO_aa, PSIF_DCFT_DPD, 0, ID("[O,O]"), ID("[n,n]"), ID("[O,O]"), ID("[n,n]"), 0,
                               "tau1AO <OO|nn>");
        ...
        global_dpd_->buf4_init(&tau1_AO_aa, PSIF_DCFT_DPD, 0, ID("[O,O]"), ID("[n,n]"), ID("[O,O]"), ID("[n,n]"), 1,
                               "tau1AO <OO|nn>");
        ...
        global_dpd_->buf4_init(&tau1_AO_aa, PSIF_DCFT_DPD, 0, ID("[n,n]"), ID("[O,O]"), ID("[n,n]"), ID("[O,O]"), 0,
                               "tau1AO <nn|OO>");
        global_dpd_->buf4_init(&tau2_AO_aa, PSIF_DCFT_DPD, 0, ID("[n,n]"), ID("[O,O]"), ID("[n,n]"), ID("[O,O]"), 0,
                               "tau2AO <nn|OO>");
        ...
        global_dpd_->buf4_init(&lambda, PSIF_DCFT_DPD, 0, ID("[o,o]"), ID("[v,v]"), ID("[o>o]-"), ID("[v>v]-"), 0,
                               "Lambda <oo|vv>");
        global_dpd_->buf4_init(&tau1_AO_bb, PSIF_DCFT_DPD, 0, ID("[o,o]"), ID("[n,n]"), ID("[o,o]"), ID("[n,n]"), 0,
                               "tau1AO <oo|nn>");
        ...
        // Now sort for better memory access patterns
        global_dpd_->buf4_init(&tau1_AO_bb, PSIF_DCFT_DPD, 0, ID("[o,o]"), ID("[n,n]"), ID("[o,o]"), ID("[n,n]"), 1,
                               "tau1AO <oo|nn>");
        global_dpd_->buf4_sort(&tau1_AO_bb, PSIF_DCFT_DPD, rspq, ID("[n,n]"), ID("[o,o]"), "tau1AO <nn|oo>");
        global_dpd_->buf4_close(&tau1_AO_bb);

        // Now reopen the two AO dpd_buf4's
        global_dpd_->buf4_init(&tau1_AO_bb, PSIF_DCFT_DPD, 0, ID("[n,n]"), ID("[o,o]"), ID("[n,n]"), ID("[o,o]"), 0,
                               "tau1AO <nn|oo>");
        global_dpd_->buf4_init(&tau2_AO_bb, PSIF_DCFT_DPD, 0, ID("[n,n]"), ID("[o,o]"), ID("[n,n]"), ID("[o,o]"), 0,
                               "tau2AO <nn|oo>");
        ...
        global_dpd_->buf4_init(&lambda, PSIF_DCFT_DPD, 0, ID("[O,o]"), ID("[V,v]"), ID("[O,o]"), ID("[V,v]"), 0,
                               "Lambda <Oo|Vv>");
        global_dpd_->buf4_init(&tau1_AO_ab, PSIF_DCFT_DPD, 0, ID("[O,o]"), ID("[n,n]"), ID("[O,o]"), ID("[n,n]"), 0,
                               "tau1AO <Oo|nn>");
        ...
        global_dpd_->buf4_init(&tau1_AO_ab, PSIF_DCFT_DPD, 0, ID("[n,n]"), ID("[O,o]"), ID("[n,n]"), ID("[O,o]"), 0,
                               "tau1AO <nn|Oo>");
        global_dpd_->buf4_init(&tau2_AO_ab, PSIF_DCFT_DPD, 0, ID("[n,n]"), ID("[O,o]"), ID("[n,n]"), ID("[O,o]"), 0,
                               "tau2AO <nn|Oo>");
    ...
    if (buildTensors) {
        ...
        global_dpd_->buf4_close(&tau2_AO_aa);
        global_dpd_->buf4_init(&tau2_AO_aa, PSIF_DCFT_DPD, 0, ID("[O,O]"), ID("[n,n]"), ID("[O,O]"), ID("[n,n]"), 0,
                               "tau2AO <OO|nn>");
        global_dpd_->buf4_init(&tau_temp, PSIF_DCFT_DPD, 0, ID("[O,O]"), ID("[V,V]"), ID("[O,O]"), ID("[V,V]"), 0,
                               "tau(temp) <OO|VV>");
        ...
        global_dpd_->buf4_close(&tau2_AO_bb);
        global_dpd_->buf4_init(&tau2_AO_bb, PSIF_DCFT_DPD, 0, ID("[o,o]"), ID("[n,n]"), ID("[o,o]"), ID("[n,n]"), 0,
                               "tau2AO <oo|nn>");
        global_dpd_->buf4_init(&tau_temp, PSIF_DCFT_DPD, 0, ID("[o,o]"), ID("[v,v]"), ID("[o,o]"), ID("[v,v]"), 0,
                               "tau(temp) <oo|vv>");
        global_dpd_->buf4_scm(&tau_temp, 0.0);
        ...
        global_dpd_->buf4_close(&tau2_AO_ab);
        global_dpd_->buf4_init(&tau2_AO_ab, PSIF_DCFT_DPD, 0, ID("[O,o]"), ID("[n,n]"), ID("[O,o]"), ID("[n,n]"), 0,
                               "tau2AO <Oo|nn>");
        global_dpd_->buf4_init(&tau_temp, PSIF_DCFT_DPD, 0, ID("[O,o]"), ID("[V,v]"), ID("[O,o]"), ID("[V,v]"), 0,
                               "tau(temp) <Oo|Vv>");
        global_dpd_->buf4_scm(&tau_temp, 0.0);
 ...
 */
void DCFTSolver::build_AO_tensors() {

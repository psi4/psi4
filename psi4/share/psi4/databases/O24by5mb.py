...
# <<< Comment Lines >>>
TAGL = {}
TAGL["%s-%s" % (dbse, "1-0.9")] = """ CN He R=0.9R_eq"""
...
TAGL["%s-%s" % (dbse, "1-1.0")] = """ CN He R=1.0R_eq"""
...
TAGL["%s-%s" % (dbse, "1-1.2")] = """ CN He R=1.2R_eq"""
...
TAGL["%s-%s" % (dbse, "1-1.5")] = """ CN He R=1.5R_eq"""
...
TAGL["%s-%s" % (dbse, "1-2.0")] = """ CN He R=2.0R_eq"""
...
TAGL["%s-%s" % (dbse, "2-0.9")] = """ NH He R=0.9R_eq"""
...
TAGL["%s-%s" % (dbse, "2-1.2")] = """ NH He R=1.2R_eq"""
...
TAGL["%s-%s" % (dbse, "2-1.5")] = """ NH He R=1.5R_eq"""
...
TAGL["%s-%s" % (dbse, "2-2.0")] = """ NH He R=2.0R_eq"""
...
TAGL["%s-%s" % (dbse, "3-0.9")] = """ C2H3 - C2H4 R=0.9R_eq"""
...
TAGL["%s-%s" % (dbse, "3-1.0")] = """ C2H3 - C2H4 R=1.0R_eq"""
...
TAGL["%s-%s" % (dbse, "3-1.2")] = """ C2H3 - C2H4 R=1.2R_eq"""
...
TAGL["%s-%s" % (dbse, "3-1.5")] = """C2H3 C2H4 R=1.5R_eq"""
...
TAGL["%s-%s" % (dbse, "3-2.0")] = """ C2H3 C2H4 R=2.0R_eq"""
...
TAGL["%s-%s" % (dbse, "4-0.9")] = """ O2 H2 R=0.9R_eq"""
...
TAGL["%s-%s" % (dbse, "4-1.0")] = """ O2 H2 R=1.0R_eq"""
...
TAGL["%s-%s" % (dbse, "4-1.2")] = """ O2 H2 R=1.2R_eq"""
...
TAGL["%s-%s" % (dbse, "4-1.5")] = """ O2 H2 R=1.5R_eq"""
...
TAGL["%s-%s" % (dbse, "4-2.0")] = """ O2 H2 R=2.0R_eq"""
...
TAGL["%s-%s" % (dbse, "5-0.9")] = """ NH Ar R=0.9R_eq"""
...
TAGL["%s-%s" % (dbse, "5-1.0")] = """ NH Ar R=1.0R_eq"""
...
TAGL["%s-%s" % (dbse, "5-1.2")] = """ NH Ar R=1.2R_eq"""
...
TAGL["%s-%s" % (dbse, "5-1.5")] = """ NH Ar R=1.5R_eq"""
...
TAGL["%s-%s" % (dbse, "5-2.0")] = """ NH Ar R=2.0R_eq"""
...
TAGL["%s-%s" % (dbse, "6-0.9")] = """ CN Ar R=0.9R_eq"""
...
TAGL["%s-%s" % (dbse, "6-1.0")] = """ CN Ar R=1.0R_eq"""
...
TAGL["%s-%s" % (dbse, "6-1.2")] = """ CN Ar R=1.2R_eq"""
...
TAGL["%s-%s" % (dbse, "6-1.5")] = """ CN Ar R=1.5R_eq"""
...
TAGL["%s-%s" % (dbse, "6-2.0")] = """ CN Ar R=2.0R_eq"""
...
TAGL["%s-%s" % (dbse, "7-0.9")] = """ O2 N2 R=0.9R_eq"""
...
TAGL["%s-%s" % (dbse, "7-1.0")] = """ O2 N2 R=1.0R_eq"""
...
TAGL["%s-%s" % (dbse, "7-1.2")] = """ O2 N2 R=1.2R_eq"""
...
TAGL["%s-%s" % (dbse, "7-1.5")] = """ O2 N2 R=1.5R_eq"""
...
TAGL["%s-%s" % (dbse, "7-2.0")] = """ O2 N2 R=2.0R_eq"""
...
TAGL["%s-%s" % (dbse, "8-0.9")] = """ H2O O2 (sp) R=0.9R_eq"""
...
TAGL["%s-%s" % (dbse, "8-1.0")] = """ H2O O2 (sp) R=1.0R_eq"""
...
TAGL["%s-%s" % (dbse, "8-1.2")] = """ H2O O2 (sp) R=1.2R_eq"""
...
TAGL["%s-%s" % (dbse, "8-1.5")] = """ H2O O2 (sp) R=1.5R_eq"""
...
TAGL["%s-%s" % (dbse, "8-2.0")] = """ H2O O2 (sp) R=2.0R_eq"""
...
TAGL["%s-%s" % (dbse, "9-0.9")] = """ O2 O2 R=0.9R_eq"""
...
TAGL["%s-%s" % (dbse, "9-1.0")] = """ O2 O2 R=1.0R_eq"""
...
TAGL["%s-%s" % (dbse, "9-1.2")] = """ O2 O2 R=1.2R_eq"""
...
TAGL["%s-%s" % (dbse, "9-1.5")] = """ O2 O2 R=1.5R_eq"""
...
TAGL["%s-%s" % (dbse, "9-2.0")] = """ O2 O2 R=2.0R_eq"""
...
TAGL["%s-%s" % (dbse, "10-0.9")] = """ NH NH R=0.9R_eq"""
...
TAGL["%s-%s" % (dbse, "10-1.0")] = """ NH NH R=1.0R_eq"""
...
TAGL["%s-%s" % (dbse, "10-1.2")] = """ NH NH R=1.2R_eq"""
...
TAGL["%s-%s" % (dbse, "10-1.5")] = """ NH NH R=1.5R_eq"""
...
TAGL["%s-%s" % (dbse, "10-2.0")] = """ NH NH R=2.0R_eq"""
...
TAGL["%s-%s" % (dbse, "11-0.9")] = """ CH2O NH2 R=0.9R_eq"""
...
TAGL["%s-%s" % (dbse, "11-1.2")] = """ CH2O NH2 R=1.2R_eq"""
...
TAGL["%s-%s" % (dbse, "11-1.5")] = """ CH2O NH2 R=1.5R_eq"""
...
TAGL["%s-%s" % (dbse, "11-2.0")] = """ CH2O NH2 R=2.0R_eq"""
...
TAGL["%s-%s" % (dbse, "12-0.9")] = """ H2O Na R=0.9R_eq"""
...
TAGL["%s-%s" % (dbse, "12-1.0")] = """ H2O Na R=1.0R_eq"""
...
TAGL["%s-%s" % (dbse, "12-1.2")] = """ H2O Na R=1.2R_eq"""
...
TAGL["%s-%s" % (dbse, "12-1.5")] = """ H2O Na R=1.5R_eq"""
...
TAGL["%s-%s" % (dbse, "12-2.0")] = """ H2O Na R=2.0R_eq"""
...
TAGL["%s-%s" % (dbse, "13-0.9")] = """ H2O OH R=0.9R_eq"""
...
TAGL["%s-%s" % (dbse, "13-1.2")] = """ H2O OH R=1.2R_eq"""
...
TAGL["%s-%s" % (dbse, "13-1.5")] = """ H2O OH R=1.5R_eq"""
...
TAGL["%s-%s" % (dbse, "13-2.0")] = """ H2O OH R=1.5R_eq"""
...
TAGL["%s-%s" % (dbse, "14-0.9")] = """ H2O O2H R=0.9R_eq"""
...
TAGL["%s-%s" % (dbse, "14-1.0")] = """ H2O O2H R=1.0R_eq"""
...
TAGL["%s-%s" % (dbse, "14-1.2")] = """ H2O O2H R=1.2R_eq"""
...
TAGL["%s-%s" % (dbse, "14-1.5")] = """ H2O O2H R=1.5R_eq"""
...
TAGL["%s-%s" % (dbse, "14-2.0")] = """ H2O O2H R=2.0R_eq"""
...
TAGL["%s-%s" % (dbse, "15-0.9")] = """ Li NH3 (gm) R=0.9R_eq"""
...
TAGL["%s-%s" % (dbse, "15-1.0")] = """ Li NH3 (gm) R=1.0R_eq"""
...
TAGL["%s-%s" % (dbse, "15-1.2")] = """ Li NH3 (gm) R=1.2R_eq"""
...
TAGL["%s-%s" % (dbse, "15-1.5")] = """ Li NH3 (gm) R=1.5R_eq"""
...
TAGL["%s-%s" % (dbse, "15-2.0")] = """ Li NH3 (gm) R=2.0R_eq"""
...
TAGL["%s-%s" % (dbse, "16-0.9")] = """ Li O2 R=0.9R_eq"""
...
TAGL["%s-%s" % (dbse, "16-1.0")] = """ Li O2 R=1.0R_eq"""
...
TAGL["%s-%s" % (dbse, "16-1.2")] = """ Li O2 R=1.2R_eq"""
...
TAGL["%s-%s" % (dbse, "16-1.5")] = """ Li O2 R=1.5R_eq"""
...
TAGL["%s-%s" % (dbse, "16-2.0")] = """ Li O2 R=2.0R_eq"""
...
TAGL["%s-%s" % (dbse, "17-0.9")] = """ CN H2 R=0.9R_eq"""
...
TAGL["%s-%s" % (dbse, "17-1.0")] = """ CN H2 R=1.0R_eq"""
...
TAGL["%s-%s" % (dbse, "17-1.2")] = """ CN H2 R=1.2R_eq"""
...
TAGL["%s-%s" % (dbse, "17-1.5")] = """ CN H2 R=1.5R_eq"""
...
TAGL["%s-%s" % (dbse, "17-2.0")] = """ CN H2 R=2.0R_eq"""
...
TAGL["%s-%s" % (dbse, "18-0.9")] = """ Li NH3 (lm) R=0.9R_eq"""
...
TAGL["%s-%s" % (dbse, "18-1.0")] = """ Li NH3 (lm) R=1.0R_eq"""
...
TAGL["%s-%s" % (dbse, "18-1.2")] = """ Li NH3 (lm) R=1.2R_eq"""
...
TAGL["%s-%s" % (dbse, "18-1.5")] = """ Li NH3 (lm) R=1.5R_eq"""
...
TAGL["%s-%s" % (dbse, "18-2.0")] = """ Li NH3 (lm) R=2.0R_eq"""
...
TAGL["%s-%s" % (dbse, "19-0.9")] = """ H2O O2 (gm) R=0.9R_eq"""
...
TAGL["%s-%s" % (dbse, "19-1.0")] = """ H2O O2 (gm) R=1.0R_eq"""
...
TAGL["%s-%s" % (dbse, "19-1.2")] = """ H2O O2 (gm) R=1.2R_eq"""
...
TAGL["%s-%s" % (dbse, "19-1.5")] = """ H2O O2 (gm) R=1.5R_eq"""
...
TAGL["%s-%s" % (dbse, "19-2.0")] = """ H2O O2 (gm) R=2.0R_eq"""
...
TAGL["%s-%s" % (dbse, "20-0.9")] = """ Na Li R=0.9R_eq"""
...
TAGL["%s-%s" % (dbse, "20-1.0")] = """ Na Li R=1.0R_eq"""
...
TAGL["%s-%s" % (dbse, "20-1.2")] = """ Na Li R=1.2R_eq"""
...
TAGL["%s-%s" % (dbse, "20-1.5")] = """ Na Li R=1.5R_eq"""
...
TAGL["%s-%s" % (dbse, "21-0.9")] = """ CO2 O2 R=0.9R_eq"""
...
TAGL["%s-%s" % (dbse, "21-1.0")] = """ CO2 O2 R=1.0R_eq"""
...
TAGL["%s-%s" % (dbse, "21-1.2")] = """ CO2 O2 R=1.2R_eq"""
...
TAGL["%s-%s" % (dbse, "21-1.5")] = """ CO2 O2 R=1.5R_eq"""
...
TAGL["%s-%s" % (dbse, "21-2.0")] = """ CO2 - O2 R=2.0R_eq"""
...
TAGL["%s-%s" % (dbse, "22-0.9")] = """ C2H3 CO2 R=0.9R_eq"""
...
TAGL["%s-%s" % (dbse, "22-1.0")] = """ C2H3 CO2 R=1.0R_eq"""
...
TAGL["%s-%s" % (dbse, "22-1.2")] = """ C2H3 CO2 R=1.2R_eq"""
...
TAGL["%s-%s" % (dbse, "22-1.5")] = """ C2H3 CO2 R=1.5R_eq"""
...
TAGL["%s-%s" % (dbse, "22-2.0")] = """ C2H3 CO2 R=2.0R_eq"""
...
TAGL["%s-%s" % (dbse, "23-0.9")] = """ He* He* R=0.9R_eq"""
...
TAGL["%s-%s" % (dbse, "23-1.0")] = """ He* He* R=1.0R_eq"""
...
TAGL["%s-%s" % (dbse, "23-1.2")] = """ He* He* R=1.2R_eq"""
...
TAGL["%s-%s" % (dbse, "23-1.5")] = """ He* He* R=1.5R_eq"""
...
TAGL["%s-%s" % (dbse, "23-2.0")] = """ He* He* R=2.0R_eq"""
...
TAGL["%s-%s" % (dbse, "24-0.9")] = """ HF CO+ R=0.9R_eq"""
...
TAGL["%s-%s" % (dbse, "24-1.0")] = """ HF CO+ R=1.0R_eq"""
...
TAGL["%s-%s" % (dbse, "24-1.2")] = """ HF CO+ R=1.2R_eq"""
...
TAGL["%s-%s" % (dbse, "24-1.5")] = """ HF CO+ R=1.5R_eq"""
...
TAGL["%s-%s" % (dbse, "24-2.0")] = """ HF CO+ R=2.0R_eq"""
...
for rxn in HRXN:
    GEOS["%s-%s-monoA-CP" % (dbse, rxn)] = GEOS["%s-%s-dimer" % (dbse, rxn)].extract_fragments(1, [2, 3])
    GEOS["%s-%s-monoB-CP" % (dbse, rxn)] = GEOS["%s-%s-dimer" % (dbse, rxn)].extract_fragments(2, [1, 3])

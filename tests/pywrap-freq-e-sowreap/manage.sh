...
../../${OBJDIR}/bin/psi4 -l ../../share/ -i FREQ-8.in                   -o FREQ-8.out 
../../${OBJDIR}/bin/psi4 -l ../../share/ -i FREQ-9.in                   -o FREQ-9.out 
../../${OBJDIR}/bin/psi4 -l ../../share/ -i FREQ-10.in                  -o FREQ-10.out   
../../${OBJDIR}/bin/psi4 -l ../../share/ -i FREQ-11.in                  -o FREQ-11.out  
../../${OBJDIR}/bin/psi4 -l ../../share/ -i FREQ-12.in                  -o FREQ-12.out  
../../${OBJDIR}/bin/psi4 -l ../../share/ -i FREQ-13.in                  -o FREQ-13.out  

...
@pytest.mark.parametrize("inp", [
    pytest.param({'driver': 'energy',   'subject': 'hf',     'options': {'reference': 'rhf',  'mp2_type': 'conv', 'qc_module': 'occ',   'freeze_core': 'true',  'scf_type': 'df'}}, id='mp2 rhf conv: 3 occ*'),
    pytest.param({'driver': 'energy',   'subject': 'hf',     'options': {'reference': 'rhf',  'mp2_type': 'conv', 'qc_module': 'fnocc', 'freeze_core': 'true',  'scf_type': 'df'}}, id='mp2 rhf conv: 3 fnocc'),
    pytest.param({'driver': 'energy',   'subject': 'hf',     'options': {'reference': 'rhf',  'mp2_type': 'conv', 'qc_module': 'detci', 'freeze_core': 'true',  'scf_type': 'df'}}, id='mp2 rhf conv: 3 detci'),
    pytest.param({'driver': 'energy',   'subject': 'hf',     'options': {'reference': 'rhf',  'mp2_type': 'df',   'qc_module': 'occ',   'freeze_core': 'true',  'scf_type': 'df'}}, id='mp2 rhf df: 2 occ'),
    pytest.param({'driver': 'energy',   'subject': 'hf',     'options': {'reference': 'rhf',  'mp2_type': 'df',   'qc_module': 'dfmp2', 'freeze_core': 'true',  'scf_type': 'df'}}, id='mp2 rhf df: 2 dfmp2*'),
    pytest.param({'driver': 'energy',   'subject': 'hf',     'options': {'reference': 'rhf',  'mp2_type': 'cd',   'qc_module': 'occ',   'freeze_core': 'true',  'scf_type': 'df'}}, id='mp2 rhf cd: 1 occ*'),
    pytest.param({'driver': 'energy',   'subject': 'bh_h2p', 'options': {'reference': 'uhf',  'mp2_type': 'conv', 'qc_module': 'occ',   'freeze_core': 'true',  'scf_type': 'df'}}, id='mp2 uhf conv: 1 occ*'),
    pytest.param({'driver': 'energy',   'subject': 'bh_h2p', 'options': {'reference': 'uhf',  'mp2_type': 'df',   'qc_module': 'occ',   'freeze_core': 'true',  'scf_type': 'df'}}, id='mp2 uhf df: 2 occ'),
    pytest.param({'driver': 'energy',   'subject': 'bh_h2p', 'options': {'reference': 'uhf',  'mp2_type': 'df',   'qc_module': 'dfmp2', 'freeze_core': 'true',  'scf_type': 'df'}}, id='mp2 uhf df: 2 dfmp2*'),
    pytest.param({'driver': 'energy',   'subject': 'bh_h2p', 'options': {'reference': 'uhf',  'mp2_type': 'cd',   'qc_module': 'occ',   'freeze_core': 'true',  'scf_type': 'df'}}, id='mp2 uhf cd: 1 occ*'),
    #pytest.param({'driver': 'energy',   'subject': 'bh_h2p', 'options': {'reference': 'rohf', 'mp2_type': 'conv', 'qc_module': 'occ',   'freeze_core': 'true',  'scf_type': 'df'}}, id='mp2 rohf conv: 2 occ*'),
    pytest.param({'driver': 'energy',   'subject': 'bh_h2p', 'options': {'reference': 'rohf', 'mp2_type': 'conv', 'qc_module': 'detci', 'freeze_core': 'true',  'scf_type': 'df'}}, id='mp2 rohf conv: 2 detci'),
    pytest.param({'driver': 'energy',   'subject': 'bh_h2p', 'options': {'reference': 'rohf', 'mp2_type': 'df',   'qc_module': 'occ',   'freeze_core': 'true',  'scf_type': 'df'}}, id='mp2 rohf df: 2 occ'),
    pytest.param({'driver': 'energy',   'subject': 'bh_h2p', 'options': {'reference': 'rohf', 'mp2_type': 'df',   'qc_module': 'dfmp2', 'freeze_core': 'true',  'scf_type': 'df'}}, id='mp2 rohf df: 2 dfmp2*'),
    pytest.param({'driver': 'energy',   'subject': 'bh_h2p', 'options': {'reference': 'rohf', 'mp2_type': 'cd',   'qc_module': 'occ',   'freeze_core': 'true',  'scf_type': 'df'}}, id='mp2 rohf cd: 1 occ*'),

    # scf_type set for indexing, not for driver
    #pytest.param({'driver': 'gradient', 'subject': 'hf',     'options': {'reference': 'rhf',  'mp2_type': 'conv', 'qc_module': 'occ',   'freeze_core': 'true',  'scf_type': 'pk'}}, id='mp2 grad rhf conv fc: 1 occ*'),
    pytest.param({'driver': 'gradient', 'subject': 'hf',     'options': {'reference': 'rhf',  'mp2_type': 'conv', 'qc_module': 'occ',   'freeze_core': 'false', 'scf_type': 'pk'}}, id='mp2 grad rhf conv nfc: 1 occ*'),
    pytest.param({'driver': 'gradient', 'subject': 'hf',     'options': {'reference': 'rhf',  'mp2_type': 'df',   'qc_module': 'occ',   'freeze_core': 'true',  'scf_type': 'df'}}, id='mp2 grad rhf df fc: 2 occ'),
    pytest.param({'driver': 'gradient', 'subject': 'hf',     'options': {'reference': 'rhf',  'mp2_type': 'df',   'qc_module': 'dfmp2', 'freeze_core': 'true',  'scf_type': 'df'}}, id='mp2 grad rhf df fc: 2 dfmp2*'),
    pytest.param({'driver': 'gradient', 'subject': 'hf',     'options': {'reference': 'rhf',  'mp2_type': 'df',   'qc_module': 'occ',   'freeze_core': 'false', 'scf_type': 'df'}}, id='mp2 grad rhf df nfc: 2 occ'),
    pytest.param({'driver': 'gradient', 'subject': 'hf',     'options': {'reference': 'rhf',  'mp2_type': 'df',   'qc_module': 'dfmp2', 'freeze_core': 'false', 'scf_type': 'df'}}, id='mp2 grad rhf df nfc: 2 dfmp2*'),
    pytest.param({'driver': 'gradient', 'subject': 'bh_h2p', 'options': {'reference': 'uhf',  'mp2_type': 'conv', 'qc_module': 'occ',   'freeze_core': 'false', 'scf_type': 'pk'}}, id='mp2 grad uhf conv nfc: 1 occ*'),
    pytest.param({'driver': 'gradient', 'subject': 'bh_h2p', 'options': {'reference': 'uhf',  'mp2_type': 'df',   'qc_module': 'occ',   'freeze_core': 'true',  'scf_type': 'df'}}, id='mp2 grad uhf df fc: 1 occ*'),
    pytest.param({'driver': 'gradient', 'subject': 'bh_h2p', 'options': {'reference': 'uhf',  'mp2_type': 'df',   'qc_module': 'occ',   'freeze_core': 'false', 'scf_type': 'df'}}, id='mp2 grad uhf df nfc: 1 occ*'),

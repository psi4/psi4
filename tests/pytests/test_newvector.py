...
import numpy as np
import pytest
from psi4.core import Dimension, NewVector
...
def test_constructors():
    ...
    v1_a = NewVector(1, [int_d])
    check_dense_vec(v1_a, int_d)

    # unnamed 1-irrep vector, shape only
    v1_b = NewVector([int_d])
    check_dense_vec(v1_b, int_d)

    # named 1-irrep vector
    v2 = NewVector('v2', 1, [int_d])

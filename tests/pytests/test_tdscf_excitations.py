...
@pytest.mark.parametrize("mol,ref,func,ptype,basis", [
    ...
    pytest.param( "METHYLOXIRANE", 'RHF-1',    'HCTH93',  'RPA',  'cc-pvdz', marks=[gga, RHF_singlet, RPA, pytest.mark.medlong]),
    pytest.param( "METHYLOXIRANE", 'RHF-1',    'HCTH93',  'TDA',  'cc-pvdz', marks=[gga, RHF_singlet, TDA, pytest.mark.medlong]),
    pytest.param( "METHYLOXIRANE", 'RHF-3',    'HCTH93',  'RPA',  'cc-pvdz', marks=[gga, RHF_triplet, RPA, pytest.mark.medlong]),
    pytest.param( "METHYLOXIRANE", 'RHF-3',    'HCTH93',  'TDA',  'cc-pvdz', marks=[gga, RHF_triplet, TDA, pytest.mark.medlong]),

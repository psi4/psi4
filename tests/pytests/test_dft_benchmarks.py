...
@pytest.mark.parametrize("func,expected,basis", [
    ...
    pytest.param(          'QTP00', 0.4470684732, 'cc-pVDZ'),  # Psi4
    pytest.param(          'QTP01', 0.4536546376, 'cc-pVDZ'),  # Psi4
    pytest.param(          'QTP02', 0.4491464888, 'cc-pVDZ'),  # Psi4
    ...
    pytest.param(          'LCQTP', 0.4557383782, 'cc-pVDZ'),  # Psi4
...
@pytest.mark.parametrize("func,expected,basis", [
    ...
    pytest.param(     'QTP00', -0.0137044263,  'cc-pVDZ'),  #   Psi4
    pytest.param(     'QTP01', -0.0154208850,  'cc-pVDZ'),  #   Psi4
    pytest.param(     'QTP02', -0.0156646743,  'cc-pVDZ'),  #   Psi4
    ...
    pytest.param(     'LCQTP', -0.0159109461,  'cc-pVDZ'),  #   Psi4

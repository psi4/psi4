...
from psi4.core import Dimension, Matrix_D, Vector_D
...
def test_numpy_interop():
    ...
    assert compare_arrays(np.arange(m3[3].size, dtype=float).reshape(*m3[3].shape), m3[3], 8,  "Assign NumPy array to labeled, 4-irrep matrix")

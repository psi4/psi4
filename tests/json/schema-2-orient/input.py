...
psi4.compare_arrays([0.0, 0.0, 0.0], json_ret.input_data.molecule.geometry[0], 3, "H Input Position")  #TEST
psi4.compare_arrays([0.0, 1.732, 0.0], json_ret.input_data.molecule.geometry[1], 3, "F Input Position")  #TEST
psi4.compare_arrays([0.0, 0.0, -0.08725], json_ret.molecule.geometry[0], 3, "H Position")  #TEST
psi4.compare_arrays([0.0, 0.0,  1.6447], json_ret.molecule.geometry[1], 3, "F Position")  #TEST

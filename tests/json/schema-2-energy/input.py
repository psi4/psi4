...
with open("output.json", "w", encoding="utf-8") as ofile:                                                    #TEST
    ofile.write(json_ret.model_dump_json(indent=2))                                                   #TEST
...
json_data["specification"]["model"] = {
    "method": "MP2",
    "basis": "cc-pVDZ"
  }
json_data["specification"]["keywords"]["scf_type"] = "pk"
json_data["specification"]["keywords"]["mp2_type"] = "conv"

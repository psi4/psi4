...
\end{Snippet}
To reiterate some of the options mentioned above: the \optionname{NAT-ORBS}{SAPT}
option will compute MP2 natural orbitals and use them in the evaluation of
the triples correction to dispersion, the \optionname{DO-THIRD-ORDER}{SAPT} option

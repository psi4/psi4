...
Multiple basis sets can be specified in the same file by adding additional sections with [ basis name ], 
\texttt{PUREAM} value, and element basis set definitions.

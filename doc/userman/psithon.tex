...
accuracy through \texttt{cbs()}. 
These are discussed separately in Appendix \ref{sphinxpsithon} (also exists in
html form with better formatting).
Note that the options documented for Python functions are placed as arguments
in the command that calls the function (formatted in this manual as

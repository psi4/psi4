...
At present, \optionname{BASIS} option in the global and
...
correlated calculations or with value \pyoptionval{\qq{scf}} otherwise. Specifying
...
\begin{itemize}
\item[] \pyoptionname{CORL\_WFN} = \pyoptionval{\qq{mp2}} \textbar\; \pyoptionval{\qq{ccsd(t)}} \textbar\; etc. \\
...
\item[] \pyoptionname{DELTA\_WFN} = \pyoptionval{\qq{ccsd}} \textbar\; \pyoptionval{\qq{ccsd(t)}} \textbar\; etc. \\
Indicates the (superior) energy method for which a delta correction to the correlation energy is to be obtained.
\item[] \pyoptionname{DELTA\_WFN\_LESSER} = \textit{\pyoptionval{\qq{mp2}}} \textbar\; \pyoptionval{\qq{ccsd}} \textbar\; etc. \\
Indicates the inferior energy method for which a delta correction to the correlation energy is to be obtained.
\item[] \pyoptionname{DELTA2\_WFN} = \pyoptionval{\qq{ccsd}} \textbar\; \pyoptionval{\qq{ccsd(t)}} \textbar\; etc. \\
Indicates the (superior) energy method for which a second delta correction to the correlation energy is to be obtained.
\item[] \pyoptionname{DELTA2\_WFN\_LESSER} = \textit{\pyoptionval{\qq{mp2}}} \textbar\; \pyoptionval{\qq{ccsd}} \textbar\; etc. \\
...
\begin{itemize}
\item[] \textbf{\pyoptionname{SCF\_BASIS}} = \textit{\pyoptionname{CORL\_BASIS}} \textbar\; \pyoptionval{\qq{cc-pV[TQ]Z}} \textbar\; \pyoptionval{\qq{jun-cc-pv[tq5]z}} \textbar\; \pyoptionval{\qq{6-31G}} \textbar\; etc. \\
...
\item[] \pyoptionname{CORL\_BASIS} = \pyoptionval{\qq{cc-pV[TQ]Z}} \textbar\; \pyoptionval{\qq{jun-cc-pv[tq5]z}} \textbar\; \pyoptionval{\qq{6-31G}} \textbar\; etc. \\
Indicates the sequence of basis sets employed for the correlation energy.
\item[] \pyoptionname{DELTA\_BASIS} = \pyoptionval{\qq{cc-pV[TQ]Z}} \textbar\; \pyoptionval{\qq{jun-cc-pv[tq5]z}} \textbar\; \pyoptionval{\qq{6-31G}} \textbar\; etc. \\
Indicates the sequence of basis sets employed for the delta correction to the correlation energy.
\item[] \pyoptionname{DELTA2\_BASIS} = \pyoptionval{\qq{cc-pV[TQ]Z}} \textbar\; \pyoptionval{\qq{jun-cc-pv[tq5]z}} \textbar\; \pyoptionval{\qq{6-31G}} \textbar\; etc. \\
...
An exception is the default, \pyoptionval{\qq{highest\_1}}, which uses the best basis set available.
\begin{itemize}
\item[] \pyoptionname{SCF\_SCHEME} = \textit{\pyoptionval{\qq{highest\_1}}} \textbar\; \pyoptionval{\qq{scf\_xtpl\_helgaker\_3}} \\
Indicates the basis set extrapolation scheme to be applied to the reference energy.
\item[] \pyoptionname{CORL\_SCHEME} = \textit{\pyoptionval{\qq{highest\_1}}} \textbar\; \pyoptionval{\qq{corl\_xtpl\_helgaker\_2}} \\
Indicates the basis set extrapolation scheme to be applied to the correlation energy.
\item[] \pyoptionname{DELTA\_SCHEME} = \textit{\pyoptionval{\qq{highest\_1}}} \textbar\; \pyoptionval{\qq{corl\_xtpl\_helgaker\_2}} \\
Indicates the basis set extrapolation scheme to be applied to the delta correction to the correlation energy.
\item[] \pyoptionname{DELTA2\_SCHEME} = \textit{\pyoptionval{\qq{highest\_1}}} \textbar\; \pyoptionval{\qq{corl\_xtpl\_helgaker\_2}} \\
...
since, for example, an \texttt{energy(\qq{ccsd(t)})} yields CCSD(T), CCSD, MP2, and SCF

...
\optionname{S\_MIN\_EIGENVALUE}, which defaults to 1.0\e{-7}. If the smallest
...
automatically by placing a \pyoptionname{cast\_up =} \pyoptionval{\qq \textit{SMALL\_BASIS\_NAME}\qq} modifier in

\subsection{Self-Consistent Field (SCF)} \label{sec:scf}
...
\begin{itemize}
\item For \optionname{GUESS}{SCF}, the \optionval{SAD} guess is usually your
...
\optionname{DOCC}{GLOBALS}/\optionname{SOCC}{GLOBALS} arrays do not play very

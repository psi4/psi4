...
really sure/the system is behaving really squirrely on you. This also helps with
the above point.
\item For wall time, \texttt{DF} beats \texttt{OUT\_OF\_CORE}/\texttt{PK} beats
...
\texttt{OUT\_OF\_CORE} unless you run out of disk space, in which case you will
probably not be running \PSIfour anymore.  

...
\item ``The Configuration Interaction Method: Advances in Highly 
   ...
   {\em Adv. Quantum Chem.}, vol. 34, P.-O. L{\"o}wdin, Ed.
   (Academic Press, New York, 1999), pp. 143-269.
\end{enumerate}

{\bf CC}
\begin{enumerate}
\item ``An Introduction to Coupled Cluster Theory for Computational
   Chemists,'' T. D. Crawford and H. F. Schaefer, {\em Rev. Comp. Chem.} 
   {\bf 14}, 33-136 (2000).
\end{enumerate}
...
follows:
\begin{enumerate}
\item ``Perturbation Theory Approach to Intermolecular Potential Energy
  Surfaces of van der Waals Complexes,'' B. Jeziorski, R. Moszynski,
  and K. Szalewicz, {\em Chem. Rev.} {\bf 94}, 1887-1930 (1994).   
\end{enumerate}
...
\hline\hline
\multicolumn{3}{l}{\footnotesize{$^*$ UHF-CCSD(T) gradients only, as of 4.0.0-beta1}} \\
\end{tabular}
\end{center}
\end{table}

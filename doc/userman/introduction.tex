...
Section \ref{tutorial} provides a brief tutorial to help new users
get started.  Section \ref{psithon} offers further details into the
structure of \PSIfour\ input files, and how Python can be mixed with
quantum chemistry directives in \PSIfour.  Section \ref{pywrappers}

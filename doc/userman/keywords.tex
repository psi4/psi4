...
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.7\textwidth}}
	 RELAX\_OPDM & Whether to relax the one-particle density matrix \\ 
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.35\textwidth}p{0.35\textwidth}}
...
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.7\textwidth}}
	 DERTYPE & The order of derivative required \\ 
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.35\textwidth}p{0.35\textwidth}}
	   & {\bf Type:} string &  {\bf Default:} NONE\\
	 & & \\
...
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.7\textwidth}}
	 CACHELEV & The amount of cacheing of data to perform \\ 
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.35\textwidth}p{0.35\textwidth}}
...
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.7\textwidth}}
	 TOLERANCE & Integrals are neglected if their magnitude is below $10^{-tolerance}$ \\ 
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.35\textwidth}p{0.35\textwidth}}
...
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.7\textwidth}}
	 PROP\_ALL & Whether to compute all relaxed excited states \\ 
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.35\textwidth}p{0.35\textwidth}}
	   & {\bf Type:} boolean &  {\bf Default:} false\\
	 & & \\
...
\subsection{PSIMRCC}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.7\textwidth}}
	 ACTIVE & The number of active orbitals per irrep (same as CORR\_ACTV, ACTV) \\ 
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.35\textwidth}p{0.35\textwidth}}
	   & {\bf Type:} array &  {\bf Default:} No Default\\
	 & & \\
...
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.7\textwidth}}
	 ACTV & The number of active orbitals per irrep (same as CORR\_ACTV, ACTIVE) \\ 
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.35\textwidth}p{0.35\textwidth}}
	   & {\bf Type:} array &  {\bf Default:} No Default\\
	 & & \\
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.7\textwidth}}
	 CONVERGENCE & The number of digits after the decimal to converge the energy to \\ 
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.35\textwidth}p{0.35\textwidth}}
...
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.7\textwidth}}
	 CORR\_DOCC & The number of doubly occupied orbitals per irrep (same as RESTRICTED\_DOCC) \\ 
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.35\textwidth}p{0.35\textwidth}}
	   & {\bf Type:} array &  {\bf Default:} No Default\\
	 & & \\
...
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.7\textwidth}}
	 DIAGONALIZE\_HEFF & Whether to diagonalize the effective Hamiltonian \\ 
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.35\textwidth}p{0.35\textwidth}}
	   & {\bf Type:} boolean &  {\bf Default:} false\\
	 & & \\
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.7\textwidth}}
	 COUPLING\_TERMS & Whether to include the terms that couple the reference determinants \\ 
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.35\textwidth}p{0.35\textwidth}}
	   & {\bf Type:} boolean &  {\bf Default:} true\\
	 & & \\
...
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.7\textwidth}}
	 RESTRICTED\_DOCC & The number of doubly occupied orbitals per irrep (same as CORR\_DOCC) \\ 
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.35\textwidth}p{0.35\textwidth}}
	   & {\bf Type:} array &  {\bf Default:} No Default\\
	 & & \\
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.7\textwidth}}
	 START\_DIIS & The number of DIIS vectors needed before extrapolation is performed \\ 
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.35\textwidth}p{0.35\textwidth}}
	   & {\bf Type:} integer &  {\bf Default:} 2\\
	 & & \\
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.7\textwidth}}
	 ZERO\_INTERNAL\_AMPS & Whether to zero the internal amplitudes, i.e., those that map reference determinants onto each other \\ 
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.35\textwidth}p{0.35\textwidth}}
	   & {\bf Type:} boolean &  {\bf Default:} true\\
	 & & \\
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.7\textwidth}}
	 FAVG\_CCSD\_T & Whether to use the averaged Fock matrix over all references in (T) computations \\ 
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.35\textwidth}p{0.35\textwidth}}
	   & {\bf Type:} boolean &  {\bf Default:} false\\
	 & & \\
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.7\textwidth}}
	 FROZEN\_DOCC & The number of frozen occupied orbitals per irrep (same as CORR\_DOCC) \\ 
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.35\textwidth}p{0.35\textwidth}}
	   & {\bf Type:} array &  {\bf Default:} No Default\\
	 & & \\
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.7\textwidth}}
	 LOCK\_SINGLET & Whether to lock onto a singlet root \\ 
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.35\textwidth}p{0.35\textwidth}}
	   & {\bf Type:} boolean &  {\bf Default:} false\\
	 & & \\
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.7\textwidth}}
	 MAXITER & The maximum number of iterations allowed to determine the amplitudes \\ 
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.35\textwidth}p{0.35\textwidth}}
...
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.7\textwidth}}
	 OFFDIAGONAL\_CCSD\_T & Whether to include the off-diagonal corrections in (T) computations \\ 
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.35\textwidth}p{0.35\textwidth}}
	   & {\bf Type:} boolean &  {\bf Default:} true\\
	 & & \\
...
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.7\textwidth}}
	 DIIS\_TRIPLES & Whether to perform DIIS extrapolation for iterative triple excitation computations \\ 
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.35\textwidth}p{0.35\textwidth}}
	   & {\bf Type:} boolean &  {\bf Default:} false\\
	 & & \\
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.7\textwidth}}
	 FROZEN\_UOCC & The number of frozen virtual orbitals (same as CORR\_FVIR) \\ 
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.35\textwidth}p{0.35\textwidth}}
	   & {\bf Type:} array &  {\bf Default:} No Default\\
	 & & \\
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.7\textwidth}}
	 CORR\_ACTV & The number of active orbitals per irrep (same as ACTV) \\ 
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.35\textwidth}p{0.35\textwidth}}
	   & {\bf Type:} array &  {\bf Default:} No Default\\
	 & & \\
...
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.7\textwidth}}
	 CORR\_FVIR & The number of frozen virtual orbitals (same as FROZEN\_UOCC) \\ 
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.35\textwidth}p{0.35\textwidth}}
	   & {\bf Type:} array &  {\bf Default:} No Default\\
	 & & \\
...
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.7\textwidth}}
	 MAXDIIS & The number of DIIS vectors to use in extrapolations \\ 
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.35\textwidth}p{0.35\textwidth}}
	   & {\bf Type:} integer &  {\bf Default:} 7\\
	 & & \\
...
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.7\textwidth}}
	 MP2\_GUESS & Whether to start from an MP2 guess \\ 
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.35\textwidth}p{0.35\textwidth}}
	   & {\bf Type:} boolean &  {\bf Default:} true\\
	 & & \\
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.7\textwidth}}
	 NUM\_THREADS & The number of threads to use on multi-core machines \\ 
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.35\textwidth}p{0.35\textwidth}}
	   & {\bf Type:} integer &  {\bf Default:} 1\\
	 & & \\
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.7\textwidth}}
	 PRINT\_HEFF & Whether to print the effective Hamiltonian \\ 
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.35\textwidth}p{0.35\textwidth}}
	   & {\bf Type:} boolean &  {\bf Default:} false\\
	 & & \\
...
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.7\textwidth}}
	 USE\_SPIN\_SYMMETRY & Whether to use symmetry to map equivalent determinants onto each other, for efficiency \\ 
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.35\textwidth}p{0.35\textwidth}}
	   & {\bf Type:} boolean &  {\bf Default:} true\\
	 & & \\
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.7\textwidth}}
	 CORR\_FOCC & The number of frozen occupied orbitals per irrep (same as FROZEN\_DOCC) \\ 
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.35\textwidth}p{0.35\textwidth}}
	   & {\bf Type:} array &  {\bf Default:} No Default\\
	 & & \\
...
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.7\textwidth}}
	 DIAGONAL\_CCSD\_T & Whether to include the diagonal corrections in (T) computations \\ 
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.35\textwidth}p{0.35\textwidth}}
	   & {\bf Type:} boolean &  {\bf Default:} true\\
	 & & \\
...
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.7\textwidth}}
	 HEFF4 & Whether to include the fourth-order contributions to the effective hamiltonian \\ 
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.35\textwidth}p{0.35\textwidth}}
	   & {\bf Type:} boolean &  {\bf Default:} true\\
	 & & \\
...
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.7\textwidth}}
	 ROOT & Which root of the effective hamiltonian is the target state? \\ 
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.35\textwidth}p{0.35\textwidth}}
	   & {\bf Type:} integer &  {\bf Default:} 1\\
	 & & \\
...
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.7\textwidth}}
	 USE\_DIIS & Whether to perform DIIS extrapolation \\ 
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.35\textwidth}p{0.35\textwidth}}
	   & {\bf Type:} boolean &  {\bf Default:} true\\
	 & & \\
...
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.7\textwidth}}
	 DERTYPE & The order of derivative information required \\ 
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.35\textwidth}p{0.35\textwidth}}
	   & {\bf Type:} string &  {\bf Default:} NONE\\
	 & & \\
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.7\textwidth}}
	 NTHREADS & The number of threads to use on multi-core machines \\ 
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.35\textwidth}p{0.35\textwidth}}
	   & {\bf Type:} integer &  {\bf Default:} 1\\
	 & & \\
...
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.7\textwidth}}
	 DIIS\_START & DIIS starts when the RMS lambda and SCF errors are less than $10^{diis\_start}$ \\ 
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.35\textwidth}p{0.35\textwidth}}
	   & {\bf Type:} integer &  {\bf Default:} 3\\
	 & & \\
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.7\textwidth}}
	 INT\_THRESH & An integral is considered to be zero if it's magnitude is less than $10^{-int\_thresh}$ \\ 
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.35\textwidth}p{0.35\textwidth}}
	   & {\bf Type:} integer &  {\bf Default:} 14\\
	 & & \\
...
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.7\textwidth}}
	 TAU\_SQUARED & Whether to compute the DCFT energy with the $\tau^{2}$ correction to $\tau$ or not \\ 
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.35\textwidth}p{0.35\textwidth}}
	   & {\bf Type:} boolean &  {\bf Default:} false\\
	 & & \\
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.7\textwidth}}
	 MAX\_DIIS & The maximum number of vectors used in DIIS extrapolation \\ 
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.35\textwidth}p{0.35\textwidth}}
	   & {\bf Type:} integer &  {\bf Default:} 6\\
	 & & \\
...
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.7\textwidth}}
	 E\_CONVERGE & How many digits after the decimal to converge the energy to \\ 
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.35\textwidth}p{0.35\textwidth}}
	   & {\bf Type:} integer &  {\bf Default:} 10\\
	 & & \\
...
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.7\textwidth}}
	 D\_CONVERGE & How many digits after the decimal to converge the density to \\ 
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.35\textwidth}p{0.35\textwidth}}
	   & {\bf Type:} integer &  {\bf Default:} 8\\
	 & & \\
...
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.7\textwidth}}
	 DIISVECS & The number of DIIS vectors used to extrapolate \\ 
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.35\textwidth}p{0.35\textwidth}}
	   & {\bf Type:} integer &  {\bf Default:} 5\\
	 & & \\
...
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.7\textwidth}}
	 JOBTYPE & The type of job being performed \\ 
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.35\textwidth}p{0.35\textwidth}}
...
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.7\textwidth}}
	 SCS & Whether to perform a spin component scaled MP2 computation \\ 
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.35\textwidth}p{0.35\textwidth}}
	   & {\bf Type:} boolean &  {\bf Default:} false\\
	 & & \\
...
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.7\textwidth}}
	 DERTYPE & The order of energy derivatives required \\ 
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.35\textwidth}p{0.35\textwidth}}
	   & {\bf Type:} string &  {\bf Default:} NONE\\
	 & & \\
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.7\textwidth}}
	 SCS\_N & Whether to perform a spin component scaled (N) MP2 computation \\ 
\end{tabular*}
\begin{tabular*}{\textwidth}[tb]{p{0.3\textwidth}p{0.35\textwidth}p{0.35\textwidth}}
	   & {\bf Type:} boolean &  {\bf Default:} false\\
	 & & \\

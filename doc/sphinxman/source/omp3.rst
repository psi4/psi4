...
The orbital-optimized MP3 methods currently supported in |Psifour| are outlined in Table :ref:`OMP3 Methods <table:omp3_calls>`.
    ...
    +=========================+==============================================================+=========+==========+===========+
    | omp3                    | Orbital-Optimized MP3                                        |    Y    |     N    | RHF/UHF   |
    +-------------------------+--------------------------------------------------------------+---------+----------+-----------+
    | scs-omp3                | Spin-Component Scaled Orbital-Optimized MP3                  |    Y    |     N    | RHF/UHF   |
    +-------------------------+--------------------------------------------------------------+---------+----------+-----------+
    | sos-omp3                | Spin-Opposite Scaled Orbital-Optimized MP3                   |    Y    |     N    | RHF/UHF   |
    +-------------------------+--------------------------------------------------------------+---------+----------+-----------+
    | scsn-omp3               | A special version of SCS-OMP3 for nucleobase interactions    |    Y    |     N    | RHF/UHF   |
    +-------------------------+--------------------------------------------------------------+---------+----------+-----------+
    | scs-mi-omp3             | A special version of SCS-OMP3 (from S22 database)            |    Y    |     N    | RHF/UHF   |
    +-------------------------+--------------------------------------------------------------+---------+----------+-----------+
    | scs-omp3-vdw            | A special version of SCS-OMP3 (from ethene dimers)           |    Y    |     N    | RHF/UHF   |
    +-------------------------+--------------------------------------------------------------+---------+----------+-----------+

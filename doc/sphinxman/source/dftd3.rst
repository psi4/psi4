...
.. table:: Variants of dispersion corrections
   ...
   +-------------------------------------+--------------------------------------------------------------------------------------+---------------------------------+---------------------------------------------------------------------------------------------+
   | -D4M                                | -D4 [#f12]_                                                                          | ``dftd4``                       | [:math:`a_1`, :math:`a_2`, :math:`alp`, :math:`s_6`, :math:`s_8`, :math:`s_9`]              |
   +-------------------------------------+--------------------------------------------------------------------------------------+---------------------------------+---------------------------------------------------------------------------------------------+
...
.. [#f12] -D4M is only defined for SAPT0 and HF with ATM disabled. In functional form, it is the same as -D4(BJ).

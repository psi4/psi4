...
over the other electron coordinate. COSX is related to the earlier pseudospectral
methods of Friesner. In COSX, numerical integration is performed on standard

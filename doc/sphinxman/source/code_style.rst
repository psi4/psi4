...
*before* they are committing them with ``git commit``.
The hook to be modified is then the *pre-commit* hook. Here is an example of
such a hook https://github.com/ddddavidmartin/Pre-commit-hooks

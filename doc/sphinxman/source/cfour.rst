...
:py:attr:`~optking.v2.optparams.OptParams.g_convergence`\ =CFOUR provides a good imitation of Cfour
...
* Specifying keywords that control geometry optimization is
  ...
  optimization keywords (*e.g.*, :py:attr:`~optking.v2.optparams.OptParams.geom_maxiter`) instead fill
  these roles.

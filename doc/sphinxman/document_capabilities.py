...
notes_holder = {
    ...
    ("mp2", "DFMP2"): ("FN", "Also available for DFT references RKS/ROKS/UKS", None),
    ("omp2", "OCC"): ("FN", "Also available for DFT references RKS/ROKS/UKS", None),
    ("omp2.5", "OCC"): ("FN", "Also available for DFT references RKS/ROKS/UKS", None),
    ("omp3", "OCC"): ("FN", "Also available for DFT references RKS/ROKS/UKS", None),
    ("oremp2", "OCC"): ("FN", "Also available for DFT references RKS/ROKS/UKS", None),
    ("olccd", "OCC"): ("FN", "Also available for DFT references RKS/ROKS/UKS", None),

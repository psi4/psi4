...
# License file psi4/share/python/source.template
fhead = open(DriverPath + '../../psi4/share/python/source.template')
...
fhead = open(DriverPath + '../../psi4/include/psifiles.h')
contents = fhead.readlines()
fhead.close()

fpy = open(DriverPath + '../../psi4/share/python/p4const/psifiles.py', 'w')
for line in license:
    fpy.write(line)
fpy.write('# Do not modify this file! It is auto-generated by the document_psifiles\n')
fpy.write('# script, from psi4topdir/psi4/include/psifiles.h\n')

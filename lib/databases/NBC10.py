...
# <<< Reference Values >>>
BIND = {}
BIND['%s-BzBz_S-3.2'  % (dbse)] =  3.522
BIND['%s-BzBz_S-3.3'  % (dbse)] =  1.535
BIND['%s-BzBz_S-3.4'  % (dbse)] =  0.189
BIND['%s-BzBz_S-3.5'  % (dbse)] = -0.689
BIND['%s-BzBz_S-3.6'  % (dbse)] = -1.231
BIND['%s-BzBz_S-3.7'  % (dbse)] = -1.535
BIND['%s-BzBz_S-3.8'  % (dbse)] = -1.674
BIND['%s-BzBz_S-3.9'  % (dbse)] = -1.701  # BzBz_S minimum
BIND['%s-BzBz_S-4.0'  % (dbse)] = -1.655
BIND['%s-BzBz_S-4.1'  % (dbse)] = -1.565
BIND['%s-BzBz_S-4.2'  % (dbse)] = -1.448
BIND['%s-BzBz_S-4.5'  % (dbse)] = -1.058
BIND['%s-BzBz_S-5.0'  % (dbse)] = -0.542
BIND['%s-BzBz_S-5.5'  % (dbse)] = -0.248
BIND['%s-BzBz_S-6.0'  % (dbse)] = -0.099
BIND['%s-BzBz_S-6.5'  % (dbse)] = -0.028
BIND['%s-BzBz_S-10.0' % (dbse)] =  0.018

BIND['%s-BzBz_T-4.4' % (dbse)] =  0.626
BIND['%s-BzBz_T-4.5' % (dbse)] = -0.760
BIND['%s-BzBz_T-4.6' % (dbse)] = -1.673
BIND['%s-BzBz_T-4.7' % (dbse)] = -2.239
BIND['%s-BzBz_T-4.8' % (dbse)] = -2.552
BIND['%s-BzBz_T-4.9' % (dbse)] = -2.687
BIND['%s-BzBz_T-5.0' % (dbse)] = -2.698  # BzBz_T minimum
BIND['%s-BzBz_T-5.1' % (dbse)] = -2.627
BIND['%s-BzBz_T-5.2' % (dbse)] = -2.503
BIND['%s-BzBz_T-5.3' % (dbse)] = -2.349
BIND['%s-BzBz_T-5.4' % (dbse)] = -2.179
BIND['%s-BzBz_T-5.5' % (dbse)] = -2.005
BIND['%s-BzBz_T-5.6' % (dbse)] = -1.833
BIND['%s-BzBz_T-6.0' % (dbse)] = -1.242
BIND['%s-BzBz_T-6.5' % (dbse)] = -0.752
BIND['%s-BzBz_T-7.0' % (dbse)] = -0.468
BIND['%s-BzBz_T-7.5' % (dbse)] = -0.302
BIND['%s-BzBz_T-8.0' % (dbse)] = -0.203

BIND['%s-BzBz_PD34-0.2' % (dbse)] =  0.070
BIND['%s-BzBz_PD34-0.4' % (dbse)] = -0.257
BIND['%s-BzBz_PD34-0.6' % (dbse)] = -0.728
BIND['%s-BzBz_PD34-0.8' % (dbse)] = -1.260
BIND['%s-BzBz_PD34-1.0' % (dbse)] = -1.766
BIND['%s-BzBz_PD34-1.2' % (dbse)] = -2.179
BIND['%s-BzBz_PD34-1.4' % (dbse)] = -2.466
BIND['%s-BzBz_PD34-1.5' % (dbse)] = -2.557
BIND['%s-BzBz_PD34-1.6' % (dbse)] = -2.614
BIND['%s-BzBz_PD34-1.7' % (dbse)] = -2.640
BIND['%s-BzBz_PD34-1.8' % (dbse)] = -2.643  # BzBz_PD34 minimum
BIND['%s-BzBz_PD34-1.9' % (dbse)] = -2.624
BIND['%s-BzBz_PD34-2.0' % (dbse)] = -2.587
BIND['%s-BzBz_PD34-2.2' % (dbse)] = -2.479
BIND['%s-BzBz_PD34-2.4' % (dbse)] = -2.356
BIND['%s-BzBz_PD34-2.6' % (dbse)] = -2.242
BIND['%s-BzBz_PD34-2.8' % (dbse)] = -2.147
BIND['%s-BzBz_PD34-3.0' % (dbse)] = -2.079

BIND['%s-BzH2S-3.2'  % (dbse)] =  1.250
BIND['%s-BzH2S-3.4'  % (dbse)] = -1.570
BIND['%s-BzH2S-3.5'  % (dbse)] = -2.256
BIND['%s-BzH2S-3.6'  % (dbse)] = -2.638
BIND['%s-BzH2S-3.7'  % (dbse)] = -2.808
BIND['%s-BzH2S-3.8'  % (dbse)] = -2.834  # BzH2S minimum
BIND['%s-BzH2S-3.9'  % (dbse)] = -2.766
BIND['%s-BzH2S-4.0'  % (dbse)] = -2.639
BIND['%s-BzH2S-4.1'  % (dbse)] = -2.478
BIND['%s-BzH2S-4.2'  % (dbse)] = -2.301
BIND['%s-BzH2S-4.5'  % (dbse)] = -1.770
BIND['%s-BzH2S-4.75' % (dbse)] = -1.393
BIND['%s-BzH2S-5.0'  % (dbse)] = -1.093
BIND['%s-BzH2S-5.25' % (dbse)] = -0.861
BIND['%s-BzH2S-5.5'  % (dbse)] = -0.684
BIND['%s-BzH2S-6.0'  % (dbse)] = -0.446
BIND['%s-BzH2S-6.5'  % (dbse)] = -0.302
BIND['%s-BzH2S-7.0'  % (dbse)] = -0.214
BIND['%s-BzH2S-7.5'  % (dbse)] = -0.155

BIND['%s-BzMe-3.2' % (dbse)] =  0.717
BIND['%s-BzMe-3.3' % (dbse)] = -0.183
BIND['%s-BzMe-3.4' % (dbse)] = -0.774
BIND['%s-BzMe-3.5' % (dbse)] = -1.135
BIND['%s-BzMe-3.6' % (dbse)] = -1.337
BIND['%s-BzMe-3.7' % (dbse)] = -1.432
BIND['%s-BzMe-3.8' % (dbse)] = -1.439  # BzMe minimum
BIND['%s-BzMe-3.9' % (dbse)] = -1.414
BIND['%s-BzMe-4.0' % (dbse)] = -1.327
BIND['%s-BzMe-4.1' % (dbse)] = -1.232
BIND['%s-BzMe-4.2' % (dbse)] = -1.138
BIND['%s-BzMe-4.4' % (dbse)] = -0.950
BIND['%s-BzMe-4.6' % (dbse)] = -0.760
BIND['%s-BzMe-4.8' % (dbse)] = -0.606
BIND['%s-BzMe-5.0' % (dbse)] = -0.475
BIND['%s-BzMe-5.2' % (dbse)] = -0.370
BIND['%s-BzMe-5.4' % (dbse)] = -0.286
BIND['%s-BzMe-5.6' % (dbse)] = -0.230
BIND['%s-BzMe-6.0' % (dbse)] = -0.141

BIND['%s-MeMe-3.2' % (dbse)] =  0.069
BIND['%s-MeMe-3.3' % (dbse)] = -0.239
BIND['%s-MeMe-3.4' % (dbse)] = -0.417
BIND['%s-MeMe-3.5' % (dbse)] = -0.508
BIND['%s-MeMe-3.6' % (dbse)] = -0.541  # MeMe minimum
BIND['%s-MeMe-3.7' % (dbse)] = -0.539
BIND['%s-MeMe-3.8' % (dbse)] = -0.515
BIND['%s-MeMe-3.9' % (dbse)] = -0.480
BIND['%s-MeMe-4.0' % (dbse)] = -0.439
BIND['%s-MeMe-4.1' % (dbse)] = -0.396
BIND['%s-MeMe-4.2' % (dbse)] = -0.354
BIND['%s-MeMe-4.3' % (dbse)] = -0.315
BIND['%s-MeMe-4.4' % (dbse)] = -0.279
BIND['%s-MeMe-4.6' % (dbse)] = -0.217
BIND['%s-MeMe-4.8' % (dbse)] = -0.168
BIND['%s-MeMe-5.0' % (dbse)] = -0.130
BIND['%s-MeMe-5.4' % (dbse)] = -0.080
BIND['%s-MeMe-5.8' % (dbse)] = -0.050

BIND['%s-PyPy_S2-3.1' % (dbse)] =  2.442
BIND['%s-PyPy_S2-3.3' % (dbse)] = -1.125
BIND['%s-PyPy_S2-3.4' % (dbse)] = -2.016
BIND['%s-PyPy_S2-3.5' % (dbse)] = -2.534
BIND['%s-PyPy_S2-3.6' % (dbse)] = -2.791
BIND['%s-PyPy_S2-3.7' % (dbse)] = -2.870  # PyPy_S2 minimum
BIND['%s-PyPy_S2-3.8' % (dbse)] = -2.832
BIND['%s-PyPy_S2-3.9' % (dbse)] = -2.719
BIND['%s-PyPy_S2-4.0' % (dbse)] = -2.561
BIND['%s-PyPy_S2-4.1' % (dbse)] = -2.381
BIND['%s-PyPy_S2-4.2' % (dbse)] = -2.192
BIND['%s-PyPy_S2-4.3' % (dbse)] = -2.005
BIND['%s-PyPy_S2-4.4' % (dbse)] = -1.824
BIND['%s-PyPy_S2-4.5' % (dbse)] = -1.655
BIND['%s-PyPy_S2-4.7' % (dbse)] = -1.354
BIND['%s-PyPy_S2-5.0' % (dbse)] = -0.999
BIND['%s-PyPy_S2-5.5' % (dbse)] = -0.618
BIND['%s-PyPy_S2-6.0' % (dbse)] = -0.402
BIND['%s-PyPy_S2-6.5' % (dbse)] = -0.277
BIND['%s-PyPy_S2-7.0' % (dbse)] = -0.200

BIND['%s-PyPy_T3-4.1' % (dbse)] =  9.340
BIND['%s-PyPy_T3-4.3' % (dbse)] =  1.991
BIND['%s-PyPy_T3-4.5' % (dbse)] = -1.377
BIND['%s-PyPy_T3-4.6' % (dbse)] = -2.203
BIND['%s-PyPy_T3-4.7' % (dbse)] = -2.673
BIND['%s-PyPy_T3-4.8' % (dbse)] = -2.897
BIND['%s-PyPy_T3-4.9' % (dbse)] = -2.954  # PyPy_T3 minimum
BIND['%s-PyPy_T3-5.0' % (dbse)] = -2.903
BIND['%s-PyPy_T3-5.1' % (dbse)] = -2.784
BIND['%s-PyPy_T3-5.2' % (dbse)] = -2.625
BIND['%s-PyPy_T3-5.3' % (dbse)] = -2.447
BIND['%s-PyPy_T3-5.4' % (dbse)] = -2.263
BIND['%s-PyPy_T3-5.5' % (dbse)] = -2.080
BIND['%s-PyPy_T3-5.7' % (dbse)] = -1.742
BIND['%s-PyPy_T3-6.0' % (dbse)] = -1.324
BIND['%s-PyPy_T3-6.5' % (dbse)] = -0.853
BIND['%s-PyPy_T3-7.0' % (dbse)] = -0.574
BIND['%s-PyPy_T3-8.0' % (dbse)] = -0.296
BIND['%s-PyPy_T3-9.0' % (dbse)] = -0.175

BIND['%s-BzBz_PD32-0.2' % (dbse)] =  3.301
BIND['%s-BzBz_PD32-0.4' % (dbse)] =  2.678
BIND['%s-BzBz_PD32-0.6' % (dbse)] =  1.783
BIND['%s-BzBz_PD32-0.8' % (dbse)] =  0.781
BIND['%s-BzBz_PD32-1.0' % (dbse)] = -0.171
BIND['%s-BzBz_PD32-1.2' % (dbse)] = -0.954
BIND['%s-BzBz_PD32-1.4' % (dbse)] = -1.508
BIND['%s-BzBz_PD32-1.5' % (dbse)] = -1.695
BIND['%s-BzBz_PD32-1.6' % (dbse)] = -1.827
BIND['%s-BzBz_PD32-1.7' % (dbse)] = -1.911
BIND['%s-BzBz_PD32-1.8' % (dbse)] = -1.950
BIND['%s-BzBz_PD32-1.9' % (dbse)] = -1.957  # BzBz_PD32 minimum
BIND['%s-BzBz_PD32-2.0' % (dbse)] = -1.937
BIND['%s-BzBz_PD32-2.2' % (dbse)] = -1.860
BIND['%s-BzBz_PD32-2.4' % (dbse)] = -1.767
BIND['%s-BzBz_PD32-2.6' % (dbse)] = -1.702
BIND['%s-BzBz_PD32-2.8' % (dbse)] = -1.680
BIND['%s-BzBz_PD32-3.0' % (dbse)] = -1.705

BIND['%s-BzBz_PD36-0.2' % (dbse)] = -1.293
BIND['%s-BzBz_PD36-0.4' % (dbse)] = -1.462
BIND['%s-BzBz_PD36-0.6' % (dbse)] = -1.708
BIND['%s-BzBz_PD36-0.8' % (dbse)] = -1.984
BIND['%s-BzBz_PD36-1.0' % (dbse)] = -2.248
BIND['%s-BzBz_PD36-1.2' % (dbse)] = -2.458
BIND['%s-BzBz_PD36-1.4' % (dbse)] = -2.597
BIND['%s-BzBz_PD36-1.5' % (dbse)] = -2.635
BIND['%s-BzBz_PD36-1.6' % (dbse)] = -2.652
BIND['%s-BzBz_PD36-1.7' % (dbse)] = -2.654  # BzBz_PD36 minimum
BIND['%s-BzBz_PD36-1.8' % (dbse)] = -2.642
BIND['%s-BzBz_PD36-1.9' % (dbse)] = -2.615
BIND['%s-BzBz_PD36-2.0' % (dbse)] = -2.575
BIND['%s-BzBz_PD36-2.2' % (dbse)] = -2.473
BIND['%s-BzBz_PD36-2.4' % (dbse)] = -2.356
BIND['%s-BzBz_PD36-2.6' % (dbse)] = -2.240
BIND['%s-BzBz_PD36-2.8' % (dbse)] = -2.130
BIND['%s-BzBz_PD36-3.0' % (dbse)] = -2.035

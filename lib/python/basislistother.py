...
def load_basfam_other():
    ...
    basis_631g.add_rifit('cc-pvdz-rifit')
    basis_631g_d_.add_rifit('cc-pvdz-rifit')
    basis_631g_d_p_.add_rifit('cc-pvdz-rifit')
    basis_631gs.add_rifit('cc-pvdz-rifit')
    basis_631gss.add_rifit('cc-pvdz-rifit')
    ...
    basis_631pg.add_rifit('heavy-aug-cc-pvdz-rifit')
    basis_631pg_d_.add_rifit('heavy-aug-cc-pvdz-rifit')
    basis_631pg_d_p_.add_rifit('heavy-aug-cc-pvdz-rifit')
    basis_631pgs.add_rifit('heavy-aug-cc-pvdz-rifit')
    basis_631pgss.add_rifit('heavy-aug-cc-pvdz-rifit')
    ...
    basis_631ppg.add_rifit('aug-cc-pvdz-rifit')
    basis_631ppg_d_.add_rifit('aug-cc-pvdz-rifit')
    basis_631ppg_d_p_.add_rifit('aug-cc-pvdz-rifit')
    basis_631ppgs.add_rifit('aug-cc-pvdz-rifit')
    basis_631ppgss.add_rifit('aug-cc-pvdz-rifit')
    ...
    basis_6311g.add_rifit('cc-pvtz-rifit')
    basis_6311g_d_.add_rifit('cc-pvtz-rifit')
    basis_6311g_d_p_.add_rifit('cc-pvtz-rifit')
    basis_6311gs.add_rifit('cc-pvtz-rifit')
    basis_6311gss.add_rifit('cc-pvtz-rifit')
    basis_6311g_2d_.add_rifit('cc-pvtz-rifit')
    basis_6311g_2d_p_.add_rifit('cc-pvtz-rifit')
    basis_6311g_2d_2p_.add_rifit('cc-pvtz-rifit')
    basis_6311g_2df_.add_rifit('cc-pvtz-rifit')
    basis_6311g_2df_p_.add_rifit('cc-pvtz-rifit')
    basis_6311g_2df_2p_.add_rifit('cc-pvtz-rifit')
    basis_6311g_2df_2pd_.add_rifit('cc-pvtz-rifit')
    basis_6311g_3df_.add_rifit('cc-pvtz-rifit')
    basis_6311g_3df_p_.add_rifit('cc-pvtz-rifit')
    basis_6311g_3df_2p_.add_rifit('cc-pvtz-rifit')
    basis_6311g_3df_2pd_.add_rifit('cc-pvtz-rifit')
    basis_6311g_3df_3pd_.add_rifit('cc-pvtz-rifit')
    ...
    basis_6311pg.add_rifit('heavy-aug-cc-pvtz-rifit')
    basis_6311pg_d_.add_rifit('heavy-aug-cc-pvtz-rifit')
    basis_6311pg_d_p_.add_rifit('heavy-aug-cc-pvtz-rifit')
    basis_6311pgs.add_rifit('heavy-aug-cc-pvtz-rifit')
    basis_6311pgss.add_rifit('heavy-aug-cc-pvtz-rifit')
    basis_6311pg_2d_.add_rifit('heavy-aug-cc-pvtz-rifit')
    basis_6311pg_2d_p_.add_rifit('heavy-aug-cc-pvtz-rifit')
    basis_6311pg_2d_2p_.add_rifit('heavy-aug-cc-pvtz-rifit')
    basis_6311pg_2df_.add_rifit('heavy-aug-cc-pvtz-rifit')
    basis_6311pg_2df_p_.add_rifit('heavy-aug-cc-pvtz-rifit')
    basis_6311pg_2df_2p_.add_rifit('heavy-aug-cc-pvtz-rifit')
    basis_6311pg_2df_2pd_.add_rifit('heavy-aug-cc-pvtz-rifit')
    basis_6311pg_3df_.add_rifit('heavy-aug-cc-pvtz-rifit')
    basis_6311pg_3df_p_.add_rifit('heavy-aug-cc-pvtz-rifit')
    basis_6311pg_3df_2p_.add_rifit('heavy-aug-cc-pvtz-rifit')
    basis_6311pg_3df_2pd_.add_rifit('heavy-aug-cc-pvtz-rifit')
    basis_6311pg_3df_3pd_.add_rifit('heavy-aug-cc-pvtz-rifit')
    ...
    basis_6311ppg.add_rifit('aug-cc-pvtz-rifit')
    basis_6311ppg_d_.add_rifit('aug-cc-pvtz-rifit')
    basis_6311ppg_d_p_.add_rifit('aug-cc-pvtz-rifit')
    basis_6311ppgs.add_rifit('aug-cc-pvtz-rifit')
    basis_6311ppgss.add_rifit('aug-cc-pvtz-rifit')
    basis_6311ppg_2d_.add_rifit('aug-cc-pvtz-rifit')
    basis_6311ppg_2d_p_.add_rifit('aug-cc-pvtz-rifit')
    basis_6311ppg_2d_2p_.add_rifit('aug-cc-pvtz-rifit')
    basis_6311ppg_2df_.add_rifit('aug-cc-pvtz-rifit')
    basis_6311ppg_2df_p_.add_rifit('aug-cc-pvtz-rifit')
    basis_6311ppg_2df_2p_.add_rifit('aug-cc-pvtz-rifit')
    basis_6311ppg_2df_2pd_.add_rifit('aug-cc-pvtz-rifit')
    basis_6311ppg_3df_.add_rifit('aug-cc-pvtz-rifit')
    basis_6311ppg_3df_p_.add_rifit('aug-cc-pvtz-rifit')
    basis_6311ppg_3df_2p_.add_rifit('aug-cc-pvtz-rifit')
    basis_6311ppg_3df_2pd_.add_rifit('aug-cc-pvtz-rifit')
    basis_6311ppg_3df_3pd_.add_rifit('aug-cc-pvtz-rifit')
